...
<td style="text-align:left;" colspan="5"><b><?php if($name!=''){ echo $name;}?></b></td>
   ...
   <td colspan="7" style="text-align:justify;">
		Allmart Building No. 2,
		MHB Colony No. 1,<br/>Near Pancholia School,
		Mahavir Nagar,<br/>Kandivali (W),
		Mumbai, Maharashtra, 400067 IN<br/>
...
?>
  ...
  <tr>
                ...
                <td style="border-collapse: collapse;border:1px solid #cccccc;text-align:left;font-size: 8px;width:10%;" ><?php if ($unitprice != '') {echo number_format($unitprice,2);}?></td>
