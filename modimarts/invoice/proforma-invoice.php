...
{
    include('../connect.php');
$show_email_sql = mysqli_query($con1, "select * from proforma_order_details  where oid='" . $oid . "' ");
...
$sql = mysqli_query($con1 , "SELECT * FROM proforma_Order_ent WHERE id = '".$oid."'");
...
$sql_address = mysqli_query($con1,"select * from proforma_new_order where oid='".$result["id"]."'");
        ...
        <div id="panel" style="padding: 0;margin: 0;">
            <table border="0" cellpadding="0" cellspacing="0" class="tb" width="100%">
                <tbody>
                    ...
                    <tr style="margin-bottom: 5px;"><td align="center" class="txt"  style="width: 25%;"></td><td align="center" class="txt" width="75%"><h2 >PROFORMA INVOICE</h2></td>
                    </tr>
                </tbody>
            </table>
            <table border="0" cellpadding="0" class="parent_table" cellspacing="0"  style="border:1px solid black;padding: 0;margin: 0;" width="100%"><tbody><tr><td colspan="12" style="padding: 0;margin: 0;"><table border="0" cellpadding="1" cellspacing="0" class="child_table"    style="margin-top: 5px;border-collapse: collapse;border-bottom: 1px solid black;" width="100%"><tbody>
                <tr><td colspan="2" style="border-right:1px solid black;font-size:9px;font-weight: bold;" >Details of Buyer (Sold to)
                    ...
                    <tr><td colspan="12" style="padding: 0;margin: 0;"><table border="0" cellpadding="1" cellspacing="0"   style="margin-top: 30px;border-collapse: collapse;"><tbody style="width: 100%;">
                        <tr><td colspan="2" style=" font-size:9px; color:#000;font-family: 'Muli', sans-serif;margin:5px;border-right: 1px solid black;">Invoice Number: </td>
                                        <td colspan="2" style=" font-size:9px; color:#000; font-family: 'Muli', sans-serif;margin:5px;border-right: 1px solid black;">Order Number: </td>
                                    </tr>
                                    <tr>
                                        <td colspan="2"  style=" font-size:9px; color:#000;font-family: 'Muli', sans-serif;margin:5px;border-right: 1px solid black;">Invoice Date: </td>
                                        <td colspan="2" style=" font-size:9px; color:#000; font-family: 'Muli', sans-serif;margin:5px;border-right: 1px solid black;">Order Date:</td>
                                    </tr>
                                    <tr>
                    ...
                    <tr ><td colspan="12" style="padding: 0;margin: 0;"><table cellpadding="2"  style="margin-top: 30px;border-collapse: collapse;"    width="100%" ><tbody><tr ><td align="center"  width="5%" style="font-size:8px;border:1px solid black;"><strong> S.N</strong>
                                                        ...
                                                        <td align="center" width="16%" style="font-size:8px;border:1px solid black;">
                                                            <strong>
                                                                Particulars
                                                            </strong>
                                                        </td>
                                                        ...
                                                        <td align="center" width="5%" style="font-size:8px;border:1px solid black;"><strong>Discount</strong>
                                                        </td>
                                                        <td align="center" width="8%" style="font-size:8px;border:1px solid black;"><strong>Discount Amt</strong>
                                                        </td>
                                                        <td align="center" width="9%" style="font-size:8px;border:1px solid black;">
                                                            <strong>
                                                                Rate
                                                         ...
                                                         <td align="center" width="9%" style="font-size:8px;border:1px solid black;"><strong>Taxable Amount</strong>
                                                        </td>
                                                        <td align="center" width="5%" style="font-size:8px;border:1px solid black;"><strong>GST %</strong>
                                                        </td>
                                                        <td align="center" width="9%" style="font-size:8px;border:1px solid black;"><strong>GST Amt</strong>
                                                        </td>
                                                        <td align="center" width="10%" style="font-size:8px;border:1px solid black;"><strong>Amount</strong>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                    $pcount=0;
                                                    ...
                                                    $ttldiscountamt=0;
                                                    $ttlnetamt=0;
                                                    $detail_sql = mysqli_query($con1,"select * from proforma_order_details where oid='".$oid."'");
                                                    while($pro_sql_result = mysqli_fetch_assoc($detail_sql)){
                                                        ...
                                                        $discountamount=$pro_sql_result['dis_amount']/$pro_qty;
                                                        }
                                                        else
                                                        {
                                                          $discountamount=0;  
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="right" width="9%" style="font-size:8px;border-right:1px solid black;"><?php echo number_format($pro_amount, 2); ?></td>
                                                        <td align="right" width="5%" style="font-size:8px;border-right:1px solid black;"> <?php if($discount!=0){ echo $discount."%";} else{ echo "";} ?></td>
                                                        <td align="right" width="8%" style="font-size:8px;border-right:1px solid black;"> <?php if($discountamount!=0){ echo $discountamount;} else{ echo "";} ?></td>
                                                    ...
                                                    <tr><td colspan="6" style="margin: 0;padding: 0;"><table border="1" cellpadding="6" cellspacing="0"  class="tb2" width="100%"><thead style="width: 100%;"><tr style="border: 1px solid black"><th style="font-size:8px;font-weight: bold;" height="15">
                                                                            Tax Name
                                                                        </th>
                                                        ...
                                                        <td style="border:1px solid black;">
                                                        </td><td colspan="5" rowspan="2" style="margin:0;padding: 0;border:1px solid black;"><table  cellpadding="6" cellspacing="0" style="margin-top: 30px;border-collapse: collapse;"><tbody style="width: 100%;"><tr><td style="border: 1px solid black;width: 42%;font-size:8px;" height="15">
                                                                        Net Amount
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td style="font-size:8px;border:1px solid black" align="right">
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <tr>
                                                        <td colspan="7" height="10" style="font-size:8px;" align="left" style="margin:15px;">
