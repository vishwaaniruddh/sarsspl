...
<head>
  ...
  <!-- Title -->
  <title>Login | Allmart Merchant Panel</title>  
  <!-- Favicon 
...
<body>
  ...
  <div class="login-widget login-login" >
    ...
    <a href="#">
        <!--<img src="" alt="">-->
        <!--<h4 class="typo login-title">User Panel Login / <a href="Sell.php">Register</a></h4>-->
        <h2 class="typo login-title"> <a href="Sell.php">Register</a></h2>
    </a>
    </header>
    <h4 class="typo login-title">Merchant Panel Login</h4>
    <form action="mem_login.php" method="post" >
      <div class="form-separator form-field">
        <div class="field-icon field-icon-left">
          <i class="i">&#xf007;</i>
          <input type="text" class="form form-full" name="uname" placeholder="Username">
        </div>
      </div>
      <div class="form-separator form-field" style="display: flex;">
        <div class="field-icon field-icon-left">
          <i class="i">&#xf023;</i>
          <input type="password" class="form form-full" name="passwd" id= "passwd" placeholder="Password">
        </div>
        <!--<span toggle="#passwd" class="fa fa-fw fa-eye field-icon toggle-password" style="margin-left: -21px;z-index: 0;"></span>-->
        <span class=" field-icon-left" style="margin-left: -21px;z-index: 0;" onmouseup="hidepwd();" onmousedown="showpwd();">
          <i class="i">&#xf06e;</i>
        </span>
      </div>
 ...
 <!--   <header class="login-header">
    ...
    <h4 class="typo login-title">Forget Password ?? <a href="#" class="login-w">Login?</a></h4>
    <form action="forgotpassword.php" method="post">
      <div class="form-separator form-field">
        <div class="field-icon field-icon-left">
          <i class="i">&#xf0e0;</i>
          <input type="text" class="form form-full" name="email" placeholder="Email Recovery!">
        </div>
      </div>
      <div class="login-submit">
