...
<table class="tables"  align="center" cellpadding="4" cellspacing="0" id="attatch1">
    ...
    <script>
     ...
     <tr>
      ...
      <td >
            <input type="text" id="others" name="others" class="form form-full" /></td>
      ...
      <td >
          <!--<button type="button" class="btn blue" onclick="showEditor('showeditor');">Add More</button>-->
            <div id="showeothers" style="display:none;">
                Additional Decription <input type="text" name="new_others" id="new_others"/>
            </div>
        </td>
     </tr>
     <tr>
    ...
    <td width="100px">
     ...
     <select class="form-control" name="var_type[]" onchange="getchng(this.value,'1')">
      ...
      <div class="row">
        <div class="col-md-6">
         <lable>Varients value</lable>
        <input type="text" name="var_val1[]" class="form form-full" />
        </div>
         <div class="col-md-6">
        <lable>Varients type</lable>
         <input list="varients1" name="browser" class="form-control" name="var_val2[]" id="browser">
         <datalist id="varients1">
        </datalist>
        </div>
        </div>
      </td>
...
function Addbtn() {
    ...
    var html='<tr><td><h3>Product varient '+nums+'</h3></td></tr><tr><td width="100px"><lable>Varients Name</lable><input type="text" name="var_name[]" class="form form-full" /></td><td width="100px"><div class="row"><div class="col-md-6"><lable>Varients price</lable><input type="text" name="var_price[]" class="form form-full" /></div><div class="col-md-6"><lable>Varients Image</lable><input type="file" name="var_img[]" class="form form-full" /></div></div></td></tr><tr><td width="100px"><lable>Varients Type</lable><select class="form-control" name="var_type[]" onchange="getchng(this.value,'+num+')"><option value="">Select Master</option><?php  $gquery = mysqli_query($con1, "SELECT * FROM `product_variant_master` WHERE under ='0'"); while ($rowq = mysqli_fetch_assoc($gquery)) { ?> <option value="<?=$rowq['id']?>" ><?=$rowq['name']?></option><?php }?></select></td><td><div class="row"><div class="col-md-6"><lable>Varients value</lable><input type="text" name="var_val1[]" class="form form-full" /></div><div class="col-md-6"><lable>Varients type</lable><input list="varients'+num+'" name="browser" class="form-control" name="var_val2[]" id="browser"><datalist id="varients'+num+'"></datalist></div></div></td></tr>';
