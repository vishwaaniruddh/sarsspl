...
?>
        ...
        <div class="title-sitemap grid-12">
          <h1 class="grid-6"><i>&#xf132;</i><span>Welcome to Vendor Panel</span></h1>
        ...
        <div class="grid-10">
            <div class="widget">
                ...
                <div class="widget-body">
                    <div>
   	                    <form id="form11" name="form11" action="processAddBlog.php" method="post" enctype="multipart/form-data" >
                            <table class="tables"  align="center" cellpadding="4" cellspacing="0" > 
                                ...
                                <tr>
                                    <td>Blog Title :</td>
                                    <td colspan="3"><input type="text" name="title" class="form form-full" /></td>
                                </tr>
                                <tr>
                                    <td><div align="left">Blog Image :</div></td>

                                    <td colspan="3"><input type="file" name="bimg" class="form" /></td>
                                                ...
                                                <tr>
                                                  ...
                                                  <td colspan="3"><textarea name="desc" class="form form-full" ></textarea></td>
                                        ...
                                        <tr>
                                          ...
                                          <td colspan="2" align="center">
                                            ...
                                            <input type="submit" value="Add Blog" id="submit" name="submit" class="btn btn-submit" />
                                              &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;
