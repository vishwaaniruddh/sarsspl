...
$sltingf=mysqli_fetch_array($con1,$slting);
    ...
    &nbsp; &nbsp;  Quentity: <font color="red"><?php echo $res["quantity"]; ?></font> <br/>
    <?php
    $c=$res["category"];
    $qryctg="SELECT name FROM main_cat where id='". $c."'";

                     $catg=mysqli_query($con1,$qryctg); 
                     $res7=mysqli_fetch_array($con1,$catg);
                     
    ?>
    &nbsp; &nbsp;Category:<font color="red"> <?php echo $res7["name"];; ?></font><br/> 
   &nbsp; &nbsp;Description:<font color="red"> <?php echo $res["description"];; ?></font><br/> 
   
     <td width="10%" > <a href="edit_product.php?pcode=<?php echo $res["code"]; ?>&cat=<?php echo $catid ?>"</a><div title="Edit" class="tipsy-s btn btn-o-icon btn-small btn-info"><i>&#xf044;</i></div></a>
