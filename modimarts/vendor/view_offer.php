          ...
          <div class="widget">
            ...
            <div class="widget-body">
                <div>
                    <div >                                    
                        <table class="tables" border="1" align="center"cellspacing="0" cellpadding="4" >
                            <tr>
                                <td colspan="4"><div align="center"><span class="style258 style149"><B>YOUR OFFERS </B></span></div></td>
                            </tr>
                            <?php
                            for ($i=0; $i<$num; $i++) 
                            {
                ...
                <td width="57%"> <b>Offer Title : </b><font color="red"><?php echo $oname; ?></font><br/>
                 ...
                 <td width="10%" >
                    <a href="edit_offer.php?offid=<?php echo $offid; ?>">
                        <div title="Edit" class="tipsy-s btn btn-o-icon btn-small btn-info"><i>&#xf044;</i></div>
                    </a>
                    <a href="javascript:confirm_delete('<?php echo $offid; ?>')" >
