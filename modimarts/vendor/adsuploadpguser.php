          ...
          <div class="widget">
            ...
            <div class="widget-body" >
                <form method="post" action="" onsubmit="return subfunc();" id="formf" name="formf">
                    <div>
                        <div> Select Period for which the ad will be displayed<br>
                            <input type="text" name="rdate[]" id="rdate"  class="inp-form" placeholder="from date" readonly/></td>
                            <td>
                                <input type="text" name="tdate[]" id="tdate"  class="inp-form" placeholder="to date" readonly/>
                            </td>
                            <td>
                                <input type="button" name="chk" id="chk"  class="inp-form" value="Check Availibility" onclick="checkavailfunc();"/>
                            </td>
                      ...
                      <div id="st2" style="display:none;">
                            <br>  Upload your Ad(Upload only mp4 format)<br>
