...
<!--<input type="text" name="pcat" class="form form-full" />--></div>
  ...
  <tr id="hd_NewCategory3" Style="">
     ...
     <td>Select Sub Category</td>
      ...
      <td><select id="pcat" name="pcat" class="form form-full" ><option value="">Select</option>
  ...
  <tr id="hd_NewCategory1" Style="display:none">
   ...
   <tr id="hd_NewCategory2" Style="display:none"><td>Create New Category</td>
   ...
   <input type="file" id="NewCategoryImgUpload" name="NewCategoryImgUpload"></td>
                                                ...
                                                <tr>
                                                  ...
                                                  <td colspan="3"><input type="text" name="pname" class="form form-full" onclick="subscrip();" required/></td>
