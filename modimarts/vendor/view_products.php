...
<html lang="en">
    <head>
        ...
        */
        ...
        var catprodid= document.getElementById("catProduct").value;
        if(perpg=="")
        {
            perp='10';
        }
        ...
        $.ajax({
           type: 'POST',    
            ...
            data:'Page='+Page+'&perpg='+perp+'&catid='+catid+'&catprodid='+catprodid,   /*+'&fdate='+fdate+'&tdate='+tdate+'&progress='+progress+'&actionid='+actionid+'&orderid='+orderid,*/
    ...
    function search(){
     ...
     function getCatProduct(){
        var catid= document.getElementById("catd").value;
         $.ajax({
          type:'POST',
          url:'searchproductbycatid.php',
          data:'id='+catid,
          success: function(msg){ debugger;
              //alert(msg);
              document.getElementById('catProduct').innerHTML="";
              document.getElementById('catProduct').innerHTML=msg;
          }
        })
    }
      </script>
      ...
      <div class="data grid-12">
        ...
        <div class="grid-10">
          <div class="widget">
            ...
            <div class="dropdown">
                Category : <select id="catd" onchange="getCatProduct()"> 
                    <?php
