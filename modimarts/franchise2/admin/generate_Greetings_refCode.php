...
?>
                  <script>
        window.location.href='https://modimart.world/franchise2/admin/generate_Greetings_refCode.php';
    </script>
    <?php
                               ...
                               foreach($query as $key => $value) {
                                ...
                                ?>
                                    <tr>
                                        <td><?=$key+1?></td>
                                        <td><?=$value['code']?></td>
                                        <td><a href="https://wa.me/?text=<?=urlencode('https://modimart.world/franchise2/Greetings/User/Register?refcode='.$value['code'])?>" target="_blank"> https://modimart.world/franchise2/Greetings/User/Register?refcode=<?=$value['code']?></a></td>
                                    </tr>
                                    <?php
                                    }
                                      ?>
                               ...
                               foreach($query as $key => $value) {
                                ...
                                ?>
                                    <tr>
                                        <td><?=$key+1?></td>
                                        <td><?=$value['code']?></td>
                                        <td><a href="https://wa.me/?text=<?=urlencode('https://modimart.world/franchise2/Greetings/Register/RegisterFranchise?refcode='.$value['code'])?>" target="_blank"> https://modimart.world/franchise2/Greetings/Register/RegisterFranchise?refcode=<?=$value['code']?></a></td>
                                    </tr>
                                    <?php
                                    }
                                      ?>
