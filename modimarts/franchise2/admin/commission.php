...
<body class="theme-red">
    ...
    <section class="content">
        <ul>
            ...
            <li>
                <a href="https://modimart.world/franchise2/com_distribution.php">Total Commission And Distribution(Level Wise)</a>
            </li>
            <li>
                <a href="https://modimart.world/franchise2/all_com.php">Total Commission With Bank Details</a>
            </li>
            <li>
                <a href="https://modimart.world/franchise2/franch_com_join.php">Joining Commission from 800 </a>
            </li>
            
                        <li>
                <a href="https://modimart.world/franchise2/overall_franch_com_join.php">Joining Commission from 800 - Overall</a>
            </li>
               <li>
                <a href="https://modimart.world/franchise2/admin/add_commission.php">Add Product Commission</a>
            </li>
        </ul>
    </section>
