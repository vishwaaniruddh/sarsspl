...
if ($check_sql_result = mysqli_fetch_assoc($check_sql)) {
    ...
    if ($check_sql_result['level_id'] <= 8) {?>
        ...
        <a class="btn btn-info btn-lg" target="_blank" href="https://modimart.world/franchise2/bill/pdf/bill.php?id=<?echo $userid ?>">Franchise Invoice</a>
    <?}
...
<script>
    function createRef(id)
    {
         ...
         $.ajax({
                url: "https://www.modimart.world/franchise2/admin/creatMemref.php",
                data: 'memcode=' + id,
                type: "POST",
