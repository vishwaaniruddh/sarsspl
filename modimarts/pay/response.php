...
$date = $_GET['date'];
$transction_id = $_GET['transction_id']; 
$amount = $_GET['amount'];
$insert_pay_details = "insert into transaction_details(name,bank_name,transction_id,date,amount) values ('".$name."','".$bank_name."','".$transction_id."','".$date."','".$amount."')";
mysqli_query($con1,$insert_pay_details);
// echo $insert_pay_details;exit;
