...
<div id="content">
    ...
    <!-- end page-heading -->
    <form action="addhomepageadsprocess.php" method="post" enctype="multipart/form-data">
    <div class="row">
        ...
        <div class="col-md-3 form-group">
            ...
            <select name="position" id="Type" class="form-control" required>
        ...
        <div class="col-md-3 form-group">
            ...
            <input type="file"  class="form-control" name="adsimg" required>
        </div>
