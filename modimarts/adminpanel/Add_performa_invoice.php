...
<div id="content">
    ...
    <!-- end page-heading -->
  <form action="proformaAddOrderProcess.php" method="post" onsubmit="return Checkform()">
    <div class="row form-group">
        <div class="col-md-3">
            <div class="form-group">
                <label>Order Date</label>
                <input type="text" name="orderdate" value="<?=date('d-m-Y h:i:s a')?>" class="form-control" id=""  required>
                 <input type="hidden" name="txnid" value="txn<?=time()?>" class="form-control" id="" required readonly>
                 <input type="hidden" name="ordertype" value="Proforma" class="form-control" id="" required readonly>
            </div>
        </div>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input name="is_franchise" type="hidden" value="0" >
            </div>
        </div>
        ...
        <table class="table table-responsive">
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td> <input colspan="2" type="number" id="totaldiscount" name="discount" step="0.01" min="0" class="form-control" value="0" readonly>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="5" align="right">Notes (Optional)</td>
                    ...
                    var product_id=array[1];
                     ...
                     $.ajax({
                         ...
                         var data = $.parseJSON(resultData)
                           ...
                           var prodata ='<input type="hidden" name="pid[]" value="'+pid+'"><input name="prod_id[]" type="hidden" value="'+prod_id+'"><input type="hidden" name="category_id[]" value="'+category_id+'"><input type="hidden" name="vendor[]" value="'+vendor+'"><input type="hidden" name="pro_img[]" value=""><input type="hidden" name="outside_product[]" value="0">';
