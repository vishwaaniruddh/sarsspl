...
<div id="content">
    ...
    <div class="row">
        <div class="col-md-3 form-group">
            <label>Date</label>
            <input type="text" value="<?=date('d-m-Y')?>" required class="form-control" name="date" id="date">
        </div>
        <div class="col-md-3 form-group">
            <label>Heading</label>
        ...
        <div class="col-md-3 form-group">
            ...
            <input type="text" required="" class="form-control" name="SourceName" id="SourceName">
        </div>
        <div class="col-md-3 form-group">
            ...
            <select name="Type" id="Type" class="form-control" required>
                ...
                <option value="2">Tv News</option>
                <option value="3">Print Media</option>
        ...
        <div class="col-md-3 form-group">
            <label>Tag</label>
            <input type="text"  class="form-control" name="tag" id="heading">
        </div>
        <div class="col-md-3 form-group">
