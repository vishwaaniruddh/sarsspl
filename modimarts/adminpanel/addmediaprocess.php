...
if (isset($_POST['Heading'])) {
    ...
    $tag       = mysqli_real_escape_string($con1, $_POST['tag']);
    ...
    if ($error == 0) {
        mysqli_query($con1, "INSERT INTO `PressReleases`( `press_type`, `heading`, `source_name`, `url`, `document`, `image`, `created_date`,`tag`) VALUES ('" . $Type . "','" . $heading . "','" . $SourceName . "','" . $url . "','" . $docdest_path . "','" . $imgdest_path . "','" . $date . "','".$tag."')");
