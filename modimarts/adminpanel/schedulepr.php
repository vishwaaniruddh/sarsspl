...
<div id="content">
  ...
  <tr> 
       <td>
              Date <input type="text" name="rdate" id="rdate"  class="inp-form" placeholder="from date"/></td>
...
$('#rdate').dcalendarpicker({format: 'dd-mm-yyyy'});
	...
	<td><input type="button" class="form-submit" name="search" value="Save" onclick="schfunc();"/></td>
