...
function getCallbackUrl()
{
	...
	return $protocol . $_SERVER['HTTP_HOST'] . '/oc1/adminpanel/response.php';
}
include('access.php');
include('header.php'); 
?>
...
<div class="main">
    ...
    <span><input type="text" id="pinfo" name="pinfo" placeholder="Product Info" value="<?php echo $_GET['mid'];?>" /></span>
    </div>
    ...
    <span><input type="text" id="mobile" name="mobile" placeholder="Mobile/Cell Number" value="7977539802" /></span>
    </div>
