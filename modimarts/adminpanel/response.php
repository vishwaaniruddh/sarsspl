...
if (isset($postdata ['key'])) {
	...
	if ($status == 'success' ) {
		...
		//Do success order processing here... id	transaction_id	mid	amount	date	req_hash	res_hash	status
		$ins = mysql_query("insert into merchant_transaction_history(transaction_id,mid,amount,date,req_hash,res_hash,status) values('".$txnid."','".$mid."','".$amount."','".$date."','".$resphash."','".$CalcHashString."',1)");
