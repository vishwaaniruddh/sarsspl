...
<div id="content">
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            $select_sql = mysqli_query($con1, "SELECT * FROM `Order_ent` WHERE id='611'");
            ...
            if (!empty($sql_result1)) {
                ...
                $allmart_commission = (($pro_amount/100)*$allmart_commission);
            }
            ...
            $date=date('d-m-Y');
            $com_details=$order_id."-".$promotion."-".$getprodeatils['id'];
            $reffid="0";


           
            $is_franchise=$order['is_franchise'];
            $villageList = Getvillagefranchasee($pincode);

            // $reff_amount="10";
            // echo '<pre>';print_r($pincode);echo '</pre>';
           $MyFunction= DistributeCommission($order_id, $commision, $f_id, $date, $com_details,$reffid,$order_id,$is_franchise,$reff_amount,$totalbillamount);
