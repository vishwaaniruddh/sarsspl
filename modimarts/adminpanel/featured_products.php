...
<h4>Featured Product</h4>
    <div class="row">
        ...
        <table class="table table-bordered">
            ...
            <tbody id="getdata">
            <?php 
            $proopt=mysqli_query($con1,"SELECT * FROM `products_extra_option` WHERE is_featured='1'")or die(mysqli_error($con1));
            $cnt = 1;
...
function AddExtraOption(prodname,pid,catid,proid,price,pro_img)
{
    $.ajax({
            ...
            type: 'post',
            data: {prodname:prodname,proid:proid,catid:catid,pid:pid,price:price,type:'1',pro_img:pro_img},
        success: function(response){
        // alert(response);
        if(response==1)
        {
