...
$txn_id = "txn-" . $txn_id;
    if ($is_franchise) {
        ...
        if ($introducer) {
            ...
            mysqli_query($con1, "insert into commission_details(txn_id,commission_to,amount,status,promotion,created_at,order_id,is_introducer,bill_amount,level) values('" . $txn_id . "','" . $introducer . "','" . $introcom . "','1','" . $promotion . "','".$date."','" . $order_id . "','1','".$bill_amount."','".$level."')");
             $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$introcom."','0','".$introducer."','".$txn_date."')");
    ...
    if ($reffid != '' && $reffid != 0) {
        ...
        $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$giveAmt."','0','".$reffid."','".$txn_date."')");
        ...
        if ($findvilage) {
            ...
            for ($j = 0; $j < $countVill; $j++) {
                ...
                if ($Villagesale != 0) {
                    ...
                    $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$distamount."','0','".$findvilage[$j]."','".$txn_date."')");
        ...
        if ($countvillage) {
            ...
            for ($k = 0; $k < $countvillage; $k++) {
                ...
                if ($Villagesale != 0) {
                    ...
                    $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$distamount."','0','".$findvilage[$k]."','".$txn_date."')");
       ...
       $count = mysqli_num_rows($pin_sql);
        ...
        $pin_mem        = $pin_sql_result['id'];
            ...
            mysqli_query($con1, "insert into commission_details(txn_id,commission_to,amount,status,promotion,created_at,order_id,is_introducer,hold,bill_amount,level) values('" . $txn_id . "','" . $pin_mem . "','" . $pin_amount . "','1','" . $promotion . "','" . $date . "','" . $order_id . "','" . $is_introducer . "','" . $hold . "','".$bill_amount."','7')");
             ...
             $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$pin_amount."','0','".$pin_mem."','".$txn_date."')");
    ...
    if ($taluka > 0) {
        ...
        $tal_mem        = $tal_sql_result['id'];
            ...
            mysqli_query($con1, "insert into commission_details(txn_id,commission_to,amount,status,promotion,created_at,order_id,is_introducer,hold,bill_amount,level) values('" . $txn_id . "','" . $tal_mem . "','" . $tal_amount . "','1','" . $promotion . "','" . $date . "','" . $order_id . "','" . $is_introducer . "','" . $hold . "','".$bill_amount."','6')");
             ...
             $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$tal_amount."','0','".$tal_mem."','".$txn_date."')");
       ...
       $count = mysqli_num_rows($dis_sql);
        ...
        $dis_mem        = $dis_sql_result['id'];
            ...
            mysqli_query($con1, "insert into commission_details(txn_id,commission_to,amount,status,promotion,created_at,order_id,is_introducer,hold,bill_amount,level) values('" . $txn_id . "','" . $dis_mem . "','" . $dis_amount . "','1','" . $promotion . "','" . $date . "','" . $order_id . "','" . $is_introducer . "','" . $hold . "','".$bill_amount."','5')");
             $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$dis_amount."','0','".$dis_mem."','".$txn_date."')");
       ...
       $count = mysqli_num_rows($div_sql);
        ...
        $div_mem        = $div_sql_result['id'];
            ...
            mysqli_query($con1, "insert into commission_details(txn_id,commission_to,amount,status,promotion,created_at,order_id,is_introducer,hold,bill_amount,level) values('" . $txn_id . "','" . $div_mem . "','" . $div_amount . "','1','" . $promotion . "','" . $date . "','" . $order_id . "','" . $is_introducer . "','" . $hold . "','".$bill_amount."','4')");
             ...
             $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$div_amount."','0','".$div_mem."','".$txn_date."')");
    ...
    if ($state > 0) {
        ...
        $state_mem        = $state_sql_result['id'];
            ...
            $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$state_amount."','0','".$state_mem."','".$txn_date."')");
    ...
    if ($zone > 0) {
        ...
        $zone_mem        = $zone_sql_result['id'];
            ...
            mysqli_query($con1, "insert into commission_details(txn_id,commission_to,amount,status,promotion,created_at,order_id,is_introducer,hold,bill_amount,level) values('" . $txn_id . "','" . $zone_mem . "','" . $zone_amount . "','1','" . $promotion . "','" . $date . "','" . $order_id . "','" . $is_introducer . "','" . $hold . "','".$bill_amount."','2')");
             ...
             $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$zone_amount."','0','".$zone_mem."','".$txn_date."')");
    ...
    if ($country > 0) {
        ...
        $country_mem        = $country_sql_result['id'];
            ...
            mysqli_query($con1, "insert into commission_details(txn_id,commission_to,amount,status,promotion,created_at,order_id,is_introducer,bill_amount,level) values('" . $txn_id . "','" . $country_mem . "','" . $country_amount . "','1','" . $promotion . "','" . $date . "','" . $order_id . "','" . $is_introducer . "','".$bill_amount."','1')");
             ...
             $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$country_amount."','0','".$country_mem."','".$txn_date."')");
    ...
    $inlag=mysql_query($con1,"INSERT INTO `commission_transaction`(`order_id`, `payment_id`, `amount`, `txn_type`, `commission_to`, `txn_date`) VALUES ('".$order_id."','','".$sar_amount."','0','SAR','".$txn_date."')");
}
}
else
{
