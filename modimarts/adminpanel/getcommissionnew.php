...
<div id="content">
    <?php 
$view="SELECT * FROM `commission_details` WHERE bill_amount<>0 Group BY `order_id` ORDER BY `commission_details`.`id` DESC";
$view=mysqli_query($con1,$view);

?>
<div class="row">
    <a href="/adminpanel/CommissionDetails.php" class="btn btn-danger" style="float:right;">Get All COmmission Details</a>
    <div class="col-md-12">
    ...
    <td><?php $franchisedata=mysqli_fetch_assoc(mysqli_query($con1,"SELECT is_franchise FROM `Order_ent` WHERE `id`='".$order_id."'"));
