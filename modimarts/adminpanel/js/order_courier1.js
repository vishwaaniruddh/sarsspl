function openform() {
    ...
    if (length != '' && breadth != '' && height != '' && weight != '') {
       ...
       var orderitemid= $("#orderitemid").val();
        ...
        CheckStatusResponse(orderitemid,itemid);
    }
    $('#form').modal('hide');
    return false;
}
...
function CheckStatusResponse(itemid1,itemid) {
    // alert(itemid);
    ...
    $.ajax({
        type: "POST",
        url: "/adminpanel/testingdata.php",
        data: postdata,
        success: function(res) {
            ...
            if (status == 1) {
                console.log(message);
                sendOrderShipRocket(itemid,itemid1);
                 // alert("sendOrderShipRocket");
            } else if (status == 2) {
                console.log(message);
                sendOrderShipRocket(itemid,itemid1);
                // alert("sendOrderShipRocket");
                ...
                console.log(message);
                var channelid = result.data.channel_id;
                var item_id = result.data.oid;
                sendOrderToShipRocket(channelid,item_id,itemid1);
                // alert("sendOrderToShipRocket");
            } else if (status == 4) {
                console.log(message);
                var order_ids = result.data.order_ids;
                CheckCourier(order_ids);
                // alert("CheckCourier");
            } else if (status == 7) {
                console.log(message);
...
function CheckCourier(order_ids) {
    debugger;
    $('.loader').show();
    ...
    $.ajax(settings).done(function(response) {
        ...
        if (status_code == 200) {
            ...
            $.ajax({
                type: "POST",
                url: "/adminpanel/addshippingdata1.php",
                data: 'order_ids=' + order_ids + '&responce2=' + res2 + '&CheckCourier=1',
                success: function(msg) {
                    console.log(msg);
                    if (msg == 1) {

                        var url = "/adminpanel/ShippingDetails1.php?track_id=" + order_ids;
...
function sendOrderShipRocket(itemid,itemid1) {
    debugger;
    $('.loader').show();
    ...
    $.ajax(settings).done(function(response) {
        ...
        if (channelid > 0) {
            $('.loader').hide();
            sendOrderToShipRocket(channelid, itemid,itemid1);
        }
        //alert(channelid);
    });
}

function sendOrderToShipRocket(channelid, itemid,itemid1) {
    debugger;
    // $('.loader').show();
    ...
    var customeord= $("#custome_"+itemid).val()
    
    var sub_total = $('#sub_total_'+itemid).val();
    var order_items = $('#order_items_'+itemid).val();
                                                        ...
                                                        $.ajax(settings).done(function(response) {
                                                            ...
                                                            if (status_code) {
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",
                                                                    url: "/adminpanel/addshippingdata1.php",
                                                                    data: 'ids='+ids+'&item_id=' + itemid1 + '&oid=' + order_id + '&channel_id=' + channelid + '&responce1=' + responce1 + '&responce2=' + res2 + '&shipment_id=' + shipment_id + '&order_ids=' + order_ids + '&sendOrderToShipRocket=1',
                                                                    success: function(msg) {
                                                                        console.log(msg);
                                                                        if (msg == 1) {
                                                                ...
                                                                $.ajax({
                                                                    type: "POST",
                                                                    url: "/adminpanel/addshippingdata1.php",
                                                                    data: 'ids='+ids+'&item_id=' + itemid1 + '&oid=' + order_id + '&channel_id=' + channelid + '&responce1=' + responce1 + '&responce2=' + res2 + '&shipment_id=""&order_ids=""&sendOrderToShipRocket=1',
                                                                    success: function(msg) {
                                                                        console.log(msg);
                                                                        if (msg == 1) {
                                                                            $('.loader').hide();
...
function ganerateAWB(shipment_id, order_ids) {
    $('.loader').show();
    var courier_id = $("#Courier_id").val();
    if (courier_id != "" && shipment_id != "" && order_ids != "") {
        generate_awb(courier_id, shipment_id, order_ids);
        // alert(courier_id);
        $('.loader').hide();
    } else {
...
function generate_awb(courier_id, shipment_id, order_ids) {
    debugger;
    $('.loader').show();
    var jwt_token = $("#jwt_token").val();
    var settings = {
    ...
    $.ajax(settings).done(function(response) {
        ...
        if (status) {
            ...
            $.ajax({
                type: "POST",
                url: "/adminpanel/addshippingdata1.php",
                data: 'order_ids=' + order_ids + '&shipment_id=' + shipment_id + '&awb_code=' + awb_code + '&responce2=' + res2 + '&generate_awb=1',
                success: function(msg) {
                    console.log(msg);
                    // alert(msg);
                    if (msg == 1) {
                        $('.loader').hide();
                        generate_pickup(shipment_id,order_ids, awb_code);
                    }
                }
            });
        } else {
        ...
        $.ajax({
            type: "POST",
            url: "/adminpanel/addshippingdata1.php",
            data: 'order_ids=' + order_ids + '&shipment_id=' + shipment_id + '&awb_code=""&responce2=' + res2 + '&generate_awb=1',
            success: function(msg) {
                console.log(msg);
                alert(msg);
                if (msg == 1) {
...
function generate_pickup(shipment_id, order_ids, awb_code) {
    debugger;
    $('.loader').show();
    var jwt_token = $("#jwt_token").val();
    ...
    $.ajax(settings).done(function(response) {
        ...
        if (status) {
            ...
            $.ajax({
                type: "POST",
                url: "/adminpanel/addshippingdata1.php",
                data: 'order_ids=' + order_ids + '&shipment_id=' + shipment_id + '&responce2=' + res2 + '&generate_pickup=1',
                success: function(msg) {
                    console.log(msg);
                    if (msg == 1) {
                        $('.loader').hide();
...
function generateManifest(shipment_id, order_ids) {
    debugger;
    $('.loader').show();
    var jwt_token = $("#jwt_token").val();
    var settings = {
    ...
    $.ajax(settings).done(function(response) {
        ...
        if (status) {
            ...
            $.ajax({
                type: "POST",
                url: "/adminpanel/addshippingdata1.php",
                data: 'order_ids=' + order_ids + '&shipment_id=' + shipment_id + '&responce2=' + res2 + '&generateManifest=1',
                success: function(msg) {
                    console.log(msg);
...
function generateLabel(shipment_id, order_ids) {
    debugger;
    $('.loader').show();
    var jwt_token = $("#jwt_token").val();
    var settings = {
    ...
    $.ajax(settings).done(function(response) {
        ...
        if (status) {
            ...
            $.ajax({
                type: "POST",
                url: "/adminpanel/addshippingdata1.php",
                data: 'order_ids=' + order_ids + '&shipment_id=' + shipment_id + '&responce2=' + res2 + '&generateLabel=1',
                success: function(msg) {
                    console.log(msg);
                    var resp = JSON.parse(msg);
                    var res_status = resp.status
