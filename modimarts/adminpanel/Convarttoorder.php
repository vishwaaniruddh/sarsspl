...
<div id="content">
    ...
    <?php 
    $getProformaOrders=mysqli_query($con1,"SELECT * FROM `proforma_Order_ent` WHERE id='".$OrderPId."'");
    $getorderdata=mysqli_fetch_assoc($getProformaOrders);

    $sql_address = mysqli_query($con1,"select * from proforma_new_order where oid='".$OrderPId."'");
  ...
  <!-- <form action="#" method="post"onsubmit="return Checkform()" > -->
    <input type="hidden" name="ProformaBill" value="<?=$OrderPId?>">
	<div class="row form-group">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <select name="ordertype" id="" class="form-control" required>
                    ...
                    <option value="Account Transfer" selected>Account Transfer </option>
         ...
         <div class="col-md-3 col-lg-3">
            <div class="form-group">
                ...
                <select name="ship_to" id="" class="form-control" required>
                    ...
                    <option value="1" selected>Given Address</option>
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="text" name="customre_Name" value="<?=$username?>" id="" class="form-control" required>
            </div>          
        </div>
        <div class="col-md-3 col-lg-3">
            <div class="form-group">
        ...
        <div class="col-md-3">
            <div class="form-group">
                ...
                <input type="email" name="customre_Email" value="<?=$email?>" id="" class="form-control" >
            </div>          
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label>Customer Mobile</label>
                <input type="number" name="customre_Mob" value="<?=$phone?>" id="mob" onkeydown="return ismob()" pattern="^[6-9]\d{9}$" class="form-control" autocomplete="off"  autocorrect="off" autocapitalize="off" required>
            </div>          
        </div>
         <div class="col-md-3">
            <div class="form-group">
                <label>GST Number </label>
                <input type="text" name="gstnumber" id="" value="<?=$getorderdata['gst_details']?>" onkeyup="this.value = this.value.toUpperCase();" class="form-control" placeholder="Enter GST Number">
            </div>          
        </div>
        <div class="col-md-3">
            <div class="form-group">
                <label>PAN Number</label>
                <input type="text" name="pannumber" value="<?=$getorderdata['pan_details']?>" onkeyup="this.value = this.value.toUpperCase();" id="" class="form-control" placeholder="Enter Pan Number">
            </div>          
        </div>
	</div>
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="shipping_addres" id=""  class="form-control" cols="30" rows="1" required><?=$address?></textarea>
            </div>          
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label>City </label>
                <input type="text" name="shipping_city" value="<?=$city?>" id="" class="form-control" placeholder="Enter City " required>
            </div>          
        </div>
        <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="form-group">
                <label>Pincode</label>
                <input type="number" name="shipping_zip" value="<?=$pincode?>" id="" class="form-control" placeholder="Enter Pincode">
            </div>          
        </div>
    </div>
    <div class="col-md-6">
      ...
      <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea name="billing_addres" id=""  class="form-control" cols="30" rows="1" required><?=$address?></textarea>
            </div>          
        </div>
        <div class="col-md-4">
            <div class="form-group">
                <label>Billing City </label>
                <input type="text" name="billing_city" id="" value="<?=$city?>" class="form-control" placeholder="Enter City " required>
            </div>          
        </div>
        <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="number" name="billing_zip" id="" value="<?=$pincode?>" class="form-control" placeholder="Enter Pincode">
            </div>          
        </div>
    </div>
  </div>
        ...
        <table class="table table-responsive">
            ...
            <tbody>
                <?php 
                 $prodata = array();
                    $i=0;
                    $getordersdata = mysqli_query($con1,"select * from proforma_order_details  where oid='".$OrderPId."' ");
                    foreach ($getordersdata as $key => $value) {
                     $item_id=$value['item_id'];
                     $_product_id   = explode('/', $item_id);

                    $pid   =  $_product_id[0];
                    $category_id   =  $_product_id[1];
                    $prod_id  =  $_product_id[2];                        
                     ?>
            <tr id="prorow_<?=$key+1?>">
                <td>
                    <input type="text" name="productId[]" class="form-control" value="<?=$value['product_name']?>" id="productId_<?=$key+1?>" readonly="">
                    <input type="hidden" name="pid[]" value="<?=$pid?>">
                    <input name="prod_id[]" type="hidden" value="<?=$prod_id?>">
                    <input type="hidden" name="category_id[]" value="<?=$category_id?>">
                    <input type="hidden" name="vendor[]" value="<?=$value['mrc_id']?>">
                    <input type="hidden" name="photo[]" value="<?=$value['image']?>">
                   </td>
                   <td>
                    <input type="text" name="productprice[]" value="<?=$value['rate']?>" onchange="subtotal()" step="0.01" min="0" class="form-control cprice" id="productprice_<?=$key+1?>">
                </td>
                <td>
                    <input type="text" name="productqty[]" value="<?=$value['qty']?>" onchange="subtotal()" class="form-control qty" id="productqty_<?=$key+1?>">
                </td>
                <td>
                    <input type="text" onchange="subtotal()" value="<?=$value['total_amt']?>" step="0.01" min="0" name="pro_total[]" class="form-control subtotal" id="pro_total_<?=$key+1?>">
                </td>
                <td>
                  <input type="text" onchange="subtotal()" name="pro_dis[]" value="<?=$value['discount']?>" min="1" class="form-control prodis" id="pro_total_1"  required>
                  
                </td> 
                <td>
                  <input type="text" onchange="subtotal()" name="pro_disamt[]" value="<?=$value['dis_amount']?>" min="1" class="form-control prodisamt" id="pro_total_1" readonly required>
                  
                </td>
                <td>
                    <button class="btn btn-sm btn-danger" onclick="Remove(<?=$key+1?>)">remove</button></td>
                </tr>            
            <?php } ?>
            </tbody>
            ...
            <tfoot>
                ...
                <tr>
                    ...
                    <td> <input colspan="2" type="number" id="totaldiscount" name="discount" step="0.01" min="0" class="form-control" value="<?=$getorderdata['discount']?>" >                     
                    </td>
                </tr>
                <tr>
                    <td colspan="3" align="right">Shipping Charges</td>
                    <td> <input colspan="2" type="number" name="shipping_charges" step="0.01" min="0" class="form-control" value="<?=$getorderdata['shipping_charges']?>" >
                    </td>
                </tr>
                <tr>
                    <td colspan="3" align="right">Total</td>
                    <td> <input colspan="2" type="number" name="g_total" class="form-control" value="<?=$getorderdata['amount']?>" id="g_total" readonly>
                      <input  type="hidden" name="totalqty" value="" id="totalqty" required>
                      <input type="hidden" type="hidden" id="rowcount" value="<?=$key+1?>">
                    </td>
                </tr>
                <tr>
                    <td colspan="3" align="right">Notes (Optional)</td>
                    <td> <input colspan="2" type="text" value="<?=$getorderdata['Notes']?>" name="Notes" class="form-control" >
