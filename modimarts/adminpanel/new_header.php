...
<div id="page-top">
	...
	<ul  id="menu">
     ...
     <li class="dropdown  navbar-right special-menu" style="margin-right: -250px;"> <a href="logout.php">LogOut</a> </li>
</ul>
 	<div class="clear"></div>
</div>
<!-- End: page-top -->
        ...
        <div class="nav-bg-class">
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
              ...
              <ul class="nav navbar-nav" id="menu">
            	...
            	<li id="hdm11" style="display:none;"><a href="#" title="Merchant proct">Merchant Products</a>
            		<ul>
                        ...
                        <li ><a href="SetcourierData.php" title="Product Report">Set Courier Charge</a></li>
                        <li ><a href="tadkaProduct.php" title="Product Report">Tadka Products</a></li>
            ...
            <li id="hdm20" >
                ...
                <ul>
                  <li><a href="ManagePress.php" title="Manage Media">Manage Media</a></li>
                  <li><a href="ManageReview.php" title="Work Details">Manage Review</a></li>
                  </ul>
            </li>
