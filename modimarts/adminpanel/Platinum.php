...
?>
<?php include('header.php'); ini_set( "display_errors", 0);
include('config.php');
$sql_statement ="select name,code,memtype from clients where memtype='Platinum' or memtype='3000'";
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<td class="green-left"  height="40px;" valign="middle"> <a href="Register.php">Add new one Customer.</a></td>
			  ...
			  <!--  start product-table ..................................................................................... -->
                ...
                <?php
				include('config.php');
				$query = "select name,code,memtype from clients where memtype='Platinum' or memtype='3000' LIMIT " . $from . "," . $offset;
...
while($row=mysql_fetch_row($result)){
				...
				<tr class="alternate-row">
					...
					<a href="deleteCustomer.php?cmp=<?php echo $row[1]; ?>" title="Delete" class="icon-2 info-tooltip"></a>
        	...
        	<?PHP
				...
				doPages($offset, 'Platinum.php', '', $total_records); 
			?>    
            </td>
		</tr>
