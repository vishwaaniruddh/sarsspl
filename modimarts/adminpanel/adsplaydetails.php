...
include('header.php'); 
$adid=$_GET['adid'];
$sql_statement = "SELECT * FROM ads_playdetails where ad_id='".$adid."'";
...
if($_POST['uplaodby']!="")
{
  $sql_statement.=" and  ccode='".$_POST['uplaodby']."' ";
...
window.open('viewproductimg.php?adid='+id,'parentcon',"scrollbars=yes, resizable=no,width=750, height=400, top="+top+", left="+left);
}catch(exc)
{
...
<?php
$getuplby=mysql_query("SELECT distinct(userid) FROM ad_booking_details");
...
<input type="submit" name="submit" action="" method="post" value="Search">-->
			  ...
			  <!--  start product-table ..................................................................................... -->
				...
				<tr>
                   ...
                   <!-- <th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">Ad name</p>	</th>
					...
					<th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">ads</p>	</th>
					<th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">date</p>	</th>
				...
				$query = "SELECT `id`, `ad_id`, `user_id`, `play_dtym` FROM `ads_playdetails` WHERE ad_id='".$adid."'" ;
				
	//	$query.=" and  status='0' ";
/*
if($_POST['uplaodby']!="")
{
  $query.=" and ccode='".$_POST['uplaodby']."' ";
...
while($row=mysql_fetch_array($result)){
	$query1 = "SELECT a.name FROM clients a,ad_booking_details b where a.code=b.userid and b.id='".$row['ad_id']."'";
//echo $query1;
...
$row1=mysql_fetch_array($result1);
				...
				<tr class="alternate-row">
					...
					<td><?php echo $row['play_dtym']; ?></td>
				<!--	<td><input type="button" onclick="fnc('<?php echo $row['code']; ?>');" value="View"></td>
					<td>
					    <?php if($adstats==2)
{

?>
					    <input type="button" id="app<?php echo $i1;?>" onclick="approvefunc('<?php echo $row['code']; ?>',this.id,'1');" value="Approve">
					<?php }elseif($adstats==1){
					?>
					<input type="button" id="app<?php echo $i1;?>" onclick="approvefunc('<?php echo $row['code']; ?>',this.id,'2');" value="Reject">
				<?php }else{
        	...
        	<?PHP
				...
				doPages($offset, 'adsplaydetails.php', '', $total_records); 
			?>    
            </td>
		</tr>
