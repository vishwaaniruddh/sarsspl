...
if($_POST["st"]=="1")
{
    $qrf=mysql_query("delete from `todays_date` ");
     
$qr=mysql_query("INSERT INTO `todays_date`(`dt`) values('".$dtt."') ");
if(!$qr)
{
  $errors++;  
}
...
$chkschdel=mysql_query("delete  from schedule_details where date='".$dtt."'");
...
{
  $qr=mysql_query("delete from `todays_date` ");
 if(!$qr)
{
  $errors++;  
} 
