...
$cid=$_GET['cmp'];
              ...
              $qry="select * from main_category where cid='$cid'";
...
<tr>
	...
	<tr valign="top">
	<td>
<form action='processEdit_mainCategory.php' method='post'>
<table align="center" border="0" width="50%" id="id-form">
  ...
  <td><input name="cname" size="50" type="text"  value="<?php echo $row[1]; ?>" class="inp-form"/></td></tr>
