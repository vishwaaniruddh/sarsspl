        ...
        if(adsnmarr.length>0)
        {
            ...
            success: function(msg){
               ...
               strr=strr+"</table>";
                ...
                document.getElementById("totalrs").value=totrs
                            ...
                            <div id="dv0">
    	                        <table align="center" width="100%">
                                    <tr>
    				                    ...
    				                    <td>
    				                        <input type="text" placeholder="Enter Name..."  id="dname0" name="dname[]"  class="inp-form" required></br>
    				                    ...
    				                    <td>
    				                        <input type="file" id="img0"  class="inp-form" name="img[]" onchange="setFileInfo(this.files,'0')"  style="padding: 14px;"></br>
                                            <lable class='errlable' id='imglable0' style='display:none;'><font color='red' size='1'>Select File</font></lable>
                                        </td>
                                        <td> Duration
                                            <input type="text" style="width:40%" id="durationv0" class="inp-form" name="durationv[]" readonly>
                                            <input type="hidden" style="width:40%" id="sizeinmb0" class="inp-form" name="sizeinmb[]" readonly>
                                        </td>
                                        <td>Description</td>
    				                    <td><input type="text" placeholder="Description"  id="desc0" name="desc[]"  class="inp-form" required ></td>
    				                    <td>
    				                        <input type="button"   id="dated0" name="dated[]"  onclick='selctdtfunc(0,"","");' value="Select Date"></br>
    				                        <input type="hidden"   id="dateslectedid0" name="dateslectedid[]"  class="inp-form" value="0">
    				                        <lable class='errlable' id='dtslable0' style='display:none;'><font color='blue' size='1'>Select Dates</font></lable>
                    				    </td>
                                        <td><button type="button" id="remv0" name="remv0" onclick="remfunc(0);">X</button></td>
                                    </tr>
                                </table>
    	                    </div>
    	                </div></br></br></br>
                        <input type="button" class="btn" name="addmore" value="Add More Ads" onclick="addmorefunc();"/>
                        <input type="button" class="btn" name="search" value="Show Details" onclick="showavailfunc();"/>
    	            </center>
                </div></br></br>
                <center> </center>
                <div id="uploaddiv">
...
<input type="hidden" id="totalrs" name="totalrs">
    ...
    <center>
      <div class="modal-contendets" >
        ...
        <div class="row" id="subtndiv">
            ...
            <div class="col-md-2" >
                <input type="button"  id="Submit"  value="" class="form-submit" onclick="submfunc();"/>
            </div>
            <div class="col-md-5"></div>
        </div>
        <div id="shprogdiv" style="display:none;">
            <div class="col-md-5"></div>
            <div class="col-md-2" >	<progress id="prog" max="100" value="0" style="height:30px"></progress><br>
                <input style="width:100px;" type="text" id="shperc" readonly/></div>
                <div class="col-md-5"></div>
            </div>
        </div>
    </center>
