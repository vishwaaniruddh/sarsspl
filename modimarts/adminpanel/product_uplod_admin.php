...
<div id="content">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Product Uploaded By Admin </h1>
	</div>
	<!-- end page-heading -->
<!--  start message-green -->
...
<form action="" method="POST">
			<!--	<div id="message-green">
				...
				<tr>
					<td class="green-left"  height="40px;" valign="middle"> <b>From Date </b>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
			  ...
			  <!--  start product-table ..................................................................................... -->
				<button onclick="myFunction()" style="margin-left:1088px;">Print this page</button><br />
                ...
                <?php
				include('config.php');
				$sql_statement = "SELECT * FROM `products` WHERE ccode='0'";
...
while($row=mysql_fetch_row($result)){
    ...
    $q="select name from categories where code='".$row[4]."' ";
    $r=mysql_query($q);
