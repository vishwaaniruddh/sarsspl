...
if(isset($_POST['product1']) && isset($_POST['is_product'])){
    ...
    //$pr=mysqli_query($con1,"SELECT * FROM `product_model` where status=0 and product_model='".$_POST['new_product']."'");
...
if($Maincate==1){	
    $table = 'fashion';
	/* $slting=mysqli_query($con1,"SELECT * FROM `fashion` where status=0 and name='".$_GET['pid']."'");
...
{
    $table = 'electronics';
     /*$slting=mysqli_query($con1,"SELECT * FROM `electronics` where status=0 and name='".$_GET['pid']."'");
     //echo "SELECT * FROM `electronics` where name='".$_GET['pid']."'";
     $pimg=mysqli_query($con1,"SELECT * FROM `electronics_img` where product_id='".$_GET['pid']."'");
	 $pspecification=mysqli_query($con1,"SELECT * FROM `electronicsSpecification` where product_id='".$_GET['pid']."'");*/  
}
else if($Maincate==218)
{
    $table = 'grocery';
     /*$slting=mysqli_query($con1,"SELECT * FROM `grocery` where status=0 and name='".$_GET['pid']."'");
     $pimg=mysqli_query($con1,"SELECT * FROM `grocery_img` where product_id='".$_GET['pid']."'");
	 $pspecification=mysqli_query($con1,"SELECT * FROM `grocerySpecification` where product_id='".$_GET['pid']."'");*/
} 
else if($Maincate==482)
{	 
    //$slting=mysqli_query($con1,"SELECT * FROM `Resale` where status=0 and status=0 and name='".$_GET['pid']."'");
} 
else
{
    $table = 'products';
     /*$slting=mysqli_query($con1,"SELECT * FROM `products` where status=0 and name='".$_GET['pid']."'");
     $pimg=mysqli_query($con1,"SELECT * FROM `product_img` where product_id='".$_GET['pid']."'");
	 $pspecification=mysqli_query($con1,"SELECT * FROM `productspecification` where product_id='".$_GET['pid']."'");*/
}
//$name=$_POST['name'];
 
   // $check_duplicate =mysqli_query($con1,"SELECT * FROM product_model where name = '".$name."'");
