...
//echo $Maincate;
if($Maincate==1) {	
	 $slting=mysqli_query($con1,"SELECT * FROM `fashion` where  code='".$_GET['pcode']."'");
	 //echo "SELECT * FROM `fashion` where  code='".$_GET['pcode']."'";
	 $pimg=mysqli_query($con1,"SELECT * FROM `fashion_img` where product_id='".$_GET['pcode']."'");
	 $pspecification=mysqli_query($con1,"SELECT * FROM `fashionSpecification` where product_id='".$_GET['pcode']."'");
}
else if($Maincate==190)
{	
    $slting=mysqli_query($con1,"SELECT * FROM `electronics` where  code='".$_GET['pcode']."'");
    //echo "SELECT * FROM `electronics` where name='".$_GET['pcode']."'";
    $pimg=mysqli_query($con1,"SELECT * FROM `electronics_img` where product_id='".$_GET['pcode']."'");
	$pspecification=mysqli_query($con1,"SELECT * FROM `electronicsSpecification` where product_id='".$_GET['pcode']."'");
}
else if($Maincate==218)
{	
    $slting=mysqli_query($con1,"SELECT * FROM `grocery` where code='".$_GET['pcode']."'");
    //echo "SELECT * FROM `grocery` where code='".$_GET['pcode']."'";
    $pimg=mysqli_query($con1,"SELECT * FROM `grocery_img` where product_id='".$_GET['pcode']."'");
	$pspecification=mysqli_query($con1,"SELECT * FROM `grocerySpecification` where product_id='".$_GET['pcode']."'");
} 
else if($Maincate==482)
{	
     $slting=mysqli_query($con1,"SELECT * FROM `Resale` where  code='".$_GET['pcode']."'");
     //echo "SELECT * FROM `Resale` where status=0 and code='".$_GET['pcode']."'";
     //$pimg=mysqli_query($con1,"SELECT * FROM `fashion_img` where product_id='".$_GET['pid']."'");
	 //$pspecification=mysqli_query($con1,"SELECT * FROM `fashionSpecification` where product_id='".$_GET['pid']."'");
} 
else
{	
     $slting=mysqli_query($con1,"SELECT * FROM `products` where code='".$_GET['pcode']."'");
     //echo "SELECT * FROM `products` where status=0 and code='".$_GET['pcode']."'";
     $pimg=mysqli_query($con1,"SELECT * FROM `product_img` where product_id='".$_GET['pcode']."'");
	 $pspecification=mysqli_query($con1,"SELECT * FROM `productspecification` where product_id='".$_GET['pcode']."'");
}
...
if(isset($_GET['pid']) && $_GET['pid']>0){
    ...
    /*$qry1 =mysqli_query($con1,"SELECT * FROM product_additional_details where product_id = '".$pid."'");*/
    $qry1 =mysqli_query($con1,"SELECT * FROM product_additional_details where product_id = '".$_GET['pcode']."'");
                        ...
                        <div class="tab-pane fade show active in" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="row register-form">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group display-prop">
                                        ...
                                        <select name="brand" class="selectpicker form-control">
                                          <?php 
                                           //get category
                                          $qry_br =mysqli_query($con1,"SELECT* FROM brand where status!=2");
                                    ...
                                    <div class="form-group display-prop">
                                        ...
                                        <select name="product" class="selectpicker form-control">
                                            <?php 
                                            //get category
                                            $qry_pr =mysqli_query($con1,"SELECT* FROM product_model where status!=2");
                                    ...
                                    <div class="form-group display-prop">
                                        ...
                                        <?php }  ?>
                                        <img src="/assets/allmart.png" alt="no img" width='8%'>
                                    </div>
                                    <div class="form-group display-prop">
                                        <label >Price</label>&nbsp;
                                ...
                                <div class="col-md-12" style="display:none">
                                    ...
                                    <div class="form-group display-prop">
                                        <?php 
                                            $qry_brand =mysqli_query($con1,"SELECT* FROM brand where status!=2 and id=".$_GET['bid']);
                                        ...
                                        <select name="brand1" class="selectpicker form-control">
                                          ...
                                          $qry_brands =mysqli_query($con1,"SELECT* FROM brand where status!=2");
                                     ...
                                     <div class="form-group display-prop">
                                         <?php 
                                            $qry_product =mysqli_query($con1,"SELECT* FROM product_model where status!=2 and id=".$result['name']);
                                        ...
                                        $qry_prod =mysqli_query($con1,"SELECT* FROM product_model where status!=2");
