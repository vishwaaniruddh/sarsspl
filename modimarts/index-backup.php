...
<div class="table-wrapper">
    <table class="fl-table" border="1" class="table">
      ...
      <th><a href="https://allmart.world/list/value-offer/803">Value Offer</th>
        ...
        <tr>
            <td><a href="https://allmart.world/catalog-product">17235</a></td>
            <?php
$categories=CategoryList('getCategoryList');
          ...
          <td><a href="https://allmart.world/catalog-product?category_id=<?=strcode($category->Category_id)?>"><?=GetTotalRecords($category->Category_id)?></a></td>
     
     <?php } ?>
      <td><a href="https://allmart.world/list/value-offer/803"><?=get_count(803,0)?></a></td> 
        </tr>
                    ...
                    <div class="grid-uniform featuredItems">
                      <div class="grid__item wide--two-thirds post-large--two-thirds large--two-thirds medium--grid__item">
                        <div class="grid__item wide--one-half post-large--one-half large--one-half medium--one-half two-blocks">
                          ...
                          <div class="overlay style_1" id="safetycardbannerimg" onclick="safetyCardClick()" style="cursor:pointer;">
                            <div class="featured-image">
                              <a class="banner_half_img" style="cursor:pointer;" href="https://allmart.world/<?=strurl("My Safety card")?>/P/<?=strcode(711)?>/<?=strcode(803)?>/<?=strcode(1427)?>">
                               <img loading="lazy" src="https://allmart.world/assets/mysafetycardEn.jpeg" alt="My Safety Card"  />
                              </a>
                            </div>
                          ...
                          <br/>
                        <div>
                           <a href="https://allmart.world/doctor_opinion.php" class=" btn btn-link " style="color:white;font-weight:600;margin-top: 17px;width: 100%;background: #fd1200;font-size: 15px;">Doctors Opinion</a>
                        </div>
                        </div>
                        </div>
                        <div class="grid__item wide--one-half post-large--one-half large--one-half medium--one-half two-blocks">
                          ...
                          <div class="overlay style_1" id="safetycardbannerimg" onclick="safetyCardClick()" style="cursor:pointer;">
                            <div class="featured-image">
                              <a class="banner_half_img" style="cursor:pointer;" href="https://allmart.world/<?=strurl("My Safety card")?>/P/<?=strcode(711)?>/<?=strcode(803)?>/<?=strcode(1427)?>">
                               <img loading="lazy" src="https://allmart.world/assets/mysafetycardHi.jpeg" alt="My Safety Card"  />
                              </a>
                            </div>
                            <div class="featured-content featured-content--160319541064fa7c38 imageText_position imgtxt-middle-right">
                              <div class="content-info" style="background: rgba(0, 0, 0, 0)">
                           ...
                           <br/>
                          <div>
                            <a href="https://allmart.world/PressReleases.php" style="color:white;font-weight:600;margin-top: 17px;width: 100%;background: #fd1200;font-size: 15px;" class=" btn btn-link">Press Releases</a>
                          </div>
                        </div>
                        </div>
                      </div>
                      ...
                      <div class="grid__item wide--one-third post-large--one-third large--one-third medium--grid__item">
                        <div class="middle-top">
                          <div class="overlay style_1">
                            <div class="featured-image">
                              <a class="banner_half_img" href="https://allmart.world/mask---3-ply---jebcon--/P/722/803/1432">
                                <img loading="lazy" src="assets/mask---3-ply---jebcon--.jpeg" alt="Organic Honey" />
                              </a>
                            </div>
                            <div class="featured-content featured-content--160319541064fa7c38 imageText_position imgtxt-middle-right">
                              <div class="content-info" style="background: rgba(0, 0, 0, 0)">
                               ...
                               Mask - 3 Ply - Jebcon
                                ...
                                <a class="link btn link1" href="https://allmart.world/mask---3-ply---jebcon--/P/722/803/1432" style="background: #f26522;color: #ffffff;">Shop Now</a>
                              </div>
                            </div>
                          </div>
                        </div>
                          ...
                          <div class="overlay style_1">
                            <div class="featured-image">
                              <a class="banner_half_img" href="#">
                                <img loading="lazy" src="assets/mask---n95-----q2.jpeg" alt="Health & Personal Care" />
                              </a>
                            </div>
                            <div class="featured-content featured-content--160319541064fa7c38 imageText_position imgtxt-middle-right">
                              <div class="content-info" style="background: rgba(0, 0, 0, 0)">
                                ...
                                <a class="link btn link2" href="https://allmart.world/mask---n95-----q2/P/655/803/1352" style="
                                          background: #ffc29b;
                                          color: #000000;
                                        ">Shop Now </a>
                              </div>
                              ...
                              <div class="support-wrapper">
                                ...
                                <div class="icon-img">
                                  ...
                                  <a href="">
                                    ...
                                    <img loading="lazy" src="https://allmart.world/assets/icon-4_medium.png" alt="Secure Payment" /></a>
                              ...
                              <div class="support-wrapper">
                                ...
                                <div class="icon-img">
                                  ...
                                  <a href="">
                                    ...
                                    <img loading="lazy" src="https://allmart.world/assets/icon-3_medium.png" alt=" Support" /></a>
...
<div id="shopify-section-home-wide-banner-1" class="shopify-section index-section home-wide-banner">
  ...
  <div class="container">
    ...
    <div class="wide-banner-type" style="
            ...
            ">
<!-- background-image: url('https://allmart.world/assets/img-4_705773b7-20ef-4f02-b468-20850646d48c_1920X.jpg');-->
...
<div id="shopify-section-home-blog-posts-2" class="shopify-section index-section home-blog-type">
  ...
  <div id="shopify-section-home-newsletter" class="shopify-section index-section">
    ...
    <div data-section-id="home-newsletter" data-section-type="home-newsletter-block" class="home-newsletter-block" style="
            ...
            background-image: url('https://allmart.world/assets/img-5_1920X.jpg');
