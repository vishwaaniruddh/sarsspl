...
<html>
    <head>
        ...
        <title> offline orders | MOdi Mart </title>
        <!-- Favicon-->
        ...
        <script>
            $(document).ready(function () {
                ...
                $("#add_more").click(function() {
                	var s = "<div class='col-sm-6'> <div class='form-group form-float'>  <div class='form-line'> <input type='hidden' name='pid' id='pid'> <select name='category' id='category'><option>select category</option>" +
                		"<?php $sql = mysqli_query($con,'select * from offline_category where status=1 and parent_id=0'); while($row = mysqli_fetch_assoc($sql)) { ?>" +
                		"<option id='<?php echo $row['id'];?>' value='<?php echo $row['id'];?>'> <?php echo $row['name'];?></option> <?php } ?></select></div></div> </div>" +
                		"<div class='col-sm-6 sub_category' style='display:none;' >  <div class='form-group form-float'>   <div class='form-line'>  <select name='sub_category' id='sub_category' > <option>select sub category</option></select> </div> </div> </div>" +
                		"<div class='col-sm-6'> <div class='form-group form-float'>  <div class='form-line'> <label class='form-label'>Product Name</label>  <select name='product_name' id='product_name'> <option>select product</option> </select> </div></div></div>" +
                
                		"<div class='col-sm-6'> <div class='form-group form-float'> <div class='form-line'> <input type='text' name='qty' id='qty' value=' ' class='form-control' /> <label class='form-label'>Qty</label> </div></div>  </div> <div class='col-sm-6'>" +
                		"<div class='form-group form-float'> <div class='form-line'> <input type='text' name='rate' id='rate' value=' ' class='form-control' /><label class='form-label'>Product Rate</label> </div></div></div>" +
                		"<div class='col-sm-6'> <div class='form-group form-float'><div class='form-line'> <input type='text' name='courier_charge' id='courier_charge' value=' ' class='form-control' /> <label class='form-label'>Courier Charge</label>"+
                
                	"<div class='col-sm-6'> <div class='form-group form-float'><div class='form-line'>  <label class='form-label'>Product Total Price(courier charge Incl.) : <span id='total'></span></label> < /div> < /div> < /div> ";
                
                	var div = document.createElement("div");
                	var productDiv = document.getElementById("productDiv");
                	div.innerHTML = s;
                	document.getElementById("productDiv").appendChild(div);
                });
            ...
            <div class="container-fluid">
                <div class="navbar-header" style="min-width: 200px;">
                    ...
                    <a class="navbar-brand" href="../index.php" style="display:flex;height: 100px;margin: auto; line-height: 3; padding: 0; width: 100%;">
                        <img src="https://modimarts.com/assets/logo.png" style="width:100px;height:100px;" >
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="card">
                                ...
                                <div class="body">
                                    ...
                                    <input type="button" class="btn-info" id="add_more" value="add more product">
