...
if (!isset($_SESSION['username']) && $_SESSION['userid']=='1') {
    ...
    <script>
        window.location.href='https://modimarts.comfranchise8/get_members.php';
    </script>
...
<body class="theme-red">
    ...
    width: 100%;">
                                      <img src="https://modimarts.comassets/logo.png" alt="" style="width: 100px;background:white;border-radius: 50%;height: auto;">
