...
?>
                  <script>
        window.location.href='https://modimarts.com/franchise8/admin/generate_Greetings_refCode.php';
    </script>
    <?php
...
<div class="heading" style="padding-top:0px !important;">
    <div class="logo">
        <a href="https://modimarts.com/franchise8/get_members.php" style="padding:10px;"><img src="https://modimarts.com/assets/logo.png" alt="" style="width: 105px;background:white;border-radius: 50%;"><span style="font-size:0.7em;padding:10px;">Modimarts.com</span></a>
    </div>
    <div class="menu">
                               ...
                               foreach($query as $key => $value) {
                                ...
                                ?>
                                    <tr>
                                        <td><?=$key+1?></td>
                                        <td><?=$value['code']?></td>
                                        <td><a href="https://wa.me/?text=<?=urlencode('https://modimarts.com/franchise8/Greetings/User/Register?refcode='.$value['code'])?>" target="_blank"> https://modimarts.com/franchise8/Greetings/User/Register?refcode=<?=$value['code']?></a></td>
                                    </tr>
                                    <?php
                                    }
                                      ?>
                               ...
                               foreach($query as $key => $value) {
                                ...
                                ?>
                                    <tr>
                                        <td><?=$key+1?></td>
                                        <td><?=$value['code']?></td>
                                        <td><a href="https://wa.me/?text=<?=urlencode('https://modimarts.com/franchise8/Greetings/Register/RegisterFranchise?refcode='.$value['code'])?>" target="_blank"> https://modimarts.com/franchise8/Greetings/Register/RegisterFranchise?refcode=<?=$value['code']?></a></td>
                                    </tr>
                                    <?php
                                    }
                                      ?>
