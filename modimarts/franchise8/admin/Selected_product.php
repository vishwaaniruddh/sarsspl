    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header" style="min-width: 200px;">
                ...
                <a class="navbar-brand" href="http://modimarts.com/franchise8/" style="display:flex;height: 100px;margin: auto; line-height: 3;     padding: 0;
    width: 100%;">
       ...
       // $product_data_result = mysqli_fetch_assoc($product_data_array);
        ...
        <select id="select_product" class="select_product">
            ...
            <?php while($product_data_result = mysqli_fetch_assoc($product_data_array)){  
                ...
                $pro_img = 'https://modimarts.com/ecom/' . $frtu['img'];
    ...
    <div class="col-md-3">
        ...
        <div class="form-group">
         ...
         for ($i=0; $i <count($imgs) ; $i++) { 
             ?>
             <img src="https://modimarts.com/franchise8/admin/<?=$imgs[$i]?>" alt="" style="width:100%">
            <?php
         }?>
        </div>

        <div class="form-group">
         <a href="<?php if($rws2['video_url']!=''){ ?>https://modimarts.com/franchise8/admin/<?php echo $rws2['video_url']; } else{ echo "#";} ?>" class="btn btn-primary">Video Link</a>
        </div>
        <!-- Sidebar2 -->
</div>
</div>
