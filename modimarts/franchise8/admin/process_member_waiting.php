...
if($passport){
    ...
    $pass_uploaded_link = 'https://www.modimarts.com/franchise8/members_image_waiting/'.$id.'/'.$file_name;
...
if($aadhar_front){
    ...
    $front_uploaded_link = 'https://www.modimarts.com/franchise8/members_image_waiting/'.$id.'/'.$file_name;
...
if($aadhar_back){
    ...
    $backuploaded_link = 'https://www.modimarts.com/franchise8/members_image_waiting/'.$id.'/'.$file_name;
...
if($pan_card){
    ...
    $panuploaded_link = 'https://www.modimarts.com/franchise8/members_image_waiting/'.$id.'/'.$file_name;
...
<script>
    setTimeout(function(){
        window.location.href="http://www.modimarts.com/franchise8/admin/waiting_edit.php?id=<? echo $id;?>"
    }, 2000);
