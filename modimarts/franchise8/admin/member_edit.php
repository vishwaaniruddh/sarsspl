...
if (!isset($_SESSION['mem_id']) && !isset($_SESSION['username'])) {
    ...
    <script>
        window.location.href='https://modimarts.com/franchise8/get_members.php';
    </script>
...
function get_image($type, $id)
{
    ...
    return str_replace("https://www.", "https://", $image);
...
<body class="theme-red">
    ...
    width: 100%;">
                                      <img src="https://modimarts.com/assets/logo.png" alt="" style="width: 100px;background:white;border-radius: 50%;height: auto;">
...
if ($check_sql_result = mysqli_fetch_assoc($check_sql)) {
    ...
    if ($check_sql_result['level_id'] <= 8) {?>
        ...
        <a class="btn btn-info btn-lg" target="_blank" href="https://modimarts.com/franchise6/bill/pdf/bill.php?id=<?echo $userid ?>">Franchise Invoice</a>
    <?}
                              ...
                              <div class="col-sm-4">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            if ($ref_code!='') {
                                                ?>
                                                <input type="text" name="reflink" value="https://modimarts.com?rf=<?=$ref_code?>" id="refcode" class="form-control" readonly/>
...
?>
    ...
    <br>
<h4 style="text-align:center;">You have accepted the Franchisee Agreement on <?echo $read_date; ?>: <?echo $read_time; ?> <?php if($read_agree){ ?> <a href="https://modimarts.com/invoice/genagreement.php?id=<?=$userid ?>" class="btn btn-success">Download Agreement</a> <?php } ?></h4>
...
<li>
    The franchisor has developed a platform where buyers can buy products and sellers can list and sell their products. The platform is in the form of e-commerce website with the domain name of – https://www.modimarts.com
</li>
...
if ($read_agree == 0) {?>
    <script>
        ...
        $("#form").submit(function(e) {
            ...
            alert("You can not become Franchisee of modimarts.com till you accept the Franchisee Agreement.");
            return false;
});
...
<script>
    function createRef(id)
    {
         ...
         $.ajax({
                url: "https://www.modimarts.com/franchise6/admin/creatMemref.php",
                data: 'memcode=' + id,
                type: "POST",
