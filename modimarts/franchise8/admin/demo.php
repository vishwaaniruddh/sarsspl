...
if($check_sql_result= mysqli_fetch_assoc($check_sql)){ 
    ...
    if($check_sql_result['level_id'] < 8 ){ ?>
       ...
       | <a class="btn btn-info btn-lg" target="_blank" href="https://modimarts.com/franchise8/bill/pdf/bill.php?id=<? echo $userid?>">Franchise Invoice</a> 
    <? }
    
    if($check_sql_result['level_id'] == 8){ ?>
        | <a class="btn btn-info btn-lg" target="_blank" href="https://modimarts.com/franchise8/bill/pdf/bill1.php?id=<? echo $userid?>">
                                    Franchise Invoice
                                </a>
