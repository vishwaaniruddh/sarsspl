                        ...
                        <div class="body">
                            <div class="table-responsive">
                                ...
                                <div class="row">
                                    ...
                                    <tbody>
                                        <?php 
                                       $mydata= mysqli_query($con3,"SELECT * FROM `franchise_transfer_history` Group By mem_id ");
                                       foreach ($mydata as $key => $value1) {

                                         $mydata= mysqli_query($con3,"SELECT * FROM `franchise_transfer_history` WHERE mem_id='".$value1['mem_id']."'ORDER BY id DESC LIMIT 1");
                                         $value=mysqli_fetch_assoc($mydata);
                                    ...
                                    <tr role="row" >
                                            ...
                                            <td><a href="GetChangeHistory.php?MemberID=<?=$value['mem_id']?>" class="btn btn-info">Details</a></td>
                                        </tr>
                                    <?php } ?>
                                    </tbody>
                                </table></div></div></div>
