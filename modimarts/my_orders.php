                              ...
                              <tr>
                                ...
                                <td>
                                  ...
                                  if ($sql11_result['status']==0) {
                                   echo "<span class='btn btn-warning' >Waiting For approval</span>";
                                  }
                                  if ($sql11_result['status']==1) {
                                   echo "<span class='btn btn-primary' >Waiting For Dispatch</span>";
                                  }
                                  if ($sql11_result['status']==2) {
                                     echo "<span class='btn btn-info' >Dispatch</span>";
                                  }
                                ...
                                <td><a href="/MyAccount/OrderDetails.php?orderid=<?=$sql11_result['id']?>" class="btn btn-primary">Details</a></td>
                              </tr>
                              <?php  
                              $i++;                            
                            }
