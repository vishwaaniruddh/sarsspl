...
$address1 = array_slice($address, 0, 3, true);
$address2 = array_slice($address, 3, 3, true);
$address3 = array_slice($address, 6, 3, true);
$address4 = array_slice($address, 9, 3, true);
$address5 = array_slice($address, 12, 3, true);
...
$link = 'https://allmart.world/franchise/bill/bill_pdf/'.$id.'.pdf';
...
$pdf->Cell(155,26,'Allmart.World','LTR',0,'C',1);
...
$pdf->MultiCell(190,7,'Add: Allmart Building No.2, Pragati Society, Near Pancholia School, Mahavir Nagar,
Kandivali West, Mumbai - 400067, Maharashtra, India',1,'C');
...
$pdf->SetFont('Arial','',12);
$pdf->Cell(95,8,'AADHAR No :  '.$adhar,'1',0,'L',0);
...
$pdf->SetFillColor(244,204,204,1);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(17,8,'Sr No ',1,0,'L',1);
$pdf->Cell(68,8,' Particulars ','1',0,'L',1);   // empty cell with left,top, and right borders
$pdf->Cell(30,8,' SAC CODE','1',0,'L',1);   // empty cell with left,top, and right
...
$pdf->Cell(17,8,'1',1,0,'L',0);
$pdf->SetFont('Arial','',12);
$pdf->Cell(68,8,' Franchise Fees (non-refundable) ','1',0,'L',0);   // empty cell with left,top, and right borders
$pdf->Cell(30,8,' 998396','1',0,'L',0);   // empty cell with left,top, and right
...
$pdf->Cell(17,8,'',1,0,'L',0);
$pdf->Cell(68,8,'','1',0,'L',0);   // empty cell with left,top, and right borders
$pdf->Cell(30,8,'','1',0,'L',0);   // empty cell with left,top, and right
...
$pdf->SetFont('Arial','',12);
$pdf->MultiCell(190,5,'Notes: This is Non-Refundable fees and charges will not be refunded under any and every circumstances',1);
