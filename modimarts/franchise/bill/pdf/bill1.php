...
if($check_sql_result = mysqli_fetch_assoc($check_sql)){
    ...
    mysqli_query($con,"insert into member_data(member_id,amount,cgst,sgst,gst,pdf,created_at) values('".$id."','1000','76.27','76.27','152.54','".$link."','".$date."')");
...
$pdf->Cell(25,8,'847.46','1',0,'L',0);   // empty cell with left,top, and right
$pdf->Cell(25,8,'847.46 ','1',0,'L',0);   // empty cell with left,top, and right
$pdf->Ln();
...
$pdf->Cell(25,8,'76.27','1',0,'L',0);   // empty cell with left,top, and right
$pdf->Ln();
...
$pdf->Cell(115,8,'Rupees: One Thousand Only ',1,0,'L',0);

$pdf->Cell(50,8,'Grand Total','1',0,'L',0);   // empty cell with left,top, and right
$pdf->Cell(25,8,'1000','1',0,'L',0);   // empty cell with left,top, and right
$pdf->Ln();
