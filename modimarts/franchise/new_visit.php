...
<html lang="en">
  <head>
    ...
    <title>Modi Mart | Franchise | Visiting Card</title>
    ...
    <div style="display:flex;justify-content:center;margin:1% 7% ;">
		<div class="row" style="display:inline-flex;" id="html-content-holder">
			<div class=" col left-section  px-0">
				<img src="visiting_assets/left_img.jpg" style="height: 600px;    width: 100%;" >
				<!-- <P>hello world</p> -->
			</div>
			
			<div class=" col right-section px-0 text-right">
				<!--<img src="visiting_assets/logo.svg"  width="100" height="100">-->
