...
<head>
    ...
    <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
        <title>All Mart | Franchise | Apply</title>
    <!-- Favicon-->
...
<body class="theme-red">
    ...
    padding: 5px;    width: 100px;" src="https://allmart.world/assets/allmart.png">
    ...
    <section class="content">
        <form id="form" action="process_apply1.php" method="post" enctype="multipart/form-data">
        <!--<form id="form" action="demo.php" method="post" enctype="multipart/form-data">-->
        <div class="container-fluid">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="mobile" required class="form-control" size="10" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength="10" minlength="10" />
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6 demo-radio-button">
                                    ...
                                    <div class="form-group">
                                        <input name="marrital_status" value="married" type="radio" id="radio_3" />
...
<input list="items" id="item" class="form-control">
...
<? } ?>
                                            ...
                                            <input type="hidden" name="intro_id" id="intro_id">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="intro_mobile" id="intro_mobile" class="form-control" placeholder="Introducer Mobile" readonly>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6 demo-radio-button">
                                    ...
                                    if($_GET['village'] > 0 ){ ?>
                                      ...
                                      <input name="pay_option" value="w" type="checkbox" id="basic_checkbox_3" class="filled-in" onclick="hide_option()">
                                        <label for="basic_checkbox_3">Applying for Waiting List</label>
                                        
                                        <input name="pay_option" value="p"  type="checkbox" id="myCheck" class="filled-in" onclick="myFunction()"/>
                                    ...
                                    if($_GET['village'] == '' || $_GET['village'] == '0'){ ?>
                                        <input name="pay_option" value="p" type="checkbox" id="myCheck" onclick="myFunction()" />
                                        <label for="myCheck">Rs 5000/- NON REFUNDABLE</label>
                                    <? }
...
<p>Name: Mr. Rajesh Modi - Partner, Allmart Ecommerce LLP</p>
...
<p>Name: Mr. NAME - Designation, Allmart Ecommerce LLP</p>
...
<div>
<input type="checkbox" id="basic_checkbox_agree" name="read_agree" class="filled-in">
...
<div id="text" style="display:none">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" name="pay_bank" id="pay_bank" class="form-control" required/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="paid_id" id="paid_id" class="form-control" required/>
...
function  hide_option(){
           var checkBox = document.getElementById("basic_checkbox_3");
...
$("#here_paste").html('');
      ...
      $(document).ready(function(){
       ...
       $(function() {
        ...
        //  $("#basic_checkbox_3").on('click',function(){
        //       $("#myCheck").removeAttr('checked');

        // });
        //  $("#myCheck").on('click',function(){
        //       $("#basic_checkbox_3").removeAttr('checked');
        // });
        ...
        $("#form").submit(function(e) {
            ...
            alert("You can not become Franchisee of allmart.world till you accept the Franchisee Agreement.");
            return false;
});
