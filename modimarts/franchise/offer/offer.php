...
<div >
    <img src="offer.jpeg" class="photo" width="550" height="630">
</div>
...
<div class="container content" style="background-color:black; color: white; text-align: center;">
    ...
    <div style="padding-top: 10px;"> 
        ...
        <p style="text-align: center;">BECOME A FRANCHISE AND START EARNING <BR> &#8377;50,000 TO &#8377;12 LAKHS PER MONTH.</p>
    </div>
    ...
    <div class="row" >
        ...
        <div class="col-4" style="text-align: center; border-right: 1px solid white;">
                ...
                <button type="button" class="btn btn-danger btn-sm" style="border:1px solid white; margin-bottom: 5px;">ENQUIRE NOW!</button><br>
