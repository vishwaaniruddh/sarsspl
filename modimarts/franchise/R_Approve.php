...
$MESSAGE_BODY="";
   ...
   // $MESSAGE_BODY.="your username is: ".$email."\r\n";
    ...
    //$MESSAGE_BODY.="your password is: ".$fetchHotelusers['password']."\r\n";
     ...
     $message="Dear User You have been successfully registered and approved please login with following link"."\r\n";
...
$mail = new PHPMailer\PHPMailer\PHPMailer();
    ...
    $mail->addAddress('work.rjkashyap05@gmail.com','Rajeshwar Kashyap'); 
