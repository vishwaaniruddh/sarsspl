	...
	<table align="center" class="table table-bordered table-striped">
			...
			<?php
               ...
               <?php  if($_row['Waiting']=='N'){?>  <td><input type="button" id="canc<?php echo $srn;?>" onclick="waitlist('<?php echo $_row[0];?>');" class="btn btn-warning btn-text" value="Waiting Approve"> </td><?php } ?>
                 ...
                 <?php if( $_row['status']==0  && $calltype!="3"){?><td><input type="button" id="canc<?php echo $srn;?>" onclick="cnctestfn('<?php echo $_row[0];?>');" class="btn btn-success btn-text" value="Approve<?php// echo $_row[0];?>"> </td><?php } ?>
