...
<head>
    ...
    <link rel="stylesheet" href="cream-offer.css">
    <title>cream-offer</title>
...
<div >
    <img src="cream-crop.jpeg" class="photo" width="550" height="630">
</div>
...
<div class="container content" style="background-color:black; color: white; text-align: center;">
    ...
    <div class="row" style="padding-top: 30px;">
        ...
        <div class="col-4" style="text-align: center; border-right: 1px solid white;">
                ...
                <button type="button" class="btn btn-danger btn-sm mob_btn">BUY NOW !</button><br>
