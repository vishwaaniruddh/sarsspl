        ...
        <div class="container-fluid">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      <a href="add_subscription.php" class="btn btn-primary" >Add</a>
                    <div class="card-body">
...
// var_dump($con);
			...
			while($sql_result = mysqli_fetch_assoc($sql)){ ?>
                    ...
                    <tr>
                        ...
                        <td><?=$sql_result['price']?></td>
                        <td><?=$sql_result['description']?></td>
                        <td><?=$sql_result['validity']?><br></td>
                       
                        <td>
                            <a href="update_subscription.php?id=<?=$sql_result['id']?>" class="btn btn-info" id="Button">Edit</a>
                            <a href="delete_subscription.php?id=<?=$sql_result['id']?>" class="btn btn-danger">Delete</a>
