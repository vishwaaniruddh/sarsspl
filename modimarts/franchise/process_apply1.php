...
$sql = mysqli_query($con,"insert into new_member(full_pay_date,level_id,country,zone,state,division,district,taluka,village,location,pincode,intro_id,status,name,mobile,introducer_name,introducer_mobile,created_at,star,password,mem_status,payable_bank,amount_paid,paid_date,txn_id ) values('".$full_pay_date."','".$level_id."','".$country."','".$zone."','".$state."','".$division."','".$district."','".$taluka."','".$village."','".$location."','".$pincode."','".$intro_id."','1','".$full_name."','".$mobile."','".$intro_name."','".$intro_mobile."','".$full_pay_date."','".$star."','".$password."','".$mem_status."','".$payable_bank."','".$amount_paid."','".$paid_date."','".$txn_id."')");
