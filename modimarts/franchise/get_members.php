...
<body>
    <div class="heading">
        <div class="logo">
            <a href="https://sarsspl.com/modimarts/franchise/get_members.php"><img src="https://sarsspl.com/modimarts/assets/logo.png" alt="" style="width: 105px;background:white;border-radius: 50%;"><span style="font-size:0.7em;">modimarts</span></a>
            <!--<a href="https://modimarts.com/franchise/get_members.php"><img src="https://modimarts.com/assets/logo.png" alt="" style="width: 105px;background:white;border-radius: 50%;"><span style="font-size:0.7em;">modimarts.com</span></a>-->
        </div>
        <div class="menu">
...
$("#txtVillage").on("change",function(){
    ...
    $.ajax({
        ...
        var show_div = '<?php echo $_SESSION['show_table'];?>';
        ...
        console.log('show_div'+show_div);
            ...
            if(village>0){
                // $("#waiting_btn").html('<a id="waiting" href="https://sarsspl.com/modimarts/franchise/waiting.php?country='+country+'&zone='+zone+'&state='+state+'&division='+division+'&district='+district+'&taluka='+taluka+'&pincode='+pincode+'&village='+village+'" class="btn btn-danger">Apply Waiting</a>');                
