...
<table class="table table-bordered table-striped table-hover dataTable js-exportable">
  <thead>
    <tr>
      ...
      <!--<th scope="col">Is This highest Commission</th>-->
...
$member_sql = mysqli_query($con,"select id,name,created_at,level_id,star,account_num,ifsc,bank from new_member where status=1  and intro_id>0");
...
while($member_sql_result = mysqli_fetch_assoc($member_sql)){
    ...
    $bank = $member_sql_result['bank'];
$account = $member_sql_result['account_num'];
$ifsc = $member_sql_result['ifsc'];
    if($date < '2020-08-21' ){
      ...
      <td><? echo $id ;?></td>
      <td><? echo $name ;?></td>
      <td><? echo date('d-m-Y',strtotime($date)); ?></td>
      <td><? echo $level; ?></td>
      <td><? echo $star; ?></td>
