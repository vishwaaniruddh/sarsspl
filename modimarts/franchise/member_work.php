...
<script>
  ...
  /*  
    ...
    $("#Zone").change(function(){
        ...
        $("#State").attr("size","6").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#State").change(function(){
        $("#State").removeAttr("size").removeAttr("style");
        $("#City").attr("size","6").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#City").change(function(){
        $("#City").removeAttr("size").removeAttr("style");
        $("#District").attr("size","6").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#District").change(function(){
        $("#District").removeAttr("size").removeAttr("style");
        $("#talukaa").attr("size","6").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#talukaa").change(function(){
        $("#talukaa").removeAttr("size").removeAttr("style");
        $("#Pincode").attr("size","6").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#Pincode").change(function(){
        $("#Pincode").removeAttr("size").removeAttr("style");
        $("#village").attr("size","6").attr("style","height:unset !important; position:relative; z-index:10");
    });
