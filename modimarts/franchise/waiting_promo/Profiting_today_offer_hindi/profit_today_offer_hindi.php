...
<head>
    ...
    <link rel="stylesheet" href="profit_today_offer_hindi.css">
    <title>Profiting-Today-offer-hindi</title>
    <style>
.mem_info p{
    font-size:12px;
    text-align:left;
...
<div >
    <a href="#"><img src="profit_today_hindi_crop.jpeg" class="photo" width="550" height="630"></a>
</div>

<div class="container content" style="background-color:black; color: white; padding-bottom:10px; text-align: center;">
