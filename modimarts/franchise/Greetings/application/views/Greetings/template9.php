...
$newstr = str_replace($search, $replace, $proimgdata->
        ...
        <div id="html-content-holder" style="background-color: #ffffff; color: black width: 500px;">
            ...
            <div class="row" >
                 <div class="col-md-10 text-center p-2 bg-warning"><b>Advertisement</b></div>
                 <div class="col-md-2 col-sm-2 col-xs-2 p-2 text-center bg-warning" ><b>Greetings Sender</b></div>
                
                <div class="col-md-10">
                      <img alt="" src="https://allmart.world/franchise/Greetings/assets/images/footerNew.jpeg" style="width: 100%;"/>
                </div>
