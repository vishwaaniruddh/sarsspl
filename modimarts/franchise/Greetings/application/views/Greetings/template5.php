            ...
            <img alt="" src="<?=$newstr?>" style="width: 100%;">
                <div>
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-xs-12 col-md-12 text-center " style="margin-top: auto;margin-bottom: auto;">
                            <img id="greetimg" alt="" src="https://allmart.world/franchise/promotions_cms/customer_promotion/<?=$user_Data->logo?>" style="width: 150px;"/>
                        </div>
                        
                        <div class="col-md-12 col-sm-12 col-xs-12 content p-2">
