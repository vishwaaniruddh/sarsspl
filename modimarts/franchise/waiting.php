...
<body class="theme-red">
    ...
    width: 100%;">
                                    <img src="https://www.modimart.world/assets/logo.jpg" style="width:100px;" >
    ...
    <section class="content">
        <form id="form" action="process_waiting.php" method="post" enctype="multipart/form-data">
        <div class="container-fluid">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <input type="text" name="intro_mobile" id="intro_mobile" class="form-control" readonly>
