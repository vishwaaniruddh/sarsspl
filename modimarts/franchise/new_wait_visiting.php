...
if($level==1){
 ...
 $image = str_replace('https://www.allmart.world/', '', $image);
?>
...
<tr>            <td><b>Issue Date : </b><? echo $newDate; ?></td></tr>
    <tr>        <td><b>I Card Valid For 1 Year</b></td></tr>
        <tr>    <td><b>ID No: </b><? echo 'WL-'.$id; ?></td>
            </tr>
    ...
    <tbody id="mid_two">
      ...
      <tr <? if($lv_id ==8){ echo 'class="member_position"'; }?> >
        ...
        <div class="bottom">
            ...
            <div class="contact">
                <p>24 Hrs Hotline Number 7710835444</p>
            </div>
            
            <div class="email">
                <p>
                    Email ID: enquiry.allmart@gmail.com
                </p>
            </div>
        </div>
