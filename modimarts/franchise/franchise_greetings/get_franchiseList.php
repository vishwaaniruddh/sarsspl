...
<div class="heading" style="padding-top:0px !important;">
    <div class="logo">
        <a href="https://allmart.world/franchise/get_members.php" style="padding:10px;"><img src="https://allmart.world/assets/logo.png" alt="" style="width: 105px; padding:5px;background:white;"><span style="font-size:0.7em;padding:10px;">Allmart.world</span></a>
    </div>
    
    <div class="menu">
                <ul class="menu_ul" style="    width: auto !important; ">
                    <li><a href="../admin/membersFranchise.php">Member Franchise</a></li> 
                </ul>
            </div>
...
//                    document.getElementById("data_row").style.display = "none";
                    ...
                    // $("#member_pic").html('<img src="<? echo $image; ?>" alt="Not Available">');





                    $("#promotions").html('<a class="btn btn-danger" href="../Greetings"> Promotions </a>');
                    // $("#option").html('<a class="btn btn-danger" onclick="Showtable('+obj['country']+','+obj['zone']+','+obj['state']+','+obj['division']+','+obj['district']+','+obj['taluka']+','+obj['pincode']+','+obj['village']+')" href="#"> Option </a>');
                    ...
                    $("#member_apply").html('<a id="apply" href="#" class="btn btn-danger">Apply</a>');
        ...
        $('#txtDivision').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://allmart.world/franchise/admin/ajax/get_division1.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        function selectDist(district){
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://allmart.world/franchise/admin/ajax/get_state1.php',
                        data: 'zone_id='+zone,
                        success:function(msg) {
                            document.getElementById("state").innerHTML = '<option value="">State</option>';
                            $("#state").html(msg);
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://allmart.world/franchise/admin/ajax/get_district1.php',
                        data: 'division_id='+division,
                        success:function(msg) {
                            document.getElementById("district").innerHTML = '<option value="">District</option>';
                            $("#district").html(msg);
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://allmart.world/franchise/admin/ajax/get_taluka1.php',
                        data: 'district_id='+district,
                        success:function(msg) {
                            document.getElementById("taluka").innerHTML = '<option value="">Taluka</option>';
                            $("#taluka").html(msg);
...
//             $("#pincode").val('');
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://allmart.world/franchise/admin/ajax/get_pincode1.php',
                        data: 'taluka_id='+taluka,
                        success:function(msg) {
                            document.getElementById("pincode").innerHTML = '<option value="">Pincode</option>';
                            $("#pincode").html(msg);
        ...
        $('#txtVillage').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://allmart.world/franchise/admin/ajax/get_village1.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        $('#mem_name').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://allmart.world/franchise/admin/ajax/get_mem_name.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        $('#mem_mobile').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://allmart.world/franchise/admin/ajax/get_mem_mobile.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
         ...
         $.ajax({
             ...
             success: function(msg) {
                 ...
                 if (msg > 0 || msg > '0') {
                     ...
                     free_date = new Date('2020-11-1 00:00:00');
                     if (created_at >= free_date) {
                         document.getElementById("25k").style.display = "block";
                         document.getElementById("5k").style.display = "none";
                     } else {
                         document.getElementById("5k").style.display = "block";
                         document.getElementById("25k").style.display = "none";
                     }
                     if (status == 1) {
                         status = 'Approve';
                     } else {
                    ...
                    //  $("#option").html('<a class="btn btn-danger" onclick="Showtable('+obj['country']+','+obj['zone']+','+obj['state']+','+obj['division']+','+obj['district']+','+obj['taluka']+','+obj['pincode']+','+obj['village']+')" href="#"> Option </a>');
                     ...
                     $("#confirm").html('<p class="confirm">Confirm</p>');
                     if (village > 0) {
                         // $("#waiting_btn").html('<a id="waiting" href="https://allmart.world/franchise/waiting.php?country='+country+'&zone='+zone+'&state='+state+'&division='+division+'&district='+district+'&taluka='+taluka+'&pincode='+pincode+'&village='+village+'" class="btn btn-danger">Apply Waiting</a>');
...
function Showtable(a,b,c,d,e,f,g,h,)
{
    // alert(a);
    // alert(b);
    // alert(c);
...
<script src="https://allmart.world/franchise/plugins/sweetalert/sweetalert.min.js"></script>

<!-- Custom Js -->
<script src="https://allmart.world/franchise/js/pages/ui/dialog2.js"></script>
</body>
</html>