...
function get_Activeintro($id){
    global $con;
    $sql = mysqli_query($con,"select count(id) as intro_count from greetings_member where intro_id='".$id."' ");
    $sql_result = mysqli_fetch_assoc($sql);
...
function get_Totalintro($id){
    global $con;
    $sql = mysqli_query($con,"select count(id) as intro_count from greetings_member where intro_id = '".$id."' and id <> '".$id."'");
    $sql_result = mysqli_fetch_assoc($sql);
...
function total_qualify($id){
    ...
    $sql = mysqli_query($con,"select * from greetings_member where intro_id='".$id."' and id <> '".$id."'");
    $qualify = 0;
    while($sql_result = mysqli_fetch_assoc($sql)){
        ...
        $check_sql = mysqli_query($con,"select count(id) as check_mem from greetings_member where intro_id='".$intro_to_id."'  and id<> '".$intro_to_id."'");
...
$member_sql = mysqli_query($con,"select * from greetings_member where pincode='".$pincode."' and village='".$village_id."' and status ='1'");

// echo "select * from greetings_member where pincode='".$pincode."' and village='".$village_id."' and status in ('1','2')";
if($member_sql_result = mysqli_fetch_assoc($member_sql)){ 
    ...
    $image_sql = mysqli_query($con,"select * from greetings_member_waiting_images where member_id='".$id."' and type='passport'");
    $image_sql_result = mysqli_fetch_assoc($image_sql);
    $image = $image_sql_result['image'];
    }
