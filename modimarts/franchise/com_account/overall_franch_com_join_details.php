...
<?
 $sql = mysqli_query($con,"select * from joining_com_details where member_id ='".$id."' and status=1");  
...
$is_intro = $sql_result['is_introducer'];
...
?>
                    ...
                    <tr>
                        <td><? echo $i;?></td>
                        <td><? echo $sql_result['joining_com_id'];?></td>
