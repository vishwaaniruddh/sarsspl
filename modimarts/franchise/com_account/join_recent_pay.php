...
<!-- Bootstrap Core Css -->
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/sweetalert/2.1.2/sweetalert.min.js"></script>
    ...
    <a class="btn btn-warning" onclick="$('#loading').show();$('#content').load( 'join_recent_pay.php');">Refresh</a>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                         ...
                                         <?
                                         $sql = mysqli_query($con,"select * from manage_join_com where status=1 order by id desc");  

$i=1;
while($sql_result = mysqli_fetch_assoc($sql)){
    $id = $sql_result['id'];
$date = $sql_result['payment_date'];
...
?>
                    ...
                    <tr>
                        ...
                        <td><? 
                        if($member_id=='SAR'){
                            echo 'SARMicrosystems Pvt Ltd.';
                        }
                        else{
                            echo member('name',$member_id);                            
                            }
                        ?>
                        </td>
