...
<!-- Bootstrap Core Css -->
 ...
 <? }
    ...
    <a class="btn btn-warning" onclick="$('#loading').show(); $('#content').load( 'payment.php?id=<? echo $id?>');">Refresh</a>
<? } ?>
                            ...
                            <div class="row">
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                         ...
                                         <?
                                         $sql = mysqli_query($con3,"select * from manage_sales_com where member_id ='".$id."' and status=1");  
