...
<div class="inner row no-gutters" id="html-content-holder">
        ...
        <div class="col left">                
                ...
                <a href="#"><img src="Wellness_English_Left.jpg" class="left_photo" width="500" height="680" ></a>    
                
                <div class="container content pb-1" style="background-color:black; color: white; padding-bottom:24px; text-align: center;">
        ...
        <div class="col right">
                <a href="#"><img src="Wellness_English_Right.jpg" class="right_photo" width="500" height="803"></a>
        </div>
