...
<head>
    ...
    <link rel="stylesheet" href="Maxcare.css">
    <title>Maxcare</title>
    <style>
...
<div class="inner row no-gutters" id="html-content-holder">
        ...
        <div class="col left">                
                ...
                <a href="#"><img src="Maxcare_English_Left.jpg" class="left_photo" width="500" height="680" ></a>    
                
                <div class="container content pb-1" style="background-color:black; color: white; text-align: center;">
                
                    <div class="row" style="padding-top: 5px;">
                
                        <div class="class="col-3 col-md-4 px-0"" style="text-align: center; border-right: 1px solid white;">
        ...
        <div class="class="col-4 col-5 col-md-4 px-0"">
        ...
        <div class="col right">
                <a href="#"><img src="Maxcare_English_Right.jpg" class="right_photo" width="500" height="803"></a>
        </div>
