...
<head>
    ...
    <title>Video Making Services</title>
    <style>
...
<div class="inner row no-gutters" id="html-content-holder">
        ...
        <div class="col left">                
                ...
                <a href="#"><img src="Video Making Services_English_Left.jpg" class="left_photo" width="500" height="680" ></a>    
        ...
        <div class="col right">
                <a href="#"><img src="Video Making Services_English_Right.jpg" class="right_photo" width="500" height="803"></a>
        </div>
