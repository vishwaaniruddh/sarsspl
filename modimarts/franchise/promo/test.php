...
$id = $_GET['id'];
    ...
    <div class="heading">
        ...
        <div class="logo">
        <a href="https://modimart.world/franchise/get_members.php"><img src="2.png" alt="" style="width: 100px; padding:10px;"><span style="font-size:0.7em;">Allmart.world</span></a>
        </div>
...
if(lang_promo($language,$promotion)==1){ ?>
      <th><a href="view_promotion.php?id=<? echo $id; ?>&&language=<? echo $language; ?>&&promotion=<? echo $promotion; ?>">Yes</a></th> 
<? }else{ ?>
      <th>No</th>
<? }
