...
if ($_POST['orderby']=='1') {
	$query = "select * from new_member where status='1' ORDER By id DESC limit 0,50";
}
else
{
	$query = "select * from new_member where status='1' ORDER By id  ASC limit 0,50";
}
...
function total_qualify($id)
{
 ...
 ?>
                                         <tr>
                                        <td><p ><?=$sql_result['id']?></p></td>
                                        <td><p ><img src="<?=$image?>" style="width:100px;height:100px;" alt="Not Available"></p></td>
                                        <td><?=$name?> </td>
                                        <td><?=$mobile?></td>
                                        <td ><?=$level?></td>
                                        <td><?=$star?></td>
                                        ...
                                        <td ><?=$mem_status?></td>
                                        <td><?=$is_product_received?></td>
                                       
                                         <td ><?=$intro_id?></td>
                                        <td ><?=$introducer_name?></td>
                                        <td ><?=$introduced_mobile?></td>
                                        
                                         <td><?=$view?></td>
                                        <td ><?=$edit?></td>
                                        <td ><?=$product_select?></td>
                                    </tr> 
