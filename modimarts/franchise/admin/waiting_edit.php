...
if(!$_SESSION){ ?>
    ...
    <script>
        window.location.href='https://allmart.world/get_members.php';
    </script>
...
if($check_sql_result= mysqli_fetch_assoc($check_sql)){ ?>
                               ...
                               | <a class="btn btn-info btn-lg" target="_blank" href="https://allmart.world/franchise/bill/pdf/bill.php?id=<? echo $userid?>">
                                    Get PDF
                                </a>
