...
<body class="theme-red">
    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header" style="min-width: 200px;">
                ...
                <a class="navbar-brand" href="http://www.modimart.world/franchise/" style="display:flex;height: 100px;margin: auto; line-height: 3;     padding: 0;
    width: 100%;">
                                    <img src="https://modimart.world/assets/logo.png" style="width: 100px;background:white;border-radius: 50%;">
    ...
    <section class="content">
        <ul>
            ...
            <li>
                <a href="https://modimart.world/franchise/com_distribution.php">Total Commission And Distribution(Level Wise)</a>
            </li>
            <li>
                <a href="https://modimart.world/franchise/all_com.php">Total Commission With Bank Details</a>
            </li>
            <li>
                <a href="https://modimart.world/franchise/franch_com_join.php">Joining Commission from 800 </a>
            </li>
            
                        <li>
                <a href="https://modimart.world/franchise/overall_franch_com_join.php">Joining Commission from 800 - Overall</a>
            </li>
               <li>
                <a href="https://modimart.world/franchise/admin/add_commission.php">Add Product Commission</a>
            </li>
        </ul>
    </section>
