...
session_start();
// var_dump($_SESSION);
 if ($_SESSION['gid'] && $_SESSION['gid']!=$_SESSION['geust_id']) {
    $userid   = $_SESSION['gid'];
                                  ...
                                  >
                                    ...
                                    >
                                     <div class="baskettop" style="font-size: 76%;">
                                        ...
                                        <?php if ($_SESSION['gid'] && $_SESSION['gid']!=$_SESSION['geust_id']) {?>
                                                ...
                                                <?php
                                                  ...
                                                  <?php
                                                        ...
                                                        ?>
                                                <a href="https://allmart.world/login.php" title="Login">Login </a>/<a href="https://allmart.world/register.php" title="Register">Register</a> 
                                                <?php
                                                    }
                                                    ?>
