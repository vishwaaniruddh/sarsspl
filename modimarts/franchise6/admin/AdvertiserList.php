                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    <thead>
                                        <tr>
                                            ...
                                            <!--<th>Bottom Portion Percentage</th>-->
                                            <!--<th>Upload Design</th>-->
                                            <!--<th>Give Advertisement</th>-->
                                    ...
                                    <tbody>
                                        ...
                                        <? $sql = mysqli_query($con,"select * from greetings_advertiser_list");
...
while($sql_result = mysqli_fetch_assoc($sql)){ ?>
                    ...
                    <tr>
                        <td><? echo $i;?></td>
                        <td><? echo $sql_result['client_name'];?></td>
                        <td><? echo $sql_result['upload_type'];?></td>
                        <td><? echo $sql_result['total_person'];?></td>
                        <td><? echo $sql_result['total_days'];?></td>
