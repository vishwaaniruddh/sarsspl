    ...
    <div class="col-md-3">
        ...
        <div class="form-group">
         ...
         for ($i=0; $i <count($imgs) ; $i++) { 
             ?>
             <img src="https://www.modimart.world/franchise6/admin/<?=$imgs[$i]?>" alt="" style="width:100%">
            <?php
         }?>
        </div>

        <div class="form-group">
         <a href="<?php if($rws2['video_url']!=''){ ?>https://www.modimart.world/franchise6/admin/<?php echo $rws2['video_url']; } else{ echo "#";} ?>" class="btn btn-primary">Video Link</a>
        </div>
        <!-- Sidebar2 -->
</div>
</div>
