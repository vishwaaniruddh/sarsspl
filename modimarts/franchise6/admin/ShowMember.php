...
if (!isset($_GET['id'])) {?>
    ...
    <script>
        window.location.href='https://modimart.world/franchise6/get_members.php';
    </script>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form action="https://modimart.world/franchise6/Payment/RequestFpayamt.php" method="post">
                            ...
                            <input type="hidden" name="redirect_url" value="https://modimart.world/franchise6/Payment/ccavResponseHandler.php" readonly hidden>

                            <input type="hidden" name="cancel_url" value="https://modimart.world/franchise6/Payment/ccavResponseHandler.php" readonly hidden>
...
<script>
    function createRef(id)
    {
         ...
         $.ajax({
                url: "https://www.modimart.world/franchise6/admin/creatMemref.php",
                data: 'memcode=' + id,
                type: "POST",
