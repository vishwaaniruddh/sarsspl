    ...
    <li class="grid__item item-row wide--one-fifth post-large--one-fifth large--one-third medium--one-half small--one-half"
                            ...
                            >
                              ...
                              <? } else { ?>
                                ...
                                <a href="/<?=strurl($productname)?>/P/<?=strcode($rws2['code'])?>/<?=strcode($rws2['category_id'])?>/<?=strcode($rws2['name'])?>">
                    ...
                    <?php } ?>
                                    ...
                                    <a
                                      ...
                                      title="Add to Cart"
                                      onclick="addtocart('<? echo $rws2['category_id'];?>','<? echo $rws2['code'];?>','<? echo $finalPrice; ?>','<? echo $imageViewproduct;?>','<? echo $productname;?>','<?php echo $rws2['name'];?>','<?=$shipping?>','<?=$shipping_charges?>',<?=$minqty?>)"
...
<?php } ?>
        <input type="hidden"  id="totalrecord" value="<?=$totalnorecord?>">		
