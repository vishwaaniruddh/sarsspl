...
$sql = "insert into Registration(Firstname,Lastname,email,Mobile,password,guest_id) values('".$Firstname."','".$Lastname."','".$email."','".$Mobile."','".$password."','".$guest_id."') ";
...
if(mysqli_query($con1,$sql)){
    ...
    swal('Registered Succesfully ! Please login to contine !')
...
<? }
    ...
    swal('Registered Error ! Please Try Again !')
