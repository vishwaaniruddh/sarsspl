...
<div class="products product-hover-11">
  ...
  <div class="product-detail">
    ...
    <a href="https://allmart.world/<?=strurl($name)?>/P/<?=strcode($pid)?>/<?=strcode($catid)?>/<?=strcode($prod_id)?>" title="<?=$name?>" style="height: 3em;" class="grid-link__title"><?=substr($name,0,30)?></a>
