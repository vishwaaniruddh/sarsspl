                      ...
                      $emailid = $sql_result['email'];
                         ...
                         ?>
                          <div id="shipping-calculator" style="margin-top: 0;">
                            ...
                            <form method="post"  action="cart.php" onsubmit="return checkdelivery()" >
                            ...
                            <input type="hidden" name="redirect_url" value="https://allmart.world/ccavResponseHandler.php" readonly hidden>

                            <input type="hidden" name="cancel_url" value="https://allmart.world/ccavResponseHandler.php" readonly hidden>
              ...
              if(billing_tel.length==10){
                     ...
                     var settings = {
                                  ...
                                  else
                                  {
                                           ...
                                           html = "<p style='color:red;margin-left:1%;'>Please Enter Your Name</p>";
                                           $("#checkdeliveryresult").html(html);
                                   return false;
                                       ...
                                       html = "<p style='color:red;margin-left:1%;'>Please put 10  digit mobile number</p>";
                                           $("#checkdeliveryresult").html(html);
                                     return false;
                                    }
                                          ...
                                          html = "<p style='color:red;margin-left:1%;'>Not a valid number</p>";
                                           $("#checkdeliveryresult").html(html);             
                                    return false;
                                 }
