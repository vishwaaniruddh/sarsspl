...
include('config.php');
       ...
       if($clientc!="")
       {
        $sql = mysqli_query($con1,"select category from clients where code='".$clientc."'");
...
//<option value='0'>select</option>";
    ...
    for ($i=0; $i<$num22; $i++) 

                {
                 ...
                 $cname22 = mysqli_result($res22,$i,"name"); 

                 $ccode22 = mysqli_result($res22,$i,"id"); 
