...
//alert(msg);
 $(".well").css({"border": "2px solid #e3e3e3","padding-top": "25px"});
         } 
     });
...
<div >
    ...
    <div class="well" style="background-color: #ffffff;margin-left: 7px;min-height:0px;border: none;padding-top: 72px;">
            ...
            <div class="form-horizontal" align="center" >
                ...
                <div class="form-group">
                    <label for="inputOrderTrackingID" class="col-sm-3 control-label">Order id :</label>
                        ...
                        <input type="text" class="form-control" id="inputOrderTrackingID"  value="" style="border: 2px solid #eaeaea;" placeholder="# put your order id here">
                     </div>
                     <div class="col-sm-3" >
                         <button type="button" id="shopGetOrderStatusID" class="btn btn-default" style="border-radius: 24px;outline: none;margin-left: -29%;" onclick="trackorderfunc();">Get status</button>
    ...
    <div class="col-md-8">
         <div  style="margin-top:-2%;">
              ...
              <div id="map">
                 ...
                 <div class="row shop-tracking-status" style="margin-right: -21%;">     
<div class="order-status" style="margin-left: 5%;">

                <div class="order-status-timeline" style="width: 74%;">
