...
while($lat1=mysqli_fetch_array($qrylatfrws))
    ...
    $getprdets=mysqli_query($con1,"select * from Productviewtable where code='".$lat1['product_id']."' and category='".$lat1['category']."' ");
      ...
      $qryimg=mysqli_query($con1,"SELECT `img` FROM `Productviewimg` where product_id='".$lat1['product_id']."' and category='".$lat1['category']."' ");
      $proimg=mysqli_fetch_array($qryimg);
        ...
        <tbody>
          ...
          <tr>
              <td style="color: #1c4b6f;font-weight: bold;">Image</td>
                        ...
                        <img style="width:250px;height:250px;" src="<?php echo trim($prodimgpth.$detsarr[0]['photo']);?>" alt="" title="<?php echo $detsarr[0]['name']?>" class="img-thumbnail" />
              </td>
              <td class="text-center" >              
                        <img style="width:250px;height:250px;"  src="<?php echo trim($prodimgpth.$detsarr[1]['photo']);?>" alt="" title="<?php echo $detsarr[1]['name']?>" class="img-thumbnail" />
              </td>
              <td class="text-center">              
                        <img style="width:250px;height:250px;"  src="<?php echo trim($prodimgpth.$detsarr[2]['photo']);?>" alt="" title="<?php echo $detsarr[2]['name']?>" class="img-thumbnail" />
              </td>
              <td class="text-center">              
                        <img style="width:250px;height:250px;"  src="<?php echo trim($prodimgpth.$detsarr[3]['photo']);?>" alt="" title="<?php echo $detsarr[3]['name']?>" class="img-thumbnail" />
              </td>
                      </tr>
...
$fstar5=mysqli_query($con1,"SELECT count(review_id),count(product_id) FROM `product_review` where product_id='".$detsarr[0]['code']."' and rating_count='".$i."'"); 
...
$avg=0;
 $ttl=0;                           $ttl=$ttl+($str5+$str4+$str3+$str2+$str1);
     ...
     $fstar=mysqli_query($con1,"SELECT count(product_id) FROM `product_review` where product_id='".$detsarr[0]['code']."'"); 
...
$fstar5=mysqli_query($con1,"SELECT count(review_id),count(product_id) FROM `product_review` where product_id='".$detsarr[1]['code']."' and rating_count='".$i."'"); 
						     $fstarftch5=mysqli_fetch_array($fstar5);
...
$avg=0;
 $ttl=0;                           $ttl=$ttl+($str5+$str4+$str3+$str2+$str1);
     ...
     $fstar=mysqli_query($con1,"SELECT count(product_id) FROM `product_review` where product_id='".$detsarr[1]['code']."'"); 
						     $fstarftch=mysqli_fetch_array($fstar);
...
$fstar5=mysqli_query("SELECT count(review_id),count(product_id) FROM `product_review` where product_id='".$detsarr[2]['code']."' and rating_count='".$i."'"); 
						     $fstarftch5=mysqli_fetch_array($fstar5);
...
$avg=0;
 $ttl=0;                           $ttl=$ttl+($str5+$str4+$str3+$str2+$str1);
     ...
     $fstar=mysqli_query("SELECT count(product_id) FROM `product_review` where product_id='".$detsarr[2]['code']."'"); 
						     $fstarftch=mysqli_fetch_array($fstar);
...
$fstar5=mysqli_query("SELECT count(review_id),count(product_id) FROM `product_review` where product_id='".$detsarr[3]['code']."' and rating_count='".$i."'"); 
						     $fstarftch5=mysqli_fetch_array($fstar5);
...
$avg=0;
 $ttl=0;                           $ttl=$ttl+($str5+$str4+$str3+$str2+$str1);
     ...
     $fstar=mysqli_query("SELECT count(product_id) FROM `product_review` where product_id='".$detsarr[3]['code']."'"); 
						     $fstarftch=mysqli_fetch_array($fstar);
          ...
          <td style="color: #1c4b6f;font-weight: bold;"></td>
                 ...
                 <!--=================== code for delete button animation (Start) ======================================-->
                     <!--   <style>     
      
                       
.trash{transition:opacity 200ms;width:128px;height:0px;opacity:0.8;position:relative;right:0;top:3px;vertical-align:middle;cursor:pointer;margin:50px auto 10px}  
 ...
 .trash:focus > .lid,.trash:hover > .lid{transform:rotate(-45deg);transition:transform 250ms;-webkit-transform:rotate(-45deg);-webkit-transition:-webkit-transform 250ms}  </style>-->
          ...
          <!--	<button type="button" onclick="parent.addcart('<?php echo $slctwishftch['product_id']; ?>','<?php echo $slctwishftch['categories_id']; ?>');" data-toggle="tooltip" title="Add to Cart" class="btn btn-primary"><img src="image/cartdemo.gif" style="width:20px;height:20px"/></button>
         --> 	<img src="image/cartdemo2.gif" style="width: 47px;height: 39px;margin-top: 0px;" data-toggle="tooltip" title="Add to Cart" onclick="addcart('<?php echo $detsarr[0]['code'];?>','<?php echo $detsarr[0]['category'];?>');"/>
                <div data-toggle="tooltip" title="Remove" class="btn btn-danger" onclick="removecompare('<?php echo $detsarr[0]['compareid'];?>')"  style="background-color: #ffffff;border-color: #ffffff;margin-left: 60px;padding-top: 3px;padding-bottom: 12px;" ><span class="glyphicon" style="top:3px;font-size: 12px;"> <div class="trash" title="Remove" style="right:-21px"><span class="lid" style="width:26px"></span><span class="can" style="width:26px"></span></div></span> </a>
          		 ...
          		 <?php } ?>
          					...
          					-->
          						<img src="image/cartdemo2.gif" style="width: 47px;height: 39px;margin-top: 0px;" data-toggle="tooltip" title="Add to Cart" onclick="addcart('<?php echo $detsarr[1]['code'];?>','<?php echo $detsarr[1]['category'];?>');"/>
                                <div data-toggle="tooltip" title="Remove" class="btn btn-danger" onclick="removecompare('<?php echo $detsarr[1]['compareid'];?>')"  style="background-color: #ffffff;border-color: #ffffff;margin-left: 60px;padding-top: 3px;padding-bottom: 12px;" ><span class="glyphicon" style="top:3px;font-size: 12px;"> <div class="trash" title="Remove" style="right:-21px"><span class="lid" style="width:26px"></span><span class="can" style="width:26px"></span></div></span> </a>
                      			...
                      			<img src="image/cartdemo2.gif" style="width: 47px;height: 39px;margin-top: 0px;" data-toggle="tooltip" title="Add to Cart" onclick="addcart('<?php echo $detsarr[2]['code'];?>','<?php echo $detsarr[2]['category'];?>');"/>
                                <div data-toggle="tooltip" title="Remove" class="btn btn-danger" onclick="removecompare('<?php echo $detsarr[2]['compareid'];?>')"  style="background-color: #ffffff;border-color: #ffffff;margin-left: 60px;padding-top: 3px;padding-bottom: 12px;" ><span class="glyphicon" style="top:3px;font-size: 12px;"> <div class="trash" title="Remove" style="right:-21px"><span class="lid" style="width:26px"></span><span class="can" style="width:26px"></span></div></span> </a>
          						...
          						<td class="text-center">
                                    ...
                                    <!--  <div class="trash" title="Remove" onclick="removecompare('<?php echo $detsarr[3]['compareid'];?>')"><span class="lid" style="width:26px"></span><span class="can" style="width:26px"></span></div>
          						   ...
          						   -->
          						  	...
          						  	<img src="image/cartdemo2.gif" style="width: 47px;height: 39px;margin-top: 0px;" data-toggle="tooltip" title="Add to Cart" onclick="addcart('<?php echo $detsarr[3]['code'];?>','<?php echo $detsarr[3]['category'];?>');"/>
                                <div data-toggle="tooltip" title="Remove" class="btn btn-danger" onclick="removecompare('<?php echo $detsarr[3]['compareid'];?>')"  style="background-color: #ffffff;border-color: #ffffff;margin-left: 60px;padding-top: 3px;padding-bottom: 12px;" ><span class="glyphicon" style="top:3px;font-size: 12px;"> <div class="trash" title="Remove" style="right:-21px"><span class="lid" style="width:26px"></span><span class="can" style="width:26px"></span></div></span> </a>
