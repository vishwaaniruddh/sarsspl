...
<header id="header-layout" class="header-v2">
  ...
  <ul class="breadcrumb">
      ...
      <div class="row">                <div id="content" class="col-sm-9">      <h2>Order Information</h2>
      <table class="table table-bordered table-hover">
        <?php
         ...
         $query1 = mysqli_query("SELECT Firstname,Lastname,address FROM Registration WHERE id ='".$rows[1]."'  ");
      $rows1 = mysqli_fetch_array($query1);
          $query2 = mysqli_query($con1,"SELECT qty,item_id,oid FROM order_details WHERE oid ='".$oid1."'  ");
      ...
      $rows3 = mysqli_fetch_array($query3);
       $query4 = mysqli_query($con1,"SELECT * FROM states WHERE state_code ='".$rows3[1]."'  ");
      $rows4 = mysqli_fetch_array($query4);
      $query5 = mysqli_query($con1,"SELECT * FROM cities WHERE code ='".$rows3[2]."'  ");
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          ...
          <?php 
                   ...
                   $query8 = mysqli_query($con1,"SELECT qty,item_id,oid,rate,total_amt,cat_id FROM order_details WHERE oid ='".$oid1."'  ");
                 //echo "SELECT qty,item_id,oid FROM order_details WHERE oid ='".$oid1."'  ";
          ...
          <tfoot>
                        <tr>
                            <?php
                            $query10=mysqli_query($con1,"select sum(total_amt) as total ,round(sum(total_amt))  from order_details where oid='".$oid1 ."' ");
