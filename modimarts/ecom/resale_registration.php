    ...
    <?}else{?>
      ...
      <form action="process_reg.php" method="post" enctype="multipart/form-data" class="form-horizontal" id="regfrm" onsubmit="return val();">
        <fieldset id="account">
          ...
          <div class="form-group col-md-12" style="margin-left: -141px !important;">    
            ...
            <div class="col-md-8 inputGroupContainer">
               ...
               <!--<input id="addressLine1" name="addressLine1" placeholder="Address Line 1" class="form-control" required="true" value="" type="text"></div>-->
                <textarea rows="3" name="address_1" <?php if(!isset($_SESSION['loginstats']) & $_SESSION['loginstats']==""){?> placeholder="Address" <?php } ?> id="input-address-1" class="form-control"" style="width: 506px;" required autofocus/> <?php if($address!=""){ echo $address;} ?></textarea>
              </div>
            </div>
          </div>
