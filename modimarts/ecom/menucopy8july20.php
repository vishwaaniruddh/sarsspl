    ...
    <div class="container" >
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-4 logo-holder" style="width: 372px;"> 
          ...
          <div class="logo row">
                <div class="col-md-1">
                  <a href="https://allmart.world/ecommerce">
            ...
            <div class="nav-outer">
              <ul class="nav navbar-nav">
               <li class="active dropdown yamm-fw"> <a href="index.php" style="padding-left: 15px;" class="dropdown-toggle">Home</a> </li>
                <?php 
                    $sql23 = mysqli_query($con1,"select * from main_cat where under ='0' order by name limit 0,6"); 
                    while($result23 =mysqli_fetch_array($sql23))
                    {

                    ?>
                    <li class="dropdown yamm mega-menu"> <a href="https://allmart.world" data-hover="dropdown" class="dropdown-toggle" data-toggle="dropdown"><?php echo $result23[1];?></a>
                    ...
                    <!--<li class="active dropdown yamm-fw"> <a href="resale_index.php" class="dropdown-toggle">RESALE</a> </li>-->
                        <div class="login pull-right hidden-xs hidden-sm">
                            <ol class="breadcrumb" style="padding-right: 34px;">
                                <li><a style="color:#fff;" href="https://allmart.world/franchise/">Franchise</a></li>
                             <?php if(!isset($_SESSION['loginstats']) && $_SESSION['loginstats']==""){?>
