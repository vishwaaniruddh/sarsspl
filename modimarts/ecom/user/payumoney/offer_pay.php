...
<div class="main">
    ...
    <input type="hidden" id="udf5" name="udf5" value="Php Bolt" />
    ...
    <span><input type="text" id="amount" name="amount" placeholder="Amount" value="10" readonly/></span>    
    </div>
    ...
    <span><input type="text" id="email" name="email" placeholder="Email ID" value="developer.ruchi@gmail.com" readonly/></span>
    </div>
    
    <div class="dv">    
        <?php  $row['MobileNumber'] =900067767; ?>
        <span class="text"><label>Mobile/Cell Number:</label></span>
        <span><input type="text" id="mobile" name="mobile" placeholder="Mobile/Cell Number" value="9555555555" readonly/></span>
    </div>
    ...
    <span><input type="text" id="city" name="city" value="Mumbai" /></span>
    </div>
