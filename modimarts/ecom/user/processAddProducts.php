...
*/
    ...
    //$lastNewCatID= mysqli_insert_id($con1$Newcategory);
    //echo $lastNewCatID;
...
if($_POST['Maincat']=="AddNewCategory"){
    ...
    $qry=mysqli_query($con1,"INSERT INTO `Approval_products`(`name`, `ccode`, `description`, `category`, `photo`, `price`, `others`,discount,discount_type,total_amt,thumbs,midsize,brand,product_type,long_desc,keyword1) VALUES ('$pname','$ccode','$p_other','$pcat','$dirs','$price','$others','$discntamt','$dicnttyp','$ttlprs','','','$pbrand','$p_type','$Longdesc','$key')");
    ...
    if(!$result2)
{
  ...
  $Newcategory=  mysqli_query($con1,"insert into approval_category (name,under,cat_img,base_cat,Product_id) values('".$CreateNewCategory."','".$newSubCat."','','".$newMainCat."','$insid')");  
 //var_dump($Newcategory);exit;
 // $lastNewCatID= mysqli_insert_id($Newcategory);
}*/
//===============================================
if($_POST['Maincat']=="AddNewCategory"){
   //echo 'categ : '.$pcat;
    ...
    /*$Newcategory=  mysqli_query($con1,"insert into approval_category (name,under,cat_img,base_cat,Product_id) values('".$CreateNewCategory."','".$newSubCat."','','".$newMainCat."','$insid')");  
    //var_dump($Newcategory);exit;
     $lastNewCatID= mysqli_insert_id($con1);
    ...
    if($Maincate==1){
        ...
        //echo "INSERT INTO `fashion`(`name`, `ccode`, `description`, `category`, `photo`, `price`, `others`,discount,discount_type,total_amt,thumbs,midsize,size,color,brand,size_id,product_type,long_desc) VALUES ('$pname','$ccode','$pdesc','$pcat','$dirs','$price','$others','$discntamt','$dicnttyp','$ttlprs','','','$hidden_size','$hidden_color','$pbrand','$hidden_sizeid','$p_type','$Longdesc')";
             ...
             $insid=mysqli_insert_id($con1); 
             $new_discount = 0;
             //Insert additional info if present
    //$new_price $new_Long_desc $new_others $new_description $new_discount $insid $pcat
    if($new){
   ...
   //echo "INSERT INTO `product_additional_details`(`price`,`long_desc`, `others`,`description`, `discount`, `product_id`,main_category) VALUES ('$new_price','$new_Long_desc','$new_others','$new_description','$new_discount','$insid','$Maincate')";
   // exit;//$insid=mysqli_insert_id($con1); 
        ...
        if(!$result2)
    {
       ...
       /* $qry_pmodel=mysqli_query($con1,"INSERT INTO `product_model`(`product_model`, `description`, `price`, `others`,discount,discount_type,brand_id,long_desc,offer_price,allmart_commission) VALUES ('$pname','$p_other','$price','$others','$discntamt','$dicnttyp','$pbrand','$Longdesc','$ttlprs','$allmart_commission')");*/
        $insid=mysqli_insert_id($con1); 
        
      /*  echo "INSERT INTO `product_model`(`product_model`, `description`, `price`, `others`,discount,discount_type,brand_id,long_desc,offer_price,allmart_commission) VALUES ('$pname','$p_other','$price','$others','$discntamt','$dicnttyp','$pbrand','$Longdesc','$ttlprs','$allmart_commission')";*/
   ...
   // exit;//$insid=mysqli_insert_id($con1); 
    ...
    //$qry=mysqli_query($con1,"INSERT INTO `products`(`name`, `ccode`, `description`, `category`, `photo`, `price`, `others`,discount,discount_type,total_amt,thumbs,midsize,brand,product_type,long_desc,keyword1) VALUES ('$pname','$ccode','$p_other','$pcat','$dirs','$price','$others','$discntamt','$dicnttyp','$ttlprs','','','$pbrand','$p_type','$Longdesc','$key')");
    //$qry=mysqli_query($con1,"INSERT INTO `products` (`name`, `ccode`, `description`, `category`, `photo`, `price`, `others`,discount,discount_type,total_amt,thumbs,midsize,size,color,brand,size_id,product_type,long_desc,keyword1) VALUES ('$pname','$ccode','$p_other','".$_POST['pcat']."','$dirs','$price','$others','$discntamt','$dicnttyp','$ttlprs','','','$hidden_size','$hidden_color','$pbrand','$hidden_sizeid','$p_type','$Longdesc','$key')");          
    //echo 'pname: '.$pname;             
    $qry=mysqli_query($con1,"INSERT INTO `products`(`name`, `ccode`, `category`, `photo`, `price`,total_amt,thumbs,midsize,size,color,brand,size_id,product_type,keyword1,offer_price,allmart_commission) VALUES ('$pname','$ccode','$pcat','$dirs','$price','$ttlprs','','','$hidden_size','$hidden_color','$pbrand','$hidden_sizeid','$p_type','$key','$ttlprs','$allmart_commission')");
    //$qry_pmodel=mysqli_query($con1,"INSERT INTO `product_model`(`product_model`, `description`, `price`, `others`,discount,discount_type,brand_id,long_desc) VALUES ('$pname','$p_other','$price','$others','$discntamt','$dicnttyp','$pbrand','$Longdesc')");
    //echo "INSERT INTO `product_model`(`product_model`, `description`, `price`, `others`,discount,discount_type,brand_id,long_desc) VALUES ('$pname','$p_other','$price','$others','$discntamt','$dicnttyp','$pbrand','$Longdesc')";
                    $insid=mysqli_insert_id($con1); 
                    if($new){
                        $qry=mysqli_query($con1,"INSERT INTO `product_additional_details`(`price`,`long_desc`, `others`,`description`, `discount`, `product_id`,main_category) VALUES ('$new_price','$new_Long_desc','$new_others','$new_description','$new_discount','$insid','$Maincate')");
                    }
...
for($i=0;$i<count($spfc);$i++)
{
    ...
    $qry1=mysqli_query($con1,"INSERT INTO `productspecification`(`product_id`, `product_specification`,`specificationname`) VALUES('".$insid."','".$_POST['specification1'][$i]."','".$_POST['specification'][$i]."')");
