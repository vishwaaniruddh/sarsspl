...
function pay(tr_for,r,slider_d,slider_pos) {
    ...
    var sp = slider_pos;
    var mid=459;
   window.location = 'http://sarmicrosystems.in/oc1/user/payumoney/pay.php?t='+t+'&mid='+mid+'&rate='+rate+'&sid='+sid+'&spos='+sp;
}
 ...
 function bkfuncmerchant1()
 {
     ...
     try
     {
        	...
        	
        {
	     ...
	     var dtsrate=slotdtschkarr["dtsnrt"].split(",");
	     alert(dtsrate);
	      pay('sl',dtsrate,sliderid,slotpos);
