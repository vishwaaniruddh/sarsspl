...
$bkit1=0;//----0 is for admin---//

$bkit2=0;//----0 is for admin---//
$bkit3=0;//----0 is for admin---//
...
$qryfeaturedrws=mysqli_query($con1,$qryfeatured);   
...
$qryspecialrws=mysqli_query($con1,$qryspecial);   
...
<!-----------------------------------------------latest images query-------------------------------------------------------------------------------------------------------------->                                                                                             
    ...
    {
        $avilfrupdt=0;
        $qravdm=mysqli_query($con1,"select * from advertise_booking where  slot='".$sliderid1."' and slot_pos='".$ca."' and dt='".date("Y-m-d")."' and merchant_id='".$_SESSION["id"]."'");
        $qspbkd=mysqli_num_rows($qravdm);
        if($qspbkd>0) 
        {
            $avilfrupdt="1";
            $frt=mysqli_fetch_array($qravdm); 
            $bkit1=$frt["booking_id"];
            ...
            if($latstprnrws>0)
            {
                ...
                $detsarr[]=['code'=>$prdrws['code'],'name'=>$prdrws['name'],'ccode'=>$prdrws['ccode'],'description'=>$prdrws['description'],'category'=>$prdrws['category'],'photo'=>$prdrwsimg['img'],'price'=>$prdrws['price'],'discount'=>$prdrws['discount'],'discount_type'=>$prdrws['discount_type'],'total_amt'=>$prdrws['total_amt'],'updtid'=>$lat1['id'],'avail'=>$avilfrupdt,'bookingid'=>$bkit1];
            }else
            {   
                $detsarr[]=['code'=>"0",'avail'=>$avilfrupdt,'bookingid'=>$bkit1];
            }
        }else
        {
        ...
        <p class="description">.....</p>
            ...
            ?>
             ...
             <div>
               ...
               <button data-loading-text="Loading..." class="btn btn-default" type="button"onclick="srchfsnchw('<?php echo $sliderid1;?>','<?php echo $detsarr[$itr]['updtid'];?>','<?php echo $slidername1; ?>','<?php echo $itr;?>','<?php echo $detsarr[$itr]['bookingid'];?>');">
...
<div class="image">
        ...
        <div class="product-img img">
          <a class="img" title="" href="javacript:void(0);">
            ...
            <img class="img-responsive" src="<?php echo $yourproducthere;?>" title="" style=" width: 100%;
  ...
  <div class="product-meta">
        ...
        ?>
                   <div class="price">
                      <span class="price-new">Rate <i class="fa fa-inr"></i> <?php echo getrt($sliderid1);?></span>
            ...
            ?>
              ...
              {?>
               <div>
                 ...
                 <?php if(getrt($sliderid1)!="")
                 {
                 ?>
               <button data-loading-text="Loading..." class="btn btn-default" type="button" onclick="slotbkfunc('<?php echo $sliderid1;?>','<?php echo $itr;?>','<?php echo getrt($sliderid1); ?>')">
...
<div class="owl-carousel" data-show="1" data-pagination="false" data-navigation="true"id="latestid">
 ...
 $avilfrupdt=0;
 $qravdm=mysqli_query($con1,"select * from advertise_booking where  slot='".$sliderid2."' and slot_pos='".$ca."' and dt='".date("Y-m-d")."' and merchant_id='".$_SESSION["id"]."'");
       $qspbkd=mysqli_num_rows($qravdm);
...
$detsarr[]=['code'=>$prdrws['code'],'name'=>$prdrws['name'],'ccode'=>$prdrws['ccode'],'description'=>$prdrws['description'],'category'=>$prdrws['category'],'photo'=>$prdrwsimg['img'],'price'=>$prdrws['price'],'discount'=>$prdrws['discount'],'discount_type'=>$prdrws['discount_type'],'total_amt'=>$prdrws['total_amt'],'updtid'=>$lat1['id'],'avail'=>$avilfrupdt,'bookingid'=>$bkit2];
...
}else
{
   ...
   $detsarr[]=['code'=>"0",'avail'=>$avilfrupdt,'bookingid'=>$bkit2];
        ...
        <p class="description">.....</p>
            ...
            ?>
              ...
              <div>
               ...
               <button data-loading-text="Loading..." class="btn btn-default" type="button"onclick="srchfsnchw('<?php echo $sliderid2;?>','<?php echo $detsarr[$itr]['updtid'];?>','<?php echo $slidername2; ?>','<?php echo $itr;?>','<?php echo $detsarr[$itr]['bookingid'];?>');">
                 <i class="hidden-lg hidden-sm hidden-md fa fa-shopping-cart"></i><span class="">Update</span>
              </button>
...
<div class="image">
  ...
  <div class="product-meta">
        ...
        ?>
                   <div class="price">
                      <span class="price-new">Rate <i class="fa fa-inr"></i> <?php echo getrt($sliderid2);?></span>
            ...
            ?>
              ...
              {?>
               <div>
                 ...
                 <?php if(getrt($sliderid2)!="")
                 {
                 ?>
               <button data-loading-text="Loading..." class="btn btn-default" type="button" onclick="slotbkfunc('<?php echo $sliderid2;?>','<?php echo $itr;?>','<?php echo getrt($sliderid2); ?>')">
                 <i class="hidden-lg hidden-sm hidden-md fa fa-shopping-cart"></i><span class="">BOOK NOW</span>
              </button>
             <?php } ?>
              </div>
...
<div class="owl-carousel" data-show="1" data-pagination="false" data-navigation="true"id="latestid">
 ...
 $avilfrupdt=0;
 $qravdm=mysqli_query($con1,"select * from advertise_booking where  slot='".$sliderid3."' and slot_pos='".$ca."' and dt='".date("Y-m-d")."' and merchant_id='".$_SESSION["id"]."'");
       $qspbkd=mysqli_num_rows($qravdm);
...
$detsarr[]=['code'=>$prdrws['code'],'name'=>$prdrws['name'],'ccode'=>$prdrws['ccode'],'description'=>$prdrws['description'],'category'=>$prdrws['category'],'photo'=>$prdrwsimg['img'],'price'=>$prdrws['price'],'discount'=>$prdrws['discount'],'discount_type'=>$prdrws['discount_type'],'total_amt'=>$prdrws['total_amt'],'updtid'=>$lat1['id'],'avail'=>$avilfrupdt,'bookingid'=>$bkit3];
...
}else
{
   ...
   $detsarr[]=['code'=>"0",'avail'=>$avilfrupdt,'bookingid'=>$bkit3];
  ...
  <div class="product-meta">
        ...
        <p class="description">.....</p>
          ...
          <div>
               ...
               <button data-loading-text="Loading..." class="btn btn-default" type="button"onclick="srchfsnchw('<?php echo $sliderid3;?>','<?php echo $detsarr[$itr]['updtid'];?>','<?php echo $slidername3; ?>','<?php echo $itr;?>','<?php echo $detsarr[$itr]['bookingid'];?>');">
                 <i class="hidden-lg hidden-sm hidden-md fa fa-shopping-cart"></i><span class="">Update</span>
              </button>
...
<div class="image">
  ...
  <div class="product-meta">
        ...
        ?>
                   <div class="price">
                      <span class="price-new">Rate <i class="fa fa-inr"></i> <?php echo getrt($sliderid3);?></span>
            ...
            ?>
              ...
              {?>
               <div>
                 ...
                 <?php if(getrt($sliderid3)!="")
                 {
                 ?>
               <button data-loading-text="Loading..." class="btn btn-default" type="button" onclick="slotbkfunc('<?php echo $sliderid3;?>','<?php echo $itr;?>','<?php echo getrt($sliderid3); ?>')">
                 <i class="hidden-lg hidden-sm hidden-md fa fa-shopping-cart"></i><span class="">BOOK NOW</span>
              </button>
             <?php } ?>
              </div>
