...
?>
      <form action="process_reg.php" method="post" enctype="multipart/form-data" class="form-horizontal" id="regfrm" onsubmit="return val();">
        ...
        <div class="form-group col-md-6">
         ...
         <div class="form-group col-md-6">
            <label class="col-md-4 control-label">Plot NO.</label>
            <div class="col-md-8 inputGroupContainer">
               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-option-horizontal"></i></span>
          ...
          <div class="form-group col-md-6">
            ...
            <div class="col-md-8 inputGroupContainer">
               <div class="input-group"><span class="input-group-addon"><i class="fa fa-map-signs"></i></span>
          ...
          <div class="form-group col-md-6">
            ...
            <div class="col-md-8 inputGroupContainer">
               <div class="input-group">
                  ...
                  <select class="selectpicker form-control" name="state" id="state" onchange="city1()" required>
            ...
            <div class="col-md-8 inputGroupContainer">
               <div class="input-group">
                  ...
                  <select class="selectpicker form-control" name="city" id="city">
                     <option value="0" style="width: 15em" >select</option>
                  </select>
               </div>
            </div>
         </div>
        ...
        <div class="form-group col-md-6" <?php if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){?> style="display:none;" <?php  } ?>>
