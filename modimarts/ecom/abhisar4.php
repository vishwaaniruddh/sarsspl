...
<!--------code for add and romove quentity---->
<style>
.button {
...
<!--------code for add and romove quentity--- end  ->
<!--=================Code For color checkbox tick <End>============================-->
...
<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
  <div class="product-info-bg">
    <h1 class="title-product" style="font-size:23px;margin-top:42px"><?php echo $latstprnrws['name'];?></h1>
...
.ab1:hover {
    ...
    margin-left: 464px;
    width: 500px;
">     <button id="down" class="ab ab1" onclick="down('0')" style="border-radius: 17px;font-size:22px;padding-left: 2px;padding-right: 2px;padding-top: 2px;padding-bottom: 1px;width: 43px;margin-top: 0px;"><i class="fa fa-minus" style="
    width: 22px;
    height: 16px;
    padding-top: 4px;
    padding-bottom: 8px;
"></span></i></button>
            ...
            <input type="text" id="myNumber" class="input-number" value="1" style="
    text-align:  center;
    border-radius: 6px;
    width: 58px;
"/>
            
            <button id="up" class="ab ab1" onclick="up('100')" style="border-radius: 17px;font-size:22px;padding-left: 2px;padding-right: 2px;padding-top: 2px;padding-bottom: 1px;width: 43px;margin-top: 0px;"><i class="fa fa-plus" style="
    width: 22px;
    height: 16px;
    padding-top: 4px;
    padding-bottom: 8px;
