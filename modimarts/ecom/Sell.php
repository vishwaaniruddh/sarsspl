...
input[type=text]:focus, textarea:focus {
 ...
 <!-- <ul class="breadcrumb">
    ...
    <div class="row">
        <br>
        <div id="content1" class="col-sm-2"> </div>
     ...
     <?php /*<div class="form-group required">
        <label class="col-sm-3 control-label" for="input-firstname">
            <font color="black" >Company Type</font> 
        </label>
        <div class="col-sm-9">
...
<script>
  ...
  //=================================================================               
          if(document.getElementById('ctyp').value=="1")
            {
                show=['hide','adhno','pcn','compname','Partshipcn','PartshipcomnyPan','Cperson','Cmobile','CTelephn','PtsGumasta','PartshipBusiAadhr','Partshiptanno','gstno','bnknm','brNam','ifscod','acno','acNam'];
                var hide=['compname','st','Ccity','CArea','Caddress','CPincode','CTelephn','Cfax','Cemail','Cperson','lDesignatn','Cmobile','Ccategory','category','Clogo','shopLic','dtofreg','PartshipRegis','Partshipcn','PtsGumasta','PartshipBusiAadhr','PartshipcomnyPan','Partshiptanno','Yestablis','adhno','pcn','Eno','gstno'];
                hideElements(hide);  
                showElements(show);
              }
              else if(document.getElementById('ctyp').value=="2")
              {
                var show=['compname','Caddress','Cperson','Cemail','Cmobile','Cperson','pcn','adhno','PtsGumasta','Partshiptanno','gstno','Ccategory','Clogo','wing','flat','road_no','locality','bldg','landmark','bnknm','brNam','ifscod','acno','acNam'];
                var hide=['compname','st','Ccity','CArea','Caddress','CPincode','CTelephn','Cfax','Cemail','Cperson','lDesignatn','Cmobile','Ccategory','category','Clogo','shopLic','dtofreg','PartshipRegis','Partshipcn','PtsGumasta','PartshipBusiAadhr','PartshipcomnyPan','Partshiptanno','Yestablis','adhno','pcn','Eno','gstno'];
                hideElements(hide);
                showElements(show);
              ...
              {  
                var show=['compname','Caddress','Cperson','Cemail','Cmobile','Cperson','pcn','PtsGumasta','Partshiptanno','gstno','Ccategory','Clogo','wing','flat','road_no','locality','bldg','landmark','bnknm','brNam','ifscod','acno','acNam'];
                var hide=['compname','st','Ccity','CArea','Caddress','CPincode','CTelephn','Cfax','Cemail','Cperson','lDesignatn','Cmobile','Ccategory','category','Clogo','shopLic','dtofreg','PartshipRegis','Partshipcn','PtsGumasta','PartshipBusiAadhr','PartshipcomnyPan','Partshiptanno','Yestablis','adhno','pcn','Eno','gstno'];
                 hideElements(hide);
                showElements(show);
                }
          ...
          <div class="form-group col-md-6" id="compname">
            ...
            <div class="col-md-8 inputGroupContainer">
               <div class="input-group"><span class="input-group-addon"><i class="fa fa-building" aria-hidden="true"></i></span>
                    <input type="text" name="cname" id="cname" placeholder=" Name"  class="form-control" size="50" tabindex=0 required/>
               </div>
            </div>
         </div>
        ...
        <!--<div class="form-group col-md-6" id="CArea">
            <label class="col-md-4 control-label" for="input-firstname" id="id-Cname">Area</label>
            <div class="col-md-8 inputGroupContainer">
               <div class="input-group"><span class="input-group-addon"><i class="fa fa-building" aria-hidden="true"></i></span>
                   <input type="text" name="area" id="area" placeholder=" Area" class="form-control" tabindex=0  />
        ...
        <!--<div class="form-group required" id="CArea">
            <label class="col-sm-3 control-label" for="input-firstname"><font color="black" >Area</font></label>
             <div class="col-sm-9">
                <input type="text"  class="form-control" name="area" id="area"   required autofocus/>
                <div id="search_suggest"> </div>
            </div>
        </div>-->
    <!--<div class="form-group col-md-6" id="Caddress">
        <label class="col-md-4 control-label" for="input-firstname" id="id-Cname">Address</label>
        <div class="col-md-8 inputGroupContainer">
           <div class="input-group"><span class="input-group-addon"><i class="fa fa-building" aria-hidden="true"></i></span>
               <textarea rows="3" name="add2" id="add2" class="form-control"  required /> </textarea>
           </div>
        </div>
    </div>-->
    ...
    <div class="form-group col-md-6" id="Cperson">
        ...
        <div class="col-md-8 inputGroupContainer">
           <div class="input-group"><span class="input-group-addon"><i class="fa fa-building" aria-hidden="true"></i></span>
                <input type="text" name="contactPerson" id="contactPerson" placeholder=" Enter character only" class="form-control" size="50" tabindex=0 required />
           </div>
        </div>
    </div>
        ...
        <div class="col-md-8 inputGroupContainer">
            <div class="input-group"><span class="input-group-addon"><i class="fa fa-list" aria-hidden="true"></i></span>
                ...
                <div class="multiselect">
        	        ...
        	        <!-- Ruhi : <div id="checkboxes" class="checkboxes" style="display: block;width: 599px;" ></div>-->
    ...
    <div  class="form-group required" id="Ccategory">
        ...
        <div class="multiselect">
        	...
        	<div id="checkboxes" class="checkboxes" style="display: block;width: 599px;" ></div>
        </div>
        <div id="res" ></div>
    </div>
</div>*/?>
...
<?php /*div class="form-group " id="dtofreg">
   ...
   <!--<div class="form-group required" id="PartshipcomnyPan" style="display:none">
    ...
    <?php /*<div class="form-group " id="Yestablis">
    ...
    <?php /* <div class="form-group required" id="adhno">
    ...
    <div class="form-group col-md-6">
     ...
     <div class="col-md-12">
        ...
        <div class="col-md-8 inputGroupContainer">
            ...
            <button type="button" style="border-radius: 10px;" class="btn btn-primary"   onclick='window.open("http://sarmicrosystems.in/oc1","_self");'>Cancel</button>
        </div>
     </div>
         <br>
        </div>
