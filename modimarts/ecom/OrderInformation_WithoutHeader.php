        ...
        <div id="content" class="col-sm-9" style="left: 5%;">
            <h2>Order Information</h2>
                ...
                <?php
                    ...
                    $query1 = mysqli_query($con1,"SELECT Firstname,Lastname,address FROM Registration WHERE id ='".$rows[1]."'  ");
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover" style="background-color: white;">
          ...
          <tfoot>
                        <tr>
                            <?php
                            $query10=mysqli_query("select sum(total_amt) as total ,round(sum(total_amt))  from order_details where oid='".$oid1 ."' ");
