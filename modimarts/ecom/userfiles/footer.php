                ...
                <div class="row">
                    ...
                    <div class="logo row">
                      ...
                      <div class="col-md-2">
                          ...
                          <img src="image/allmart.jpg" style="width:200px;height: 100px;margin-top: -12px;margin-left:52px;" alt="logo"></a>
        		      </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box-content">
              <ul class="list folow">  				
                <!--  <li><i class="fa fa-facebook"></i><a data-original-title="Facebook" data-placement="top" target="_blank" href="https://www.facebook.com/Merabazaar-1362889730447213/" title=""><span>Facebook</span> </a></li>  	
                  ...
                  <li><i class="fa fa-facebook"></i><a data-original-title="Facebook" data-placement="top" target="_blank" href="" title=""><span>Facebook</span> </a></li>  	
                  <li><i class="fa fa-twitter"> </i><a data-original-title="Twitter" data-placement="top" target="_blank" href="" title=""><span>Twitter</span> </a></li>  
                  ...
                  <li><i class="fa fa-youtube"> </i><a data-original-title="Youtube" data-placement="top" target="_blank" href="" title=""><span>Youtube</span> </a></li>  		
                  <li><i class="fa fa-instagram"> </i><a data-original-title="Instagram" data-placement="top" target="_blank" href="" title=""><span>Instagram</span> </a></li>
             </ul>           
            </div>
          </div>
        </div>        
...
<div class="footer-bottom " id="pavo-footer-bottom" style="padding-top: 0px;padding-bottom: 0px; background-color:white">
  <div class="container">
    <div class="container-inner">
     <div class="row">
      <?php /*<div class="column col-xs-12 col-sm-6 col-md-3 col-lg-3">
        <div class="box">
          <!--<div class="panel-heading">
      ...
      <div class="column col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div class="box">
         <!--<div class="panel-heading">
          ...
          <ul class="list-unstyled list display-prop">
            <li class="li-style"><a onclick="popup('2','')">About Us</a></li>
            <!--<li><a onclick="popup('3','')">Newsletter</a></li>-->
            <li class="li-style"><a onclick="popup('4','')">Privacy Policy</a></li>
            <li class="li-style"><a onclick="popup('5','')">Terms &amp; Conditions</a></li>
            <li class="li-style"><a onclick="popup('6','')">Returns</a></li>
            <?php if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){?>
            <li class="li-style"><a onclick="popup('9','')">Gift Certificates</a></li>
            <?php }else{ ?>
             <li class="li-style"><a  onclick="popup('1','myaccount')">Gift Certificates</a></li>
             <?php } ?>
          </ul>
        </div>
      </div>
