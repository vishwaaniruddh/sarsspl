...
<header id="header-layout" class="header-v2">
  ...
  <div class="row">                <div id="content" class="col-sm-9">      <h1>Order History</h1>
...
?>
            ...
            <td class="text-center"><a href="OrderInformation.php?id=<?php echo $rows[0];?>"><i class="fa fa-eye"></i></a></td>
