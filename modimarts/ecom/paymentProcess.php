      ...
      <div class="panel-group" id="accordion" style="margin-bottom: 5px;">
        ...
        <div class="panel panel-default">
          <div class="panel-heading"  style="background-image:url(images/Steps.jpg);padding:4px">
            <div class="row">
                <div class="col-md-6">
                    <h4 style="margin-top: 2px;margin-bottom: 0px;" >STEP 3 :</h4>
                </div>
                <div class="col-md-6">
                    <h4 class="panel-title" style="color:white">Payment Method</h4>
                </div>
            </div>
          </div>
...
function paymethodop_test()
{
    ...
    $.ajax({
                    ...
                    success: function(html) {
                       ...
                       /*var h ="<form aciton='http://sarmicrosystems.in/oc1/payumoney/pay/index.php' method='post'><input type ='hidden' name='pid' value='<?php echo $_GET["Pid"]; ?>'>";
                       h+= "<input type ='hidden' name='cid' value='263'><input type ='hidden' name='gid' value='73'><input type ='hidden' name='qty' value='2'><input type ='hidden' name='amnt' id='amnt' value=''>";
                      h+="<input type='submit' value='pay' class='btn-info'></form>";*/
                     // alert(h)
                      var h= "<div class='pm-button'><a href='pay.php?gid=<?php echo $_SESSION["gid"]; ?>&email=<?php echo $_SESSION["email"]; ?>&pid=<?php echo $_GET["Pid"]; ?>&cId=<?php echo $_GET['cId']; ?>&size=<?php echo $_GET['sz']; ?>&qty=<?php echo $_GET['qty'];?>&color=<?php echo $_GET['clr']; ?>'><img src='https://www.payumoney.com/media/images/payby_payumoney/new_buttons/21.png' /></a></div> ";
                      $('#collapse-payment-method .panel-body').html(h);
                      
                      /*document.getElementById('amnt').value = price;
                      alert(document.getElementById('amnt').value);*/

// comment by ( anand )    	$('#collapse-payment-method').parent().find('.panel-heading .panel-title').html('<a href="#collapse-payment-method" data-toggle="collapse" data-parent="#accordion" class= '".$_GET['gid']."'" "accordion-toggle">Step 3: Payment Method <i class="fa fa-caret-down"></i></a>');
...
function paymethodop()
{
    $.ajax({
        ...
        success: function(html) {
            /*$('#collapse-payment-method .panel-body').html(html);*/
            /*var h="<a href='#'>button type='button' class='btn btn-info'>Info</button></a>";*/
            var h ="<div class='pm-button'><a href='https://www.payumoney.com/paybypayumoney/#/368D4C8E78C682561658D084D1EB9A59'><img src='https://www.payumoney.com/media/images/payby_payumoney/new_buttons/21.png' /></a></div> ";
           $('#collapse-payment-method .panel-body').html(h);
