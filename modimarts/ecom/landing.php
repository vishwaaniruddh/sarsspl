...
<body id="bd" class="common-home page-common-home layout-fullwidth">
    ...
    <br> <br> <br> <br>
        <div class="container-fluid">
            <div class="col-md-6">
                <h4><a href="franchise/index.php">About Franchisee</a></h4>
                <form>
                    <div class="row"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            ...
                            <div class="form-check">
                                ...
                                <a href="#">
                                  <label class="form-check-label" > VIdeo - Rajesh Salvi </label>
                                </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <ul class="list-group">
                              <li class="list-group-item"><a href="https://www.facebook.com/AllmartWorld-111946707234321">Facebook</a></li>
                              <li class="list-group-item"><a href="https://www.instagram.com/allmart.world">Instagram</li></a>
                              <li class="list-group-item"><a href="#">Linked inn</li></a>
                              <li class="list-group-item"><a href="https://www.youtube.com/channel/UCmwbXGCoL4RnSuzEhbA71Aw">You tube</li></a>
                              <li class="list-group-item"><a href="#">Presentation</li></a>
                              <li class="list-group-item"><a href="#">Training</li></a>
                            </ul>
                        </div>
                    </div>
                    <br>
            ...
            <div class="col-md-6">
                <h4><a href="index.php">About Ecommerce Website</a></h4>
            </div>
            <div class="col-md-6">
                <h4><a href="franchise/index.php">About Franchisee</a></h4>
                <div class="row">
                    <div class="col-md-6 col-sm-6">
                        <ul class="list-group">
                          <li class="list-group-item"><a href="#">E Commerce Website</a> </li>
                          <li class="list-group-item"><a href="#">Franchisee</a></li>
                          <li class="list-group-item"><a href="#">Show Advertisement of Companies</a></li>
                        </ul>
                    </div>
                </div>
                <br>
