...
.latest-posts-v6 .latest-posts-profile .created:before {
  border-bottom: 29px solid #00a9e0;
...
#header-layout #logo-theme a {
  background-image: url("../image/nelogo.png");
...
#search button:before {
  border-left: 9px solid #00a9e0;
  border-right: 9px solid #00a9e0;
  border-top: 17px solid #00a9e0;
  bottom: 0px;
  content: "";
  display: inline-block;
  right: 0;
...
#pav-megamenu .bg1 div.dropdown-menu {
  background-image: url("../image/s-l1200.jpg");
...
.product-info .cart1 button:hover {
  background-color: #00a9e0;
  -webkit-transition: all 0.5s ease 0s;
  -o-transition: all 0.5s ease 0s;
  transition: all 0.5s ease 0s;
...
.videoad{width:100%;height:350px; margin-top: -49px;}
