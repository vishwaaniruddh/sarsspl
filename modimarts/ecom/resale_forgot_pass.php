    ...
    <div id="content" class="col-sm-9">      
     <h1>Forgot Your Password?</h1>
      <p>Enter the e-mail address associated with your account. Click submit to have a password e-mailed to you.</p>
        ...
        <form action="resale_forgotpass.php" method="post" enctype="multipart/form-data" class="form-horizontal">
        <fieldset>
          <legend>Your E-Mail Address</legend>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-emails">E-Mail Address</label>
            <div class="col-sm-10">
              <input type="text" name="emails" value="" placeholder="E-Mail Address" id="input-emails" class="form-control" required/>
            </div>
          </div>
        </fieldset>
