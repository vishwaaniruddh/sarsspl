...
<div class="sidenav">
 <h4 style="color: black;">My Account</h4>
      <ul class="list-unstyled" >
        <li><a href="#expe1" id="" style="font-size:14px" onclick="showData('expe1');">Edit account</a></li>
        <li><a href="#expe2" style="font-size:14px" onclick="showData('expe2');">Change password</a></li>
       <!-- <li><a href="addressbookentries.php">Modify your address book entries</a></li>-->  <!------  comment by anand ------->
        <li><a href="#expe3" style="font-size:16px" onclick="showData('expe3');">wish list</a></li>
      ...
      <ul class="list-unstyled">
        <li><a href="#expe5" style="font-size:14px" onclick="showData('expe5');">Upload Resale Products</a></li>
        <li><a  style="font-size:14px" onclick="showData('expe6');">View My Uploaded Products</a></li>
      </ul>
      
      <h4 style="color: black;">My Orders</h4>
      <ul class="list-unstyled">
        <li><a href="#expe4" style="font-size:14px" onclick="showData('expe4');">View order history</a></li>
...
function showData(id){
    var ids = ['expe1','expe2','expe3','expe4','expe5','expe6','expe7','expe8'];
    var i;
