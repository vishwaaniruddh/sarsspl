...
<div class="container" >
 <!-- <ul class="breadcrumb">
    ...
    <div class="row">               
    <div id="content" class="col-sm-8 col-md-offset-2" style="border-radius:1%;margin-left: 108px;width:735px">      
     <?php if(!isset($_SESSION['loginstats']) & $_SESSION['loginstats']==""){?>
    <h1>Register Account</h1>
    <p>If you already have an account with us, please login at the <a href="login.php">login page</a>.</p>
    <?}else{?>
     <h3 style="color: currentColor;">Edit Account</h3>
       <?php } 
       if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){
         ...
         // echo "SELECT * FROM `Registration` WHERE id='".$_SESSION['gid']."'";
          ...
          $Mobile=$sltqryftch["Mobile"];
           ...
           $wingNo=$sltqryftch["wingNo"];
          $plotNo=$sltqryftch["plotNo"];
          $buildName=$sltqryftch["buildName"];
          $roadNo=$sltqryftch["roadNo"];
          $landmark=$sltqryftch["landmark"];
          $Locality=$sltqryftch["Locality"];
...
?>
      <form action="process_reg.php" method="post" enctype="multipart/form-data" class="form-horizontal" id="regfrm" onsubmit="return val();">
        <fieldset id="account" style="padding-right: 28px;padding-left: 28px;">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-firstname"  style="text-align: left;">First Name</label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-lastname" style="text-align: left;">Last Name</label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-email"  style="text-align: left;">E-Mail</label>
            <div class="col-sm-10">
            ...
            <div class="col-sm-10">
              <input type="tel" name="contact" <?php if(!isset($_SESSION['loginstats']) & $_SESSION['loginstats']==""){?> placeholder="Mobile" <?php } ?> id="contact"  class="form-control" onblur="checkcontact();" value="<?php if($Mobile!=""){ echo $Mobile;} ?>"  onblur ='return (event.which >= 48 && event.which <= 57) || event.which == 8 || event.which == 46' required autofocus/>
                       <input type="hidden" name="contact2" id="contact2"   class="form-control" value="<?php if($Mobile!=""){ echo  $Mobile;} ?>"/>
                            ...
                            <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-telephone"  style="text-align: left;">Mobile No.</label>
            <div class="col-sm-10">
        ...
        <fieldset id="address" style="padding-right: 28px;padding-left: 28px;">
          <p>Your Address</p>
         <!-- <div class="form-group">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-address-1"  style="text-align: left;">Address</label>
            <div class="col-sm-10">
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-zone"  style="text-align: left;">State</label>
            <div class="col-sm-10">
...
<?php } ?>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-city"  style="text-align: left;">City</label>
            <div class="col-sm-10">
              <div id="city1" >
<select  name="city" class="form-control" class="styledselect_form_1" id="city" ><option value="0" style="width: 15em" >select</option>
          ...
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-postcode"  style="text-align: left;">PIN Code</label>
            <div class="col-sm-10">
        ...
        <fieldset>
          ...
          <input type="checkbox" name="agree" id="agree" value="1" <?php if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){ ?> checked style="display:none;" <?php } ?>/>
            ...
            <input type="submit" name="submit" value="Submit" data-loading-text="Loading..."  class="btn btn-primary" <?php if(isset($_SESSION['loginstats']) && $_SESSION['loginstats']!=""){?>  style="display:none;border-radius: 10px;"<?php }else{ ?>style="display:none;border-radius: 10px;"<?php } ?>/>
...
else
{
 ...
 document.getElementById('notification1').innerHTML='<div class="alert alert-success" style="width: 1016px;"><i class="fa fa-exclamation-circle"></i> ' +'Update successfull'+ '<button type="button" class="close" data-dismiss="alert">&times;</button></div>';
 <?php } ?>
