...
<div class="widget panel ">
		<div class="widget-heading panel-heading block-borderbox"><h4 class="panel-title">  &nbsp; &nbsp;</h4>CURRENT OFFERS  &nbsp;&nbsp;[<a href="javascript:void(0);" onclick="setrtfunc(<?php echo $sliderid12;?>);">SET RATE</a>]</br></br>
    
    	    <?php echo"Todays slider Rate: ".getrt($sliderid12); ?>
    </div>
   ...
   $avilfrupdt=0;
       ...
       $qravdm=mysql_query("select * from advertise_booking where  slot='".$sliderid12."' and slot_pos='".$ca."' and dt='".date("Y-m-d")."'");
   ...
   {
      $avilfrupdt="1";
      $qrylatf2="select id,pid,cat from top_right_slider where  slot_id='".$sliderid12."' and slot_pos='".$ca."' and user_id='0'  and stats='0'";
       
   } else
   {
       $ftrw=mysql_fetch_array($qravdm);
       $qrylatf2="select id,pid,cat from top_right_slider where  slot_id='".$sliderid12."' and slot_pos='".$ca."' and user_id='".$ftrw["merchant_id"]."'  and stats='0'";
       $avilfrupdt="0";
        ...
        <p class="description">.....</p>
            ...
            ?>
              ...
              <div>
               ...
               <button data-loading-text="Loading..." class="btn btn-default" type="button" onclick="srchfsnchw('<?php echo $sliderid12;?>','<?php echo $detsarr[$itr]['updtid'];?>','<?php echo $slidername; ?>','<?php echo $itr;?>');">
