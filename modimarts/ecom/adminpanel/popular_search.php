...
include('header.php'); 
include('config.php');
$sql_statement = 'SELECT * FROM popular_search';
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<td class="green-left"  height="40px;" valign="middle"> <a href="Addpopular.php">Add new one Popular Search.</a></td>
			  ...
			  <!--  start product-table ..................................................................................... -->
				...
				<tr>
                    ...
                    <th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">Category Name</p>	</th>
					<th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">Popular Search</p>	</th>
					<th class="table-header-options line-left"><p style="font-size:16px; color:#FFF;">Options</p></th>
				</tr>
                <?php
				
				$query = "SELECT * FROM popular_search order by status ASC LIMIT " . $from . "," . $offset;
...
$query1 = "SELECT * FROM main_category where cid='$row[1]'";
...
$row1=mysql_fetch_row($result1);
 ?>
				<tr class="alternate-row">
					...
					<a href="edit_search.php?id=<?php echo $row[0]; ?>"  title="Edit" class="icon-1 info-tooltip"></a>
					<a href="deleteSearch.php?id=<?php echo $row[0]; ?>" title="Delete" class="icon-2 info-tooltip"></a>
