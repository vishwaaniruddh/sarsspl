	...
	<table align="center" width="100%">
			...
			<td> ADS Name<font color="red">*</font></td>
             ...
             <td>Select File<font color="red">*</font></td><td>
				...
				<td><input type="button"   id="dated0" name="dated[]"  onclick='selctdtfunc(0,"","");' value="Select Date"></br>
...
<div class="row" id="subtndiv">
    ...
    <div class="col-md-2" >	<input type="button"  id="Submit"  value="" class="form-submit" onclick="submfunc();"/></div>
    <div class="col-md-5"></div>
</div>
