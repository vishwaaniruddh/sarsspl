...
include('config.php');
$sql_statement ='select name,code,memtype from clients where memtype="silver"';
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
			  ...
			  <!--  start product-table ..................................................................................... -->
                ...
                <?php
				include('config.php');
				$query = "select name,code,memtype from clients where memtype='silver' LIMIT " . $from . "," . $offset;
...
while($row=mysql_fetch_row($result)){
        	...
        	<?PHP
				...
				doPages($offset, 'silverCustomer.php', '', $total_records); 
			?>    
            </td>
		</tr>
