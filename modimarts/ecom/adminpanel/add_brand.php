  ...
  /*var pro= document.getElementById('fileToUpload').value;
     if(pro==""){
        ...
        else
        {
          if($("input[name='chk[]']:checked").length==0)
          {
        conf=confirm("You have not selected any brand this will create a new base brand, are you sure to continue");
    ...
    <div class="inner clearfix">
        ...
        <div class="filter-right col-lg-10 col-md-10 col-sm-10 col-xs-12">
            <div class="sort col-lg-12 col-md-12 col-sm-12 col-xs-12 pull-right">
                <form action='addBrandProcess.php' method='post' enctype="multipart/form-data" onsubmit="return vali();">
