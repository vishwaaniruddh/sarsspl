...
<div id="content">
 ...
 <tr height="30" ><td ><input type="text" style="margin-left:20px;" name="searchtxt" class="inp-form" size="50"  value="<?php echo $searchtxt;?>"/>
 <input type="submit" class="btn-form" name="search" value="Search"/></td></tr>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
			  ...
			  <!--  start product-table ..................................................................................... -->
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">City Name</p>	</th>
					<th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">City Code</p></th>
			...
			$query = "SELECT name,code FROM cities where 1 ";
...
while($row=mysql_fetch_row($result)){
        	...
        	<?PHP
				...
				doPages($offset, 'cities.php', '', $total_records); 
			?>    
            </td>
		</tr>
				</table>
