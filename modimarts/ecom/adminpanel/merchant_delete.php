...
session_start();
	...
	$searchtxt=$_POST['searchtxt'];
		...
		include('config.php');
			//	$query = "select name,code from cities order by name";
//$result = mysql_query($query);
	
	$sql_statement = 'select name,delete_reason from clients_deleted';
...
<div id="">
	...
	<!--  start page-heading -->
	<div id="page-heading">
		<h1>Deleted Marchent</h1>
	</div>
	<!-- end page-heading -->
	<!-- filter -->
	
	<table width="10%"  align="center" border="0" id="id-form">
 <tr height="40" ><td ><input type="text" style="margin-left:20px;width:200px;" name="searchtxt" class="form-control"  size="50" />
 </td><td>
   
     <input type="submit" class="btn btn-form " name="search" value="Search"/></td>
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table">
				...
				<tr>
					<td class="green-left"  height="40px;" valign="middle"> <a href="AddCity.php">Add new one City.</a></td>
			  ...
			  <!--  start product-table ..................................................................................... -->
				...
				<tr>
					...
					<th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">Reason</p></th>
			...
			$query = "select name,delete_reason from clients_deleted where 1 ";
...
while($row=mysql_fetch_row($result)){
				...
				<!--	<td class="options-width">
					<a href="editCity.php?cmp=<?php echo $row[1]; ?>"  title="Edit" class="icon-1 info-tooltip"></a>
					<a href="deleteCity.php?cmp=<?php echo $row[1]; ?>" title="Delete" class="icon-2 info-tooltip"></a>
        	...
        	<?PHP
				...
				doPages($offset, 'merchant_delete.php', '', $total_records); 
			?>    
            </td>
		</tr>
				</table>
