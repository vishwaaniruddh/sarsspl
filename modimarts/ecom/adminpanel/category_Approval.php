...
/*
$isSubAdmin = false;
$querySubAdmin=mysqli_query($con3,"SELECT * FROM subAdminLogin where email='".$_SESSION['email']."'");
...
-->
	...
	<table border="0" width="100%" cellpadding="0" cellspacing="0" id="content-table">
		...
		<div id="content-table-inner">
            ...
            $QClientCode = mysqli_query($con3,"SELECT ccode FROM `Approval_products` where code='".$row['Product_id']."'");
            $FetchClientCode=mysqli_fetch_array($QClientCode);
            
        	$query1 = mysqli_query($con3,"SELECT code,name,category,email FROM clients where code='".$FetchClientCode['ccode']."'");
        ...
        $aa=$rowa[2];
         ...
         $resulta2=mysqli_query($con3,$qrya2);
