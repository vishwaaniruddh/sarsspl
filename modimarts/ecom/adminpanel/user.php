	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<td class="green-left"  height="40px;" valign="middle"> <a href="createUser.php">Add new one User.</a></td>
			  ...
			  <!--  start product-table ..................................................................................... -->
				...
				<tr>
                    ...
                    <th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">Customer Id</p>	</th>
					<th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">User Name</p>	</th>
					<th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">Password</p></th>
					<th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#FFF;">Department</p></th>
				...
				$query = "SELECT * FROM users order by cid ASC LIMIT " . $from . "," . $offset;
...
while($row=mysql_fetch_row($result)){
				...
				<tr class="alternate-row">
					...
					<a href="editUser.php?cmp=<?php echo $row[0]; ?>"  title="Edit" class="icon-1 info-tooltip"></a>
					<a href="deleteUser.php?cmp=<?php echo $row[0]; ?>" title="Delete" class="icon-2 info-tooltip"></a>
        	...
        	<?PHP
				...
				doPages($offset, 'user.php', '', $total_records); 
			?>    
            </td>
		</tr>
