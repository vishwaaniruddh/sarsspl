...
<header id="header-layout" class="header-v2">
  ...
  <ul class="breadcrumb">
       ...
       <?php if(!isset($_SESSION['loginstats']) & $_SESSION['loginstats']==""){ ?>
        <li><a href="#">Register</a><a href="resale_index.php"> <img src="image/back-button.png" class="btnreqmt" style="width: 79px;height: 33px;left: 1233px;top: 81px;"/></a></li>
        <?php } ?>
      </ul>
    ...
    <div id="content" class="col-sm-9 container"  style="background-color: #f5f5f5;border-radius: 2%;margin-left: 2%;">      
     <?php if(!isset($_SESSION['loginstats']) & $_SESSION['loginstats']==""){?>
    <h1>Register Account</h1>
    <p>If you already have an account with us, please login at the <!--<a href="login.php">--><a onclick="popup('1')">login page</a>.</p>
    <?}else{?>
...
?>
      <form action="resale_process_reg.php" method="post" enctype="multipart/form-data" class="form-horizontal" id="regfrm" onsubmit="return val();">
        <fieldset id="account">
...
<select  name="city" class="form-control" class="styledselect_form_1" id="city" ><option value="0" style="width: 15em" >Select</option>
        ...
        <fieldset>
          ...
          <div class="form-group required" <?php if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){?> style="display:none;" <?php  } ?>>
            ...
            <div class="col-sm-9">
              <input type="password" name="password" placeholder="Password"   <?php if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){?> placeholder="Password" <?php } ?> id="password" class="form-control" value="<?php echo $password;?>" required autofocus/>
                          </div>
          </div>
          <div class="form-group required" <?php if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){?> style="display:none;" <?php } ?>>
...
input[type=password]:focus, textarea:focus {
  ...
  border: 1px solid rgba(81, 203, 238, 1);
        ...
        <input type="submit" name="update" data-loading-text="Loading..."  class="btn btn-primary" value="update" <?php if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){ ?> style="display:block;" <?php }else{ ?>style="display:none;border-radius: 17px;" <?php } ?>/>
         
            <!--<button type="submit" name="submit" data-loading-text="Loading..." value="Continue" id="regbtn"  class="btn btn-primary" />Submit</button>-->
            <input type="submit" name="submit" value="Submit" data-loading-text="Loading..."  class="btn btn-primary" <?php if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){?> style="display:none;"<?php }else{ ?>style="display:block;border-radius: 17px;"<?php } ?>/>
