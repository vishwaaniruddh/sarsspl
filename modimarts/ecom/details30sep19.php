...
//echo "select * from main_cat where id='".$cid."'";
...
if($Maincate==1)
{
    ...
    //$qrylatf="SELECT ` `color` ,`size`,Long_desc FROM `fashion` WHERE code='".$pid."'";
}
    ...
    height:500px;
            ...
            <div class="row" id="" style="margin-left: 7px;">
                ...
                <div id="a" class="" style="border: 1px solid #f0f0f0;">
                    <center ><div id="b"> <a href="<?php echo $prodimgpth.$frtu['img'];?>" title="<?php echo $latstprnrws['name'];?>" class="elevateZoom" target = '_blank'>
 ...
 <?php if($latstprnrws['total_amt']>0){?>
        ...
        <div class="row" style="  ">
                <!--<div class="col-md-12" style="   border: 1px solid #f0f0f0;"><h2>Long Description</h2></div>-->
                 <div class="col-md-12" style="width: 195%;height: 121px;color:black">
                     <p>
       ...
       <?php if($latstprnrws['others']!=""){?>
        ...
        <div class="row" style=" margin-top:10px;margin-bottom:29px;"> 
                <div class="col-md-12" style="font-size:23px;">
                    ...
                    <h2 style="font-size:23px;">Specifications</h2></div>
                 <div class="col-md-12" style="  ">
                     <table>
                         <tr>
               ...
               <?php } ?> <hr style="margin-top: 168px; margin-bottom: -2px;" />
               </tr>
                         </table>
          <br/>
...
<tbody>
  <tr>
    <td colspan="2" style="padding-bottom: 0px;padding-top: 0px;">    <?php
