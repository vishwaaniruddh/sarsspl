...
<!DOCTYPE html>
    <html lang="en">
        <head>
            ...
            <!-- Bootstrap core CSS -->
            <link href="css/new_bootstrap.min.css" rel="stylesheet">
            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                <div class="container logo-container"> 
                    <a class="navbar-brand" href="https://allmart.world">
                        <img src="images/allmart.png" style="width:100px;" alt="logo"> &nbsp;&nbsp;allmart.world
                    </a>
                        ...
                        <!--<p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse necessitatibus neque sequi doloribus.</p>-->
                            ...
                            <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-6">
                                        <ul class="list-group">
                                          <!--<li class="list-group-item"><a href="about.php?page=1">Mission & Vision</a></li>
                                          <li class="list-group-item"><a href="about.php?page=2">Values</li></a>
                                          <li class="list-group-item"><a href="#">People Behind Company</li></a>
                                          <li class="list-group-item"><a href="about.php?page=4">Consultants</li></a>-->
                  ...
                  <div class="col-md-4 mb-5">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-sm-6">
                                    <label class="col-form-label"><a href="https://allmart.world/">E Commerce Website</a></label>
                                    <label class="col-form-label"><a href="http://www.allmart.world/franchise/get_members.php">Franchisee</a></label>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer">
