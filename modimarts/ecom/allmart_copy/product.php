                            ...
                            <ul id="collapse_214945721881688183652" class="box-category list-group accordion">
                                <?php
                                   ...
                                   // echo "select * from Productviewtable where category ='".$idc."' and status=1";
                                    //$chkqrnrprodcts=mysqli_query($con1,"select * from (select p.* from Productviewtable where category ='".$idc."' and status=1 order by price ) order by p.name");
                                ...
                                <li class="collapse accordion-body in" class="active">
                                    <a href="product.php?mdi=<?php echo $row->id;?>">
                                        <?php 
                                        echo $row->name; 
                                        //if($cprodexs>0){/* echo  " (".$cprodexs.")";*/ } 
                                        ?>
                                    </a>
                                <?php
