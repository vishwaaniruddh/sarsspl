...
nm=nm+'<img src='+imgr+' title="" alt="" id="xzoom-default"  style="height:350px;width:75%;object-fit: contain" data-zoom-image='+imgr+' class="product-image-zoom img-responsive"/></a>';
                 
//document.getElementById("imgzm").innerHTML=nm;
 // document.getElementById("a").innerHTML=nm;
  document.getElementById("aa").innerHTML=nm;               
   ...
   #sticky::after{
    ...
    height:500px;
         ...
         <!-- <img class="xzoom" id="xzoom-default" src="images/gallery/preview/01_b_car.jpg" xoriginal="images/gallery/original/01_b_car.jpg" />-->
          <img class="xzoom" id="xzoom-default" src="<?php echo $prodimgpth.$frtu['midsize'];?>" xoriginal="<?php echo $prodimgpth.$frtu['img'];?>"  />
         
        </div>    
                   
   
    <!-- <div id="aa" class="xzoom-container">-->
                <div id="aa">          
                       ...
                       style="height:350px;width:75%;object-fit: contain" class="product-image-zoom img-responsive"/>
             ...
             <div class="row " style="margin-top:20px;" >
                        <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"><div class="cart pull-left" style="padding-left: 127px;">
               ...
               <?php } ?>
                    ...
                    <?php if($latstprnrws['total_amt']>0){?>
                        ...
                        <button type="button" id="button-cart" data-loading-text="Loading..." class="btn btn-primary" style="width: 241px;" onclick="addcart2('<?php echo $_GET['prid'];?>');">
                        BUY NOW</button>
               <?php } ?>
                </div></div>-->
            </div>
...
<?php  $s=  $latstprnrws['color'];
 ...
 //===========code for hide "size" box ======================
   ...
   <!--===================================================-->
    ...
    <input type="button" id="<?php echo $Rowcolor['id']?>" value="" onclick="colrcod(this.id)" style="width:40px;height:40px;text-align:center;background-color:<?php echo $Rowcolor['color_code']?>" >
<?php }
