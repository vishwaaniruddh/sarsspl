    ...
    <body id="bd" class="common-home page-common-home layout-fullwidth" >
        ...
        <div class="row-offcanvas row-offcanvas-left">
            <div id="page">
                ...
                <!-- /sys-notification -->
                <div class="breadcrumbs space-30" style="margin-top:13%;" id="fix">
                                                        ...
                                                        <div class="row" id="" style="margin-left: 7px;">
                                                            ...
                                                            <div class="col-xs-12 col-sm-10 col-md-10 col-lg-10 " >
                                                                <div id="a" class="" style="border: 1px solid #f0f0f0;">
                                                                    <center >
                                                                        <div id="b">
                                                                            <a href="<?php echo $prodimgpth.$frtu['img'];?>" title="<?php echo $product_name['product_model'];?>" class="elevateZoom" target = '_blank'>
                                                                                <img src="<?php echo $prodimgpth.$frtu[2];?>" title="<?php echo $product_name['product_model'];?>" alt="<?php echo $product_name['product_model'];?>" id="image" style="height:350px;width:100%;object-fit:contain" data-zoom-image="<?php echo $prodimgpth.$frtu[3];?>" class="product-image-zoom img-responsive"/>
                                                                            </a>
                                                                        </div>
                                                                    </center>
                                                                </div>
