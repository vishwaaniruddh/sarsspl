...
include("config.php");
$sliderid="13";
$slidername="topratingslider5";
$slidertablename="top_right_slider5";
...
<div class="widget panel ">
		<div class="widget-heading panel-heading block-borderbox"><h4 class="panel-title">  &nbsp; &nbsp;</h4>Latest Offers
    </div>
...
<div class="image">
  ...
  <div class="product-meta">
        <h6 class="name"><a href="details.php?prid=<?php echo $detsarr[$itr]['code'];?>&catid=<?php echo $detsarr[$itr]['category'];?>">
            <p class="b"><?php echo $detsarr[$itr]['pname'];?></p></a></h6>
