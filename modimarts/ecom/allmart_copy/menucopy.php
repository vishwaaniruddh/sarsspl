                    ...
                    <!--<li class="active dropdown yamm-fw"> <a href="resale_index.php" class="dropdown-toggle">RESALE</a> </li>-->
                        <div class="login pull-right ">
                            <ol class="breadcrumb" style="padding-right: 34px;">
                                <li><a class="upper-class" style="color:#fff; " href="https://allmart.world/franchise/">Franchise</a></li>
                             <?php if(!isset($_SESSION['loginstats']) && $_SESSION['loginstats']==""){?>
                                ...
                                <li> 
                                    ...
                                    <a href="#" onclick="popup('1','')" style="color:#fff;" class="upper-class">Login /</a>
                                    <a href="Register.php" style="color:#fff;" class="upper-class">Register</a> 
                                </li>
                                <?php } ?>
