...
<div class="tab">
    <button class="tablinks" onclick="openPaymentSection(event, 'CreditCard')" id="defaultOpen"> Credit Card <span id="CreditCardarro" style="display:none" ><i class="fa fa-angle-right" style="font-size:14px;    float: right;"></i> </span></button>
...
<div id="CreditCard" class="tabcontent" style="display:none">
    <h6>Card Number</h6>
    ...
    <div class="row">
        <div class="col-md-6">
            ...
            <div class="col-md-6">
				...
				<div class="col-md-5" style="padding-left: 0px;"><span class="cvv"></span></div> </div>
                </div>
            </div>
            <p>I agree with the <b style="color:#0f6cb2">Privacy Policy</b> by proceeding with this payment.</p> </p><b style="color:#0f6cb2">INR 600.00</b>  (Total Amount Payable)</p>
		...
		<table border="1">
			<tbody>
				...
				<tr>
					<td></td>
					<td></td>
					<td><input value="CheckOut11" type="submit" id="paytm_submit"></td>
				</tr>
			</tbody>
		</table>
		* - Mandatory Fields
