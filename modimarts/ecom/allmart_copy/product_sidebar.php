...
<div class="list box-products owl-carousel-play panel-body block-content bg-white" id="product_list1886397652"  data-ride="owlcarousel" >
						<div class="carousel-controls">
				<a class="carousel-control left center" href="#product_list1886397652"   data-slide="prev">
					<i class="fa fa-angle-left"></i>
				</a>
				<a class="carousel-control right center" href="#product_list1886397652"  data-slide="next">
...
}else
{
 ...
 //  print_r($detsarr)."<>";     
  ...
  $merchntidsall=array();
    ...
    $Viewrt=mysqli_query("SELECT distinct(merchant_id) FROM merchantdetsfm where 1 order by distance asc");
 echo mysqli_error();
...
$nrtws=mysqli_num_rows($Viewrt);
 ...
 $lat1=mysqli2_fetch_array($Viewrt);
