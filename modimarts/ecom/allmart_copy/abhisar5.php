...
<div class="row"  >
    ...
    if($Maincate==1){
     $sqlimg23mn=mysql_query("SELECT img,thumbs,midsize,largeSize FROM `fashion_img` WHERE `product_id`='$pid' order by id asc limit 0,1");
    }
    else if($Maincate==190)
    {
         $sqlimg23mn=mysql_query("SELECT img,thumbs,midsize,largeSize FROM `electronics_img` WHERE `product_id`='$pid' order by id asc  limit 0,1");
    }
    else if($Maincate==218)
    {
         $sqlimg23mn=mysql_query("SELECT img,thumbs,midsize,largeSize FROM `grocery_img` WHERE `product_id`='$pid' order by id asc limit 0,1");
    }
    else 
    {
         $sqlimg23mn=mysql_query("SELECT img,thumbs,midsize,largeSize FROM `product_img` WHERE `product_id`='$pid' order by id asc limit 0,1");
    }
            ...
            <div class="row" id="" style="margin-left: 7px;">
             ...
             <div class="row " style="margin-top:20px;margin-bottom:20px;" >
               ...
               <?php } ?>
                     ...
                     <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6"><div class="cart1 pull-left">
                    <?php if($latstprnrws['total_amt']>0){?>
...
<div class="fixed_div" id="x">

<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 ">
  <div class="product-info-bg">
    <h1 class="title-product" style="font-size:23px;margin-top:42px;width: 649px;"><?php echo $latstprnrws['name'];?></h1>
...
$avg=0;
 $ttl=0;                           $ttl=$ttl+($str5+$str4+$str3+$str2+$str1);
						    ...
						    ?>                               <? if($round==1){ ?>      <span class="fa fa-stack"><i style="color:red;" class="fa fa-star fa-stack-1x"></i></span>
...
.row:after {
    ...
    clear: both;
             ...
             <div class="row" style="width: 688px;height: 59px;margin-left: 0px;margin-right: 0px;">
  <div class="columnn" style="height: 63px;">
   <div class="price detail space-20">
                <ul class="list-unstyled" >
           ...
           <div class="columnn" style="height: 64px;">  
           <button id="down" class="ab ab1" onclick="down('1')" style="border-radius: 17px;font-size:22px;padding-left: 2px;padding-right: 2px;padding-top: 2px;padding-bottom: 1px;width: 43px;margin-top: 0px;"><i class="fa fa-minus" style="width: 22px;height: 16px;padding-top: 4px;padding-bottom: 8px;"></span></i></button>
                 
           <input type="text" id="input-quantity" name="quantity" class="input-number" value="1" onkeydown='return (event.which >= 48 && event.which <= 57) || event.which == 8 || event.which == 46' style="text-align:center;border-radius: 6px;width: 58px;"/>
            
           <button id="up" class="ab ab1" onclick="up('100')" style="border-radius: 17px;font-size:22px;padding-left: 2px;padding-right: 2px;padding-top: 2px;padding-bottom: 1px;width: 43px;margin-top: 0px;"><i class="fa fa-plus" style="width: 22px;height: 16px;padding-top: 4px;padding-bottom: 8px;"></span></i></button> 
           </div>
 ...
 <?php if($latstprnrws['total_amt']>0){?>
        ...
        <div class="row" style="  ">
                <!--<div class="col-md-12" style="   border: 1px solid #f0f0f0;"><h2>Long Description</h2></div>-->
                 <div class="col-md-12" style="width: 195%;">
                     <p>
...
<!--  border: 1px solid #f0f0f0;-->
        ...
        <div class="row" style=" margin-top:10px;margin-bottom:29px;">
                <div class="col-md-12" style="font-size:23px;"><h2 style="font-size:23px;">Specifications</h2></div>
                 <div class="col-md-12" style="  ">
                     <table>
                         <tr>
...
<div class="box-product-infomation tab-v2 tabs-left" style="width:96%;" >
    ...
    <ul class="" role="tablist" >
      <!--  <li class="active"><a href="#tab-description" data-toggle="tab">Description</a></li>-->
        <li ><a href="#tab-review" data-toggle="tab">Reviews (<?php echo $fstarftc[0];?>)</a>/<button type="button" class="btn btn-link" style="color:blue" data-toggle="modal" data-target="#myModal">Write a review</button></li>
    </ul>
    </div>
    <div class="">
...
<thead > 
  <tr style="height:20%;">
    ...
    <th class="text-right" style="padding-bottom: 0px;padding-top: 0px;padding-right: 21px;"><?php echo date('d-m-Y',strtotime($getreviewarr['date_time']));?></th>
  </tr>  
</thead>
<tbody>
  <tr>
    <td colspan="2" style="padding-bottom: 0px;padding-top: 0px;"><p style="margin-bottom: 0px;"><?php echo $getreviewarr['description'];?></p>
    <?php
