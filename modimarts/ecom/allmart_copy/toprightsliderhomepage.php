        ...
        if($frds["Latitude"]!="")
        {
         ...
         //       print_r($arrdist2); 
            ...
            if($latstprnrws>0)
            {
                ...
                $gtallprdshwn=mysqli_query("select pid,category from slider_location_dets where city_id='".$livecityid."' and slot_id='".$sliderid."' and slot_pos='".$ca."' and sts=0 and entrydt='".$todaysdtt."'  ");
                if(!$gtallprdshwn)
                {
                    echo mysqli_error();
                }
...
<div class="image">
  ...
  <div class="product-meta">
        ...
        <h6 class="name">
            <a href="details.php?prid=<?php echo $detsarr[$itr]['code'];?>&catid=<?php echo $detsarr[$itr]['category'];?>"><p class="c" ><?php echo $detsarr[$itr]['name'];?></p></a></h6>
