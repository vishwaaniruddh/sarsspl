...
$.ajax({
   type: 'POST',    
url:'product_search_detailsCopy.php',
dataType: 'html',
   ...
   <div id="sidebar-main" class="col-md-12 col-sm-12 col-xs-12" >
    ...
    <div class="inner clearfix">
       <!-- <div class="display col-lg-2 col-md-2 col-sm-2 hidden-xs">
        ...
        <div class="filter-right col-lg-8 col-md-10 col-sm-10 col-xs-12">
         <div class="limit col-lg-3 col-md-3 col-sm-4 col-xs-12 " style="display:none">
                <span>Show:</span>
              ...
              <div class="sort col-lg-7 col-md-3 col-sm-5 col-xs-12 ">
                <span>Sort By:</span>
           ...
           <div class="product-compare col-lg-3 col-md-3 col-sm-3 col-xs-12 " style="display:none">
            ...
            <div class="limit col-lg-3 col-md-3 col-sm-4 col-xs-12 pull-right">
