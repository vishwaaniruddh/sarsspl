  ...
  <div class="main-header" style="padding-bottom: 0px;">
    <div class="container" >
      <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-7 top-search-holder" style="width: 588px;top:2px;padding-right: 0px;"> 
          <!-- /.contact-row --> 
          <!-- ============================================================= SEARCH AREA ============================================================= -->
   ...
   <input type="hidden" name="latitude" id="latitude" readonly>
          <input type="hidden" name="longitude" id="longitude" readonly>
                ...
                <input type="text" name="srchtxt" id="srchtxt" value="<?php echo $_POST["srchtxt"];?>" class="search-field" placeholder="Search for products, brands & more..." style="width: 517px;"/>
          ...
          <div class="navbar-collapse collapse" id="mc-horizontal-menu-collapse">
            <div class="nav-outer">
              <ul class="nav navbar-nav">
               ...
               <li class="active dropdown yamm-fw"> <a href="index.php" style="padding-left: 0px;" class="dropdown-toggle">Home</a> </li>
                <?php
