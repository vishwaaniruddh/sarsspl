...
<div class="widget panel ">
	<div class="widget-heading panel-heading block-borderbox"><h4 class="panel-title">  &nbsp; &nbsp;</h4>Top Rating </div>
            ...
            for($ca=0;$ca<=8;$ca++)
            {
                ...
                if($latstprnrws>0)
                {
                    ...
                    */
                    ...
                    //echo "select p.*,pm.product_model from Productviewtable p join product_model pm on p.name = pm.id where p.code='".$lat1['pid']."' and p.category='".$lat1['cat']."' ";
