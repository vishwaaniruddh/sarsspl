...
$querycat=mysqli_query($con1,"SELECT * FROM `main_cat` where id in ($catarr) or under in($catarr) order by name");
...
?>
            ...
            <select id="Maincat" name="Maincat" class="form form-full" onchange="chkcategory();setSubCategory2('Maincat','Maincategory','newSubCat2');getBrands('Maincat',this.value);" required>
                ...
                <?php 
                    ...
                    $querycat=mysqli_query($con1,"SELECT id,name FROM `main_cat` where id IN ($clintctf[0]) order by name");
                ?>
                <optgroup label="Product Category">Product Category</optgroup>
                <?
                while($querycatf=mysqli_fetch_assoc($querycat)) 
                {?>
  ...
  <tr id="hd_NewCategory1" Style="display:none">
      ...
      <?php $mnCat=mysqli_query($con1,"SELECT id,name FROM `main_cat` where id IN ($clintctf[0])");
    ...
    <tr>
      ...
      <td>
        ...
        <select name="pbrand"  id="pbrand" onchange="showDiv(this,'brand');">
              <option value="">Select</option>
                <? /*php $brand=mysqli_query($con1,"SELECT * FROM `brand`");
                    while($fetchBrand=mysqli_fetch_array($brand)){
                ?>
...
<table class="tables"  align="center" cellpadding="4" cellspacing="0" id="attatch1">
    <tr>
        ...
        <td ><input type="text" name="price" id="price" class="form form-full" onchange="a()"  required/></td>
        <td >
