...
$id=$_SESSION['id'];
include "config.php"; 
 $qry =mysqli_query($con1,"SELECT s.id as sid,s.period,s.type,sd.rate,sd.discount,sb.sdate,sb.tilldate,sb.s_purchase_date FROM subscriptions s join  subscription_details sd on s.id=sd.subscription_id join Subscription sb on sd.subscription_id=sb.sid where sd.status!=2 and sb.mid=".$id);
                      ...
                      <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <?php echo $row['tilldate'] ;?>
                                </td>
                                <td>
                                    <?php echo $row['s_purchase_date'] ;?>
                                </td>
                                <td>
