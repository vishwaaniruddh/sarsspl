...
<div class="list box-products owl-carousel-play panel-body block-content bg-white" id="product_list500423425"  data-ride="owlcarousel" >
	...
	<div class="owl-carousel product-grid"  data-show="1" data-pagination="false" data-navigation="true">
        ...
        {
            $avilfrupdt=0;
            //echo "select * from advertise_booking where  slot='".$sliderid."' and slot_pos='".$ca."' and dt='".date("Y-m-d")."' and merchant_id='".$_SESSION["id"]."'";
            ...
            if($qspbkd>0)
            {
                ...
                if($latstprnrws>0)
                {
                    ...
                    $detsarr[]=['code'=>$prdrws['code'],'name'=>$prdrws['name'],'ccode'=>$prdrws['ccode'],'description'=>$prdrws['description'],'category'=>$prdrws['category'],'photo'=>$prdrwsimg['img'],'price'=>$prdrws['price'],'discount'=>$prdrws['discount'],'discount_type'=>$prdrws['discount_type'],'total_amt'=>$prdrws['total_amt'],'updtid'=>$lat1['id'],'avail'=>$avilfrupdt,'bookingid'=>$bkit];
...
<div class="image">
        ...
        <div class="product-img img">
          <a class="img" title="<?php echo $detsarr[$itr]['name'];?>" href="javacript:void(0);">
  ...
  <div class="product-meta">
        <h6 class="name"><a href="javacript:void(0);"><?php echo $detsarr[$itr]['name'];?></a></h6>
