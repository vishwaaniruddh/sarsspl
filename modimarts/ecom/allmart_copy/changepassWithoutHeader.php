...
<header id="header-layout" class="header-v2">
 ...
 <!-- <ul class="breadcrumb">
    ...
    <div id="content" class="col-md-12" style="margin-left: 10%;border-radius: 10px;">     
    ...
    <form method="post" action="" onsubmit="return logfnn();">
        ...
        <?php /*
         <div class="form-group required" >
          ...
          <div class="form-group col-md-6">
            ...
            <div class="col-md-8 inputGroupContainer">
               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                    <input type="password" name="confirm1" placeholder="New Password "  id="confirm1" class="form-control"  required autofocus/>
               </div>
            </div>
        </div>
        <!--
      ...
      <div class="form-group col-md-12">
            ...
            <div class="col-md-8 inputGroupContainer">
               <div class="input-group col-md-10"> </span>
