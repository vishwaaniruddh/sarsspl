  ...
  <ul class="breadcrumb">
    ...
    <fieldset>
     <div class="form-group required" >
            <label class="col-sm-2 control-label" for="input-password">Enter Current Password</label></br>
            <div class="col-sm-10">
              <input type="password" name="password" <?php if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){?> placeholder="Password" <?php } ?> id="password" class="form-control" required autofocus onblur="chkifpasswrd()";/>
                          </div>
          </div>
          </fieldset>
           <fieldset>
           <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-confirm">Enter New Password</label></br>
            <div class="col-sm-10">
              <input type="password" name="confirm1" <?php if(!isset($_SESSION['loginstats']) & $_SESSION['loginstats']==""){?> placeholder="New Password " <?php } ?> id="confirm1" class="form-control"  required autofocus/>
                          </div>
          </div>
          </fieldset>
              <fieldset>
          <div class="form-group required">
            <label class="col-sm-2 control-label" for="input-confirm">Password Confirm</label></br>
            <div class="col-sm-10">
              <input type="password" name="confirm" <?php if(!isset($_SESSION['loginstats']) & $_SESSION['loginstats']==""){?> placeholder="Password Confirm" <?php } ?> id="confirm" class="form-control"  required autofocus/>
                          </div>
          </div>
          </fieldset>
