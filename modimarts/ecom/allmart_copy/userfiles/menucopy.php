        ...
        <div class="col-xs-12 col-sm-12 col-md-4 logo-holder" style="width: 372px;"> 
          ...
          <div class="logo row">
                ...
                <div class="col-md-2">
                    ...
                    <!--<img src="image/Merabaz.png" style="width:200px;height: 63px;margin-top: -12px;" alt="logo"> -->
                    <img src="image/allmart.jpg" style="width:200px;height: 120px;margin-top: -12px;" alt="logo">
                  </a>
		      </div>
             <!--  <a href="https://sarmicrosystems.in/oc1">
          ...
          <div class="search-area" style="width: 448px;">
            <form id="frmsrchsub" method="post" action="product_search.php">
              <div class="control-group" style="width: 456px;">
                ...
                <input type="text" name="srchtxt" id="srchtxt" value="<?php echo $_POST["srchtxt"];?>" class="search-field" placeholder="Search for products, brands & more..." style="width: 401px;"/>
    ...
    <div class="login pull-left hidden-xs hidden-sm">
        <ol class="breadcrumb" style="padding-left: 0px;padding-right: 0px;">
            ...
            <li>
              ...
              $slctqry=mysql_query("SELECT Firstname FROM `Registration` WHERE id='".$_SESSION['gid']."'");
              $sltqryftch=mysql_fetch_array($slctqry);
              if($sltqryftch[0]!=""){
              ?>
            ...
            <div class="nav-outer">
              <ul class="nav navbar-nav">
               <li class="active dropdown yamm-fw"> <a href="index.php" style="padding-left: 15px;" class="dropdown-toggle">Home</a> </li>
                <?php
                    $sql23 = mysql_query("select * from main_cat where under ='0' order by name limit 0,6");
                    ...
                    <?php } ?>
                    <!--<li class="active dropdown yamm-fw"> <a href="resale_index.php"</a> class="dropdown-toggle">RESALE</a> </li>-->
                        <div class="login pull-right hidden-xs hidden-sm">
                            <ol class="breadcrumb" style="padding-right: 34px;">
                             <?php if(!isset($_SESSION['loginstats']) & $_SESSION['loginstats']==""){?>
                                <li class="active dropdown yamm-fw">  <a href="user/index.php" style="color:#fff;">Merchant Login /</a><a href="Sell.php" style="color:#fff;"> Register</a></li>
                                <li> 
                                    <!-- <a href="login.php" style="color:#fff;">Login /</a>-->
                                    <a href="#" onclick="popup('1','')" style="color:#fff;">Login /</a>
