...
include("config.php");
$sliderid="2";
$slidername="onsaleslider";
$slidertablename="top_right_slider";
$todaysdtt=date("Y-m-d");
?>

<div class="list box-products owl-carousel-play panel-body block-content bg-white" id="product_list1797851720"  data-ride="owlcarousel" >
						<div class="carousel-controls">
				<a class="carousel-control left center" href="#product_list1797851720"   data-slide="prev">
					<i class="fa fa-angle-left"></i>
				</a>
				<a class="carousel-control right center" href="#product_list1797851720"  data-slide="next">
...
?>
   ...
   $avilfrupdt=0;
       ...
       $qravdm=mysqli_query($con1,"select * from advertise_booking where  slot='".$sliderid."' and slot_pos='".$ca."' and dt='".$todaysdtt."'");
         ...
         if(count($arrdist2)>0 )
       {
        ...
        else
        {
                $key = array_search('$arrdist2[0]', $arrdist);
                  ...
                  $qravdmf=mysqli_query($con1,"select * from advertise_booking where  slot='".$sliderid."' and slot_pos='".$ca."' and dt='".$todaysdtt."' and merchant_id='".$arraycid[$key]."'");
...
$detsarr[]=['code'=>$prdrws['code'],'name'=>$prdrws['name'],'ccode'=>$prdrws['ccode'],'description'=>$prdrws['description'],'category'=>$prdrws['category'],'photo'=>$prdrwsimg['img'],'price'=>$prdrws['price'],'discount'=>$prdrws['discount'],'discount_type'=>$prdrws['discount_type'],'total_amt'=>$prdrws['total_amt'],'updtid'=>$lat1['id'],'distance'=>$avilfrupdt];
