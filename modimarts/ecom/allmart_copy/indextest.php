...
function showloader(divid)
{
 ...
 $('#'+divid).html('<div id="overlay"><img src="image/giphy123.gif" class="loading_circle" alt="loading" /></div>');    
}
...
function fnuncloadfn()
{
  ...
  <body id="bd" class="common-home page-common-home layout-fullwidth" onload="rtymvid();">
...
<video class="videoad" id="vid"  src="" type="video/mp4"  onclick="flsc()" muted></video>   
...
<div class="productdeals panel panel-default nopadding ">
	...
	<div id="topratingsliderdivs">
     		    	     ...
     		    	     <div class="widget-heading panel-heading block-borderbox"><h4 class="panel-title">Fast Selling Product &nbsp; &nbsp;</h4></div>
			
			
			<div id="toprightsliderdiv">
