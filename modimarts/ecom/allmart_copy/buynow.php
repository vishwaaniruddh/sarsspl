...
<header id="header-layout" class="header-v2">
  ...
  <ul class="breadcrumb">
        ...
        <li><a href="buynow.php">Buy Now Process</a></li>
      </ul>
        <div class="row" >              
...
//===============================================================  
    ...
    if($Maincate==1){
         $getprdets=mysql_query("select * from fashion where code='".$cartdetsrw['pid']."'");
         $prdrws=mysql_fetch_array($getprdets);
     
         $getprdets1=mysql_query("select img from fashion_img where product_id='".$cartdetsrw['pid']."'");
         $prdrws1=mysql_fetch_array($getprdets1);
         
         $getprcolor=mysql_query("select * from fashioncolor where id='".$cartdetsrw['color']."'");
         $pcolor=mysql_fetch_array($getprcolor);
     
    }
    else  if($Maincate==190)
    {
         $getprdets=mysql_query("select * from electronics where code='".$cartdetsrw['pid']."'");
         $prdrws=mysql_fetch_array($getprdets);
         
     
         $getprdets1=mysql_query("select img from electronics_img where product_id='".$cartdetsrw['pid']."'");
         $prdrws1=mysql_fetch_array($getprdets1);
    ...
    {
         $getprdets=mysql_query("select * from grocery where code='".$cartdetsrw['pid']."'");
         $prdrws=mysql_fetch_array($getprdets);
     
         $getprdets1=mysql_query("select img from grocery_img where product_id='".$cartdetsrw['pid']."'");
         $prdrws1=mysql_fetch_array($getprdets1);
    ...
    {
         $getprdets=mysql_query("select * from products where code='".$cartdetsrw['pid']."'");
         $prdrws=mysql_fetch_array($getprdets);
     
         $getprdets1=mysql_query("select img from product_img where product_id='".$cartdetsrw['pid']."'");
         $prdrws1=mysql_fetch_array($getprdets1);
     ...
     //echo "select * from Productviewtable where code='".$_GET["Pid"]."' and category='".$_GET["cId"]."' ";
        ...
        // echo "select * from products where code='".$cartdetsrw['pid']."'";
                ...
                <a href="details.php?prid=<?php echo $prdrws['code'];?>"><img style="width:100px;height:100px;" src="<?php echo $prdrws1[0];?>" alt="" title="<?php echo $prdrws['name'];?>" class="img-thumbnail" /></a>
                  </td>
            ...
            <?php } else{ ?>
             ...
             <?php }?>
              ...
              <!-- <td class="text-left"><?php echo $pcolor['color'];?></td>
                <td class="text-left"><?php echo $_GET["sz"];?></td>-->
              <td class="text-left"><?php echo $_GET["qty"];?></td> 
      ...
      <div class="row">
       ...
       <!-- <div class="pull-left"><a href="index.php" class="btn btn-default">Continue Shopping</a></div>-->
        <div class="pull-right"><a href="Checkout.php?Pid=<?php echo $_GET["Pid"];?>&cId=<?php echo $_GET["cId"];?>&qty=<?php echo $_GET["qty"];?>&clr=<?php echo $_GET["clr"];?>&sz='<?php echo $_GET["sz"];?>'" class="btn btn-primary">Checkout</a></div>
      </div>
