...
<header id="header-layout" class="header-v2">
  ...
  <div class="row">           
  <div id="content" class="col-sm-9" style="left: -23px;width: 1018px;">  
  <h1>Order History</h1>
...
<?php    
    $query = mysql_query("SELECT * FROM Orders WHERE user_id ='".$_SESSION['gid']."' ");
      ...
      $query1 = mysql_query("SELECT Firstname FROM Registration WHERE id ='".$rows[1]."'  ");
      $rows1 = mysql_fetch_array($query1);
          $query2 = mysql_query("SELECT qty FROM order_details WHERE oid ='".$rows[0]."'  ");
