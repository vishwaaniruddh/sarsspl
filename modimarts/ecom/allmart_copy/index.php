...
<html dir="ltr" class="ltr" lang="en">
    ...
    <head>
        ...
        <link href="https://allmart.world" rel="canonical" />
...
/*function addcart(pid,cid)
{
    ...
    <body id="bd" class="common-home page-common-home layout-fullwidth" onload="showtoprigthslider();">
				    	                ...
				    	                <div class="row-inner clearfix" >
					        	            <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 ">
					            	            <div class="col-inner space-30" >
                                                        ...
                                                        <!--    <iframe src="https://www.youtube.com/embed/s5Knr9lTVsU" frameborder="0" allow="accelerometer; autoplay; loop; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> -->
                                                            <div id="youtube-fs"><iframe id="youtube-iframe" type="text/html" src="https://www.youtube.com/embed/s5Knr9lTVsU?enablejsapi=1&html5=1&autoplay=1&showinfo=0&controls=0&rel=0&wmode=transparent&vq=hd1080&hd=1&loop=1" frameborder="0" wmode="Opaque" ></iframe> 
    ...
    <!--
      ...
      function onPlayerStateChange(event) {
        if (event.data == YT.PlayerState.ENDED) { player.seekTo(0 , false); } // Play from 0 seconds
      }
        -->
    </script>
