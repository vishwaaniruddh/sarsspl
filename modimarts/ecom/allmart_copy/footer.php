<div class="footer-center " id="pavo-footer-center" style="position:relative;">
			...
			<!-- <img  src="image/shopping-cart.png" style="width:100px;height: 43px;" alt="logo"/> 	<img alt="icon" src="image/merabazaar.png" style="width:100%;height:94px;"> -->	</div>    
				<div class="media-body">  				
    				<div class="ourservice-content">  					
    				    <p>Clothes, electronics, accessories - whatever your need for the hour maybe, Allmart, your favorite online shopping site, is sure to spoil you with a wide range of products.</p>  		
    				</div>  	
				</div>    		
			</div>      
		</div>
              ...
              <div class="box-content">
                <!--<div class="box-content">
                    ...
                    <ul class="list contact"> 
                        <li>
                            <span class="iconbox"><i class="fa fa-phone">&nbsp;</i>+022 2898 6153 </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="iconbox"><i class="fa fa-map-marker" aria-hidden="true" data-toggle="modal" data-target="#myModal">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mapouter">
            <div class="gmap_canvas">
                <iframe width="458" height="322" id="gmap_canvas" src="https://maps.google.com/maps?q=Borivali%20west%20L%20T%20road%20hsbc%20bank&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                <a href="https://www.bitgeeks.net/embed-google-map/">embed google map in excel</a>
            </div>
            <style>.mapouter{position:relative;text-align:right;height:322px;width:458px;}.gmap_canvas {overflow:hidden;background:none!important;height:322px;width:458px;}</style>
            </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        ...
                        <li>
                            <span class="iconbox"><i class="fa fa-envelope">&nbsp;</i>info@merabazaar.com</span>
                        </li>  
                    </ul> 
                </div>  -->          
                <div class="box-content">
                    ...
                    <ul class="list contact"> 
                        <li>
                            <span class="iconbox"><i class="fa fa-phone">&nbsp;</i>+022  </span> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span class="iconbox"><i class="fa fa-map-marker" aria-hidden="true" data-toggle="modal" data-target="#myModal">
                                <!-- Modal -->
  <div class="modal fade" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="mapouter">
            <div class="gmap_canvas">
                <iframe width="458" height="322" id="gmap_canvas" src="https://maps.google.com/maps?q=Kandivali%20west%20&t=&z=15&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
                <a href="https://www.bitgeeks.net/embed-google-map/">embed google map in excel</a>
            </div>
            <style>.mapouter{position:relative;text-align:right;height:322px;width:458px;}.gmap_canvas {overflow:hidden;background:none!important;height:322px;width:458px;}</style>
            </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        ...
                        <li><span class="iconbox"><i class="fa fa-mobile-phone">&nbsp;</i></span></li>  	
                        <li>
                            <span class="iconbox"><i class="fa fa-envelope">&nbsp;</i>info@allmart.world</span>
                        </li>  
                    </ul> 
                </div>
              </div>
            ...
            <div class="box-content">
              <ul class="list folow">  		
                ...
                <!--  <li><i class="fa fa-facebook"></i><a data-original-title="Facebook" data-placement="top" target="_blank" href="https://www.facebook.com/Merabazaar-1362889730447213/" title=""><span>Facebook</span> </a></li>  	
                  ...
                  <li><i class="fa fa-facebook"></i><a data-original-title="Facebook" data-placement="top" target="_blank" href="https://www.facebook.com/AllmartWorld-111946707234321" title=""><span>Facebook</span> </a></li>  	
                  <li><i class="fa fa-twitter"> </i><a data-original-title="Twitter" data-placement="top" target="_blank" href="https://twitter.com/AllMart_World" title=""><span>Twitter</span> </a></li>  
                  <!--<li><i class="fa fa-google-plus"> </i><a data-original-title="Google +" data-placement="top" target="_blank" href="" title=""><span>Google +</span> </a></li> -->
                  <li><i class="fa fa-youtube"> </i><a data-original-title="Youtube" data-placement="top" target="_blank" href="https://www.youtube.com/channel/UCmwbXGCoL4RnSuzEhbA71Aw" title=""><span>Youtube</span> </a></li>  		
                  <li><i class="fa fa-instagram"> </i><a data-original-title="Instagram" data-placement="top" target="_blank" href="https://www.instagram.com/allmart.world" title=""><span>Instagram</span> </a></li>
             </ul>           
            </div>
          </div>
        </div>        
     ...
     <div class="row">
        ...
        <div class="box">
         <!--<div class="panel-heading">
          ...
          <ul class="cust_ul list-unstyled list display-prop" style="width:100%; margin:auto;">
            <li class="li-style"><a onclick="popup('2','')">About Us</a></li>
            <!--<li><a onclick="popup('3','')">Newsletter</a></li>-->
            <!--<li class="li-style">
                <a href="working.php">How It Works</a> 
            </li>-->
            <li class="li-style"><a href="privacy_policy.php">Privacy Policy</a></li>
            <li class="li-style"><a href="docs/terms.pdf">Terms &amp; Conditions</a></li>
            <li class="li-style"><a href="refund_policy.php">Returns</a></li>
            <?php if(isset($_SESSION['loginstats']) & $_SESSION['loginstats']!=""){?>
            <li class="li-style"><a href="#">Gift Certificates</a></li>
            <?php }else{ ?>
             <li class="li-style"><a  href="#">Gift Certificates</a></li>
             <?php } ?>
          </ul>
...
<section class="footer1 cid-rfRDVhbs56" id="footer03-2n">
    
    
    <div class="footer-container container">
        
        <div class="copyright mbr-px-2 mbr-flex mbr-jc-c">
            <div class="copyright" style="font-size: 18px; text-align: center; display:flex;justify-content:center;"> <p>© Copyright 2020 <a href="#">Allmart</a></p> <p>ALL RIGHTS RESERVED</p></div>
            <div style="text-align: center; margin: 2% auto;">  Designed  by <a href="https://sarmicrosystems.in" target="_blank">Sarmicrosystems</a> 
            </div>
        </div>
    </div>
</section>
