...
<div class="sidenav"  >
 <h2 style="color: lightslategrey;">My Account</h2>
      <ul class="list-unstyled" >
        <li><a href="#expe1" id="" style="font-size:16px" >Edit account</a></li>
        <li><a href="#expe2" style="font-size:16px">Change password</a></li>
       <!-- <li><a href="addressbookentries.php">Modify your address book entries</a></li>-->  <!------  comment by anand ------->
        <li><a href="#expe3" style="font-size:16px">wish list</a></li>
            ...
            <h2 style="color: lightslategrey;">My Orders</h2>
      <ul class="list-unstyled">
        <li><a href="#expe4" style="font-size:16px">View order history</a></li>
