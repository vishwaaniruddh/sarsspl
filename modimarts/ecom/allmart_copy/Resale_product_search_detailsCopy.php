...
$View="SELECT * FROM Resale where status='1' ";
...
<div id="products" class="product-grid">
	<div class="products-block block-content"  style="padding-top: 0px;">
  ...
  <div class="container" style="height:280px;width:1307px;padding-top:24px;">
...
}else
{
   $newh= $height."px";
    ...
    $Viewimg="SELECT * FROM Resale_img where 1 and product_id='".$rwss['code']."' and category='".$rwss['category']."'";
...
?>
      ...
      <div class="col-lg-2">
        <div class="thumbnail">
        <figure>  <img src="<?php echo trim($Pimg['midsize']);?>" class="hover13 column" alt="<?php echo $rwss['name'];?>" title="<?php echo $rwss['name'];?>" style="width:180px; height:165px"></figure>
          <p  class="b"><strong><?php echo $rwss['name'];?></strong></p>
          <p> <span class="price-new"><i class="fa fa-inr"></i> <?php echo $rwss['total_amt'];?></span></p>
          
        <a class="img" style="color:white" title="<?php echo $Resale['name'];?>" href="resale_Details.php?prid=<?php echo $rwss['code'];?>&catid=<?php echo $rwss['category'];?>"> <button class="btn"  style="background-color:#63bcf9;font-size:16px" > BuyNow </button> </a> 
       </div>
      </div>
