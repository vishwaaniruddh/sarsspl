...
<div class="widget panel ">
    <div class="widget-heading panel-heading block-borderbox">
        <h4 class="panel-title">  &nbsp; &nbsp;</h4>Deals Of The Day &nbsp;&nbsp;[<a href="javascript:void(0);" onclick="setrtfunc(<?php echo $sliderid8;?>);">SET RATE</a>]</br></br>
        <?php echo"Todays slider Rate: ".getrt($sliderid8); ?>
    </div>
	<div class="list box-products owl-carousel-play panel-body block-content bg-white" id="product_list1011535050"  data-ride="owlcarousel">
		...
		<div class="owl-carousel product-grid"  data-show="1" data-pagination="false" data-navigation="true">
            ...
            {
                $avilfrupdt=0;
                $qravdm=mysql_query("select * from advertise_booking where  slot='".$sliderid8."' and slot_pos='".$ca."' and dt='".date("Y-m-d")."'");
                //echo "select * from advertise_booking where  slot='".$sliderid8."' and slot_pos='".$ca."' and dt='".date("Y-m-d")."'";
                $qspbkd=mysql_num_rows($qravdm);
                $bkit=0;
                if($qspbkd==0)
                {
                    $avilfrupdt="1";
                    $qrylatf2="select id,pid,cat from top_right_slider where  slot_id='".$sliderid8."' and slot_pos='".$ca."' and user_id='0'  and stats='0'";
   
                } else {
                    $ftrw=mysql_fetch_array($qravdm);
                    $qrylatf2="select id,pid,cat from top_right_slider where  slot_id='".$sliderid8."' and slot_pos='".$ca."' and user_id='".$ftrw["merchant_id"]."'  and stats='0'";
                    $avilfrupdt="0";
                } 
                ...
                if($latstprnrws>0)
                {
                    ...
                    //  echo "select * from Productviewtable where code='".$lat1['pid']."' and category='".$lat1['cat']."' ";
                                        ...
                                        <div class="product-meta">
                                            ...
                                            <?php if($detsarr[$itr]['avail']==1){ ?> 
                                                <div>
                                                    ...
                                                    <button data-loading-text="Loading..." class="btn btn-default" type="button" onclick="srchfsnchw('<?php echo $sliderid8;?>','<?php echo $detsarr[$itr]['updtid'];?>','<?php echo $slidername; ?>','<?php echo $itr;?>');">
                                    ...
                                    <div class="product-block">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <div class="image">
                                                <div class="product-img img">
                                                    <a class="img" title="" href="javacript:void(0);">
                                                        <img class="img-responsive" src="images/booked.png" title="" style=" width: 100%;  height: 150px;object-fit: contain"  />
                                                    </a>          
                                                    <div class="compare hover-icon">  </div>  
                                                </div>
                                            </div>
