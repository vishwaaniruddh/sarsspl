...
foreach($myArray as $my_Array){
   ...
   if($my_Array==5) {?>
    ...
    <script> $(function(){  $("#22").show();$("#hdm20").show(); });</script><?php } 
     ...
     if($my_Array==23){ ?>
    <script> $(function(){  $("#23").show();$("#hdm20").show(); });</script><?php } 
  
     if($my_Array==24){ ?>
    <script> $(function(){  $("#24").show();$("#hdm17").show(); });</script><?php } 
...
<header class="header-style-1"> 
  ...
  <div class="header-nav animate-dropdown">
	...
	<li id="hdm4" style="display:none;"><a href="#" title="Admin Products">Admin Products</a>
	     <ul>
	...
	<li id="hdm11" style="display:none;"><a href="#" title="Merchant proct">Merchant Products</a>
		...
		<li id="hdm19" style="display:none;">
		   ...
		   <ul>
		     <li id="19" style="display:none;"><a href="merchant_details.php" title="Products Approval">Order Details</a></li>
