...
include('header.php'); 
include('config.php');
$sql_statement = 'SELECT * FROM main_category';
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					<td class="green-left"  height="40px;" valign="middle"> <a href="Add_Main_cat.php">Add new one Category.</a></td>
			  ...
			  <!--  start product-table ..................................................................................... -->
				...
				$query = "SELECT * FROM main_category order by code ASC LIMIT " . $from . "," . $offset;
...
while($row=mysql_fetch_row($result)){
				...
				<tr class="alternate-row">
					...
					<a href="editMain_cat.php?cmp=<?php echo $row[0]; ?>"  title="Edit" class="icon-1 info-tooltip"></a>
					<a href="deleteMain_cat.php?cmp=<?php echo $row[0]; ?>" title="Delete" class="icon-2 info-tooltip"></a>
        	...
        	<?PHP
				...
				doPages($offset, 'main_cat.php', '', $total_records); 
			?>    
            </td>
		</tr>
