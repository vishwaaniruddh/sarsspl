...
include('config.php');
$sql_statement ="select name,code,memtype from clients where memtype='1500' or memtype='gold'";
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
			  ...
			  <!--  start product-table ..................................................................................... -->
                ...
                <?php
				include('config.php');
				$query = "select name,code,memtype from clients where memtype='1500' or memtype='gold' LIMIT " . $from . "," . $offset;
...
<tr>
        	...
        	<?PHP
				...
				doPages($offset, 'goldCustomer.php', '', $total_records); 
			?>    
            </td>
		</tr>
