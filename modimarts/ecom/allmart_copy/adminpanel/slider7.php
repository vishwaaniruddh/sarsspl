...
<div class="widget panel ">
	<div class="widget-heading panel-heading block-borderbox">
	    ...
	    LATEST OFFERS   &nbsp;&nbsp;[<a href="javascript:void(0);" onclick="setrtfunc(<?php echo $sliderid13;?>);">SET RATE</a>]</br></br>
	    <?php echo"Todays slider Rate: ".getrt($sliderid13); ?>
    </div>
	<div class="list box-products owl-carousel-play panel-body block-content bg-white" id="product_list1011535050"  data-ride="owlcarousel">
        ...
        {
           $avilfrupdt=0;
           $qravdm=mysql_query("select * from advertise_booking where  slot='".$sliderid13."' and slot_pos='".$ca."' and dt='".date("Y-m-d")."'");
           $qspbkd=mysql_num_rows($qravdm);
           $bkit=0;
           if($qspbkd==0)
           {
          $avilfrupdt="1";
          $qrylatf2="select id,pid,cat from top_right_slider where  slot_id='".$sliderid13."' and slot_pos='".$ca."' and user_id='0'  and stats='0'";
           
        } else
        {
           $ftrw=mysql_fetch_array($qravdm);
           $qrylatf2="select id,pid,cat from top_right_slider where  slot_id='".$sliderid13."' and slot_pos='".$ca."' and user_id='".$ftrw["merchant_id"]."'  and stats='0'";
           $avilfrupdt="0";
        }
            ...
            <div class="product-block">
                ...
                <div class="product-meta">
                    ...
                    <div>
                        ...
                        <button data-loading-text="Loading..." class="btn btn-default" type="button" onclick="srchfsnchw('<?php echo $sliderid13;?>','<?php echo $detsarr[$itr]['updtid'];?>','<?php echo $slidername; ?>','<?php echo $itr;?>');">
