...
<form action='ProcesshAddimg.php' enctype='multipart/form-data' method='post' >
...
echo "Bottom Left";
	...
	echo "Center"; }?></td><td width="221">

<input type='file' name='banner' size='40' /></td></tr>
<tr><!--<td>Total Count</td><td><input type='hidden' name='count' />-->                     <tr><td height="48" colspan="2"> <input type="text" name='pid' value="<?php echo $pos; ?>" /><input name="Submit" id="Submit" type='submit' class="form-submit"/>
