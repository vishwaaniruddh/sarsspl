...
$(element3).parent().addClass('has-error');
 ...
 function finalval()
{
    if(checkcont1() && checkemail() &&validation())
    {
       return true; 
    }
    else
 ...
 function validation()
 {
    ...
    if(comtyp=="1"){
                       ...
                       if(Registn=="")
                          ...
                          { alert("please insert Gumasta either Business Aadhar");
                            return false; 
                          }
                        ...
                        /*     else if(rdate=="")
                          { document.getElementById('rdate').setAttribute('required','required');
                            return false; 
                          }*/
                          else
                          {  
...
try{
 ...
 // var q=favorite.join(", ");
  ...
  // alert("length"+q.length);
    ...
    /*
     var selected = $(".cd option:selected");
                var message = "";
                var message1 = "";
 ...
 //document.getElementById('catn').value=q1;
...
function validate_fileupload(input_element)
{
    ...
    el.innerHTML="Please Upload image only..";
    valid = false;
}
...
#checkboxes label:hover {
 ...
 <!-- <ul class="breadcrumb">
    ...
    <div class="row">        <div id="content1" class="col-sm-2"> </div>       <div id="content" class="col-sm-8">      
    If you are already a Member <a href="user/index.php">Click Here</a>
              ...
              //  document.getElementById('Partshipcn').style.display="block";
               ...
               // document.getElementById('Eno').style.display="block";
                document.getElementById('gstno').style.display="block";
                      ...
                      document.getElementById('dtofreg').style.display="none";   document.getElementById('adhar').value=" ";
                          document.getElementById('adhno').style.display="none";
...
<div class="multiselect">
		<div class="selectbox" onclick="showCheckBoxes()">
			<select id="compny" name="compny"  class="form-control" style="width:300%" >
...
$('#rdate').dcalendarpicker({format: 'dd-mm-yyyy'});
            ...
            <div class="col-sm-9">
            <input type="text" id="Registn" name="Registn" class="form-control"  /> 
            </div>
            </div>
            ...
            <div class="col-sm-9">
            <input type="text" id="busiAadhar" name="busiAadhar" class="form-control" onkeypress='return (event.which >= 48 && event.which <= 57) || event.which == 8 || event.which == 46' /> 
            </div>
            </div>
...
<!--<input type="text" class="form-control" name="adhar" onkeypress="return event.charCode >= 48 && event.charCode <= 57" maxlength="12" size="50" class="inp-form" required autofocus/>-->
              ...
              <input type="text" name="adhar" maxlength ="12" <?php if(!isset($_SESSION['loginstats']) & $_SESSION['loginstats']==""){?> placeholder="Adhar Number" <?php } ?> id="adhar"  class="form-control" onkeypress='return (event.which >= 48 && event.which <= 57) || event.which == 8 || event.which == 46' value="<?php if($adhar!=""){ echo $adhar;} ?>"   autofocus />
...
<input type="text" id="actno" name="actno" class="form-control"  class="inp-form" placeholder="Account Number" onkeypress='return (event.which >= 48 && event.which <= 57) || event.which == 8 || event.which == 46' required autofocus/>
                          </div>
          </div>
...
<input type="text" id="acholnm" name="acholnm" class="form-control"  class="inp-form" placeholder="Account Holder Name"  required autofocus/>
         ...
         <div align="center">
            ...
            <button type="button" class="btn btn-primary"  onclick='window.open("admin.php","_self");'>Cancel</button>
         </div>
