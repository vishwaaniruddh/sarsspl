...
while($row=mysql_fetch_array($result)){
    ...
    $rt=mysql_query("select * from Productviewimg where product_id='".$row[0]."' limit 0,1");
$ftyr=mysql_fetch_array($rt);
				...
				<tr class="alternate-row">
					...
					<button type="button" onclick='saleupdtfn("<?php echo $row["code"]; ?>")'>Select</button>
                ...
                <?php $i1++; } ?>
                 ...
                 <tr>
        	<td align="center" colspan="5" class="white">
        	<?PHP
