...
$check_duration=mysql_query("select * from Date_duration where Date='".$daterange."'");
$check_durationf1=mysql_num_rows($check_duration);

if($check_durationf1>0){
    
    $check_durationf=mysql_fetch_row($check_duration);
