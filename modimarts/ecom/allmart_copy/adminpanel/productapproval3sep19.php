...
<input type="button" name="submit" action="" method="post" value="Search" onclick="srfn();">
	...
	<tr>
		...
		<div id="content-table-inner">
			...
			//	echo "SELECT `code`, `name`, `ccode`, `description`, `category`, `photo`,  `price`, `others`, `discount`, `discount_type`, `total_amt`, `status`,brand,Long_desc FROM `Productviewtable` WHERE 1";
	//	$query.=" and  status='0' ";
...
?>
				<tr class="alternate-row">
					...
					<td></td>
					<?php }?>
					<td><?php echo $row['brand'].$row['status']; ?></td>
					<td><?php echo $row['description']; ?></td>
					...
					<td>
				        ...
				        <?php }else{
				            if($row['status']==3){
				         ?>
				            <input type="button"   id="app<?php echo $i1;?>" onclick="approvefunc('<?php echo $row['code']; ?>',this.id,'1','app<?php echo $i1;?>','<?php echo $row['category']?>');" value="Admin Approval Required" disabled>
				        <?php } else {?>
				            <input type="button"   id="app<?php echo $i1;?>" onclick="approvefunc('<?php echo $row['code']; ?>',this.id,'1','app<?php echo $i1;?>','<?php echo $row['category']?>');" value=" Approve" >
				        <?php } ?>
				        <input type="button" id="apps<?php echo $i1;?>" onclick="approvefunc('<?php echo $row['code']; ?>',this.id,'2','app<?php echo $i1;?>','<?php echo $row['category']?>');" value=" Reject " >
