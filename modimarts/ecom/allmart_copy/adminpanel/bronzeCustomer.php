...
include('config.php');
$sql_statement ="select name,code,memtype from clients where memtype='bronze' or memtype='500'";
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
			  ...
			  <!--  start product-table ..................................................................................... -->
                ...
                <?php
				include('config.php');
				$query = "select name,code,memtype from clients where memtype='bronze' or memtype='500' LIMIT " . $from . "," . $offset;
...
while($row=mysql_fetch_row($result)){
        	...
        	<?PHP
				...
				doPages($offset, 'bronzeCustomer.php', '', $total_records); 
			?>    
            </td>
		</tr>
