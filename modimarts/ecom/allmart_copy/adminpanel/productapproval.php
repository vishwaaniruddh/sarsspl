...
'union all select `allmart_test`.`Approval_products`.`code` AS `code`,`allmart_test`.`Approval_products`.`name` AS `name`,'.
 '`allmart_test`.`Approval_products`.`ccode` AS `ccode`,`allmart_test`.`Approval_products`.`description` AS `description`,'.
 '`allmart_test`.`Approval_products`.`category` AS `category`,`allmart_test`.`Approval_products`.`photo` AS `photo`,'.
 '`allmart_test`.`Approval_products`.`price` AS `price`,`allmart_test`.`Approval_products`.`others` AS `others`,'.
' `allmart_test`.`Approval_products`.`discount` AS `discount`,`allmart_test`.`Approval_products`.`discount_type` AS `discount_type`,'.
 '`allmart_test`.`Approval_products`.`quentity` AS `quentity`,`allmart_test`.`Approval_products`.`total_amt` AS `total_amt`,'.
 '`allmart_test`.`Approval_products`.`status` AS `status`,`allmart_test`.`Approval_products`.`thumbs` AS `thumbs`,'.
 '`allmart_test`.`Approval_products`.`midsize` AS `midsize`,`allmart_test`.`Approval_products`.`Reason` AS `Reason`,'.
' `allmart_test`.`Approval_products`.`size` AS `size`,`allmart_test`.`Approval_products`.`brand` AS `brand`,'.
' `allmart_test`.`Approval_products`.`color` AS `color`,`allmart_test`.`Approval_products`.`size_id` AS `size_id`,'.
' `allmart_test`.`Approval_products`.`product_type` AS `product_type`,`allmart_test`.`Approval_products`.`Long_desc` AS `Long_desc`,'.
' `allmart_test`.`Approval_products`.`keyword1` AS `keyword1` from `allmart_test`.`Approval_products` where 1 ';
