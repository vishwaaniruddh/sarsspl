...
if(!$_SESSION){ ?>
    ...
    <script>
        window.location.href='https://allmart.world/franchise';
    </script>
    ...
    width: 100%;">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <? if($_SESSION['id'] && $_SESSION['status']==1){ ?>
                    <li>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <?
                                    ...
                                    <option value="<? echo $district_sql_result['id']?>" selected><? echo $district_sql_result['division'];?></option>
