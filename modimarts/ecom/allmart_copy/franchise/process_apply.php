...
$sql = mysqli_query($con,"insert into new_member(full_pay_date,level_id,country,zone,state,division,district,taluka,village,location,pincode,status,name,mobile,introducer_name,introducer_mobile,created_at,star,password) values('".$full_pay_date."','".$level_id."','".$country."','".$zone."','".$state."','".$division."','".$district."','".$taluka."','".$village."','".$location."','".$pincode."','2','".$full_name."','".$mobile."','".$intro_name."','".$intro_mobile."','".$full_pay_date."','".$star."','".$password."')");
