...
return $protocol . $_SERVER['HTTP_HOST'] .  '/temple/PHP_Bolt-master/response.php';
}
...
<div class="main">
    ...
    <span><input type="text" id="key" name="key" placeholder="Merchant Key" value="YFJhqElE" /></span>
    </div>
    
    <div class="dv" style="">
    <span class="text"><label>Merchant Salt:</label></span>
    <span><input type="text" id="salt" name="salt" placeholder="Merchant Salt" value="EpyELt9Piw" /></span>
    </div>
...
$('#payment_form').bind('keyup blur', function(){
	$.ajax({
          ...
          success: function(json) {
            if (json['error']) {
			 $('#alertinfo').h
			 tml('<i class="fa fa-info-circle"></i>'+json['error']);
            }
