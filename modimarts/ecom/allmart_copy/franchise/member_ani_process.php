                ...
                <tr>
                    ...
                    <td class="" style="text-align:center">&nbsp;&nbsp;
                      <?php while($sql2fetch=mysqli_fetch_array($runsql2)){ if($sql2fetch['file']!=''){ ?>
                            <img src="https://shyambabadham.com/Committee/<?php echo $sql2fetch['file']?>" width="90px" style="height:100px" />
                      <?php  } } ?>
                    </td>
                    ...
                    <td class="th-prop">
                     ...
                     <td class="th-prop">
                        ...
                        ?>
                         <div>
                         <a class="btn btn-success btn-text btn-style"  href="../membership.php" style="padding: 0;" >Contribute</a>                           
                        </div>
                      <? }
                      ?>
                    </td>
                    <td class="th-prop">
                        <?php if($runnum2==0 && $runnum_waiting<5){   ?>
                            <a class="btn btn-success btn-text btn-style" style="padding:0" href="member.php?st=<?php echo $state;?>&ci=<?php echo $city;?>&Di=<?php echo $district;?>&ta=<?php echo $taluka;?>&Zo=<?php echo $zone;?>&con=<?php echo $country?>&p=<?php echo $pincode;?>&v=<?php echo $village;?>&pos=<?php echo $_row['id']?>&Lev=<?php echo $hdLevel?>&Loc=<?php echo $hdLoc?>">Apply</a>
                        <?php }?>
                    </td>
                    <td class="th-prop">
                        <?php if($runnum2!=0 && $runnum_waiting<5){?>
                            	 <a class="btn btn-warning btn-text btn-style" style="padding:0" href="member.php?st=<?php echo $state;?>&ci=<?php echo $city;?>&Di=<?php echo $district;?>&ta=<?php echo $taluka;?>&Zo=<?php echo $zone;?>&con=<?php echo $country?>&p=<?php echo $pincode;?>&v=<?php echo $village;?>&pos=<?php echo $_row['id']?>&Lev=<?php echo $hdLevel?>&Loc=<?php echo $hdLoc?>" >Apply</a>
                        <?php }?>
                    </td>
                    ...
                    <td>
                     ...
                     <td class="th-prop">
                          <?php if($runnum2!=0){?>
<a class="btn btn-success btn-text btn-style" style="padding:0" href="visiting.php?state=<?php echo $state;?>&city=<?php echo $city;?>&District=<?php echo $district;?>&talukaa=<?php echo $taluka;?>&Zone=<?php echo $zone;?>&cnt=<?php echo $country;?>&p=<?php echo $pincode;?>&v=<?php echo $village;?>&position=<?php echo $_row['id']?>&Level=<?php echo $hdLevel?>&Loc=<?php echo $hdLoc?>"> Send Card</a>
                         </td>
                   <?php } ?>
                </tr>
          <?php 
            ...
            <?   } ?>                
                 <td class="th-prop">
                        <?php if($data['status']==0){ ?>
                         <div>
                         <a class="btn btn-success btn-text btn-style"  href="payment_details.php" style="padding:0;">Contribute</a></a>                          
                        </div>
                      <? } ?>
                    </td>
                    <td></td>
