        ...
        function taluka() {
          ...
          DisableArrowKeys();
            ...
            function regi_modal(){
                ...
                var y = document.getElementById("password_inputs");
                if(y.style.display == "block"){
                                    y.style.display = "none";
                }else{ y.style.display = "block"
                    
                }
                 var z = document.getElementById("get_otp"); 
            ...
            function member_login(){
                console.log("========here is workin")
                                //   var otp = Math.floor(1000 + Math.random() * 9000);
                                   var mobile_no = document.getElementById('login_mobile_no').value;
                            ...
                            url:'member_login.php',
                             ...
                             success:function(msg){
                                ...
                                if(msg==1){
                                    ...
                                    window.location = "https://shyambabadham.com/demo/sapna/account.php?mobile="+mobile_no;
                       ...
                       function send_otp(){
                                   ...
                                   var member_id = document.getElementById('member_id').value;
                                    var x = document.getElementById("otp_inputs");
                                    var y = document.getElementById("password_inputs");
                                    var z = document.getElementById("get_otp");
                                            
  
                                console.log('======otp',otp,'=======mobile',mobile_no);
                                 console.log('======id',member_id)
                                 if(mobile_no == "" ){
                                     swal("Plese fill mobile no");
                                 }else{
                            ...
                            function otp_match(){
                             console.log("========here is workin")
                                //   var otp = Math.floor(1000 + Math.random() * 9000);
                                   var mobile_no = document.getElementById('mobile_no').value;
                                   var get_otp = document.getElementById('get_otp_user').value;
                                   var x = document.getElementById("otp_inputs");
                                    var y = document.getElementById("password_inputs");
                                    var z = document.getElementById("get_otp");
