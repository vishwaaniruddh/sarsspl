...
$_SESSION['visiting_mobile']=$fetch['mobile'];
...
$(document).ready(function() { 
    ...
    console.log(getCanvas.toDataURL("image/jpeg"));
...
<div id="img" style="display:none; width:40%; "> 
			<img src="" id="newimg" style="width:100%" class="top" /> 
		</div> 
