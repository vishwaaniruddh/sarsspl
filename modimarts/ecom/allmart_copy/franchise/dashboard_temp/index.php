...
?>
    ...
    <nav class="navbar">
        ...
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php"><span><img src="../manir.jpg"/ width="100px" height="40px"style="margin-top: -20px;"></span></a>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#" id="hdm1" style="display:none;">Member<span class="caret"></span></a>
        <ul class="dropdown-menu">
         <!-- <li><a href="../addsite.php">Add Site</a></li>-->
          <li><a id="1" style="display:none;" href="../member.php" >Member</a></li>
          <li><a id="2" style="display:none;" href="../viewmember.php" >View Member</a></li>
...
?> 
            ...
            <div class="legal">
                <div class="copyright">
                    &copy; 2017 - 2018 <a href="javascript:void(0);">Temple Management</a>.
                </div>
                <div class="version">
                    <b>Version: </b> 1.0.5
                </div>
...
$emp="select id from committee_structure";
...
<!--=======================================================================-->
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    ...
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">TOTAL COMMITTEE TYPE</div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12" style="margin-left:12%">
                <a href="../viewuser.php" style="color:white;text-decoration: none;" >
                    <div class="info-box hover-expand-effect" style="background-color:#f86c31;color:#fff">
                        <div class="icon">
                            <i class="material-icons">playlist_add_check</i>
                        </div>
                        <div class="content">
                            <div class="text" style="color:#fff">TOTAL VISITORS</div>
                       <div class="number count-to" data-from="0" data-to="<?php echo $visits;?>" data-speed="1000" data-fresh-interval="20" style="color:#fff"></div>
