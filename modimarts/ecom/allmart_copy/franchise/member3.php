...
<?php if(isset($_SESSION['user_name']) && $_SESSION['user_name']=='Admin'){    
  ...
  <hr style="margin-top: 0rem;
    ...
    <div align="right" class="mt-2 mr-2 mb-1" style="display:none;">
       
        <input type="text" id="search_data" placeholder="Search member by contact number..." name="search" style="width: 20%;margin-bottom: 1px;padding: 1.5%" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "10" minlength="10"  size="10" onkeypress="javascript:return isNumber(event)">
        <button class="btn" style="width: 3%;" onclick="mobileSearch()"><i class="fa fa-search" ></i></button>
    </div>
    ...
    ?>
        <div class="" align="center" >
            <div class="row" id="Levelwise" style="margin-top:1%;">
                <div class="col-md-2">
                <h3 style="font-family: 'Playfair Display', serif;">Search</h3>
    ...
    <select class="rounded" name="City" id="City" onchange="cities()">
        ...
        <div class="row" style="">
            ...
            <!--  <div id="zones" style="display:none;margin-top: -20px;" class="col-md-12" style="width:25%;position:fixed;"> -->
              ...
              <div id="zones" style="display:none;" style="position:fixed;">
              <h3 id="ZoneHeading_respons"  style=" font-family: 'Playfair Display', serif;"> Zone/State</h3>
                  <div id="zone_respons" class="table-responsive " style="height: 650px;overflow-y: inherit;">
               ...
               <!-- <div id="cities" class="col-md-12" style="display:none;margin-top: -20px;"  style=" width:25%;position:fixed;">-->
                     ...
                     <!-- <div  class="col-md-6" style="margin-top: -20px;"> -->
                      <div id="cities"  style="display:none;"  style=" position:fixed;">
                  <!--<div class="col-md-6" style="margin-top: 23px;display:block;">-->
                  <h3 style="font-family: 'Playfair Display', serif; ">City/District</h3>
     ...
     <div class="col-md-7" id="html-content-holder">
        <!--<a class="btn btn-primary" id="btn-Convert-Html2Image" href="#">Download</a>-->
                <!--<a class="btn btn-primary" href="member3-pdf.php">Download</a>-->
                
                <a id="memberpdf" data-toggle="modal" data-target="#myModala">
                    <img src="images/screenshot.png">
                    </a>
        <div id="show_container" style="width: 115%;">

         <div id="show" style="margin-left: -16%;"></div>
        </div>    
    </div>
...
float: right;
    ...
    #show_html #show_container{
        ...
        .modal-header-image{
            background-image: linear-gradient(#c5412a,#e45327, #ea5b2c);
            width:100%;
        }
        #show_html h3{
            text-align:center;
...
<!-- Modal -->
<div id="myModala" class="modal" role="dialog">
  <div class="modal-dialog" style="max-width:none;">

    <!-- Modal content-->
    <div class="modal-content">
       
        <!--<img class="modal-header-image" src="https://shyambabadham.com/images/vishwa_header.png">-->
        
        <div class="modal-actions" >

            <input type="button" class="btn btn-primary" value="Download As PDF" onclick="javascript:printDiv('show_html')" />
        ...
        <!--<a href="#" class="btn btn-primary" id="member_pdf_download">Download As PDF</a>-->
...
// document.getElementById("show_html").innerHTML = "whatever";
document.getElementById("show_html").innerHTML = $("div.col-md-7").html();


        $('#html-content-holder').on('DOMSubtreeModified',function(event) {
document.getElementById("show_html").innerHTML = $("div.col-md-7").html();
        });        
...
// $("#html-content-holder").on('DOMSubtreeModified', "#selector", function() {
//   alert('change');
// });
</script>
...
<script>
  ...
  /*  
    ...
    $('#country').change(function(){
        $("#Zone").attr("size","6").attr("style","height:unset !important; position:relative; z-index:10");
        //$("#Zone").removeAttr("disabled");
        //clear feilds if selecetd
        $('#txtState').val(null);
        $('#txtCity').val(null);
    ...
    $("#Zone").attr("size","12").attr("style","height:unset !important; position:relative; z-index:10");
    $("#Zone").change(function(){
        ResetDropdown();
        $("#State").attr("size","12").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#State").change(function(){
        ResetDropdown();
        $("#City").attr("size","12").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#City").change(function(){
        ResetDropdown();
        $("#District").attr("size","12").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#District").change(function(){
        ResetDropdown();
        $("#talukaa").attr("size","12").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#talukaa").change(function(){
        ResetDropdown();
        $("#Pincode").attr("size","12").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#Pincode").change(function(){
        ResetDropdown();
        $("#village").attr("size","12").attr("style","height:unset !important; position:relative; z-index:10");
    });
    $("#village").change(function(){
        ResetDropdown();
    });
    function ResetDropdown(){
        $("#Zone").removeAttr("size").removeAttr("style");
        $("#State").removeAttr("size").removeAttr("style");
        $("#City").removeAttr("size").removeAttr("style");
        $("#District").removeAttr("size").removeAttr("style");
        $("#talukaa").removeAttr("size").removeAttr("style");
        $("#Pincode").removeAttr("size").removeAttr("style");
        $("#village").removeAttr("size").removeAttr("style");
    }
...
<script type="text/javascript">
    ...
    function mobileSearch(){
        var element = document.getElementById('search_data');
...
//                     $custom_fetch=$_SESSION['custom_fetch'];

// var_dump($custom_fetch);

// foreach($custom_fetch as $key=>$value){
...
// $('#html-content-holder').bind('contentchanged', function() {
//   // do something after the div content has changed
//   alert('woo');
// });

// $("body").on('DOMSubtreeModified', "#html-content-holder", function() {
//     alert('changed');
// });
