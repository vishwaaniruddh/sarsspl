     ...
     <table  class="table-bordered" >
        ...
        <tr >
         ...
         <tr <?php if($country!="" && $Zone=="" && $state=="" && $city=="" &&$District=="" &&$talukaa=="" && $Pincode=="" && $village=="" ){ ?> style="background-color:#fcae007a" <?php } ?> > 
             <td width="30%" ><?php if($country!="" && $Zone=="" && $state=="" && $city=="" &&$District=="" &&$talukaa=="" && $Pincode=="" && $village=="" ){ ?><img src="star_img/8 star red.png" style="width:350px; height:27px;padding-bottom:5px"><?php }else{ ?><img src="star_img/8 star blank.png" style="width:350px;height:27px;padding-bottom:5px"><?php } ?></td>
          ...
          <tr  <?php if($country!="" && $Zone!="" && $state=="" && $city=="" &&$District=="" &&$talukaa=="" && $Pincode=="" && $village=="" ){ ?> style="background-color:#fcae007a" <?php } ?>>
             <td ><?php if($country!="" && $Zone!="" && $state=="" && $city=="" &&$District=="" &&$talukaa=="" && $Pincode=="" && $village=="" ){ ?><img src="star_img/7 star red.png" style="width:300px;height:27px;padding-left:3;padding-bottom:5px"><?php }else{ ?><img src="star_img/7 star blank.png" style="width:300px;height:27px;padding-left:3;padding-bottom:6px"><?php } ?></td>
             <td >Zone</td>
          ...
          <tr <?php if($country!="" && $Zone!="" && $state!="" && $city=="" &&$District=="" &&$talukaa=="" && $Pincode=="" && $village=="" ){ ?>style="background-color:#fcae007a" <?php } ?> >
             <td><?php if($country!="" && $Zone!="" && $state!="" && $city=="" &&$District=="" &&$talukaa=="" && $Pincode=="" && $village=="" ){ ?><img src="star_img/6 star red.png" style="width:250px;height:27px;margin-left:6px;padding-bottom:5px"><?php }else{ ?><img src="star_img/6 star blank.png" style="width:250px;height:27px;margin-left:6px;"><?php } ?></td>
             <td>State</td>
          ...
          <tr <?php if($country!="" && $Zone!="" && $state!="" && $city!="" &&$District=="" &&$talukaa=="" && $Pincode=="" && $village=="" ){ ?>style="background-color:#fcae007a" <?php } ?> >
             <td><?php if($country!="" && $Zone!="" && $state!="" && $city!="" &&$District=="" &&$talukaa=="" && $Pincode=="" && $village=="" ){ ?><img src="star_img/5 star red.png" style="width:200px;height:27px;margin-left:10px;padding-bottom:5px"><?php }else{ ?><img src="star_img/5 star blank.png" style="width:200px;height:27px;margin-left:10px;padding-bottom:5px"><?php } ?></td>
             <td>City</td>
          ...
          <tr <?php if($country!="" && $Zone!="" && $state!="" && $city!="" &&$District!="" &&$talukaa=="" && $Pincode=="" && $village=="" ){ ?> style="background-color:#fcae007a" <?php } ?>>
             <td><?php if($country!="" && $Zone!="" && $state!="" && $city!="" &&$District!="" &&$talukaa=="" && $Pincode=="" && $village=="" ){ ?><img src="star_img/4 star red.png" style="width:150px;height:27px;margin-left:14px;padding-bottom:5px"><?php }else{ ?><img src="star_img/4 star blank.png" style="width:150px;height:27px;margin-left:14px;padding-bottom:5px"><?php } ?></td>
             <td>District</td>
          ...
          <tr <?php if($country!="" && $Zone!="" && $state!="" && $city!="" &&$District!="" &&$talukaa!="" && $Pincode=="" && $village==""){ ?>style="background-color:#fcae007a" <?php } ?> >
             <td><?php if($country!="" && $Zone!="" && $state!="" && $city!="" &&$District!="" &&$talukaa!="" && $Pincode=="" && $village==""){ ?><img src="star_img/3 star red.png" style="width:110px;height:27px%;margin-left:22px;padding-bottom:5px"><?php }else{ ?><img src="star_img/3 star blank.png" style="width:110px;height:27px;margin-left:22px;padding-bottom:5px"><?php } ?></td>
             <td>Taluka</td>
             <td><?php  echo $talukaV;?></td>
          </tr>
          
          <tr <?php if($country!="" && $Zone!="" && $state!="" && $city!="" &&$District!="" &&$talukaa!="" && $Pincode!="" && $village==""){ ?> style="background-color:#fcae007a" <?php } ?>>
             <td><?php if($country!="" && $Zone!="" && $state!="" && $city!="" &&$District!="" &&$talukaa!="" && $Pincode!="" && $village==""){ ?><img src="star_img/2 star red.png" style="width:70px;height:27px;margin-left:28px;padding-bottom:5px"><?php }else{ ?><img src="star_img/2 star blank.png" style="width:70px;height:27px;margin-left:28px;padding-bottom:5px"><?php } ?></td>
             <td>Pincode</td>
             <td><?php echo $pincodeV;?></td>
          </tr>
          
          <tr <?php if($country!="" && $Zone!="" && $state!="" && $city!="" &&$District!="" &&$talukaa!="" && $Pincode!="" && $village!=""){ ?> style="background-color:#fcae007a" <?php } ?>>
             <td><?php if($country!="" && $Zone!="" && $state!="" && $city!="" &&$District!="" &&$talukaa!="" && $Pincode!="" && $village!=""){ ?><img src="star_img/1 star red.png" style="width:40px;height:27px;margin-left:33px;padding-bottom:5px"><?php }else{ ?><img src="star_img/1 star blank.png" style="width:40px;height:27px;margin-left:33px;padding-bottom:5px"><?php } ?></td>
             <td>Village</td>
...
">
		<label>Karyalaya</label> : 1st Floor, 18/2, Sainath Road, Next to Lifeline Hospital Malad West Subway, Mum-64
		</a>
		</li>
					<li>
				...
				<label>Dham Address</label> : SHYAM BABA DHAM, Village - Chanana, District - Jhunjhunu, Rajasthan - 333026
					</a>
					</li>
		    </ul>   					
		</div>
