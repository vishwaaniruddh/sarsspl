...
?>
   <!-- <div class="row" style="margin-right:0px;">
      ...
      <form  action="demo_member_process.php" method="post" enctype="multipart/form-data" id="myForm">
      <div class="row" >
      ...
      <input type="hidden" name="id" id="id" value="<?php echo $id;?>">
        <h3 style="margin: 5% 47%;">Member</h3>
        <!--<fieldset>-->
        <?php 
        if(isset($_GET['id'])){
...
<p><b>Date of Birth:</b><input type="text" id="datepicker" name="datepicker" value="<?php if($id>0){echo $result['DOB'] ;}?>"></p>
          ...
          <!--  <div class="form-group col-md-6">
            ...
            <div class="form-group col-md-6">
            	...
            	<input type="file" id="up" name="up" value="Choose a file">
<div id="upload-demo"></div>
<input type="hidden" id="hdpic" name="hdpic">
          ...
          <input type="button" name="click" id="clk" class="btn btn-primary upload-result" onclick="finalval()" style="width: 25% !important;" value="Submit">
        ...
        <!--<button type="button"  class="btn btn-primary" onclick="finalval()" style="border-radius: 50px;width: 206px;height: 37px;background-color: #fbba00;">Submit</button>-->
