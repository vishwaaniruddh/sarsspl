        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-6">
              ...
              <input type="text" name="NPass" onkeyup="checksPassword(this.value)" id="NPass" class="form-control" required>
            </div>            
          </div>    
          <div class="row">
            <div class="col-md-6">
          ...
          <div class="row">
            <div class="col-md-6">              
              <input type="submit" name="UpdatePass" class="btn btn-primary" onclick="return checkpass()">
            </div>            
          </div>          
          </div>
          </form>
