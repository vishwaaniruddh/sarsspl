      ...
      <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12" style="margin-top: 100px;position: unset">
        <div class="container">
                        ...
                        <p>Hello <strong><?php echo $_SESSION['email'];?></strong> (not <strong><?php echo $_SESSION['email'];?></strong>? <a href="../logout.php">Log out</a>)</p>
                                        <p>From your account dashboard you can view your <a href="https://allmart.world/my_orders.php">recent orders</a>, manage your <a href="EditAddress.php">shipping and billing addresses</a>, and <a href="UpdateAccount.php">edit your password and account details</a>.</p>
