...
<html lang="en">
  <head>
    ...
    <title>Modi Mart | Wellness TV</title>
...
/*}*/
  ...
  <body>
<div>
    <div style="display:flex;justify-content:center;margin:1% 5% ;">
		<div class="row" style="display:inline-flex;" id="html-content-holder">
			<div class="col left-section px-0">
				<img src="visiting_assets/left.jpg" style="height: 600px; width: 100%;" >
			</div>
			
			<div class=" col right-section px-0 text-right">
			    
				<!--<img src="visiting_assets/modi-logo.png"  width="220" height="50">-->
				...
				<p class="textclass "><b>Association Head For</b></p>
...
<div id="previewImage" style="display:none;"><canvas width="100%" height="100%"></canvas></div>
<!--style="display:none;"-->
