                        ...
                        <div class="body">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <?$sql = mysqli_query($con, "select id,mem_status,is_product_received,created_at,name,mobile,level_id,star,position_name,country,zone,state,division,district,taluka,pincode,village,location,pan,adhar_card,gst,intro_id,introducer_name,introducer_mobile from new_member where status=1 order by id ASC");
                    ...
                    <tr>
                        ...
                        <!-- <td> -->
                           ...
                           // $star=$sql_result['star'];
                            // if ($star=="Country") {
                            //        echo get_position($star,$sql_result['country']);
                            //     }
                            //     else if($star=="Zone")
                            //     {
                            //           echo get_position($star,$sql_result['zone']);
                            //     }
                            //     else if($star=="State")
                            //     {
                            //           echo get_position($star,$sql_result['state']);
                            //     }
                            //     else if($star=="Division")
                            //     {
                            //           echo get_position($star,$sql_result['division']);
                            //     }
                            //     else if($star=="District")
                            //     {
                            //           echo get_position($star,$sql_result['district']);
                            //     }
                            //     else if($star=="Taluka")
                            //     {
                            //           echo get_position($star,$sql_result['taluka']);
                            //     }
                            //     else if($star=="Pincode")
                            //     {
                            //           echo get_position($star,$sql_result['pincode']);
                            //     } 
                            //     else if($star=="Village")
                            //     {
                            //       echo $sql_result['village'];
                            //     }
