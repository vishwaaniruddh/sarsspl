            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                        <form action="https://modimart.world/franchise5/Payment/RequestFpayamt.php" method="post">
                            ...
                            <input type="hidden" name="redirect_url" value="https://modimart.world/franchise5/Payment/ccavResponseHandler.php" readonly hidden>

                            <input type="hidden" name="cancel_url" value="https://modimart.world/franchise5/Payment/ccavResponseHandler.php" readonly hidden>
