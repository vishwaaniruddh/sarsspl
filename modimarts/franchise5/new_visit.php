    ...
    <div style="display:flex;justify-content:center;margin:1% 7% ;">
		<div class="row" style="display:inline-flex;" id="html-content-holder">
			<div class=" col left-section  px-0">
				<!--<img src="visiting_assets/wellness1.png" style="height: 600px;    width: 100%;" >-->
				<!--<img src="visiting_assets/ID_card.jpg" style="height: 600px;    width: 100%;" >-->
				<img src="visiting_assets/npa_image.jpg" style="height: 600px;    width: 100%;" >
				<!-- <P>hello world</p> -->
			</div>
