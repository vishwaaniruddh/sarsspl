...
values('$cname','$city','".mysqli_real_escape_string($con1,$staterows[0])."','$area','$add2','$Pincode','$cat','$catn','$phone','$fax','$email','$contact','$mobile','$emp','$memtype','$lic','$fees','$yoe','$target','$fdt','$tdate','$Latitude','$Longitude','$vat','$adhar','$pan','$Establishment','$pancardno','$Pnameno','$Aadharcardno','$companytyp','deactive','$Ldesignation','$Registn','$cin','$gumastaNo','$busiAadhar','$comnyPan','$tanno','$Establishment')";*/
 
 //Ruchi : 5 aug 19
    $qry="insert into clients(`name`,`city`,`state`,`pincode`,`cid`,`category`,`phone`,`fax`,`email`,`contact`,`mobile`,`noe`,`memtype`,`license`,`fees`,`logo`,`rdate`,`till_date`,Latitude,Longitude,vat, `adhar_no`, `pan_no`, partnerpancatd,partnerName,partnerAadhar,companytyp,subscribe,designation,RegisterationNo,CIN,Gumasta,BusiAadharNo,CompanyPancard,Tanno,wing,flat_no,bldg_name,locality,landmark,road_no,introducer_id,free_introducer_id) 
    values('$cname','$city','".mysqli_real_escape_string($staterows[0])."','$Pincode','$cat','$catn','$phone','$fax','$email','$contact','$mobile','$emp','$memtype','$lic','$fees','$target','$fdt','$tdate','$Latitude','$Longitude','$vat','$adhar','$pan','$pancardno','$Pnameno','$Aadharcardno','$companytyp','deactive','$Ldesignation','$Registn','$cin','$gumastaNo','$busiAadhar','$comnyPan','$tanno','$wing','$flat','$bldg','$locality','$landmark','$road_no',$introducer_id,$free_introducer_id)";
