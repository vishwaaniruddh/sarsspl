...
<script>
  ...
  //=================================================================               
          if(document.getElementById('ctyp').value=="1")
            {
                var show=['hide','adhno','pcn','compname','Partshipcn','PartshipcomnyPan','Cperson','Cmobile','CTelephn','PtsGumasta','PartshipBusiAadhr','Partshiptanno','gstno','bnknm','brNam','ifscod','acno','acNam','CPincode'];
    ...
    <!--<div class="form-group col-md-6">
            ...
            <div class="col-md-8 inputGroupContainer">
               <div class="input-group"><span class="input-group-addon"><i class="glyphicon glyphicon-list-alt"></i></span>
                    <input id="upi" name="upi" placeholder="UPI Handler" class="form-control"  value="" type="text">
               </div>
            </div>
    </div>-->
