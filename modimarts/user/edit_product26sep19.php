...
else
{
 $qry2="select *  from products where code='$pcode'  and ccode='$id'";   
                          ...
                          $res2=mysql_query($qry2);
                           $nrwsd=mysql_num_rows($res2);
                          $row2=mysql_fetch_array($res2);  
                          
                          $sltcat=mysql_query("SELECT name FROM `main_cat` where id ='".$row2[4]."' ");
 
$sltcat=mysql_fetch_array($sltcat);
?>
<!doctype html>
<html lang="en">
<head>
...
?>
      ...
      <table class="tables"  align="center" cellpadding="4" cellspacing="0"  id="attatch">
                                                ...
                                                <tr>
                                                  ...
                                                  <td colspan="3"><input type="text" name="pname" class="form form-full" value="<?php echo $row2[1];?>" required/></td>
                                              ...
                                              <!--  <tr>
                                                ...
                                                <tr>
                                                 ...
                                                 <tr>
                                                  ...
                                                  <td colspan="3"><input type="text" name="pbrand" id="pbrand" class="form form-full" value="<?php echo $row2["brand"];?>" required/></td>
...
<input type="hidden" id="hidden_sizeid" name="hidden_sizeid" value="<?php echo $row2['size_id']; ?>"/>
 ...
 <tr>
                                                  ...
                                                  <td colspan="3">
                                                      ...
                                                      if($pcat==1)
                                                       {
                                                        $slting=mysql_query("SELECT * FROM `fashion_img` where product_id='".$pcode."'");
                                                        
                                                       }
                                                       else if($pcat==190)
                                                       {
                                                        $slting=mysql_query("SELECT * FROM `electronics_img` where product_id='".$pcode."'");
                                                       }
                                                        else if($pcat==218)
                                                       {
                                                        $slting=mysql_query("SELECT * FROM `grocery_img` where product_id='".$pcode."'");
                                                       }
                                                         else if($pcat==482)
                                                       {
                                                        $slting=mysql_query("SELECT * FROM `Resale_img` where product_id='".$pcode."'");
                                                       }
                                                        else 
                                                       {
                                                      
                                                        $slting=mysql_query("SELECT * FROM `product_img` where product_id='".$pcode."'");
                                                       }
                                                       
                                                       
                                                       
while($sltingf=mysql_fetch_array($slting))
{
                                             ...
                                             <tr>
                                                ...
                                                <tr>
                                                  ...
                                                  <?php 
                                                              if($pcat==1)
                                                                    {
                                                                          $qryspc=mysql_query("SELECT * FROM `fashionSpecification` where product_id='".$pcode."'");
                                                      // echo "SELECT * FROM `fashionSpecification` where product_id='".$pcode."'";
                                                                    }
                                                                    else if($pcat==190)
                                                                    { $qryspc=mysql_query("SELECT * FROM `electronicsSpecification` where product_id='".$pcode."'");
                                                       
                                                                    }
                                                                    else if($pcat==218)
                                                                    { $qryspc=mysql_query("SELECT * FROM `grocerySpecification` where product_id='".$pcode."'");
                                                       
                                                                    }
                                                                     else if($pcat==482)
                                                                    { $qryspc=mysql_query("SELECT * FROM `ResaleSpecification` where product_id='".$pcode."'");
                                                       
                                                                    }
                                                                    else
                                                                    {
                                                                    $qryspc=mysql_query("SELECT * FROM `productspecification` where product_id='".$pcode."'");
                                                                    }
