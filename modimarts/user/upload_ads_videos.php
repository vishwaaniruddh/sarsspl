...
/*if(!isset($_SESSION['adminuser']) || (trim($_SESSION['adminuser']) == '')) 
{
...
<body> 
    <!--<form id="formf" method="POST"  enctype="multipart/form-data" onsubmit="return submfunc();">-->
        <form id="formf" method="POST" enctype="multipart/form-data"  action="payumoney/index.php">
        <input type="hidden" name="tymst" id="tymst">
        <!-- Ruchi -->
        <input type="hidden" name="mrc_id" value="<?php echo $_SESSION['id'];?>">
        <input type="hidden" name="email" value="<?php echo $_SESSION['adminuser'];?>">
...
<center>
  <div class="modal-contendets" >
    ...
    <div class="row" id="subtndiv">
        ...
        <input type="submit" value="Submit" class="form-submit"  style="width:80px"  />
    </div>
    <div class="col-md-5"></div>
</div>
