...
$sql_statement = "select * from Productviewtable where ccode='".$_SESSION["id"]."'";
  ...
  <tr>
    ...
    <div id="content-table-inner">
      ...
      <div id="table-content">
        ...
        <tr>
          <th class="table-header-check"><p style="font-size:16px; color:#000;">Sr No</p></th>
          <th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#000;">Image</p> </th>
          <th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#000;">Product code</p></th>
          
          <th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#000;">Product Name</p></th>
            <th class="table-header-repeat line-left minwidth-1"><p style="font-size:16px; color:#000;">category</p></th>
          
          
          <th class="table-header-options line-left"><p style="font-size:16px; color:#000;">Price</p></th>
          <th class="table-header-options line-left"><p style="font-size:16px; color:#000;">Select</p></th>
        </tr>
                <?php
      
      $query = "select * from Productviewtable where ccode='".$_SESSION["id"]."'";
...
while($row=mysqli_fetch_array($result)){
    ...
    $rt=mysqli_query($con1,"select * from Productviewimg where product_id='".$row[0]."' and category='".$row['category']."' limit 0,1");
   // echo $rt;
   
$ftyr=mysqli_fetch_array($rt);
        ?>
        <tr class="alternate-row">
          ...
          <button type="button" onclick='saleupdtfn("<?php echo $row["code"]; ?>","<?php echo $row["category"]; ?>","<?php echo $row["code"]; ?>")'>Select</button>
