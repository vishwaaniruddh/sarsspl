            ...
            <div class="grid__item">
              <div class="container-bg">
                <div class="grid__item">
                        ...
                        while($item=mysqli_fetch_assoc($qryc))
                          {
                            ...
                            $is_shipping=$prodata['is_shipping'];
                            $shipping_in_area=$prodata['shipping_in_area'];
                       ?>
                        ...
                        <div class="cart__row">
                          ...
                          >
                            ...
                            >
                              <a
                                href="https://allmart.world/<?=strurl($item['product_name'])?>/P/<?=strcode($item['pid'])?>/<?=strcode($item['cat_id'])?>/<?=strcode($item['prodid'])?>"
                                class="cart__image"
                              >
                                <img
                                  src="<?=$item['image']?>"
                  ...
                  if($is_shipping)
                  {
                     $shipping_charges=$shipping_in_area;
                  }
                  else
                  {
                      ...
                      $Name = $sql_result['name'];
                         ...
                         ?>
                          <div id="shipping-calculator" style="margin-top: 0;">
                            ...
                            <form method="post" name="customerData" id="cardform" action="ccavRequestHandler.php" onsubmit="checkdelivery()"  >
