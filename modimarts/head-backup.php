                            ...
                            for ($j=0; $j <count($category) ; $j++) { 
                                                        ?>
                                                              ...
                                                              <div data-gridItem class="menu-lv-2 inner dropdown col-12 col-xl-3">
                                                                    ...
                                                                    <a class="menu__moblie"  class="current" href="https://allmart.world/catalog-product?category_id=<?=strcode($category[$j]->Category_id)?>">

                                                                      <?php echo $category[$j]->Category; ?>
                                                                      <span class="icon-dropdown" data-toggle-menu-mb>
                                                                          <i class="fa fa-angle-right" aria-hidden="true"></i>
                                                                        </span>
                                                                ...
                                                                <ul class="dropdown"> 
                                                                    <?php 
                                                                     $catprods=GetCategoryProduct($category[$j]->Category_id);
                                                                    
                                                                       for ($i=0; $i <count($catprods) ; $i++) { 
                                                                          
                                                                        ?>
                                                                <li class="menu-lv-3 inner">
                                                                            <a href="https://allmart.world/catalog-product?category_id=<?=strcode($catprods[$i]->Category_id)?>">

                                                                            <?php echo $catprods[$i]->Category; ?>                   
                                                                            </a>
                                                              ...
                                                              <?php }?>
                                                              <div data-griditem="" class="menu-lv-2 inner dropdown col-12 col-xl-3" style="position: absolute; left: 966.75px; top: 220px;">
