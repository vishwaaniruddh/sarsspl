 ...
 <div class="container-bg">
  ...
  <div class="grid__item small--text-center">
    <div class="register-form">
      ...
      <input type="number" name="mob" id="mob" placeholder="Mobile Number" onkeypress="return ismob(event)" pattern="^[6-9]\d{9}$" autocomplete="off"  autocorrect="off" autocapitalize="off" require>
