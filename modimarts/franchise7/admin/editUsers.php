...
<body class="theme-red">
    ...
    <section class="content">
        <form id="form" action="EditUsersProcess.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row clearfix">
                                ...
                                <label class="form-label">Designation</label>
                                  <select class="form-control" name="UserType" required>
                                        ...
                                        <option <?php if($getusrData['UserType']==""){ echo "selected";} ?> value="">NA</option>
                                ...
                                <div class="col-sm-3">
                                     <div class="form-line">
                                        <label class="form-label">Enter User Login</label>
                                ...
                                <div class="col-sm-3">
                                     <div class="form-line">
                                            ...
                                            <input type="text" name="mobile" value="<?=$getusrData['mobile']?>" class="form-control" required />
                                ...
                                <div class="col-sm-3">
                                     <div class="form-line">
                                        ...
                                        <img src="https://www.modimarts.com/<?=$getusrData['image']?>" alt="" width="100px" height="100px">
