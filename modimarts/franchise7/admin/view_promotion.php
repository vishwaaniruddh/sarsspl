...
<body>
   ...
   $str = str_replace('https://www.modimarts.com/franchise7', '', $newimg);  
    ?>
    <!-- <section>
...
<div class="container content">
    ...
    <div class="row" id="withimg" style="padding-top: 5px;padding-bottom: 0px;border-bottom: 1px solid white;margin-bottom: 1px;">
        ...
        <div class="col-3" style="text-align: center; border-right: 1px solid white;margin-bottom: 5px;">
                <img src="https://modimarts.com/franchise7/promo/allmart_logo.png" class="logo">
        </div>
    
        <div class="col-6 mem_info">
            <p style="text-align:center;">www.modimarts.com</p>
            <small class="small" style="font-size: 5px;">Ecommerce Platform for <br/>All Types of Consumer Goods with agent network at all India Upto village level</small>
            
                 <p style="font-family: Arial , sans-serif;font-size: 6px;"> <?=strtoupper($name)?>-<?=$mobile?></p>
            
            <p style="font-family: Arial , sans-serif;font-size: 6px;text-align: center;"><?=strtoupper($designation)?></p>
        </div>
    
        <div class="col-3">
            <img src="<? echo 'https://modimarts.com'.$image;?>" class="character">
        </div>
    ...
    <div class="row" id="withoutimg" style="padding-top: 5px;padding-bottom: 0px;border-bottom: 1px solid white;margin-bottom: 1px;display:none;">
        ...
        <div class="col-9 mem_info">
            <p style="text-align:center;">www.modimarts.com</p>
            <small class="small" style="font-size: 11px;">Ecommerce Platform for <br/>All Types of Consumer Goods with agent network at all India Upto village level</small>
