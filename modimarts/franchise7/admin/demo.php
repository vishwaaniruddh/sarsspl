...
if(!$_SESSION){ ?>
    ...
    <script>
        window.location.href='https://modimarts.com/get_members.php';
    </script>
...
if($check_sql_result= mysqli_fetch_assoc($check_sql)){ 
    ...
    if($check_sql_result['level_id'] == 8){ ?>
        | <a class="btn btn-info btn-lg" target="_blank" href="https://modimarts.com/franchise7/bill/pdf/bill1.php?id=<? echo $userid?>">
                                    Franchise Invoice
                                </a>
