    ...
    width: 100%;">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <!-- Call Search -->
                    <li>
                        <a href="http://www.modimarts.com/franchise7/admin/members.php" class="">Member</a>
                    </li>
                    
                    
                    <li>
                        <a href="http://www.modimarts.com/franchise7/admin/pending_approve.php" class="">Pending Approve</a>
                    </li>
