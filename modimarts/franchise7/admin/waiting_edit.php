...
$userid = $_GET['id'];
$sql = mysqli_query($con,"select * from new_waiting where id='".$userid."'");
...
function get_image($type,$id){
    ...
    $sql = mysqli_query($con,"select * from new_member_waiting_images where member_id='".$id."' and type='".$type."'");
    $sql_result = mysqli_fetch_assoc($sql);
...
<body class="theme-red">
    ...
    <section class="content">
        <form id="form" action="process_member_waiting.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div>
                                ...
                                <?
$check_sql = mysqli_query($con,"SELECT * FROM `new_member` where (pan <> '' OR gst <> '' OR adhar_card <> '') and id='".$userid."' and status=1");

if($check_sql_result= mysqli_fetch_assoc($check_sql)){ ?>
    
                               | <a class="btn btn-info btn-lg" target="_blank" href="https://modimarts.com/franchise7/bill/pdf/bill.php?id=<? echo $userid?>">
                                    Get PDF
                                </a>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="intro_mobile" value="<? echo $introducer_mobile;?>" class="form-control" />
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6 demo-radio-button">
                                    ...
                                    <div class="form-group">
                                        <input name="pay_option" value="5000" type="radio" id="radio_5" <? if($pay_option=='5000'){ echo 'checked';}?> />
                                        <label for="radio_5">Option 1: Rs 5000/- NON REFUNDABLE</label>
                                        <input name="pay_option" value="10000" type="radio" id="radio_6" <? if($pay_option=='10000'){ echo 'checked';}?> />
