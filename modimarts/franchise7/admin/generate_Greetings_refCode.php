...
?>
                  <script>
        window.location.href='https://modimarts.com/franchise7/admin/generate_Greetings_refCode.php';
    </script>
    <?php
                               ...
                               foreach($query as $key => $value) {
                                ...
                                ?>
                                    <tr>
                                        <td><?=$key+1?></td>
                                        <td><?=$value['code']?></td>
                                        <td><a href="https://wa.me/?text=<?=urlencode('https://modimarts.com/franchise7/Greetings/User/Register?refcode='.$value['code'])?>" target="_blank"> https://modimarts.com/franchise7/Greetings/User/Register?refcode=<?=$value['code']?></a></td>
                                    </tr>
                                    <?php
                                    }
                                      ?>
                               ...
                               foreach($query as $key => $value) {
                                ...
                                ?>
                                    <tr>
                                        <td><?=$key+1?></td>
                                        <td><?=$value['code']?></td>
                                        <td><a href="https://wa.me/?text=<?=urlencode('https://modimarts.com/franchise7/Greetings/Register/RegisterFranchise?refcode='.$value['code'])?>" target="_blank"> https://modimarts.com/franchise7/Greetings/Register/RegisterFranchise?refcode=<?=$value['code']?></a></td>
                                    </tr>
                                    <?php
                                    }
                                      ?>
