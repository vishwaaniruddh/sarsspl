    ...
    width: 100%;">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav navbar-right">
                    <!-- Call Search -->
                    <li>
                        <a href="http://www.modimart.world/franchise6/get_members.php" class="">Member Filter</a>
                    </li>
                    
                    
                    <li>
                        <a href="http://www.modimart.world/franchise6/admin/members.php" class="">Member</a>
                    </li>
                
                    
                    <li>
                        <a href="http://www.modimart.world/franchise6/admin/pending_approve.php" class="">Pending Approve</a>
                    </li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <? $sql = mysqli_query($con,"select * from new_member2 where status=2 order by id DESC");
...
while($sql_result = mysqli_fetch_assoc($sql)){ ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-success" href="member_approve1.php?id=<? echo $sql_result['id'];?>">Approve</a> |
                            <a class="btn btn-danger" href="member_reject1.php?id=<? echo $sql_result['id'];?>">Reject</a>
                        </td>
