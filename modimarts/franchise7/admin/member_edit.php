...
if (!isset($_SESSION['mem_id']) && !isset($_SESSION['username'])) {
    ...
    <script>
        window.location.href='https://modimarts.com/franchise7/get_members.php';
    </script>
...
if ($check_sql_result = mysqli_fetch_assoc($check_sql)) {
    ...
    if ($check_sql_result['level_id'] <= 8) {?>
        ...
        <a class="btn btn-info btn-lg" target="_blank" href="https://modimarts.com/franchise7/bill/pdf/bill.php?id=<?echo $userid ?>">Franchise Invoice</a>
    <?}
...
<script>
    function createRef(id)
    {
         ...
         $.ajax({
                url: "https://www.modimarts.com/franchise7/admin/creatMemref.php",
                data: 'memcode=' + id,
                type: "POST",
