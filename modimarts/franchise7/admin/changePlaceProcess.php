	...
	if ($updatedQuery) {
		...
		<script>
		  ...
		  'error'
		     ...
		     window.location = "https://www.modimarts.com/franchise7/admin/member_edit.php?id=<?=$userid?>"
		});
		</script>
		<?php
		}
		...
		<script>
		  ...
		  'success'
		    ...
		    window.location = "https://www.modimart.world/franchise6/admin/member_edit.php?id=<?=$userid?>"
		});
