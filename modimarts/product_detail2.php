...
if ($cid == 80) {
    ...
    if ($Maincate == 1) {
        $qrylatf = "SELECT `code`, `name`, `ccode`, `description`, `category`, `photo`, `price`, `others`, `discount`, `discount_type`, `total_amt` , `color` ,`maxqty`,`minqty`,`size`,Long_desc,shipping_in_area,shipping_out_state,`maxqty`,`minqty` FROM `fashion` WHERE code='" . $pid . "'";
    } else if ($Maincate == 190) {
        $qrylatf = "SELECT `code`, `name`, `ccode`, `description`, `category`, `photo`, `price`, `others`, `discount`, `discount_type`, `total_amt`, `color` ,`size`,`maxqty`,`minqty`,Long_desc,shipping_in_area,shipping_out_state FROM `electronics` WHERE code='" . $pid . "'";
    } else if ($Maincate == 218) {
        $qrylatf = "SELECT `code`, `name`, `ccode`, `description`, `category`, `photo`, `price`, `others`, `discount`, `discount_type`, `total_amt`, `color` ,`size`,`maxqty`,`minqty`,Long_desc,shipping_in_area,shipping_out_state FROM `grocery` WHERE code='" . $pid . "'";
    ...
    $qrylatf="SELECT `code`, `name`, `ccode`, `description`, `category`, `photo`, `price`, `others`, `discount`, `discount_type`, `total_amt`, `color` ,`size`,Long_desc,shipping_in_area,shipping_out_state FROM `services` WHERE code='".$pid."'";
        ...
        $qrylatf = "SELECT `code`, `name`, `ccode`, `description`, `category`, `photo`, `price`, `others`, `discount`, `discount_type`, `total_amt`, `color` ,`size`,`maxqty`,`minqty`,Long_desc,shipping_in_area,shipping_out_state FROM `products` WHERE code='" . $pid . "'";
    }
}
...
$prod_id    = mysqli_real_escape_string($con1, $_GET['prod_id']);
    ...
    $msg= $prolink;
            ...
            $getreview=mysqli_query($con1,"SELECT * FROM `product_review` WHERE status='1'");
...
foreach ($getreview as $key => $review) {
   ...
   ?>
    <div class="spr-reviews" id="reviews_5969999724734"><div class="spr-review" id="spr-review-105032506">
      ...
      ?>
  <div class="column">  
    <img src="<?=$images[$i]?>" style="width:80px" onclick="openModal();currentSlide(1)" class="hover-shadow cursor">
  </div>
<?php } ?>
...
function resetRating() {
  ...
  */
   ...
   // alert(quntity);
        ...
        {
             notyf.error('Error  Please  Only Bdel Products');
        }
        else
        {
