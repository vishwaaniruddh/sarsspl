...
for ($j=0; $j <count($Prodata) ; $j++) { 
    ...
    $mrp=$Prodata[$j]->Regular_price;
    
    if($_SESSION['mem_id']!=''){
      $discount=50;
     $amount= getdiscamount($amount,$discount); 
   }
   else
   {
    $discount=0;
    ...
    $Regular_price = $Prodata[$j]->Regular_price;
    $GST = $Prodata[$j]->Gst_per_first;
    $GST2 = $Prodata[$j]->Gst_per_second;
    $HSN = $Prodata[$j]->Hsn_code;
    $Category_id = $Prodata[$j]->Category_id;
...
foreach ($collect as $row) {
            ?>
                              ...
                              >
                                ...
                                <div class="product_single_price" id="pricebox" style="display: block;">
                                  ...
                                  </div> <?php if ($amount < $mrp) {?>
                                    <span style="color:red"><del>₹<?php echo $mrp; ?></del> (<?php echo round((1 - ($amount / $mrp)) * 100, 0); ?> % Off )</span>
                                  <?php }?>
                                  ...
                                  <div class="selector-wrapper-secton">
                                            ...
                                            <div class="swatch" data-option-index="0" style="display: block;">
                                               ...
                                               foreach ($size_res as $key => $value) {
                                                 
                                                  ?>
                                               
                                                <div data-value="" class="swatch-element 1-kg available">
                                                    <input
                                                    ...
                                                    <label onclick="SetSize(<?=$value->Size_id?>)" ><?=$value->Size_name?> </label>
                                                </div>
                                                <?php } ?>
                                                </div>
                                            ...
                                            <div class="swatch" data-option-index="0" style="display: block;">
                                               ...
                                               foreach ($color_res as $key => $value) {
                                                ...
                                                <div data-value="" class="swatch-element 1-kg available">
                                                    ...
                                                    <label onclick="SetColor('<?=$value->Color_id?>')" ><?=$value->Color_name?> </label>
                                                </div>
                                                <?php } ?>
                                                </div>

                                                <input type="hidden" id="selectcolor" value="<?=$color?>">
                                                <input type="hidden" id="selectsize" value="<?=$size?>">

                                                <input type="hidden" id="price" value="<?=$amount?>">
                                                <input type="hidden" id="proname" value="<?=urlencode($pro_name)?>">
                                                <input type="hidden" id="pro_id" value="<?=$Product_id?>">
                                                <input type="hidden" id="shopping" value="<?=$Shipping_charges?>">
                                                <input type="hidden" id="sku_id" value="<?=$Sku_id?>">
                                                <input type="hidden" id="pro_img" value="<?=$Medium_file?>">
                                                <input type="hidden" id="User_id" value="<?=$userid?>">
                                                <input type="hidden" id="GST" value="<?=$GST?>">
                                                <input type="hidden" id="GST2" value="<?=$GST2?>">
                                                <input type="hidden" id="HSN" value="<?=$HSN?>"> 
                                                <input type="hidden" id="Mrp" value="<?=$mrp?>"> 
                                  ...
                                  <div class="product-single__quantity" style="display: block;">
                                    <div class="quantity-box-section">
                                      ...
                                      <?php } else { ?>
                                       <p
                                          class="min-qty-alert" style="font-size: 18px;color: #ff6c26;font-weight: bold;"
                                          style="display: block"
  ...
  <div class="dt-sc-tabs-content rte" id="desc_pro" style="display: block;">
    <p><span
                                  ...
                                  <p class="vote"><?php echo $description; ?></p>
                                </span
                                ></p>
...
<?php } ?>
      <script src="https://allmart.world/assets/Apicall.js"></script>
