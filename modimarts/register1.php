...
<nav class="breadcrumb" aria-label="breadcrumbs">
 <div class="container-bg">
  ...
  <div class="grid__item small--text-center">
    <div class="register-form">
      ...
      <input type="text" name="fname" id="fname" placeholder="First Name" onKeyPress="return ValidateAlpha(event);"  autocapitalize="words" autofocus autocomplete="off" require>

      <label for="LastName" class="label--hidden">Last Name *</label>
      <input type="text" name="lname" id="lname" placeholder="Last Name" onKeyPress="return ValidateAlpha(event);"  autocapitalize="words" autocomplete="off" require>
      ...
      <input type="number" name="mob" id="mob" placeholder="Mobile Number" onkeypress="return isNumberKey(event)" pattern="^[6-9]\d{9}$" autocomplete="off"  autocorrect="off" autocapitalize="off" require>
 ...
 -->
      ...
      <input type="password"  id="rpass" placeholder="Retype Password" autocomplete="off" require >
      <span id="message"></span>
      <span class="error_message spassword_error" style="display: none;">Enter minimum 8 chars with atleast 1 number, lower, upper </span>
      <p>
