...
$image = str_replace('https://www.modimart.world/franchise4/', '', $image);
?>
...
<html lang="en">
  <head>
    ...
    <title>Modi Mart | Once More Studio OMS</title>
    ...
    <div style="display:flex;justify-content:center;margin:1% 7% ;">
		<div class="row" style="display:inline-flex;" id="html-content-holder">
			<div class=" col left-section  px-0">
				<img src="visiting_assets/left_oms.jpeg" style="height: 600px;    width: 100%;" >
				<!-- <P>hello world</p> -->
			</div>
