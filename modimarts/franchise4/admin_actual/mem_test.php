...
if (!isset($_SESSION['username'])) {?>
    ...
    <script>
        window.location.href='https://www.allmart.world/franchise/admin';
    </script>
...
<head>
    ...
    <script type="text/javascript" src="https://www.allmart.world/franchise/typeahead.js"></script>
    <!--<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>-->
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    <link rel="stylesheet" href="https://www.allmart.world/franchise/style.css">
    <!-- Sweetalert Css -->
    <link href="https://www.allmart.world/franchise/plugins/sweetalert/sweetalert.css" rel="stylesheet" />
    <link rel="shortcut icon" href="https://www.allmart.world/assets/logo-original.png" type="image/png" />
...
<div class="heading" style="padding-top:0px !important;">
    <div class="logo">
        <a href="https://www.allmart.world/franchise/get_members.php" style="padding:10px;"><img src="https://www.allmart.world/assets/logo.png" alt="" style="width: 105px;background:white;border-radius: 50%;"><span style="font-size:0.7em;padding:10px;">Allmart.world</span></a>
    </div>
    <div class="menu">
...
$(document).ready(function () {
    ...
    $("#data_row").html('<img class="loader_img" src="https://www.allmart.world/franchise/landing_assets/830.gif">');
    ...
    setTimeout(function(){
        ...
        $('#txtCountry').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://www.allmart.world/franchise/get_country.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
        ...
        function selectZone(zone){
            ...
            $.ajax({
                url: "https://www.allmart.world/franchise/fill_by_zone.php",
                data: 'zone=' + zone,
                type: "POST",
                success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://www.allmart.world/franchise/get_zone.php',
                        data: 'zone_id='+zone,
                        success:function(msg) {
        ...
        $('#txtZone').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://www.allmart.world/franchise/get_zone1.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        function selectState(state){
            ...
            $.ajax({
                url: "https://www.allmart.world/franchise/fill_by_state.php",
                data: 'state=' + state,
                type: "POST",
                success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://www.allmart.world/franchise/get_state.php',
                        data: 'zone_id='+zone,
                        success:function(msg) {
                            document.getElementById("state").innerHTML = '<option value="">State</option>';
                            $("#state").html(msg);
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://www.allmart.world/franchise/get_division.php',
                        data: 'state_id='+state,
                        success:function(msg) {
        ...
        $('#txtState').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://www.allmart.world/franchise/get_state1.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        function selectPincode(pincode){
            ...
            $.ajax({
                url: "https://www.allmart.world/franchise/fill_by_pin.php",
                ...
                success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://www.allmart.world/franchise/get_district.php',
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://www.allmart.world/franchise/get_taluka.php',
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://www.allmart.world/franchise/get_pincode.php',
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://www.allmart.world/franchise/get_village.php',
        ...
        $('#txtPincode').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://www.allmart.world/franchise/get_pincode1.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        function selectDivision(division){
            ...
            $.ajax({
                url: "https://www.allmart.world/franchise/fill_by_division.php",
        ...
        $('#txtDivision').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://www.allmart.world/franchise/get_division1.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        function selectDist(district){
            ...
            $.ajax({
                url: "https://www.allmart.world/franchise/fill_by_district.php",
        ...
        $('#txtDistrict').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://www.allmart.world/franchise/get_district1.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
...
//             $("#pincode").val('');
            ...
            $.ajax({
                url: "https://www.allmart.world/franchise/fill_by_taluka.php",
                data: 'taluka=' + taluka,
                type: "POST",
                success: function (data) {
        ...
        $('#txtTaluka').typeahead({
            source: function (query, result) {
                ...
                j++;
                $.ajax({
                    url: "https://www.allmart.world/franchise/get_taluka1.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        function selectVillage(village){
            ...
            $.ajax({
                url: "https://www.allmart.world/franchise/fill_by_village.php",
        ...
        $('#txtVillage').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://www.allmart.world/franchise/get_village1.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        $('#mem_name').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://www.allmart.world/franchise/get_mem_name.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        $('#mem_mobile').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://www.allmart.world/franchise/get_mem_mobile.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
...
<script src="https://www.allmart.world/franchise/plugins/sweetalert/sweetalert.min.js"></script>

<!-- Custom Js -->
<script src="https://www.allmart.world/franchise/js/pages/ui/dialog2.js"></script>
</body>
</html>