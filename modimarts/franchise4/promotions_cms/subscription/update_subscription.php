...
$sql        = mysqli_query($con, "select * from Subscription where id='" . $userid . "'");
...
<body class="theme-red">
    ...
    <section class="content">
        <form id="form" action="updatesubscription.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="price" value="<?echo $price; ?>" class="form-control" required/>
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="date" name="validity" value="<?echo $validity; ?>" class="form-control" />
...
background: #cccccc;
    ...
    .main_ol li p{
        ...
        <div style="display:flex;justify-content:center;">
            <input type="submit" id="button" name="submit" value="Edit" class="btn btn-danger">
        </div>
...
<script src="https://www.allmart.world/franchise/plugins/dropzone/dropzone.js"></script>
   ...
   <script type="text/javascript">
    document.getElementById("button").onclick = function () {
        location.href = "https://allmart.world/franchise/promotions_cms/subscription/display.php";
    };
