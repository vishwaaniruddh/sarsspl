...
<? $sql = mysqli_query($con,"SELECT * from total_promotions where status=1 ORDER BY `total_promotions`.`id` ASC");  
...
while($sql_result = mysqli_fetch_assoc($sql)){ ?>
                    ...
                    <tr>
                        ...
                        <td><a href="delete_images.php?id=<?=$sql_result['id']?>" class="btn btn-danger">Delete</a>
                        <a href="edit_image.php?id=<?=$sql_result['id']?>" class="btn btn-danger">Edit</a></td>
                    </tr>
    <? $i++; } ?>
