...
$sql        = mysqli_query($con, "select * from customer_promotion where customer_id='" . $userid . "'");
$sql_result = mysqli_fetch_assoc($sql);
//var_dump($sql_result);

$customer_id          = $sql_result['customer_id'];
$customer_address     = $sql_result['customer_address'];
$mobile_number        = $sql_result['mobile_number'];
$content              = $sql_result['content'];
$content1             = $sql_result['content1'];
$content2             = $sql_result['content2'];
$content3             = $sql_result['content3'];
$content4             = $sql_result['content4'];
$email                = $sql_result['email'];
$website              = $sql_result['website'];
$designation          = $sql_result['designation'];

$customer_name        = $sql_result['customer_name'];
$logo                 = $sql_result['logo'];
$image                = $sql_result['image'];
$footer_image                = $sql_result['footer_image'];
$status               = $sql_result['status'];
$password             = $sql_result['password'];
$is_franchisee        = $sql_result['is_franchisee'];
...
<body class="theme-red">
    ...
    <section class="content">
        <form id="form" action="updatecustomerpromo.php" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-6">
                                 ...
                                 <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="number" name="mobile_number" value="<?=$mobile_number?>"  class="form-control" required/>
                                 ...
                                 <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="email" name="email" value="<?=$email?>" maxlength="25"  class="form-control"  />
                                 ...
                                 <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="website" value="<?=$website?>" maxlength="25"  class="form-control" />
                                 ...
                                 <div class="col-sm-6">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input type="text" name="designation" value="<?=$designation?>" maxlength="25"  class="form-control" />
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                           ...
                                           <textarea maxlength="58" name="content"  class="form-control" id="text"><?=$content; ?></textarea>
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                           ...
                                           <textarea maxlength="58" name="content1"  class="form-control" id="text"><?=$content1; ?></textarea>
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                           ...
                                           <textarea maxlength="58" name="content2"  class="form-control" id="text"><?=$content2; ?></textarea>
                                 ...
                                 <div class="col-sm-12">
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                           ...
                                           <textarea maxlength="58" name="content3"  class="form-control" id="text"><?=$content3; ?></textarea>
                                      ...
                                      <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <select class="form-control" name="status" required>
                                                ...
                                                <option <?php if($status=='0'){ echo "selected";} ?> value="0">DisActive</option>
                                            </select>
                                        </div>
                                    </div>
                                    </div>
                                <div class="col-sm-6">
                                      <div class="form-group form-float">
                                        <div class="form-line">
                                            ...
                                            <label class="form-label">is franchisee</label>
                                            <select class="form-control" name="is_franchisee" required>
                                                <option <?php if($is_franchisee=='1'){ echo "selected";} ?> value="1">Franchisee</option>
                                                <option <?php if($is_franchisee=='0'){ echo "selected";} ?> value="0">Free Customer</option>
                                                <option <?php if($is_franchisee=='2'){ echo "selected";} ?> value="2">Paid Customer</option>
                                                <option <?php if($is_franchisee=='4'){ echo "selected";} ?> value="4">Staff</option>
                                                <option <?php if($is_franchisee=='3'){ echo "selected";} ?> value="3">Advertiser</option>
                                            </select>
                                        </div>
                                    </div>
                                    </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                            <input type="file" name="logo" class="form-control" onchange="preview_images();">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                            ...
                                            <input type="file" name="image" onchange="preview_images();" value="<?echo $image; ?>" class="form-control" />
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group form-float">
                                            ...
                                            <input type="file" name="footer_image" onchange="preview_images();" value="<?echo $footer_image; ?>" class="form-control" />
                                            <label class="form-label">footer_image</label>
                                            <input type="hidden" name="oldfooter_image"  value="<?=$footer_image; ?>">
