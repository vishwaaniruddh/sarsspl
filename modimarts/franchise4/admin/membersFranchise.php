...
if (!isset($_SESSION['username'])) {?>
    ...
    <script>
        window.location.href='https://modimart.world/franchise4/admin';
    </script>
...
<head>
    ...
    <script type="text/javascript" src="https://modimart.world/franchise4/typeahead.js"></script>
    <!--<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>-->
    <!-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script> -->
    <link rel="stylesheet" href="https://modimart.world/franchise4/style.css">
    <!-- Sweetalert Css -->
    <link href="https://modimart.world/franchise4/plugins/sweetalert/sweetalert.css" rel="stylesheet" />
...
<div class="heading" style="padding-top:0px !important;">
    <div class="logo">
        <a href="https://modimart.world/franchise4/get_members.php" style="padding:10px;"><img src="https://modimart.world/assets/logo.png" alt="" style="width: 105px;background:white;border-radius: 50%;"><span style="font-size:0.7em;padding:10px;">Modimart.world</span></a>
    </div>
    <div class="menu">
...
$(document).ready(function() {
            ...
            // $("#data_row").html('<img class="loader_img" src="https://modimart.world/franchise4/landing_assets/830.gif">');
            // document.getElementById("data_table").style.display = "none";
                        ...
                        $('#txtCountry').typeahead({
                            source: function(query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/ajax/getcountryajex.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                         ...
                         $('#txtZone').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/ajax/getzoneajex.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtState').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/ajax/get_state1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtPincode').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/ajax/get_pincode1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtDivision').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/ajax/get_division1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtDistrict').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/ajax/get_district1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtTaluka').typeahead({
                            source: function (query, result) {
                                ...
                                j++;
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/ajax/get_taluka1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtVillage').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/ajax/get_village1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                          ...
                          $('#mem_mobile').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/ajax/get_mem_mobile.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                          ...
                          $('#mem_name').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/ajax/get_mem_name.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                          ...
                          $('#mem_id').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/admin/ajax/getmemberid.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                          ...
                          $('#created_at').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise4/admin/admin/ajax/getmemberdate.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
...
<script src="https://modimart.world/franchise4/plugins/sweetalert/sweetalert.min.js"></script>

<!-- Custom Js -->
<script src="https://modimart.world/franchise4/js/pages/ui/dialog2.js"></script>
