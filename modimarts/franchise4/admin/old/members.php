    ...
    $("document").ready(function(){
        ...
        console.log(msg);
            ...
            if(msg>0 || msg > '0'){
               ...
               $("#visiting_card").html('<a href="https://modimart.world/franchise4/new_visiting.php?id='+obj['id']+'" class="btn btn-danger">Visiting Card</a> | <button id="trees" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-original-title ='+obj['id']+' data-target="#myModal">View Tree</button>');           
                $("#member_apply").html('');
                ...
                $("#member_pic").html('');
                $("#member_apply").html('<a id="apply" href="https://modimart.world/franchise4/apply.php?country='+country+'&zone='+zone+'&state='+state+'&division='+division+'&district='+district+'&taluka='+taluka+'&pincode='+pincode+'&village='+village+'" class="btn btn-danger">Apply</a>');
        ...
        $.ajax({
            ...
            if(msg>0 || msg > '0'){
               ...
               $("#visiting_card").html('<a href="https://modimart.world/franchise4/new_visiting.php?id='+obj['id']+'" class="btn btn-danger">Visiting Card</a> | <button id="trees" type="button" class="btn btn-info btn-lg" data-toggle="modal" data-original-title ='+obj['id']+' data-target="#myModal">View Tree</button>');
                ...
                $("#waiting_btn").html('<a id="waiting" href="https://modimart.world/franchise4/waiting.php?country='+country+'&zone='+zone+'&state='+state+'&division='+division+'&district='+district+'&taluka='+taluka+'&pincode='+pincode+'&village='+village+'" class="btn btn-danger">Waiting</a>');
