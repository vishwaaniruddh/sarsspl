...
?>
    <div class="heading">
        ...
        <div class="logo">
        <a href="https://modimart.world/franchise4/get_members.php"><img src="../2.png" alt="" style="width: 100px; padding:10px;"><span style="font-size:0.7em;">Modimart.world</span></a>
        </div>
