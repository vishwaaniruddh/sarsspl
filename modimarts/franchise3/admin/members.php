            ...
            // document.getElementById("data_table").style.display = "none";
                        ...
                        $('#txtCountry').typeahead({
                            source: function(query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/admin/getcountryajex.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                         ...
                         $('#txtZone').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/admin/getzoneajex.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtState').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/get_state1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtPincode').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/get_pincode1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtDivision').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/get_division1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtDistrict').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/get_district1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtTaluka').typeahead({
                            source: function (query, result) {
                                ...
                                j++;
                                $.ajax({
                                    url: "https://modimart.world/franchise3/get_taluka1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtVillage').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/get_village1.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                          ...
                          $('#mem_mobile').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/get_mem_mobile.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                          ...
                          $('#mem_name').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/get_mem_name.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                          ...
                          $('#mem_id').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/admin/getmemberid.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                          ...
                          $('#created_at').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://modimart.world/franchise3/admin/getmemberdate.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
