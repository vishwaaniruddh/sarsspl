            ...
            // document.getElementById("data_table").style.display = "none";
                        ...
                        $('#txtCountry').typeahead({
                            source: function(query, result) {
                                $.ajax({
                                    url: "https://www.modimart.world/franchise3/admin/getcountryajex.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                         ...
                         $('#txtZone').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://www.modimart.world/franchise3/admin/getzoneajex.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                         ...
                         $('#txtVillage').typeahead({
                          ...
                          $('#mem_id').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://www.modimart.world/franchise3/admin/getmemberid.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
                          ...
                          $('#created_at').typeahead({
                            source: function (query, result) {
                                $.ajax({
                                    url: "https://www.modimart.world/franchise3/admin/getmemberdate.php",
                                    data: 'query=' + query,
                                    dataType: "json",
                                    type: "POST",
                                    success: function (data) {
