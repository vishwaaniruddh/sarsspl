...
// });
      ...
      $("#zone").on('change',function(){
             ...
             $.ajax({
                ...
                type: "POST",
                url: 'https://modimart.world/franchise3/get_state.php',
         ...
         $("#state").on('change',function(){
             ...
             $.ajax({
                type: "POST",
                url: 'https://modimart.world/franchise3/get_division.php',
         ...
         $("#division").on('change',function(){
             ...
             $.ajax({
                ...
                type: "POST",
                url: 'https://modimart.world/franchise3/get_district.php',
          ...
          $("#district").on('change',function(){
             ...
             $.ajax({
                ...
                type: "POST",
                url: 'https://modimart.world/franchise3/get_taluka.php',
      ...
      $("#taluka").on('change',function(){
             ...
             $.ajax({
                ...
                type: "POST",
                url: 'https://modimart.world/franchise3/get_pincode.php',
      ...
      $("#pincode").on('change',function(){
             ...
             $.ajax({
                ...
                type: "POST",
                url: 'https://modimart.world/franchise3/get_village.php',
...
<script>
 ...
 $('#txtCountry').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://modimart.world/franchise3/get_country.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
        ...
        function selectZone(zone){
            ...
            $.ajax({
                url: "https://modimart.world/franchise3/fill_by_zone.php",
                data: 'zone=' + zone,
                type: "POST",
                success: function (data) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: 'https://modimart.world/franchise3/get_zone.php',
                        data: 'zone_id='+zone,
                        success:function(msg) {
                            document.getElementById("state").innerHTML = '<option value="">State</option>';
                            $("#state").html(msg);
        ...
        $('#txtZone').typeahead({
            source: function (query, result) {
                $.ajax({
                    url: "https://modimart.world/franchise3/get_zone1.php",
                    data: 'query=' + query,
                    dataType: "json",
                    type: "POST",
                    success: function (data) {
        ...
        function selectState(state){
            ...
            $.ajax({
                url: "https://modimart.world/franchise3/fill_by_state.php",
                data: 'state=' + state,
                type: "POST",
                success: function (data) {
        ...
        function selectPincode(pincode){
            ...
            $.ajax({
                url: "https://modimart.world/franchise3/fill_by_pin.php",
        ...
        function selectDivision(division){
            ...
            $.ajax({
                url: "https://modimart.world/franchise3/fill_by_division.php",
        ...
        function selectDist(district){
            ...
            $.ajax({
                url: "https://modimart.world/franchise3/fill_by_district.php",
...
//             $("#pincode").val('');
            ...
            $.ajax({
                url: "https://modimart.world/franchise3/fill_by_taluka.php",
                data: 'taluka=' + taluka,
                type: "POST",
                success: function (data) {
        ...
        function selectVillage(village){
            ...
            $.ajax({
                url: "https://modimart.world/franchise3/fill_by_village.php",
