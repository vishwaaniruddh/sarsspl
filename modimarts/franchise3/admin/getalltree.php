    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header" style="min-width: 200px;">
                ...
                <a class="navbar-brand" href="http://www.modimart.world/franchise3/" style="display:flex;height: 100px;margin: auto; line-height: 3;     padding: 0;
    width: 100%;">
                                    <img src="https://modimart.world/assets/logo.png" style="width:100px;border-radius: 50%;" >
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <td><?echo $amount; ?></td>
                                        ...
                                        $sql = mysqli_query($con, "select * from new_member where status=1 $query order by zone ASC");
                                               $count=mysqli_num_rows($sql);
                                                    if($count){
                        ...
                        <td><?echo $amount; ?></td>
                                        ...
                                        <?$i++;} }
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td><? if($level==3){echo   $zone['state'];} ?></td>
                                                                <td>india</td>
                                                                <td><?php echo get_zone(GetzoneByState($zone['id'])); ?></td>
                                                                <td><? if($level==3){echo   $zone['state'];} ?></td>
                                                                <td><? if($level==4){echo $zone['division'];} ?></td>
                                                                <td><? if($level==5){echo  $zone['district'];} ?></td>
                                                                <td><? if($level==6){echo  $zone['taluka']; }?></td>          
                        ...
                        <td><?echo $amount; ?></td>
                                        ...
                                        <?$i++;} }
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td>4</td>
                                                                <td>Division</td>
                                                                <td><?php  echo $zone['division'];?></td>
                                                                <td>india</td>
                                                                <td><?php echo get_zone(GetzoneByState(GetStateBydivision($zone['id']))); ?></td>
                                                                <td><?php echo get_state(GetStateBydivision($zone['id'])) ?></td>
                                                                <td><?php  echo $zone['division'];?></td>
                                                                <td><? if($level==5){echo  $zone['district'];} ?></td>
                                                                <td><? if($level==6){echo  $zone['taluka']; }?></td>          
                                                                <td></td>
                        ...
                        <td><?echo $amount; ?></td>
                                        ...
                                        <?$i++;} }
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td>5</td>
                                                                <td>District</td>
                                                                <td><?php  echo $zone['district'];?></td>
                                                                <td>india</td>
                                                                <td><?php
                                                                 echo get_zone(GetzoneByState(GetStateBydivision(GetdivisionBydistrict($zone['id'])))); ?></td>
                                                                <td><?php echo get_state(GetStateBydivision(GetdivisionBydistrict($zone['id']))) ?></td>
                                                                <td><?php  echo get_division(GetdivisionBydistrict($zone['id']));?></td>
                                                                <td><? if($level==5){echo  $zone['district'];} ?></td>
                                                                <td><? if($level==6){echo  $zone['taluka']; }?></td>          
                                                                <td></td>
                                                                <td></td>
                                        ...
                                        <?$i++;} }
                                                              ...
                                                              <tr>
                                                                ...
                                                                <td>6</td>
                                                                <td>Taluka</td>
                                                                <td><?php  echo $zone['taluka'];?></td>
                                                                <td>india</td>
                                                                <td><?php echo get_zone(GetzoneByState(GetStateBydivision(GetdivisionBydistrict(GetdistrictBytaluka($zone['id']))))); ?></td>
                                                                <td><?php echo get_state(GetStateBydivision(GetdivisionBydistrict(GetdistrictBytaluka($zone['id'])))); ?></td>
                                                                <td><?php  echo get_division(GetdivisionBydistrict(GetdistrictBytaluka($zone['id'])));?></td>
                                                                <td><?echo  get_district(GetdivisionBydistrict(GetdistrictBytaluka($zone['id'])));?></td>
                                                                <td><? if($level==6){echo  $zone['taluka']; }?></td>          
                                                                <td></td>
                                                                <td></td>
                                                                <td></td> 
                                                        ...
                                                        $amount = 1000;
                                                          ...
                                                          ?>
                                                            <tr>
                                                                ...
                                                                <td><? if($sql_result['district']!=0){echo get_district($sql_result['district']);} ?></td>
                                                                <td><? if($sql_result['taluka']!=0){echo get_taluka($sql_result['taluka']); }?></td>
                                                                <td><? if($sql_result['taluka']!=0){echo get_pincode($sql_result['pincode']); }?></td>
                                                                <td></td>
                                                                <td><?echo $sql_result['id']; ?></td>
                                                                <td><?echo $sql_result['name']; ?></td>
                                                                <td><?echo $sql_result['mobile']; ?></td>
                                        ...
                                        <?$i++;} }
                                                                ...
                                                                <td>7</td>
                                                                <td>Pincode</td>
                                                                <td><?php  echo $zone['pincode'];?></td>
                                                                <td>india</td>
                                                                <td><?php echo get_zone(GetzoneByState(GetStateBydivision(GetdivisionBydistrict(GetdistrictBytaluka(GettalukaBypincode($zone['id'])))))); ?></td>
                                                                <td><?php echo get_state(GetStateBydivision(GetdivisionBydistrict(GetdistrictBytaluka(GettalukaBypincode($zone['id']))))); ?></td>
                                                                <td><?php  echo get_division(GetdivisionBydistrict(GetdistrictBytaluka(GettalukaBypincode($zone['id']))));?></td>
                                                                <td><?echo  get_district(GetdivisionBydistrict(GetdistrictBytaluka(GettalukaBypincode($zone['id']))));?></td>
                                                                <td><? echo get_taluka(GettalukaBypincode($zone['id']));?></td>          
                                                                <td><? echo $zone['pincode']; ?></td>
