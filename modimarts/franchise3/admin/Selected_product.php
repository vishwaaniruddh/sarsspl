       ...
       // $product_data_result = mysqli_fetch_assoc($product_data_array);
        ...
        <select id="select_product" class="select_product">
            ...
            <?php while($product_data_result = mysqli_fetch_assoc($product_data_array)){  
                ...
                $pro_img = 'https://modimart.world/ecom/' . $frtu['img'];
    ...
    <div class="col-md-3">
        ...
        <div class="form-group">
         ...
         for ($i=0; $i <count($imgs) ; $i++) { 
             ?>
             <img src="https://www.modimart.world/franchise3/admin/<?=$imgs[$i]?>" alt="" style="width:100%">
            <?php
         }?>
        </div>

        <div class="form-group">
         <a href="<?php if($rws2['video_url']!=''){ ?>https://www.modimart.world/franchise3/admin/<?php echo $rws2['video_url']; } else{ echo "#";} ?>" class="btn btn-primary">Video Link</a>
        </div>
        <!-- Sidebar2 -->
</div>
</div>
