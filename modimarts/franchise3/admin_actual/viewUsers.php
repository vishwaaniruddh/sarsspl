...
if (!isset($_SESSION['username']) && $_SESSION['userid']=='1') {
    ...
    <script>
        window.location.href='https://allmart.world/franchise/admin/login_form.php';
    </script>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <a  class="btn btn-lg  btn-danger" href="https://www.allmart.world/franchise/admin/Users.php">Back</a>
                    </div>
                            </div>
