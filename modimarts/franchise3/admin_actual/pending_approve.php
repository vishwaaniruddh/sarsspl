...
<body class="theme-red">
    ...
    width: 100%;">
                                    <img src="https://modimart.world/assets/logo.png" style="width: 105px;background:white;border-radius: 50%;" >
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                        ...
                                        <? $sql = mysqli_query($con,"select * from new_member where status=2 order by id DESC");
