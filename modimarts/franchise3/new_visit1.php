...
<html lang="en">
  <head>
    ...
    <title>Modi Mart | DoubtX Education Software</title>
    ...
    <div style="display:flex;justify-content:center;margin:1% 7% ;">
		<div class="row" style="display:inline-flex;" id="html-content-holder">
			<div class=" col left-section  px-0">
				<img src="visiting_assets/doubtx_left.jpg" style="height: 600px;    width: 100%;" >
				<!-- <P>hello world</p> -->
			</div>
			
			<div class=" col right-section px-0 text-right">
			    
				<img src="visiting_assets/modi-logo.png" align="center"  width="220" height="50">
...
<div id="previewImage" style="display:none;"><canvas width="992" height="1508"></canvas></div>
<!--style="display:none;"-->
...
$(document).ready(function() { //alert(2);
    ...
    var getCanvas;
    // $('#btn-Convert-Html2Image').click(function(){ alert(4);
        	html2canvas(element, {
                  scale: 5,
