...
<body>
    ...
    width: 100%;">
                    ...
                    <span style="margin: auto 5%; color:white;">ModiMart</span>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                    ...
                                    <tbody>
                                         ...
                                         <?
                                         $sql = mysqli_query($con3,"select * from commission_details where commission_to ='".$id."' and status=1");  
...
?>
                    ...
                    <tr>
                        <td><? echo $i;?></td>
                        <td><? echo $sql_result['txn_id'];?></td>
                        <td><? echo round($sql_result['amount'],2);?></td>
                        <td><? echo $date;?></td>
                    </tr>
