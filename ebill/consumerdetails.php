    ...
    $id = $_GET['id'];
	 $cid = $_GET['cid'];
	  $bid = $_GET['bid'];
        ...
        $sql = "select * from ".$cid."_ebill where atmtrackid='".$sid."'";

		$result = mysqli_query($con,$sql);
	$row = mysqli_fetch_row($result);
	$sql = "select site_id from ".$cid."_sites where trackerid='".$sid."'";
...
if(avgbill.value=='')
{
alert("Please Enter Average Bill");
avgbill.focus();
return false;
}
return true
...
<form id="form1" name="form1" method="post" action="updateconsdet.php" onsubmit="return validate(this)">
 <table width="790" border="1" align="center" cellpadding="4" cellspacing="0">
  <tr>
    <td width="146" height="52"><div align="center">TrackerID</div></td>
    <td width="211"><div align="center">
      <p>
        <input type="text" name="bill_id" tabindex="1" value="<?php echo $sid; ?>" readonly="readonly" />
        </p>
      </div></td>
  <td width="29"></td>
    ...
    <td width="248"><div align="center">
      <p>
        <input type="text" name="con_no" tabindex="2" value="<?php echo $row[1]; ?>"/>
      </p>
    </div></td>
  </tr>
  <tr>
 ...
 <td><div align="center">
   <p>
     <input type="text" name="atmid" tabindex="3" value="<?php echo $row[3]; ?>" readonly="readonly" />
   </p>
 </div></td>
    <td width="29"></td>
     <td><div align="center">Distributor</div></td>
     <td><div align="center">
       <input type="text" name="distributor" tabindex="4" value="<?php echo $row[2]; ?>"/>
     </div></td>
  </tr>      
     <tr>
 <td width="146" height="52"><div align="center">Due DATE (Month in numbers Only)</div></td>
   <td><div align="center">
     <input type="text" name="duedate" id="duedate" tabindex="9" value="<?php echo $row[4]; ?>"/>
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><div align="center">Landlord</div></td>
     <td><div align="center">
       <p>
         <input type="text" name="landlord" tabindex="5" value="<?php echo $row[5]; ?>"/>
       </p>
     </div></td>
    </tr>    
<tr>
 <td width="146" height="52"><div align="center">Billing Unit</div></td>
   <td><div align="center">
     <input type="text" name="billunit" id="billunit" tabindex="9" value="<?php echo $row[6]; ?>"/>
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><div align="center">Meter Number</div></td>
     <td><div align="center">
       <p>
         <input type="text" name="meterno" id="meterno" value="<?php echo $row[7]; ?>"/>
       </p>
     </div></td>
    </tr>
<tr>
 <td width="146" height="52"><div align="center">Averarge Bill</div></td>
   <td><div align="center">
     <input type="text" name="avgbill" id="avgbill" value="<?php echo $row[8]; ?>"/>
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><div align="center">Site ID: </div></td>
     <td><div align="center">
     <input type="text" name="siteid" id="siteid" value="<?php echo $site['site_id']; ?>"/>
   </div></td>
</tr>
  <tr><input type="hidden" name="id" value="<?php echo $id; ?>" />
    <td colspan="11" align="center"><input type="hidden" name="cid" value="<?php echo $cid; ?>" /><input type="text" name="trackid" tabindex="3" value="<?php echo $sid; ?>" readonly="readonly" /><input type="submit" value="submit" /> 
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
