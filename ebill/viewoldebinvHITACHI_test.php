...
$sttcode=mysqli_query($con,"select * from hitachi_gst where State like'%".$sndbillqryf['state']."%'");
...
if($sttcodef[2]=="" or $sttcodef[2]=="na"){
    ...
    $sttcodemh=mysqli_query($con,"select * from hitachi_gst where State like '%Maharashtra%'");
...
$arno=$sttcodef['ARN'];    
   ...
   //echo "select * from gst_no_os where state like '%".$sndbillqryf['state']."%' and gst!='na'";
...
<table width="850" cellpadding="0" cellspacing="0">
  ...
  <tr height="17">
    ...
    <td width="300">&nbsp;</td>
     ...
     <td width="302" rowspan="8" align="right" valign="top" style="padding-right:8px"><div align="right">Invoice No:-<span id="invoiceNumber_a"><?php  echo  $invro[5]; ?></span>
    </div>
...
Maharashtra
    ...
    <tr>
        ...
        <tr>
            ...
            <td><span id="invoiceNumber_bb"><?php  echo  $sndbillqryf['invoice2'];  ?></span></td>
        </tr>
  
    <tr>
        <td colspan= align="center" >Date of Invoice:-</td>
        <td colspan=  align="center" ><?php echo $sndbillqryf['date']; ?></td>
...
<?php }
 ...
 $getgstnumos11=mysqli_query($con,"select * from hitachi_gst where State ='".$addrow1[8]."'");
...
<tr>
<td><?php echo  $getgstnumosf11[1]; ?></td>
</tr>
...
<tr>
    <td style="width:150px;">State Code: </td>
    <td><?php echo $statename; ?></td>
</tr>
<tr><td style="width:150px;">GSTIN/Unique ID :- </td>
<td style="text-align:left"><?php echo $gstcode; ?></td>
</tr>
<tr><td style="width:150px;">ARN No. :- </td>
<td style="text-align:left"><?php echo $arno; ?></td>
</tr>
			...
			function formatTwoDecimals($value, $trim)
{
  ...
  <col width="151" />
  <tr height="18">
    <td height="18" colspan="2" align="left">Invoice No:-  
    <span id="invoiceNumber_b"><?php  echo  $invro[9];  ?></span>
    </td>
  </tr>
  <tr height="20">
...
<tr>
  ...
  <td colspan="4" align="right"><b>Grand Total</b></td>
    ...
    $nwtt=round($svgsistotrw[0],2)+round($svgsistotrw[1],2)+round($svgsistotrw[2],2)+round($to,2);
    ?>
