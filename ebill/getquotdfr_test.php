...
// var_dump($_POST['custr']);

$cust_ids = $_POST['custr'];
...
$cust_ids = "'" . implode("', '", $cust_ids) . "'";
	...
	$qry1="select * from quotation1 where 1 ";
// echo $_POST['sup'];

if($_POST['custr']!="")
{
$qry1.=" and cust in ($cust_ids)";
}
 ...
 if($_POST['atm']!="")
	...
	//$qry1.=" and pdate>='".$strt."' and pdate<='". $endt."'";
          ...
          $qry1.=" and id in (Select qid from quotation1ftransfers where status!='0' and date(pdate)>='".$strt."' and date(pdate)<='". $endt."')";
	
	}
 else
{
$qry1.=" and id in (Select qid from quotation1ftransfers where status!='0' )";
}
