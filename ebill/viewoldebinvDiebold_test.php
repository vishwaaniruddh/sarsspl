...
$odooInvoice_a = $invro[24];
$odooInvoice_b = $invro[25];
...
function PrintDiv3() {    
           ...
           popupWin.document.write('<html><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
            popupWin.document.close();
                ...
                function PrintDiv4() {    
           var divToPrint = document.getElementById('page10');
           var popupWin = window.open('', '_blank', 'width=800,height=500');
           popupWin.document.open();
           popupWin.document.write('<html><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
            popupWin.document.close();
             ...
             <a href="#" id="changeInvoice">View with odoo Invoice</a> | <a href="#" onclick="location.reload();">View CSS Invoice</a>
...
$currentdate=date('Y-m-d');
      ...
      $sndbillqry=mysqli_query($con,"select * from send_bill where send_id like '".$_GET['invid']."' ");
        $i=1;
     $sndbillqryf=mysqli_fetch_array($sndbillqry);
   
   
   
   $sttcode=mysqli_query($con,"select * from diebold_gst where State like'%".$sndbillqryf['state']."%'");
...
if($sttcodef[2]=="" or $sttcodef[2]=="na"){
    
    $sttcodemh=mysqli_query($con,"select * from diebold_gst where State like '%Maharashtra%'");
...
$arno=$sttcodef['ARN'];    
   ...
   $getgstnumos1=mysqli_query($con,"select * from gst_no_os where state like '%".$sndbillqryf['state']."%' and gst!='na'");
       $getgstnumosf1=mysqli_num_rows($getgstnumos1);
       if($getgstnumosf1=="0"){
           $getgstnumos=mysqli_query($con,"select * from gst_no_os where state = 'Maharashtra'");
           
       }else{
           
           $getgstnumos=mysqli_query($con,"select * from gst_no_os where state like '%".$sndbillqryf['state']."%'");
       }
       
        $getgstnumosf=mysqli_fetch_array($getgstnumos);
...
<table width="950" cellpadding="0" cellspacing="0">
  ...
  <tr height="17">
    ...
    <td width="220">&nbsp;</td>
     <td width="302" rowspan="8" align="right" valign="top" style="padding-right:8px">
     <div align="left"><b>From,</b> </div>    
     <div align="left"><b>Clear Secured Services Pvt Ltd.   </b> </div>
     <div align="left" width="500px">D-201, Runwal & Omkar ,Esquare, </div>
      <div align="left" width="500px">Near Sion Fort,Sion (East),</div>
       <div align="left" width="500px">MUMBAI-400022</div>
     
     
     
     <div align="left"><b>Invoice No:-<span id="invoiceNumber_a"><?php  echo  $invro[5]; ?></span> </b> </div>
  
    
    <div align="left"><b>Date :- <?php echo date("d-F-Y",strtotime($invro[3])); ?></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
    <div align="left" width="500px"><b>GSTIN/Unique ID :-27AADCC5952H1ZK</b></div></td>
...
<tr height="18">
    ...
    <tr height="18">
    <td height="18" colspan="2"><b>GSTIN/Unique ID :-27AAACD3206C1ZD<b/></td>
    </tr>
    <?php } ?>
</table>
...
<form method="post" action="showEbill.php" ><table border="1" style="border-collapse:collapse; table-layout: fixed; width: 900px;"><thead>
  <tr>
   ...
   <?php }else{?>
    ...
    <th style="overflow: hidden; width: 60px; font-size:small;"  ><div align="center">TICKET ID</div></th> 
...
$ij=0;
  //echo "select * from send_bill_detail where send_id='".$id."'";
	...
	$qshow=	mysqli_query($con,"select Diebold_TicketNo from ebillfundrequests where req_no='".$annr['reqid']."'");
	$qshowdata=mysqli_fetch_array($qshow);	
...
$result = mysqli_query($con,$nsql);
	...
	<td align="center" style="overflow: hidden; width: 28px;">&nbsp;<?php echo $ij; ?></td>
	 ...
	 <td align="center" style="word-break: break-all;overflow: hidden; width: 75px; font-size:small;" >&nbsp;<?php echo $qshowdata[0]; ?></td>
...
?>
<tr><td colspan="<?php if($cid=='FIS03'){echo '6';}else{echo '13';}?>" align="right"><b>Total Billing Amount</b></td>
			...
			function formatTwoDecimals($value, $trim)
{
   ...
   return $fin;
          ...
          <tr height="150px"><td></td></tr>
			...
			<table width="580" align="right" celldpading="0" cellspacing="0" border='0'>
  <col width="151" />
  <col width="151" />
  ...
  <tr>
      <td><b> Clear Secured Services Pvt Ltd.</b></td>
  </tr>
  <tr>
      <td>D-201, Runwal & Omkar ,Esquare,</td>
  </tr>
   <tr>
      <td>Near Sion Fort,Sion (East),</td>
  </tr>
   <tr>
      <td>MUMBAI-400022</td>
  </tr>
  ...
  <tr height="18">
    <td height="18" colspan="2" align="left"><b>Invoice No:-  <span id="invoiceNumber_b"><?php  echo  $invro[9];  ?></span> </td>
 
  
   
  </tr>
  <tr height="20">
    <td width="208" height="20" colspan="2" align="left" ><b>Bill Date :- <?php echo date("d-F-Y",strtotime($invro[3])); ?></b></td>
  ...
  <tr><td><b>GSTIN/Unique ID :-27AADCC5952H1ZK</b></td></tr>
</table>

 <table cellspacing="0" width="400px" cellpadding="0" border='0'>
...
$svgsistot=mysqli_query($con,"select sum(sgst),sum(cgst),sum(igst) from send_bill where send_id='".$id."'");

$svgsistotrw=mysqli_fetch_array($svgsistot);
...
<tr>
   ...
   <td align="right"><?php echo $svgsistotrw[1]; ?>
   </td>
...
<tr>
   ...
   <td align="right"><?php echo $svgsistotrw[0]; ?></td>

</tr>
<tr>
    <td colspan="4" align="right">IGST 18%</td>

   <td align="right"><?php echo $svgsistotrw[2]; ?></td>
...
<tr>
  ...
  <td colspan="4" align="right"><b>Grand Total</b></td>
    ...
    $nwtt=round($svgsistotrw[0])+round($svgsistotrw[1])+round($svgsistotrw[2])+round($to);
    ?>
    <td align="right"><?php echo number_format(round($nwtt),2); ?></td>
...
<div  align="left"> 
<table width="1006">
<tr height="50px"><td colspan="2">(Rs.  <?php $rsword=round($nwtt); $gtot=int_to_words($rsword); echo $gtot." only"; ?>) </td></tr>
...
<tr>
    <tr><td>GSTIN/Unique ID :-27AAACD3206C1ZD</td></tr>
...
<td><table>
    ...
    <tr>
<td width="505" align="left"><b>Clear Secured Services Pvt Ltd.</b></td>
</tr>
<tr>
    <td>D-201, RUNWAL & OMKAR ,ESQUARE,</td>
</tr>
...
<tr>
    ...
    <tr>
<td width="505" align="left"><b>Invoice No:- <span id="invoiceNumber_bb"><?php echo $invro[5]; ?></b></span> </td></tr>
   
    <tr height="20">
    <td width="208" height="20" colspan="" align="left" ><b>Bill Date :- <?php echo date("d-F-Y",strtotime($invro[3])); ?></b></td>
    
  </tr>
    
    <tr>
        <td><b>
            GSTIN/Unique ID :-27AADCC5952H1ZK	
</b>
        </td>
    </tr>
    </table></td>
...
<table cellspacing="0" cellpadding="0" border='1'>
    <tr>
        <td colspan=16 align="center"><h3>Tax Invoice</h3></td>
      
    </tr>
    <tr>
        <td colspan=8 align="center" bgcolor="#eee5fc"><b>Head Office Details</b> </td>
        <td colspan=8 align="center" bgcolor="#eee5fc"><b>Details of Supplier</b><br/>Address of Service provided in state, to be specified if different from billing address.
        </td>
    </tr>  
    <?php 
     ...
     ?>
     <tr>
        <td colspan=8  align="" rowspan=""> <b>Clear Secured Services Pvt Ltd.</b><br/>		
D-201,Runwal & Omkar E-Square, Second Floor, <br/>	
Second Floor, Sion (East), <br/>
<br/>
Mumbai - 400 022<br/>
Maharashtra
        ...
        <td colspan=8  rowspan="" align="">
            <b>Clear Secured Services Pvt Ltd.</b><br/>
        <?php 
        //echo "select * from gst_no_os where state like '%".$sndbillqryf['state']."%'";
        
        
        
        echo  $getgstnumosf['address'];
        ?><br/><br/>
    <table>
    
    <tr>
        <td colspan= align="center" >State</td>
        <td colspan=  align="center" ><?php echo $getgstnumosf['state']; ?><br/></td>
        
    </tr>
    
      <tr>
        <td colspan= align="center" >State Code</td>
        <td colspan=  align="center" ><?php echo $getgstnumosf['state_code']; ?><br/></td>
        
    </tr>
        <tr>
            <td>Serial No. of Invoice:-</td>
            <td><span class="invoiceNumber_b"><?php echo $sndbillqryf['invoice2']; ?> </span></td>
        </tr>
  
    <tr>
        <td colspan= align="center" >Date of Invoice:-</td>
        <td colspan=  align="center" ><?php echo date("d-F-Y",strtotime($sndbillqryf['date'])); ?></td>
        
    </tr>
    
    <tr>
        <td colspan= align="center" >GSTIN/Unique ID :-</td>
        <td colspan=  align="center" ><?php echo $getgstnumosf['gst']; ?><br/></td>
    ...
    <tr>
        <td colspan=8 align="center" bgcolor="#eee5fc"><b>Details of Receipent (Billed to)</b><br/>Details of the person to whom the invoice is billed </td>
        <td colspan=8 align="center" bgcolor="#eee5fc"><b>Details of Consignee (Shipped to)</b><br/>Address of delivery, to be specified if different from billing address.
        </td>
    </tr>  
    <tr>
    ...
    <tr>
<?php
//echo "select * from eps_gst where State like'%".$sndbillqryf['state']."%'";

if($addrow1[18]!=''){ ?><tr height="18">
...
<?php }
 ...
 $getgstnumos11=mysqli_query($con,"select * from diebold_gst where State='".$addrow1[8]."'");
       
       
        $getgstnumosf11=mysqli_fetch_array($getgstnumos11);
   
?>

<tr>
<td><?php echo  $getgstnumosf11["State"]; ?></td>
</tr>

<tr>
    <td>State Code: </td>
    <td><?php 
 //   echo "select * from gst_no_os where state like '%".$addrow1[8]."%'";
    
        
        
    
    
    echo $getgstnumosf11['state_Code']; ?></td>
</tr>
<tr><td>GSTIN/Unique ID :- </td>
<td><?php echo $getgstnumosf11['GSTIN']; ?></td>
</tr>
...
<td><?php echo ""; ?></td>
    ...
    <tr>
    <td><b>Diebold Nixdorf India Private Limited</b></td>
    </tr>
    <tr>
        <td colspan="2"><?php echo $sttcodef['address']; ?><br/><br/></td>
    </tr>
...
<tr>
    <td style="width:250px;">State Code: <?php echo $statename ?></td>
    <td></td>
</tr>
<tr><td style="width:350px;">GSTIN/Unique ID :- <?php echo $gstcode; ?></td>
<td style="text-align:left"></td>
</tr>
<tr><td style="width:250px;">ARN No. :- <?php echo $arno; ?></td>
<td style="text-align:left"></td>
</tr>

<tr><td style=""> SC Po Number. :-<?php echo $invro[21];?></td></td></tr>

<tr>
    <td>
Po date. :-<?php  if($invro[22]!="" && $invro[22]!="0000-00-00"){ echo date("d-F-Y",strtotime($invro[22])); }?> </td>
</tr>

<tr><td style="width:250px;"> Approval date. :-<?php  if($invro[23]!="" && $invro[23]!="0000-00-00"){ echo date("d-F-Y",strtotime($invro[23])); }?> </td>
</tr>
     ...
     <tr>
        ...
        <td colspan=2 align="center" bgcolor="#bae2ef">CGST</td>
        <td colspan=2 align="center" bgcolor="#bae2ef">SGST</td>
        <td colspan=2 align="center" bgcolor="#bae2ef">IGST</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Total Amount</td>
    </tr>
     <tr>
        <td colspan=0 align="center" bgcolor="#bae2ef">S.No.</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Description</td>
        <td colspan=2 align="center" bgcolor="#bae2ef">Service Accounting Code</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Qty.</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Unit.</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Rate</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Discount</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Taxable Amount</td>
        <td colspan=0 align="center" bgcolor="#bae2ef"> Rate </td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Amt.</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Rate</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Amt.</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Rate</td>
        <td colspan=0 align="center" bgcolor="#bae2ef">Amt.</td>
    ...
    <?php 
    /*
        $sndbillqry=mysqli_query($con,"select * from send_bill where send_id='".$_GET['invid']."' ");
   
     $sndbillqryf=mysqli_fetch_array($sndbillqry);*/
          $i=1;
          $sndbillqrydtls=mysqli_query($con,"select sum(srvchrg),sum(discon_chrg) from send_bill_detail where send_id='".$_GET['invid']."' and status=0 ");
     
        $sndbillqrydtlscnt=mysqli_query($con,"select * from send_bill_detail where send_id='".$_GET['invid']."' and status=0 ");
     
        $sndbillqrydtlsfnm=mysqli_num_rows($sndbillqrydtlscnt);
     $sndbillqrydtlsf=mysqli_fetch_array($sndbillqrydtls);
         $pstg="";
        if($sndbillqryf['cgst']!="0.00"){
            
            $pstg="9%";
            $cgstamt=$sndbillqryf['cgst'];
            $sgstamt=$sndbillqryf['sgst'];
            
        }
         if($sndbillqryf['igst']!="0.00"){
            
            $pstg1="18%";
            $igstamt=$sndbillqryf['igst'];
        }
        
    ?>
     <tr>
        <td colspan=0 align="center" ><?php echo $i; ?></td>
        <td colspan=0 align="">Electricity Bill</td>
        <td colspan=2 align="center">998599</td>
        <td colspan=0 align="right"><?php echo $sndbillqrydtlsfnm; ?></td>
        <td colspan=0 align="right"><?php echo $sndbillqrydtlsfnm; ?></td>
        <td colspan=0 align="right"><?php echo $sndbillqrydtlsf[0]/$sndbillqrydtlsfnm; ?></td>
        <td colspan=0 align="right"><?php echo $sndbillqrydtlsf[1]; ?></td>
        <td colspan=0 align="right"><?php $ttltax=$sndbillqrydtlsf[0]-$sndbillqrydtlsf[1]; echo $ttltax; ?></td>
        <td colspan=0 align="right"><?php echo $pstg; ?></td>
        <td colspan=0 align="right"><?php echo $cgstamt; ?></td>
        <td colspan=0 align="right"><?php echo $pstg; ?></td>
        <td colspan=0 align="right"><?php echo $sgstamt; ?></td>
        <td colspan=0 align="right"><?php echo $pstg1; ?></td>
        <td colspan=0 align="right"><?php echo $igstamt; ?></td>
        <td colspan=0 align="right"><?php echo $sndbillqryf['servchrg']; ?></td>
    ...
    <tr>
        <td colspan=4 align="" >Total Invoice Value(In Figure) :-</td>
       
        <td colspan=6 align="">Rs.<?php echo $sndbillqryf['servchrg']; ?>/-</td>
       
        
        
    </tr>
    <tr>
        <td colspan=4 align="" >Total Invoice Value(In Words) :-</td>
        
        <td colspan=6 align=""><p align="left"><b>  <?php $st=int_to_words(round( $sndbillqryf['servchrg'])); echo $st." Only /-";
 ...
 ?>  </td>
    ...
    <tr>
        <td colspan=5 align="" >Whether tax payable under reverse charge?</td>
      
        <td colspan=2 align="">Yes/ No</td>
    ...
    <tr>
        <td colspan=5 align="" >Tax payable by the customer</td>
        <td colspan=2 align="">NO</td>
        <td colspan=3 align="center"></td>
        
        
    </tr>
    <tr>
        <td colspan=5 align="" >Tax payable by FIS</td>
        <td colspan=2 align="">NO</td>
        <td colspan=3 align="center"></td>
    ...
    <tr>
        ...
        <td colspan="6" align="center" style="border-top:none;border-bottom:none;"> </td>
    </tr>
     <tr>
...
<a onclick='PrintDiv4(); 'href="#" onMouseOver="this.style.textDecoration='underline'" 
onmouseout="this.style.textDecoration='none'" ><font size='+2' color="#993333"> Print Page 4 </font></a>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<a href="generateEbill.php?cid=<?php echo $cid ?>&bid=<?php echo $bid ?>" onMouseOver="this.style.textDecoration='underline'" 
onmouseout="this.style.textDecoration='none'" ><font size='+2' color="#993333"> Back </font></a>
 <?php //} ?>
...
<script>
    $(document).on('click','#changeInvoice',function(){
        
        $("#invoiceNumber_a").html('<? echo $odooInvoice_a; ?>'); 
        $("#invoiceNumber_b").html('<? echo $odooInvoice_b; ?>');
        $("#invoiceNumber_bb").html('<? echo $odooInvoice_b; ?>');
        $(".invoiceNumber_b").html('<? echo $odooInvoice_b; ?>');
