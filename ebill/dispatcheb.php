...
<!--<select name="dispt" id="dispt" onchange="searchById('Listing','1','');" >
<option value="">Waiting to Dispatch</option>
<option value="0">Dispatched Bills</option>
<option value="1">Revised Bills</option>
<option value="-1">All</option>
</select>-->
           
           
           <!--<input type="text" name="bank" id="bank" onkeyup="searchById('Listing','1','');" placeholder="Bank"/>-->
    <input type="hidden" name="atmid" id="atmid" onkeyup="searchById('Listing','1','');" placeholder="ATM"/>
   
    <input type="hidden" name="area" id="area" onkeyup="searchById('Listing','1','');" placeholder="location"/> 
    <input type="hidden" name="address" id="address" onkeyup="searchById('Listing','1','');" placeholder="Address"/>
    <input type="hidden" name="zone" id="zone" onkeyup="searchById('Listing','1','');" placeholder="Zone"/>         
    ...
    <input type="text" name="invoice_no" id="invoice_no" onblur="searchById('Listing','1','');" placeholder="Invoice No."/>
