...
$damt=$netam-($paidamt+$paidamt2+$paidamt3+$paidamt4+$paidamt5)-($podtotal+$disputeamt);
$udtqrydiffamt=mysqli_query($con,"UPDATE `fundaccounts` SET debit2017='".$damt."' where aid='".$_POST['sup']."'");
?>
