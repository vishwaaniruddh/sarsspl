...
if($_POST['sdate']!='' & $_POST['edate']!='')
 ...
 $qry="Select * from quotation1 where ((status='a' or status='app') and category='a') and rnm_invoice_status=0";
...
$qry.=" and id in(".$qidtostr.")";
 ...
 if($_POST['state']!="")
	...
	if($_POST['project']!="")
	{
	$qry.=" and project_id='".$_POST['project']."'";
	} 
...
{ echo round($approw[9]); $apptotamt=$apptotamt+round($approw[9]); }?>

<input type="text" id="aprmth<?php echo $srn;?>" value="<?php echo round($approw[9]);?>" readonly>
...
<td><input type="checkbox" name="clbillqid[]" id="clbillqid<?php echo $srn;?>" value="<?php echo $row[0]; ?>" onchange="calctotmt();" /></td>
...
<td align="center"><b><input type="text" id="fnamt"  readonly><b> 
