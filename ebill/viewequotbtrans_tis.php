...
//echo "select * from ebfundtransfers where chqno='".$tid."' and status=0";
       $tra=mysqli_query($con,"select * from quotation1ftransfers_tis where tid='".$tid."' and status!=0");
...
$qry1=mysqli_query($con,"select distinct(accid) from quotation1ftransfers_tis where tid='$tid' and status!=0 and accid<>90");
$ct=1;
...
<?php
 ...
 $qry3=mysqli_query($con,"select accid,qid from quotation1ftransfers_tis where chqno='$tid' and accid=90 and status=0");
//$ct=1;
...
$qry3=mysqli_query($con,"select tamout from quotation1ftransfers_tis where qid ='".$qrrow3[1]."'");
...
<br><br>									
      ...
      <a href="ebillreqapprovals_tis.php" >HOME</a>      
</center></body>
</head>
</html>
<?php
