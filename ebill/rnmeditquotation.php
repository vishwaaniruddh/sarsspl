...
$.ajax({
            ...
            success: function(msg){
                ...
                alert(msg);
                window.open('rnmeditquotation.php?qid='+quotid,'_self');
...
window.open('rnmeditquotation.php?qid='+qid,'_self');
            }           
       });
...
$.ajax({
            type: "POST",
            url: "process_quotation_cancelrnm.php",
            data:fd,
           contentType: false,
            cache: false,
            processData:false,
