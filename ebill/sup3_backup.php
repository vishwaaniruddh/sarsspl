...
?><div class=article>
<div class=title><tr>
<td width="25"><?php echo $cnt."<br/>".$app[1]; ?></td>
<td width="200">
<?php echo $rx[1]."/".$rx[2]; ?>
</td>
...
if($req=="")
$ebpay=mysqli_query($con,"select * from ebpayment where  Bill_No in(select r.req_no from ebillfundrequests r,fundaccounts a where r.supervisor=a.hname and a.aid='".$_POST['sup']."') and upby!='' and entrydt>='2015-04-01 00:00:00'");
else
$ebpay=mysqli_query($con,"select * from ebpayment where  Bill_No in(select r.req_no from ebillfundrequests r,fundaccounts a where r.req_no not in($req) and r.supervisor=a.hname and a.aid='".$_POST['sup']."') and upby!='' and entrydt>='2015-04-01 00:00:00'");
...
$ebpay=mysqli_query($con,"select * from ebonacctransfers where  accid='".$_POST['sup']."' and pdate>='2015-04-01'");
...
$trans_qry=mysqli_query($con,"SELECT * FROM `transfer` where  to_accid='".$_POST['sup']."' and status=1 and pdate>='2015-04-01'");
...
$trans_qry=mysqli_query($con,"SELECT * FROM `transfer` where  from_accid='".$_POST['sup']."' and status=1 and pdate>='2015-04-01'");
...
$paidamt6=0;
$x=0;
$rev_qry=mysqli_query($con,"SELECT * FROM `reversal` where  accid='".$_POST['sup']."' and status=1 and pdate>='2015-04-01'");
...
//echo $paidamt+$paidamt2+$paidamt3+$paidamt4+$paidamt5+$paidamt6+$opening_fund[2];
  ?>
  </td><td><?php echo $paidamt+$paidamt2+$paidamt3+$paidamt4+$paidamt5+$paidamt6; ?></td><td colspan=8 align='right' >&nbsp;</td></tr>
