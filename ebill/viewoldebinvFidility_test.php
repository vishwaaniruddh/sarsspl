...
$currentdate=date('Y-m-d');
   ...
   $sttcode=mysqli_query($con,"select * from fis_gst where State like'%".$sndbillqryf['state']."%'");
...
if($sttcodef[2]=="" or $sttcodef[2]=="na"){
    ...
    $sttcodemh=mysqli_query($con,"select * from fis_gst where State like '%Maharashtra%'");
$sttcodefmh=mysqli_fetch_array($sttcodemh);
$statename=$sttcodefmh['state_code'];
$statename1=$sttcodefmh[1];
$gstcode=$sttcodefmh[2];
}else{
...
<table width="850" cellpadding="0" cellspacing="0">
  ...
  <tr height="17">
    ...
    <td width="300">&nbsp;</td>
     <td width="302" rowspan="8" align="right" valign="top" style="padding-right:8px"><div align="left">Invoice No:-<?php 
   echo  $invro[5]; ?>
    </div>
    <div align="left">Date :- <?php echo date("d-F-Y",strtotime($invro[3])); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
...
<tr height="18">
  ...
  <?php
  $getgstnumos11n=mysqli_query($con,"select * from fis_gst where state= 'Maharashtra'");
    $getgstnumosf11n=mysqli_fetch_array($getgstnumos11n);
...
<table width="850"  border="0">
  ...
  <tr>
  <td  height="45"><b>Sub:</b>&nbsp;&nbsp; Settlement Of Electricity Bills.</td>
  </tr>
...
<form method="post" action="showEbill.php" ><table border="1" style="border-collapse:collapse; table-layout: fixed; width: 900px;"><thead>
  <tr>
   <?php if($cid=='FIS03'){?>
		...
		<th style="overflow: hidden; width: 124px;" colspan="2"><div align="center">BILLING PERIOD
		</div></th>    
...
Maharashtra
        ...
        ?><br/><br/>
        <div align="left"><b>PO No :-</b> 435640008002&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    </div>
    ...
    <table>
        ...
        <tr>
            ...
            <td><?php echo $sndbillqryf['invoice2']; ?></td>
        </tr>
    ...
    <tr>
     ...
     <tr>
        <td colspan="2"><b><?php echo $addrow1[3]; ?></b></td>
    </tr>
    
    <tr>
        <td colspan="2"><?php echo $sttcodef[3]; ?><br/><br/></td>
    </tr>


<tr>
    
    <td>State</td>  <td><?php   echo $statename1; ?></td>
    </tr>
...
<td><?php echo $gstcode; ?></td>
    ...
    // echo "select sum(srvchrg),sum(discon_chrg) from send_bill_detail where send_id='".$_GET['invid']."' and status=0 ";
          $i=1;
    ...
    ?>
     <tr>
       ...
       <!-- <td colspan=0 align="right"><?php echo $sndbillqrydtlsfnm; ?></td>-->
       <td colspan=0 align="right">NO</td>
     ...
     <tr>
      ...
      <tr>
        ...
        <td colspan="6" rowspan="8" align="center"> </td>
    </tr>
    <tr>
 ...
 ?>  </td>
     ...
     <tr>
        ...
        <td colspan="10" rowspan="4"  align="center" style="height:100px;"> </td>
...
<div id="page5">
    <table border="1">
        ...
        <?php 
            $viewsndbill=mysqli_query($con,"select * from send_bill_detail where send_id='".$id."' and status=0");
            $i=1;
            $totalamount=0;
        while($viewsndbillf=mysqli_fetch_array($viewsndbill)){
            
             $viewsndbillfssbill=mysqli_query($con,"select * from FIS03_ebill where atmtrackid='".$viewsndbillf['atm_id']."'");
           
       $viewsndbillfssbillf=mysqli_fetch_array($viewsndbillfssbill);
            
             $viewsndbillfissite=mysqli_query($con,"select * from FIS03_sites where trackerid='".$viewsndbillf['atm_id']."'");
           
       $viewsndbillfsssitef=mysqli_fetch_array($viewsndbillfissite);
            
            
             $viewsndid=mysqli_query($con,"select * from send_bill where send_id='".$viewsndbillf['send_id']."'");
           
       $viewsndidf=mysqli_fetch_array($viewsndid);
        ...
        <tr>
            <td><?php echo $i; ?></td>
            <td><?php echo $viewsndbillfsssitef['projectid']; ?></td>
            <td><?php echo $viewsndbillfsssitef['bank']; ?></td>
            <td><?php echo $viewsndbillfsssitef['atm_id1']; ?></td>
            <td><?php echo $viewsndbillfsssitef['location']; ?></td>
            <td><?php echo $viewsndbillfsssitef['state']; ?></td>
            <td><?php echo date("M-Y", strtotime($viewsndbillf['usdate']));
            ?> to <?php echo date("M-Y", strtotime($viewsndbillf['uedate'])); ?></td>
            <td><?php echo $viewsndbillf['srvchrg'];
            $totalamount=$totalamount+ $viewsndbillf['srvchrg'];
            ?></td>
            <td><?php echo $viewsndidf['invoice2']; ?></td>
            <td><?php echo date("d-M-Y", strtotime($viewsndidf['date'])); ?></td>
        </tr> 
        <?php  $i++;  } ?>
        <tr>
            <td colspan="6" ></td>
