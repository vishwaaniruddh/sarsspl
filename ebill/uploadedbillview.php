  ...
  <th>Atm ID</th>
	...
	<?php	while($row = mysql_fetch_row($result))
		...
		//echo "select bank,csslocalbranch,zone,state,city,location,atmsite_address,takeover_date from ".$row[14]."_sites where atm_id1='".$row[1]."'<br>";
			...
			$qry=mysql_query("select bank,csslocalbranch,zone,state,city,location,atmsite_address,takeover_date from ".$row[14]."_sites where atm_id1='".$row[1]."'");

		$ro=mysql_fetch_row($qry);
