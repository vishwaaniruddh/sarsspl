...
<table width="850" cellpadding="0" cellspacing="0">
  ...
  <tr height="17">
    ...
    <td width="300">&nbsp;</td>
     <td width="302" rowspan="8" align="right" valign="top" style="padding-right:8px"><div align="right">Invoice No:-<span id="invoiceNumber"><?php 
   echo  $invro[5]; ?></span> 
    </div>
...
<script>
    $(document).on('click','#changeInvoice',function(){
        ...
        $("#invoiceNumber").html('<? echo $odooInvoice_a; ?>'); 
