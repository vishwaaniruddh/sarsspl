...
$qry=mysqli_query($con,"select * from  quotation1ftransfers where tid='".$_GET['tid']."'");
...
alert(msg);
window.open('view_quotrans.php','_self')
...
<input type="button" name="bck" id="bck" value="Back" onclick="window.open('view_quotrans.php','_self');"></td>
</tr>
</table>
</center>
