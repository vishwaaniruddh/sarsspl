...
$result1 = mysqli_query($con,"SELECT DISTINCT cust_name, cust_id FROM newtempsites where ebill='Y' and cust_id<>'' order by cust_name ASC");		
$result2 = mysqli_query($con,"SELECT DISTINCT project FROM newtempsites where ebill='Y' order by project ASC");		
 ?>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1" />
<title>Temporary Ebill sites</title>
...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		...
		//  var calltype=document.getElementById('calltype').value;
			 ...
			 var myapp=document.getElementById('myapp').value;
			  }
			 // alert(br);
			//alert("gg"); 
			var url = 'searchlevel1ebill_data.php'; 
		//  }
 	//alert(br);
 	//alert(dt);
		    var pmeters="";
			...
			if(a!="Loading"){ 
			 pmeters = 'atmid='+id+'&cid='+cid+'&area='+area+'&bank='+bank+'&Page='+b+'&perpg='+ppg+"&address="+address+"&zone="+zone+"&dt="+dt+"&dt2="+dt2+"&proj="+proj+"&myapp="+myapp;
			// alert(pmeters);
			}
			else
			{
...
//echo $_SESSION['branch'];
 ?>
  ...
  <h2 class="style1"> MANAGE TEMPORARY EBill SITES</h2>
  <a href="uploadebilldetails.php">  Upload data with Consumer Details</a>
...
<p align="center">
   ...
   <select name=myapp id="myapp">
   <option value="ebill">My Approval</option>
