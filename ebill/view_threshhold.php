...
<table border="1" cellpadding="2" cellspacing="2">
	...
	<tr>
        ...
        <td>
        	...
        	<select name="bank" id="bank" required="required" ><option value="">select Bank</option></select>

        </td>

        <td>

        	<select name="proj" id="proj" required="required" ><option value="">select Project</option></select>
