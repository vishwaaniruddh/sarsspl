...
$qry=mysqli_query($con,"SELECT sum(tamount),`tid`, `qid`, `accid`, `pdate`, `chq_name`, `chqno`, `dbtaccno`, `tamount`, `entrydt`,email_body,mail_by FROM `quotation1ftransfers_tis` where tid='".$tid."' GROUP BY accid");
