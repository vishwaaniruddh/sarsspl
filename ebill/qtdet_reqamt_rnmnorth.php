...
$srqry=mysqli_query($con,"select srno from login where username='".$_SESSION['user']."'");
	...
	/*echo "Insert into `quotation1_req`(`qid`, `req_amt`, `remark`, `reqby`, `entrydt`)values('".$qid."','".$upreqamt."','".$uprem."','".$srno[0]."','".$dt."')";*/
...
$errors++;
		...
		$upqr=mysqli_query($con,"update quotation1 set p_stat='3',supervisor='".$sup."' where id='".$qid."'");
		if(!$upqr)
{
