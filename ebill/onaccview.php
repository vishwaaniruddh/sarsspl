...
<?php
	if(isset($_SESSION['success']))
	{
		...
		{
?>
alert("Request processing failed please try again !")
<?php
		}
...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		...
		var desig=document.getElementById('desig').value;
			...
			var url = 'searchonaccreq.php';
	var pmeters="";
	if(a!="Loading"){ 
			 pmeters = 'cid='+cid+'&Page='+b+'&perpg='+ppg+'&sdate='+sdate+'&edate='+edate+'&desig='+desig+'&service='+serv+'&dept='+dept+'&pstat='+pstat+'&atm='+atm;
			}//alert("gg");
			else
			{
...
//alert(xmlhttp.responseText);
   ...
   // alert("Fund Approved");
	document.getElementById("app"+cnt).innerHTML=st;
		...
		//document.getElementById("app"+cnt).innerHTML=xmlhttp.responseText;
	 alert("Some Error Occurred");
    }
  }
 var rem=document.getElementById("rem"+cnt).value;
 // alert("apponacfund.php?id="+id+"&stat="+stat+"&rem="+rem+'&amt='+amt);
xmlhttp.open("GET","apponacfund.php?id="+id+"&stat="+stat+"&rem="+rem+'&amt='+amt,true);
xmlhttp.send();
}
...
//alert(xmlhttp.responseText);
 ...
 var rem=document.getElementById("rem"+cnt).value;
// alert("apponacfund.php?id="+id+"&stat="+stat+"&rem="+rem+'&amt='+amt);
xmlhttp.open("GET","apponacfund.php?id="+id+"&stat="+stat+"&rem="+rem+'&amt='+amt+"&chk="+chkno,true);
xmlhttp.send();
}
