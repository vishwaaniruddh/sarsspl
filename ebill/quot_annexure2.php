...
$.ajax({
   type: 'POST',    
url:'search_quotationannex2.php',
 beforeSend: function()
                   {
        
                  document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
                  },
data:'cid='+cid+'&sdate='+sdate+'&edate='+edate+"&atmid="+atmid+"&qid="+qid+'&perpg='+perp+'&Page='+Page+'&bank='+bank+'&accname='+accname,
success: function(msg){
...
function updtinvfunc(qid,btnid,inputid,spanid)
{
    ...
    try
    {
        ...
        {
        var invno=document.getElementById(inputid).value.trim();
        
        $.ajax({
   type: 'POST',    
url:'updt_rnm_upld_invno.php',
data:{qid:qid,invno:invno},
success: function(msg){
...
{
    //alert()
document.getElementById(spanid).innerHTML=invno;  
