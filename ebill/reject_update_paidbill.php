...
<body>
<center><h2>Rejection Bill Details </h2>
<form name="form" method="get" action="process_reject_update_paidbill.php" onsubmit="return validate(this)">
<div>
<table width="100%">
<tr>
<th>Email :</th><td><input type="text" name="rejemail" required id="rejemail" value="<?php //echo $row[5]; ?>"></td>
</tr>
<tr>
<th>CCEmail :</th><td><textarea rows="5" name="rejccemail" required id="rejccemail"></textarea></td>
</tr>
<tr>
...
<ol>
<?php
$qry=mysqli_query($con,"select * from rejection_updatebill where status='1'");
while($row=mysqli_fetch_array($qry))
{
?>
<li><input type="checkbox" name="reason[]" value="<?php echo $row['id']; ?>" onchange="reasonCheck(this.id)"/><b><?php echo $row['reason']; ?></b><br /></li>
<?php
}
?>
</ol>
...
<tr>
<th>Remarks:</th><td><input type="text" name="reason1" id="reason1" placeholder="Remarks" >
