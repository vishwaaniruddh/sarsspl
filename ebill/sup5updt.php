...
<tr><td colspan=2 align='right' >Difference Amount </td><td align='CENTER' ><?php echo $updtamtfinal=$netam-($paidamt+$paidamt2+$paidamt3+$paidamt4+$paidamt5)-($podtotal+$disputeamt); ?></td><td></td><td colspan=10 align='right' >&nbsp;</td></tr>
<?php
    ...
    $accsop=mysqli_query($con,"select * from fundaccounts_opbal where aid='".$_POST['sup']."' and financial_year='2018-2019'");
$rxop=mysqli_fetch_row($accsop);
$nrw=mysqli_num_rows($accsop);

if($nrw>0)
{
    $qrt=mysqli_query($con,"update fundaccounts_opbal set opbal='".$updtamtfinal."' where aid='".$_POST['sup']."' and financial_year='2018-2019'");
    
    echo mysqli_error();
}else
{
    
       $qrt=mysqli_query($con,"insert into fundaccounts_opbal(aid,opbal,financial_year)values('".$_POST['sup']."','".$updtamtfinal."','2018-2019')");
