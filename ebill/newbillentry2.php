...
<head>
  ...
  <!--<script type="text/javascript" src="3.7.1.jquery.min.js"></script>-->
...
day (usually either today's date or the current date field value) */
  ...
  <style>
        ...
        #cmdsub:hover {
          background-color: #33b249; /* change to your desired color */
          color: white; /* change to your desired color */
        }
        
        #update:hover {
          background-color: #80669d; /* change to your desired color */
          color: white; /* change to your desired color */
        }
...
<body onload="showatm()">
  ...
  <form id="form1" name="form1" method="post" action="processbillentry.php" onsubmit="return validate(this)"
    autocomplete="OFF" enctype="multipart/form-data">
    <center><input type="text" name="err" id="err" readonly="readonly" /></center>
    <center>
      <div id="bckpod" name="bckpod"><a href="view_ebill_package.php?podfbill=<?php echo $podno; ?>">Back to POD</a>
      </div>
      <center>
        <input type="text" style="display:none" name="atmno" id="atmno" value="<?php echo $atmd; ?>"
          readonly="readonly" />
        <input type="text" style="display:none" name="pidnumber" id="pidnumber" value="<?php echo $pidno; ?>"
          readonly="readonly" />
        <input type="text" style="display:none" name="podnumber" id="podnumber" value="<?php echo $podno; ?>"
          readonly="readonly" />
        <input type="text" style="display:none" name="supid" id="supid" value="<?php echo $supvid; ?>"
          readonly="readonly" />
        <input type="hidden" name="fiscalyr" id="fiscalyr"
          value="<?php
          if (date('m') >= '4') {
          ...
          <tr>
            ...
            <td valign="top">
              <table width="790" border="1" align="center" cellpadding="4" cellspacing="0">
                <tr>
                  <td width="146" height="52">
                    <div align="center">Select Client</div>
                  </td>
                  <td>
                    <div align="center">
                      <p>
                  ...
                  <td width="29"></td>
                  <td>
                    <div align="center">ATM ID</div>
                  </td>
                  <td>
                    <div align="center"><input type="text" name="atmid" id="atmid"
                        value="<?php if ($atmd != "")
                          echo $atmd; ?>" onblur="getdetails(this.value,'atm_id1');" />
                ...
                <tr>
                  ...
                  <td>
                    <div align="center">Project ID</div>
                  </td>
                  <td>
                    <div align="center">
                ...
                <tr>
                  ...
                  <td>
                    <div align="center">Distributor</div>
                  </td>
                  <td>
                    <div align="center">
                      <!--<input type="text" name="distributor" id="distributor" />-->
                      <select name="distributor" id="distributor" style="width:350px">
                        <option value="" width="60px">select Provider</option>
                        <?php
                        ...
                        while ($spro = mysqli_fetch_array($sp)) {
                          ?>
                          <option value="<?php echo $spro[0]; ?>">
                            <?php echo $spro[1] . " (" . $spro[0] . ")"; ?>
                            <?php
                        }
                        ?>
                      </select>
                ...
                <tr>
                  <td width="146" height="52">
                    <div align="center">Tracker ID</div>
                  </td>
                  <td width="211">
                    <div align="center">
                      <p>
                  ...
                  <td width="29"></td>
                  <td width="122">
                    <div align="center">Consumer No</div>
                  </td>
                  <td width="248">
                    <div align="center">
                      <p>
                      <div id='divcon_no' style="display:block">
                        <input type="checkbox" name="cons" id="cons" />&nbsp;&nbsp;Search<br> <input type="text"
                          name="con_no" id="con_no" onblur="getdetails(this.value,'Consumer_No');" />
                      </div><br />
                      <!--<input type="checkbox" name="cons" id="cons" onclick="getdetails(this.value,'Consumer_No');" >&nbsp;&nbsp;
                              <div id='divcon_no2' style="display:none">
                            <input type="text" name="newcons" id="newcons" >-->
                    </div>
                    </p>
                    </div>
                  </td>
                ...
                <tr>
                  <td width="146" height="52">
                    <div align="center">Due DATE (Month in numbers Only)</div>
                  </td>
                  <td>
                    <div align="center">
                ...
                <tr>
                  <td width="146" height="52">
                    <div align="center">Billing Unit</div>
                  </td>
                  <td>
                    <div align="center">
                  ...
                  <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td>
                    <div align="center">Meter Number</div>
                  </td>
                  <td>
                    <div align="center">
                      <p>
                ...
                <tr>
                  <td width="146" height="52">
                    <div align="center">Averarge Bill</div>
                  </td>
                  <td>
                    <div align="center">
                  ...
                  <td align="center"><input type="text" name="bill_date" id="bill_date"
                      onclick="displayDatePicker('bill_date');" /></td>
                </tr>
                <tr>
                  <td width="146" height="52">
                  ...
                  <td align="center"><input type="text" name="todt" id="todt" onclick="displayDatePicker('todt');" />
                  </td>
                </tr>
                <tr>
                  <td width="146" height="52">
                  ...
                  <td align="center"><input type="text" name="openr" id="openr" onkeyup="calc('openr','closer');" />
                  </td>
                </tr>
                <tr>
                  <td align="center">Close Reading</td>
                  <td align="center"><input type="text" name="closer" id="closer" onkeyup="calc('openr','closer');" />
                  </td>
                  <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td width="146" height="52">
                ...
                <tr>
                  <td width="146" height="52">
                    <div align="center">Extra Charge</div>
                  </td>
                  <td>
                    <div align="center">
                ...
                <tr>
                  ...
                  <td align="center"><input type="text" name="paiddt" id="paiddt"
                      onclick="displayDatePicker('paiddt');" /></td>
                  <td width="146" height="52">
                    ...
                    <div align="center">
                      <select name="sv" id="sv">
                        ...
                        if ($supvid == "") {
                          ...
                          ?>
                          <option value="<?php echo $supn[0]; ?>" selected="selected">
                            <?php echo $supn[0]; ?>
                          </option>
                          <?php
                ...
                <tr>
                  <td align="center">Reconnection Charge</div>
                  </td>
                  <td align="center"><input type="text" name="recon_chrg" id="recon_chrg"
                      onkeypress="return isNumberKey(event);" /></td>
                  <td align="center" width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td align="center">Disconnection Charge</td>
                  <td align="center"><input type="text" name="discon_chrg" id="discon_chrg"
                      onkeypress="return isNumberKey(event);" /></td>
                </tr>
                <tr>
                  <td align="center">Security Deposit</div>
                  </td>
                  <td align="center"><input type="text" name="sd" id="sd" onkeypress="return isNumberKey(event);" />
                  </td>
                  <td align="center" width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                  <td align="center">After due date charges</td>
                  <td align="center"><input type="text" name="after_duedt_chrg" id="after_duedt_chrg"
                      onkeypress="return isNumberKey(event);" /></td>
                </tr>
                <tr>
                  <td width="146" height="52">
                    <div align="center">Attach email</div>
                  </td>
                  <td>
                    <div align="center"><input type="file" name="email_cpy" id="email_cpy"></div>
                  </td>
                  <td>&nbsp;</td>
                  <td>
                    <div align="LEFT">
                ...
                <tr>
                  ...
                  <td align="left" colspan=""><select name="ptype" id="ptype">
                      <option value="paid">Paid</option>
                      <option value="unpaid">Unpaid</option>
                    </select></td>

                  <td align="center">Payment Type</td>
                  <td align="left" colspan="5"><select name="ptp" id="ptp">
                ...
                <tr>
                  <td colspan="11" align="center"><input type="hidden" name="stat" id="stat" value="paid" />
                    ...
                    <!--<input type="button" value="submit" id="cmdsub" name="cmdsub">-->
                    ...
                    <div style="display: none;" id="disp"> <textarea id="rem"></textarea><input type="file" name="file"
                        id="upload" value="Upload" /><input type="button" id="go" value="Go" onclick="processfunc();" />
                    </div>
