...
while($rowarr=mysqli_fetch_array($sqry))
{
    ...
    $sheet->setCellValueByColumnAndRow('A', $row, $srn);
    $sheet->setCellValueByColumnAndRow('B', $row,$cat);
    $sheet->setCellValueByColumnAndRow('C', $row,$mdby1);
    $sheet->setCellValueByColumnAndRow('D', $row,$rowarr[1]);
    $sheet->setCellValueByColumnAndRow('E', $row,$qname[0]);
    $sheet->setCellValueExplicitByColumnAndRow('F', $row, $rowarr[5]);
    $sheet->setCellValueByColumnAndRow('G', $row, $rowarr[4]);
    $sheet->setCellValueByColumnAndRow('H', $row, $rowarr[3]);
    $sheet->setCellValueByColumnAndRow('I', $row,$projrow[1] );
    $sheet->setCellValueByColumnAndRow('J', $row, $approw[3]);
    $sheet->setCellValueByColumnAndRow('K', $row, $approw[2]);
    $sheet->setCellValueByColumnAndRow('L', $row,$approw[4]);
    $sheet->setCellValueByColumnAndRow('M', $row,$approw[14]);
    $sheet->setCellValueByColumnAndRow('N', $row, $rowarr[7]);
    $sheet->setCellValueByColumnAndRow('O', $row,$rowarr[8]);
    $sheet->setCellValueByColumnAndRow('P', $row,$rowarr[6]);
    $sheet->setCellValueByColumnAndRow('Q', $row,$wrkdet);
    $sheet->setCellValueByColumnAndRow('R', $row,$projrow[2]);
    $sheet->setCellValueByColumnAndRow('S', $row,$mnth);
    $sheet->setCellValueByColumnAndRow('T', $row,$appdt);
    $sheet->setCellValueByColumnAndRow('U', $row,$appamt);
    
    $sheet->setCellValueByColumnAndRow('V', $row,$transdetaildate);
    $sheet->setCellValueByColumnAndRow('W', $row,$transdetail[7]);
    
    $sheet->setCellValueByColumnAndRow('X', $row,$approw[7]);
    $sheet->setCellValueByColumnAndRow('Y', $row,$mdrow[0]);
    $sheet->setCellValueByColumnAndRow('Z', $row,$st);
    $sheet->setCellValueByColumnAndRow('AA', $row,$approw[5]);
...
$sheet->setCellValue('U' .$lastrow, $totamt);
...
header('Content-Disposition: attachment;filename="Quotation_Annexure.xlsx"');
