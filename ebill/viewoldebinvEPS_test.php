...
$currentdate=date('Y-m-d');
   ...
   $sttcode=mysqli_query($con,"select * from eps_gst where State like'%".$sndbillqryf['state']."%'");
...
if($sttcodef[2]=="" or $sttcodef[2]=="na"){
    ...
    $sttcodemh=mysqli_query($con,"select * from eps_gst where State like '%Maharashtra%'");
...
?>
<tr><td colspan="<?php if($cid=='FIS03'){echo '6';}else{echo '11';}?>" align="right"><b>Total Billing Amount</b></td>
...
Maharashtra
    ...
    <tr>
        ...
        <td colspan=  align="center" >
            ...
            <?php echo date("d-F-Y",strtotime($sndbillqryf['date'])); ?>
            </td>
...
<div id='page3' ><br><br><br>
  ...
  <tr height="20">
    <td width="208" height="20" colspan="2" align="left" >
    
    <?php echo "GSTIN/Unique ID:".$getgstnumosf['gst'];?> 
...
<tr>
    <td colspan="4" align="right">IGST@9%</td>
...
<tr>
  ...
  <td colspan="4" align="right"><b>Grand Total</b></td>
    ...
    ?>
    <td align="right"><?php echo $sndbillqryf['servchrg']; ?></td>
