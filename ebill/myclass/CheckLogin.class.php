...
Class CheckLogin
{
	...
	$this->logchk();
	 ...
	 public function logchk()
	 {
		 ...
		 //$result = mysqli_query($con,"select * from login where username='$this->user' and password='$this->pwd' and status=1 and designation<8 or designation=13");
		//$result = mysqli_query($con,"select * from login where username='$this->user' and password='$this->pwd' and status=1 and (designation < 8 or designation=13 or designation=20 or designation=21 or designation=30 or designation=31)");
