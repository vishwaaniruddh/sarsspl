...
$panel_ID = $rowData[$i][0][17];
$panel_IP = $rowData[$i][0][18];
$router_IP = $rowData[$i][0][19];
$router_ID = $rowData[$i][0][20];
$panel_Make = $rowData[$i][0][21];
$dvr_Model = $rowData[$i][0][22];
$dvr_IP = $rowData[$i][0][23];
              ...
              if($branchcount==1 && $zonecount ==1 && $citycount ==1 && $errorcount==0){
                  ...
                  echo    $sql = "insert into mis_newsitetest_success(activity,customer,bank,atmid,atmid2,atmid3,trackerno,address,city,state,zone,branch,bm_name,bm_number,status,engineer_user_id,created_by,created_at,panel_ID,panel_IP,router_IP,router_ID,panel_Make,dvr_Model,dvr_IP) 
                    values('".$activity."','".$customer."','".$bank."','".$atmid."','".$atmid2."','".$atmid3."','".$trackerno."','".$address."','".$city."','".$state."','".$zone."','".$branch."','".$bm_name."','".$bm_number."','0','".$engineer."','".$userid."','".$created_at."','".$panel_ID."','".$panel_IP."','".$router_IP."','".$router_ID."','".$panel_Make."','".$dvr_Model."','".$dvr_IP."')";
                    ...
                    if(mysqli_query($con,$sql)){ 
                      ...
                      $sql = "insert into mis_newsitetest_success(activity,customer,bank,atmid,atmid2,atmid3,trackerno,address,city,state,zone,branch,bm_name,bm_number,status,engineer_user_id,created_by,created_at,panel_ID,panel_IP,router_IP,router_ID,panel_Make,dvr_Model,dvr_IP) 
                        values('".$activity."','".$customer."','".$bank."','".$atmid."','".$atmid2."','".$atmid3."','".$trackerno."','".$address."','".$city."','".$state."','".$zone."','".$branch."','".$bm_name."','".$bm_number."','0','".$engineer."','".$userid."','".$created_at."','".$panel_ID."','".$panel_IP."','".$router_IP."','".$router_ID."','".$panel_Make."','".$dvr_Model."','".$dvr_IP."')";
                     ...
                     echo   $sql = "insert into mis_newsitetest_err(activity,customer,bank,atmid,atmid2,atmid3,trackerno,address,city,state,zone,branch,bm_name,bm_number,status,engineer_user_id,created_by,created_at,remark,panel_ID,panel_IP,router_IP,router_ID,panel_Make,dvr_Model,dvr_IP) 
                        values('".$activity."','".$customer."','".$bank."','".$atmid."','".$atmid2."','".$atmid3."','".$trackerno."','".$address."','".$city."','".$state."','".$zone."','".$branch."','".$bm_name."','".$bm_number."','0','".$engineer."','".$userid."','".$created_at."','".$sentence."','".$panel_ID."','".$panel_IP."','".$router_IP."','".$router_ID."','".$panel_Make."','".$dvr_Model."','".$dvr_IP."')";
