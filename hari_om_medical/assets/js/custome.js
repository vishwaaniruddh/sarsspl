                  ...
                  //  Function For Add Purchase Product From Database
                   ...
                   function checkquantity(proid){ debugger;
                    //   var pro_id = proid;
                       
                       var myKeyVals = {pro_id : proid}
                     
                     $.ajax({
                          type: 'POST',
                          url: base_url+"Sale/getquantity",
                          data: myKeyVals,
                          success: function(resultData) { 
                          // alert(resultData);  
                          console.log(resultData)
