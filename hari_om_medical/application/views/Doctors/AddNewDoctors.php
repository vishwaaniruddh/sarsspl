                    ...
                    <div class="container-fluid">
                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            ...
                                            <li class="breadcrumb-item active">New Doctors</li>
                                        </ol>
                                    </div>
                                    <h4 class="page-title">New Doctors</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Create New Doctors</h4>
                                                ...
                                                <form action="<?=base_url('Doctors/Create')?>" method="post">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control date"  name="birthdate" class="form-control date" data-single-date-picker="true"  data-date-format="yyyy-mm-dd" >
                                                        </div>
                                                        <div class="form-group col-md-4">
