                                                ...
                                                <form action="<?=base_url('Supplier/Create')?>" method="post">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control date" data-single-date-picker="true"  data-date-format="dd-mm-yyyy">
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="ifsccode" id="ifsccode" placeholder="IFSC Code">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <input type="text" class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="gstno" id="gstno" placeholder="GST No">
                                                        </div>
                                                    ...
                                                    <button type="submit" class="btn btn-success float-right">Create Supplier</button>
