                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">View Supplier</h4>
                                                ...
                                                <form action="<?=base_url('Supplier/Edit')?>/<?=urlencode($this->encryption->encrypt($supplier->person_id))?>" method="post">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control date"   value="<?=date('d-m-Y',strtotime($supplier->dob))?>" name="birthdate" data-single-date-picker="true"  data-date-format="dd-mm-yyyy">
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <select name="state" class="form-control" id="inputState" disabled>
