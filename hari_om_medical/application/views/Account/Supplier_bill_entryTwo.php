<!-- Start Content-->
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                              <form action="<?=base_url('Supplier/create_billTwo')?>" method="post">
                                <div class="card">
                                    <div class="card-body">
                                                ...
                                                <div class="row">
                                                  ...
                                                  <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                      <div class="form-group" >
                                                          <br/>
                                                          <a   class="btn btn-info text-white" style="margin-top:3%;" onclick="AddtolistNew()" >Add product</a>
                                                      </div>
                                                    </div>
                                                  </div>
                                                  <div class="row">
