                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" name="bill_id" value="ORDNO-<?=$billno?>" class="form-control" readonly>
                                                            </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                                <label for="simpleinput">Bill Date :</label>
                                                                 <input type="text" class="form-control date"  name="bill_date" data-toggle="date-picker" data-single-date-picker="true" data-date-format="mm-dd-yyyy">
                                                            </div>
                                                    </div>
                                                  </div>
                                                  <div class="row">
                                                  ...
                                                  <div class="row">
                                                      ...
                                                      <input type="hidden" name="rowcount" id="rowcount" value="1">
                                                        <table class="table">
                                                           <tr>
                                                               ...
                                                               <th>Manufacturer Price<span class="text-danger">*</span></th>
                                                    ...
                                                    <div class="col-md-1">
                                                        ...
                                                        <div class="form-group mb-3 offset-md-4">
                                                                ...
                                                                <input type="text" name="payamt" id="payamt" class="form-control">
                                                            </div>
                                                    </div>
                                                </div>
