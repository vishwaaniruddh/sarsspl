                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">New Customers</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Create New Customers</h4>
                                                ...
                                                <form action="<?=base_url('Customers/Create')?>" method="post">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control date"  name="birthdate" class="form-control date" data-single-date-picker="true"  data-date-format="dd-mm-yyyy" >
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-row">
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" value="India" name="country" id="country" placeholder="Country" required>
                                                        </div>
                                                        <!-- <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-row"> -->
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="text" class="form-control" onkeyup="this.value = this.value.toUpperCase();" name="pannumber" id="pannumber" placeholder="Pan Number">
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="gstno" class="col-form-label">GST No</label>
                                                            <input type="text" onkeyup="this.value = this.value.toUpperCase();" class="form-control" name="gstno" id="gstno" placeholder="GST No">
                                                        </div>
                                                    ...
                                                    <div class="form-row">
                                                         <div class="form-group col-md-12">
                                                            ...
                                                            <textarea name="comments" id="comments" class="form-control" cols="30" rows="7" placeholder="Comments Here"></textarea>
                                                        </div>
                                                    ...
                                                    <button type="submit" class="btn btn-success float-right">Create Customer</button>
