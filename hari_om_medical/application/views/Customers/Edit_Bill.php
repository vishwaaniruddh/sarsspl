                                                      ...
                                                      <input type="hidden" name="rowcount" id="rowcount" value="1">
                                                        <table class="table">
                                                           ...
                                                           <tr id="rowid_<?=$key+1?>">
															    ...
															    <td>
															        <input class="form-control" name="hsn[]" value="<?=$product->item_id?>" type="text" readonly/>
															    </td>
															    <td>
															    ...
															    <td>
															        <input  class="form-control subtotal" id="subtotal<?=$key+1?>" name="totalamt" onkeyup="subtotalNew()" value="<?=$product->qty*$product->price?>" type="text"/>
															    </td>
															    <td>
                                                    ...
                                                    <br/>
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="hidden" value="<?=$bills_data->totalqty?>" id="totalcount" class="form-control" >
