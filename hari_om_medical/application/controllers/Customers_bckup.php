...
class Customers extends CI_Controller {
		...
		public function create_bill()
	{
		...
		$gstper=$this->input->post('gstper',TRUE);
		$addgst=$this->input->post('addgst',TRUE);
...
public function View_bill()
	...
	function View_bill_details($billid)
	{
