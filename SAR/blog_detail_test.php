...
<!-- Page Title -->
        ...
        <!-- End Page Title -->
           ...
           <?php
            ...
            $sql = mysqli_query($con,"select * from blog_detail where id='".$id."' order by id desc limit 1");
            $row= mysqli_fetch_assoc($sql);
            
            $nextsql = mysqli_query($con,"select * from blog_detail where id='".$next."' order by id desc limit 1");
            $row= mysqli_fetch_assoc($nextsql);
            $num_rows = mysqli_num_rows($nextsql);
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 btn-column">
                                        <div class="single-btn prev-btn p_relative d_block b_radius_5 pt_25 pr_30 pb_25 pl_30 tran_5">
                                            ...
                                            <?php if($prev<=1) { ?> 
                                                <h6 class="d_block fs_15 fw_sbold mb_11" hidden><a href="blog_detail_test.php?id=<?php echo '1';?>" class="d_iblock color_black"><i class="far fa-long-arrow-left"></i>Previous</h6>
