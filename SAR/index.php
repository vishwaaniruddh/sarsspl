...
<section class="slider-one centred p_relative">
            <div class="banner-carousel owl-theme owl-carousel owl-dots-none">
                <div class="slide-item p_relative pt_140 pb_170">
                    ...
                    <!--<div class="image-layer p_absolute" style="background-image:url(assets/images/HomePage/Banner 1 video.mp4)"></div>-->
                   <div class="image-layer p_absolute">
    <img src="assets/images/HomePage/About Us SAR Banner 1.gif" alt="Banner GIF" class="banner-gif">
</div>

                   <!-- =======================below -->
                    <!--<div class="banner-container">-->
                        <!--<div class="video-layer p_absolute" autoplay loop muted>-->
                        <!--    <source src="assets/images/HomePage/Banner 1 video.mp4" type="video/mp4">-->
                        <!--    Your browser does not support the video tag.-->
                        <!--</div>-->
                    <!--</div>-->
            <!-- ===============================above -->
                    <div class="auto-container btn-container">
                        <div class="content-box p_relative d_block z_5">
                            <!--<h2 class="p_relative d_iblock fw_bold fs_80 lh_70 mb_35 content-header"><span class="slider-text-anim">Do you need help getting  </span><br /> <span class="slider-text-anim"> the best IT solution  </span><br/><span class="slider-text-anim">that fits your business process?</span></h2>-->
                ...
                <div class="slide-item p_relative pt_140 pb_170">
                    ...
                    <div class="image-layer p_absolute " style="background-image:url(assets/images/HomePage/Banner_images/2.jpg)"></div>
                    <div class="auto-container btn-container">
                        <div class="content-box p_relative d_block z_5">
                            <!-- ======================below
                            <h2 class="p_relative d_iblock fw_bold fs_80 lh_70 mb_25 content-header"><span class="slider-text-anim">Do you want your business </span><br /> <span class="slider-text-anim"> to grow faster?</span></h2>
                            <p class="d_block fs_18 mb_45">Technology accelerates productivity, speed up your business processes, and easily unifies the business functionalities and the team to facilitate working seamlessly from anywhere. Stop wasting time on repetitive and manual tasks and focus on the core of the business.</p>
                            <h2 class="p_relative d_iblock fw_bold fs_80 lh_70 mb_25 content-header"><span class="slider-text-anim"> </span>
                ...
                <div class="slide-item p_relative pt_140 pb_170">
                    ...
                    <div class="image-layer p_absolute " style="background-image:url(assets/images/HomePage/Banner_images/3.jpg)"></div>
                    <div class="auto-container btn-container">
                        <div class="content-box p_relative d_block z_5">
                            <h2 class="p_relative d_iblock fw_bold fs_80 lh_70 mb_25 content-header"><span class="slider-text-anim">Do you find it challenging to keep up </span><br /> <span class="slider-text-anim">with manual activities?</span><br/></h2>
                            <p class="d_block fs_18 mb_45">Technology accelerates productivity, speed up your business processes, and easily unifies the business functionalities and the team to facilitate working seamlessly from anywhere. Stop wasting time on repetitive and manual tasks and focus on the core of the business.</p>
                            <div class="btn-box clearfix">
                                <a href="index.html" class="theme-btn theme-btn-two"><span data-text="Get Started">Get Started</span></a>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image_block_one">
                                <div class="image-box p_relative d_block mr_30 pb_100 pt_130 ">
                                    ...
                                    <!--</div>-->
                                    <figure class="image image-1 p_relative d_block b_radius_10"><img src="assets/images/HomePage/About us 1.svg" alt=""></figure>
                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12 image-column">
                            <div class="image_block_two">
                                <div class="image-box p_relative d_block ml_30 pb_140 mt_20">
                                    ...
                                    <!--</div>-->
                                    <figure class="image image-1 p_relative d_block b_radius_10"><img src="assets/images/HomePage/Testing.svg" alt=""></figure>
                                    <!--<figure class="image image-2 p_absolute l_0 b_0 b_radius_10 d_block"><img src="assets/images/HomePage/Reasons to choose us.svg" alt=""></figure>-->
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="cta-one p_relative pt_130 pb_140 centred">
            ...
            <div class="auto-container">
                <div class="inner-box p_relative z_1">
                    ...
                    <p class="fs_17 mb_35">Find out how our business automation platform can enhance your business and accelerate growth.</p>
