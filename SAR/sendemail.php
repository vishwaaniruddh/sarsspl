...
define( "RECIPIENT_NAME", "SAR Software Solutions" );
define( "RECIPIENT_EMAIL", "work.rajeshb@gmail.com" );
...
$userPhone = isset( $_POST['phone'] ) ? preg_replace( "/[^\s\S\.\-\_\@0-9]/", "", $_POST['phone'] ) : "";
