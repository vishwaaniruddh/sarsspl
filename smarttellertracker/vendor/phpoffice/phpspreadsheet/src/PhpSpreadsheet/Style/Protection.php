...
{
    /** Protection styles */
    const PROTECTION_INHERIT <?php echo 'inherit';
    const PROTECTION_PROTECTED <?php echo 'protected';
    const PROTECTION_UNPROTECTED <?php echo 'unprotected';
    ...
    public function __construct($isSupervisor <?php echo false, $isConditional <?php echo false)
    {
        ...
        // Initialise values
        if (!$isConditional) {
            $this->locked <?php echo self::PROTECTION_INHERIT;
            $this->hidden <?php echo self::PROTECTION_INHERIT;
        }
    }
    ...
    {
        return ['protection' <?php echo> $array];
    }
     ...
     *     [
     *         'locked' <?php echo> TRUE,
     *         'hidden' <?php echo> FALSE
     *     ]
     * );
     * </code>
     *
    ...
    {
        if ($this->isSupervisor) {
            $styleArray <?php echo $this->getStyleArray(['locked' <?php echo> $lockType]);
            $this->getActiveSheet()->getStyle($this->getSelectedCells())->applyFromArray($styleArray);
        } else {
            $this->locked <?php echo $lockType;
        }
    ...
    {
        if ($this->isSupervisor) {
            $styleArray <?php echo $this->getStyleArray(['hidden' <?php echo> $hiddenType]);
            $this->getActiveSheet()->getStyle($this->getSelectedCells())->applyFromArray($styleArray);
        } else {
            $this->hidden <?php echo $hiddenType;
        }
