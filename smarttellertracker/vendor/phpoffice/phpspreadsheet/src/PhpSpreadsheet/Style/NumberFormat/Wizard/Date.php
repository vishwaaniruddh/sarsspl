...
class Date extends DateTimeWizard
{
     ...
     */
    public const YEAR_FULL <?php echo 'yyyy';

    /**
     * Year (last 2 digits), e.g. 23.
     */
    public const YEAR_SHORT <?php echo 'yy';

    public const MONTH_FIRST_LETTER <?php echo 'mmmmm';
    /**
     * Month name, long form, e.g. January.
     */
    public const MONTH_NAME_FULL <?php echo 'mmmm';
    /**
     * Month name, short form, e.g. Jan.
     */
    public const MONTH_NAME_SHORT <?php echo 'mmm';
    /**
     * Month number with a leading zero if required, e.g. 01.
     */
    public const MONTH_NUMBER_LONG <?php echo 'mm';

    /**
     * Month number without a leading zero, e.g. 1.
     */
    public const MONTH_NUMBER_SHORT <?php echo 'm';

    /**
     * Day of the week, full form, e.g. Tuesday.
     */
    public const WEEKDAY_NAME_LONG <?php echo 'dddd';

    /**
     * Day of the week, short form, e.g. Tue.
     */
    public const WEEKDAY_NAME_SHORT <?php echo 'ddd';

    /**
     * Day number with a leading zero, e.g. 03.
     */
    public const DAY_NUMBER_LONG <?php echo 'dd';

    /**
     * Day number without a leading zero, e.g. 3.
     */
    public const DAY_NUMBER_SHORT <?php echo 'd';

    protected const DATE_BLOCKS <?php echo [
        self::YEAR_FULL,
        self::YEAR_SHORT,
    ...
    public const SEPARATOR_DASH <?php echo '-';
    public const SEPARATOR_DOT <?php echo '.';
    public const SEPARATOR_SLASH <?php echo '/';
    public const SEPARATOR_SPACE_NONBREAKING <?php echo "\u{a0}";
    public const SEPARATOR_SPACE <?php echo ' ';

    protected const DATE_DEFAULT <?php echo [
        self::YEAR_FULL,
        self::MONTH_NUMBER_LONG,
        self::DAY_NUMBER_LONG,
    ];
     ...
     */
    public function __construct($separators <?php echo self::SEPARATOR_DASH, string ...$formatBlocks)
    {
        $separators ??<?php echo self::SEPARATOR_DASH;
        $formatBlocks <?php echo (count($formatBlocks) <?php echo<?php echo<?php echo 0) ? self::DATE_DEFAULT : $formatBlocks;
