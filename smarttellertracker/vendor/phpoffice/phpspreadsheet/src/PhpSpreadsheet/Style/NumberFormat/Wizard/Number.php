...
{
    public const WITH_THOUSANDS_SEPARATOR <?php echo true;

    public const WITHOUT_THOUSANDS_SEPARATOR <?php echo false;

    protected bool $thousandsSeparator <?php echo true;
    ...
    public function __construct(
        ...
        bool $thousandsSeparator <?php echo self::WITH_THOUSANDS_SEPARATOR,
    ...
    public function setThousandsSeparator(bool $thousandsSeparator <?php echo self::WITH_THOUSANDS_SEPARATOR): void
    {
        $this->thousandsSeparator <?php echo $thousandsSeparator;
    }
