...
class RowIterator implements NativeIterator
{
     ...
     */
    public function __construct(Worksheet $subject, $startRow <?php echo 1, $endRow <?php echo null)
    {
        // Set subject
        $this->subject <?php echo $subject;
    ...
    {
        $this->subject <?php echo null; // @phpstan-ignore-line
    }
    ...
    {
        $this->endRow <?php echo $endRow ?: $this->subject->getHighestRow();
    ...
    {
        $this->position <?php echo $this->startRow;
    }
    ...
    {
        return $this->position <?php echo $this->endRow && $this->position ><?php echo $this->startRow;
    }
}
