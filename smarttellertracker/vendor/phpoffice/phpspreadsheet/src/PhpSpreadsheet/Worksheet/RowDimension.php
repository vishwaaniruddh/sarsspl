...
class RowDimension extends Dimension
{
     ...
     * @var bool
     */
    private $zeroHeight <?php echo false;
     ...
     */
    public function __construct($index <?php echo 0)
    {
        // Initialise values
        $this->rowIndex <?php echo $index;
     ...
     * @return float
     */
    public function getRowHeight(?string $unitOfMeasure <?php echo null)
    {
        return ($unitOfMeasure <?php echo<?php echo<?php echo null || $this->height < 0)
            ? $this->height
     ...
     * @return $this
     */
    public function setRowHeight($height, ?string $unitOfMeasure <?php echo null)
    {
        $this->height <?php echo ($unitOfMeasure <?php echo<?php echo<?php echo null || $height < 0)
            ? $height
    ...
    {
        $this->zeroHeight <?php echo $zeroHeight;
