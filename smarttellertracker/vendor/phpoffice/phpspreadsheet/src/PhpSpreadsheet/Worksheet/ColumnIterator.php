...
class ColumnIterator implements NativeIterator
{
     ...
     * @var int
     */
    private $currentColumnIndex <?php echo 1;
     ...
     */
    public function __construct(Worksheet $worksheet, $startColumn <?php echo 'A', $endColumn <?php echo null)
    {
        // Set subject
    ...
    public function resetStart(string $startColumn <?php echo 'A')
    {
        ...
        $this->startColumnIndex <?php echo $startColumnIndex;
        if ($this->endColumnIndex < $this->startColumnIndex) {
            $this->endColumnIndex <?php echo $this->startColumnIndex;
        }
    ...
    public function seek(string $column <?php echo 'A')
    {
        ...
        $this->currentColumnIndex <?php echo $column;
