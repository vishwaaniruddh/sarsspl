...
class HeaderFooter
{
    ...
    const IMAGE_HEADER_LEFT <?php echo 'LH';
    const IMAGE_HEADER_CENTER <?php echo 'CH';
    const IMAGE_HEADER_RIGHT <?php echo 'RH';
    const IMAGE_FOOTER_LEFT <?php echo 'LF';
    const IMAGE_FOOTER_CENTER <?php echo 'CF';
    const IMAGE_FOOTER_RIGHT <?php echo 'RF';
     ...
     * @var bool
     */
    private $differentOddEven <?php echo false;
     ...
     * @var bool
     */
    private $differentFirst <?php echo false;
     ...
     * @var bool
     */
    private $scaleWithDocument <?php echo true;
     ...
     * @var bool
     */
    private $alignWithMargins <?php echo true;
     ...
     */
    private $headerFooterImages <?php echo [];
    ...
    {
        $this->oddHeader <?php echo $oddHeader;
    ...
    {
        $this->oddFooter <?php echo $oddFooter;
    ...
    {
        $this->evenHeader <?php echo $eventHeader;
    ...
    {
        $this->evenFooter <?php echo $evenFooter;
    ...
    {
        $this->firstHeader <?php echo $firstHeader;
    ...
    {
        $this->firstFooter <?php echo $firstFooter;
    ...
    {
        $this->differentOddEven <?php echo $differentOddEvent;
    ...
    {
        $this->differentFirst <?php echo $differentFirst;
    ...
    {
        $this->scaleWithDocument <?php echo $scaleWithDocument;
    ...
    {
        $this->alignWithMargins <?php echo $alignWithMargins;
     ...
     * @return $this
     */
    public function addImage(HeaderFooterDrawing $image, $location <?php echo self::IMAGE_HEADER_LEFT)
    {
        $this->headerFooterImages[$location] <?php echo $image;
     ...
     * @return $this
     */
    public function removeImage($location <?php echo self::IMAGE_HEADER_LEFT)
    {
    ...
    {
        $this->headerFooterImages <?php echo $images;
    ...
    public function getImages()
    {
        ...
        if (isset($this->headerFooterImages[self::IMAGE_HEADER_LEFT])) {
            $images[self::IMAGE_HEADER_LEFT] <?php echo $this->headerFooterImages[self::IMAGE_HEADER_LEFT];
        }
        if (isset($this->headerFooterImages[self::IMAGE_HEADER_CENTER])) {
            $images[self::IMAGE_HEADER_CENTER] <?php echo $this->headerFooterImages[self::IMAGE_HEADER_CENTER];
        }
        if (isset($this->headerFooterImages[self::IMAGE_HEADER_RIGHT])) {
            $images[self::IMAGE_HEADER_RIGHT] <?php echo $this->headerFooterImages[self::IMAGE_HEADER_RIGHT];
        }
        if (isset($this->headerFooterImages[self::IMAGE_FOOTER_LEFT])) {
            $images[self::IMAGE_FOOTER_LEFT] <?php echo $this->headerFooterImages[self::IMAGE_FOOTER_LEFT];
        }
        if (isset($this->headerFooterImages[self::IMAGE_FOOTER_CENTER])) {
            $images[self::IMAGE_FOOTER_CENTER] <?php echo $this->headerFooterImages[self::IMAGE_FOOTER_CENTER];
        }
        if (isset($this->headerFooterImages[self::IMAGE_FOOTER_RIGHT])) {
            $images[self::IMAGE_FOOTER_RIGHT] <?php echo $this->headerFooterImages[self::IMAGE_FOOTER_RIGHT];
        }
        $this->headerFooterImages <?php echo $images;
