...
class Settings
{
    ...
    public static function setChartRenderer(string $rendererClassName): void
    {
        ...
        self::$chartRenderer <?php echo $rendererClassName;
    }
    ...
    {
        if ($options <?php echo<?php echo<?php echo null) {
            $options <?php echo defined('LIBXML_DTDLOAD') ? (LIBXML_DTDLOAD | LIBXML_DTDATTR) : 0;
        }
        self::$libXmlLoaderOptions <?php echo $options;
    ...
    {
        if (self::$libXmlLoaderOptions <?php echo<?php echo<?php echo null) {
    ...
    {
        if (!self::$cache) {
            self::$cache <?php echo self::useSimpleCacheVersion3() ? new Memory\SimpleCache3() : new Memory\SimpleCache1();
        }
    ...
    {
        return
            PHP_MAJOR_VERSION <?php echo<?php echo<?php echo 8 &&
            (new ReflectionClass(CacheInterface::class))->getMethod('get')->getReturnType() !<?php echo<?php echo null;
    }
    ...
    {
        self::$httpClient <?php echo $httpClient;
        self::$requestFactory <?php echo $requestFactory;
    }
    ...
    {
        self::$httpClient <?php echo null;
        self::$requestFactory <?php echo null;
    }
