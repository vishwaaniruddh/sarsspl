...
class Html extends BaseReader
{
     ...
     */
    const TEST_SAMPLE_SIZE <?php echo 2048;
     ...
     * @var string
     */
    protected $inputEncoding <?php echo 'ANSI';
     ...
     * @var int
     */
    protected $sheetIndex <?php echo 0;
    ...
    protected $formats <?php echo [
        ...
        'a' <?php echo> [
            'font' <?php echo> [
                'underline' <?php echo> true,
                'color' <?php echo> [
                    'argb' <?php echo> Color::COLOR_BLUE,
                ],
            ],
        ], //    Blue underlined
        'hr' <?php echo> [
            'borders' <?php echo> [
                'bottom' <?php echo> [
                    'borderStyle' <?php echo> Border::BORDER_THIN,
                    'color' <?php echo> [
                        Color::COLOR_BLACK,
                    ],
                ],
