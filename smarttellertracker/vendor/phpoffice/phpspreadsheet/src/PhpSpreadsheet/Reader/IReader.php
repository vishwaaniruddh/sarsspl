...
interface IReader
{
    public const LOAD_WITH_CHARTS <?php echo 1;

    public const READ_DATA_ONLY <?php echo 2;

    public const SKIP_EMPTY_CELLS <?php echo 4;
    public const IGNORE_EMPTY_CELLS <?php echo 4;
     ...
     */
    public function load(string $filename, int $flags <?php echo 0);
}
