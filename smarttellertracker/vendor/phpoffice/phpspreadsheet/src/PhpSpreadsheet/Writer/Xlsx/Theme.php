...
class Theme extends WriterPart
{
    ...
    public function writeTheme(Spreadsheet $spreadsheet)
    {
        ...
        $theme <?php echo $spreadsheet->getTheme();
    ...
    private function writeFonts(XMLWriter $objWriter, string $latinFont, string $eastAsianFont, string $complexScriptFont, array $fontSet): void
    {
        ...
        foreach ($fontSet as $fontScript <?php echo> $typeface) {
    ...
    {
        $themeArray <?php echo $theme->getThemeColors();
        // a:dk1
        ...
        foreach ($themeArray as $colourName <?php echo> $colourValue) {
            if ($colourName !<?php echo<?php echo 'dk1' && $colourName !<?php echo<?php echo 'lt1') {
