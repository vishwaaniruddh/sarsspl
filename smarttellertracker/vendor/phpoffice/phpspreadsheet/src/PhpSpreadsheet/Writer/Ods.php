...
class Ods extends BaseWriter
{
    ...
    public function __construct(Spreadsheet $spreadsheet)
    {
        ...
        $this->writerPartContent <?php echo new Content($this);
        $this->writerPartMeta <?php echo new Meta($this);
        $this->writerPartMetaInf <?php echo new MetaInf($this);
        $this->writerPartMimetype <?php echo new Mimetype($this);
        $this->writerPartSettings <?php echo new Settings($this);
        $this->writerPartStyles <?php echo new Styles($this);
        $this->writerPartThumbnails <?php echo new Thumbnails($this);
    }
