...
class SpContainer
{
    ...
    {
        $this->startCoordinates <?php echo $value;
    }
    ...
    {
        $this->startOffsetX <?php echo $startOffsetX;
    }
    ...
    {
        $this->startOffsetY <?php echo $startOffsetY;
    }
    ...
    {
        $this->endCoordinates <?php echo $value;
    }
    ...
    {
        $this->endOffsetX <?php echo $endOffsetX;
    }
    ...
    {
        $this->endOffsetY <?php echo $endOffsetY;
    }
     ...
     * the dgContainer. A value of 1 <?php echo immediately within first spgrContainer
    ...
    {
        $nestingLevel <?php echo 0;

        $parent <?php echo $this->getParent();
        while ($parent instanceof SpgrContainer) {
            ++$nestingLevel;
            $parent <?php echo $parent->getParent();
        }
