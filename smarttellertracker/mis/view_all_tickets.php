...
if (isset($_REQUEST['status']) && $_REQUEST['status'] != '') {
  ...
  $statement .= " and b.status in('open','permission_require','dispatch','material_requirement','material_in_process','schedule','material_available_i','material_dispatch','cancelled','not_available','available','MRS','fund_required','service_center','reassign','material_delivered')";
  $sqlappCount .= " and b.status in('open','permission_require','dispatch','material_requirement','material_in_process','schedule','material_available_i','material_dispatch','cancelled','not_available','available','MRS','fund_required','service_center','reassign','material_delivered')";
}
...
echo $statement .= " order by b.id desc";
