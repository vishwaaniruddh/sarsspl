                    ...
                    <div class="col-xs-2 col-sm-6 col-md-3 col-lg-4 col-xl-6">
                        <div class=" ">
                            ...
                            <?php if ($result['type'] == '1') { ?>
                                ...
                                <?php if ($result['missing_status'] == '1' || $result['missing_status'] == '2') { ?>
                                ...
                                <!--<?php } ?>-->
                                  ...
                                  <?php if ($result['missing_status'] == '1') { ?>
                                        <div class="col-md-4 col-lg-8 col-xl-12"><div class="div_title">In Case of Emergency Call our Command Station</div></div>
                                            <div class="col-md-4 col-lg-8 col-xl-12 mb-2"><div class="div_title"></div>
                                                <div class=" div_border">
                                                    18002104567
                                                    <button class="button call_btn"><a href="tel:18002104567"><i class="fa fa-phone color_white"></i></a></button>
                                                </div>
                                            </div>
                                     <?php } ?>

                                <?php if ($result['missing_status'] == '2') { ?>
                                  <div class="col-md-4 col-lg-8 col-xl-12"><div class="div_title">Person Missing Please Call our Command Station</div></div>
                                            <div class="col-md-4 col-lg-8 col-xl-12 mb-2"><div class="div_title"></div>
                                                <div class=" div_border">
                                                    18002104567
                                                    <button class="button call_btn"><a href="tel:18002104567"><i class="fa fa-phone color_white"></i></a></button>
                                               ...
                                               <div class="col-md-4 col-lg-8 col-xl-12"><div class="div_title">OR</div></div>
                                    <div class="col-md-4 col-lg-8 col-xl-12 mb-2" id="view_detail_button">
                                        <div class="div_title text-center">
                        ...
                        <?php if ($result['type'] == '2') { ?>
                            ...
                            <?php } ?>
                                    ...
                                    <?php if ($result['missing_status'] == '1') { ?>
                                        <div class="col-md-4 col-lg-8 col-xl-12"><div class="div_title">In Case of Emergency Call our Pet Safety Station</div></div>
                                            <div class="col-md-4 col-lg-8 col-xl-12 mb-2"><div class="div_title"></div>
                                                <div class=" div_border">
                                                    18002104567
                                                    <button class="button call_btn"><a href="tel:18002104567"><i class="fa fa-phone color_white"></i></a></button>
                            ...
                            <?php if ($result['missing_status'] == '2') { ?>
                                    <div class="col-md-4 col-lg-8 col-xl-12"><div class="div_title">Pet Missing Please Call Pet Safety Station</div></div>
                                            <div class="col-md-4 col-lg-8 col-xl-12 mb-2"><div class="div_title"></div>
                                                <div class=" div_border">
                                                    18002104567
                                                    <button class="button call_btn"><a href="tel:18002104567"><i class="fa fa-phone color_white"></i></a></button>
                            ...
                            <div class="col-md-4 col-lg-8 col-xl-12 mb-2">
                                ...
                                <div class=" div_border">
                                    ...
                                    <!--</div>-->
                                     ...
                                     <?php } ?>
                                    <?php if ($result['missing_status'] == '2') { ?>
                                    <div class="col-md-4 col-lg-8 col-xl-12"><div class="div_title">Things Missing Please Call our Command Station</div></div>
                                            <div class="col-md-4 col-lg-8 col-xl-12 mb-2"><div class="div_title"></div>
                                                <div class=" div_border">
                                                    18002104567
                                                    <button class="button call_btn"><a href="tel:18002104567"><i class="fa fa-phone color_white"></i></a></button>
                        ...
                        <?php if ($result['location'] != '' || $result['location'] != null ) { ?>
                            <div class="col-md-4 col-lg-8 col-xl-12 mb-2">
                                <div class="div_title">Location</div>
                                <div class=" div_border">
                                    <?php echo $result['location']; ?>
                                    <?php if ($result['lat'] != '' || $result['lat'] != null ) { ?>
                                    <a target="_blank" href="https://www.google.com/maps/search/?api=1&amp;query=<?php echo $result['lat']; ?>,<?php echo $result['long']; ?>"><img src="/img/map-location.png" style="width: 24px; height: 19px;"></a>
                                    <?php } ?>
                                </div>
                        ...
                        <!--<?php if ($result['lat'] != '' || $result['lat'] != null ) { ?>-->
                        <!--    <div class="col-md-4 col-lg-8 col-xl-12 mb-2">-->
                        <!--        <div class="div_title">Lat</div>-->
                        <!--        <div class=" div_border">-->
                        <!--            <?php echo $result['lat']; ?>-->
                        <!--        </div>-->
                        <!--    </div>-->
                        <!--<?php } ?>-->
                        <!--<?php if ($result['long'] != '' || $result['long'] != null ) { ?>-->
                        <!--    <div class="col-md-4 col-lg-8 col-xl-12 mb-2">-->
                        <!--        <div class="div_title">Long</div>-->
                        <!--        <div class=" div_border">-->
