                                ...
                                <div class="form-group floating-label col-md-12">
                                  ...
                                  <!--  <input type="text" required class="form-control" id="name" name="name" style="text-align: center" placeholder="Hotel Name *">-->
                                     <select class="form-control" id="name" name="name" required>
                                          ...
                                          $qryHotel_Creation=mysqli_query($conn,"SELECT * FROM `Hotel_Creation` where Brand='1' ");
                                          while($fetchHotel_Creation=mysqli_fetch_array($qryHotel_Creation)){
                                         
                                          ?>
                                          
                                          <option value="<?php echo $fetchHotel_Creation['Hotel_Name'];?>"><?php echo $fetchHotel_Creation['Hotel_Name'];?></option>
                                         <?php } ?>
                                     </select>
                                </div>
