                        ...
                        <div class="card-body ">
                            <div class="form-group">
                                    		...
                                    		<td>
                                    		        <div class="form-row">
                                    		             <div class="form-group col-md-3">
                                    		                      <select class="form-control"  style="padding-left: 0px;" name="Level" id="Level"  required>
                                ...
                                <div class="form-group col-md-4">
                              	<input type="text" class="code form-control" id="FromSerial" name="FromSerial[]" value="" placeholder="From Serial *" required/> &nbsp;
                                    		  </div>
                                         <div class="form-group col-md-4">
                                     	<input type="text" class="code form-control" id="ToSerial" name="ToSerial[]" value="" placeholder="To Serial *" required/> &nbsp;
                                    	 </div>
                                    	  <div class="form-group col-md-1">	 <a href="javascript:void(0);" class="addCF">Add</a></div>
                                          </div>
                                    	</td>
                                    	</tr>
                                    </table>
