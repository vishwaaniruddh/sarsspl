                        ...
                        <div class="card-body ">
                            <div class="form-group">
                                ...
                                <div class="form-group col-md-5">
                               		...
                               		<input type="text" class="code form-control" id="POScode" name="POScode[]" value="" placeholder="POS Code" required/> &nbsp;
...
<script>
	...
	$(".addCF").click(function(){
		$("#customFields").append('<tr valign="top"><td><input type="text" class="code" id="serviceName" name="serviceName[]" value="" placeholder="Service Name" required/> &nbsp; <input type="text" class="code" id="POScode" name="POScode[]" value="" placeholder="POS Code" required/> &nbsp; <a href="javascript:void(0);" class="remCF">Remove</a></td></tr>');
	});
