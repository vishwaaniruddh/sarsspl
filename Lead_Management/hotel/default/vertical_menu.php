...
<aside class="admin-sidebar">
    <div class="admin-sidebar-brand">
        ...
        <img class="admin-brand-logo" src="images/orchids.png" width="40" alt="atmos Logo">
        <span class="admin-brand-content font-secondary"><a href="dashboard.php">THE ORCHID</a></span>
