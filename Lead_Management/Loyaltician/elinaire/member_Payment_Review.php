                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDetails_Level"
                                            ...
                                            value="<?php echo $_POST['MembershipDetails_Level']; ?>" readonly required>
                                        <input type="hidden" class="form-control" id="Hidden_MembershipDetails_id"
                                            name="Hidden_MembershipDetails_id"
                                            value="<?php echo $_POST['Hidden_MembershipDetails_id']; ?>" readonly
                                            required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDetails_Fee"
                                            ...
                                            value="<?php echo $_POST['MembershipDetails_Fee']; ?>" readonly required>
                                    </div>


                                    <div class="custom-control custom-checkbox" id="sample">
                                        <input type="checkbox" class="custom-control-input"
                                            id="MembershipSampal_offerCheck1" name="MembershipSampal_offerCheck1" <?php if ($_POST['MembershipSampal_offerCheck1'] == "") { ?>
                                        <?php } else { ?> checked
                                        <?php } ?> >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDts_NetPayment"
                                            ...
                                            value="<?php echo $_POST['MembershipDts_NetPayment']; ?>" required readonly>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="BankName" name="BankName"
                                            placeholder='Bank Name' value="<?php echo $_POST['BankName']; ?>" readonly>
                                    </div>
