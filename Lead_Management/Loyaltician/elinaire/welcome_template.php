...
$bcc = ['rajeshrungta719@gmail.com','work.rajeshb@gmail.com'];
function select($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf,$MembershipDts_NetPayment,$MembershipDts_GrossTotal,$AssignBooklet){
    ...
    $nodes = 'https://sarsspl.com/sendmailapi/elinairemailapi.php';
    
    $attachment = "https://sarsspl.com/Lead_Management/Loyaltician/elinaire/Leadpdf/memberpdf/$Primary_nameOnTheCard.pdf";

    $EmailSubject2="Welcome to Club Elinaire !";
    $message2 ='<table width="50%" align="center"><td><img style="width:60%;padding-left:20%" id="Picture 4" src="https://sarsspl.com/Lead_Management/Loyaltician/elinaire/newassets/elinaire_mail_head.jpeg"></td></table>
                  ...
                  <tr>
                    ...
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                        <p align="right" style="text-align:center">
                          <span style="text-decoration:none"><img border="0" width="130" style="width:3.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/elinaire/newassets/elinaire_logo.jpeg" alt="Club Elinaire Select">
                          </span>
                       <u></u><u></u></p>
                    </td>
                  </tr>
...
$htmtab1='<table border="1" cellpadding="5">
                                        <tbody>
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <img src="https://sarsspl.com/Lead_Management/Loyaltician/elinaire/newassets/elinaire_logo.jpeg" style="margin-left:200px;height:60px;">
                                            </th>
                                            </tr>
                                            ...
                                            <tr>
                                            <th colspan="6" style="text-align:center;"> 7022, 1 Aerocity, Safedpul, Kurla Andheri Road Mumbai 400072  </th>
                                            </tr>

                                            <tr>
                                            <th colspan="6" style="text-align:center;"> E Mail:contactus@clubelinaire.com Website : www.clubelinaire.com </th>
                                            </tr>
...
function plus($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf,$MembershipDts_NetPayment,$MembershipDts_GrossTotal,$AssignBooklet)
{
     global $conn,$bcc;
...
<td>
<img style="width:60%;padding-left:20%;" id="Picture 4" src="https://sarsspl.com/Lead_Management/Loyaltician/elinaire/newassets/elinaire_mail_head.jpeg">
...
<td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                        <p align="right" style="text-align:center">
                          <span style="text-decoration:none"><img border="0" width="130" style="width:3.3541in;padding-right: 80px;" src="https://sarsspl.com/Lead_Management/Loyaltician/elinaire/newassets/elinaire_logo.jpeg" alt="Club Elinaire Select">
                          </span>
                       <u></u><u></u></p>
                    </td>
</tr>
...
<p class=MsoNormal><span lang=EN-IN style="font-size:12.0pt;line-height:107%">&nbsp;</span></p>
                          ...
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN><b><u>Membership Details</u></b></span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>&nbsp;</span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>Membership Level - Plus</span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>Your Membership Card number is '.$member_id.'. </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>The membership is valid till '.date('M Y', strtotime($validity)).' </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN> </span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>
<a href="https://www.clubelinaire.com"><span style="font-size:12.0pt;
line-height:107%">www.clubelinaire.com</span></a>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>
<a href="mailto:contactus@clubelinaire.com"><span style="font-size:12.0pt;
line-height:107%">https://www.clubelinaire.com</span></a>
</span><span lang=EN-IN
style="font-size:12.0pt;line-height:107%"> </span></p>
...
var_dump($response);
 ...
 function premium($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf,$MembershipDts_NetPayment,$MembershipDts_GrossTotal,$AssignBooklet)
 {
     global $conn,$bcc;
...
<p align="right" style="text-align:right">
  ...
  <span style="text-decoration:none"><img border="0" width="130" style="width:3.3541in;padding-right: 75px;" src="https://sarsspl.com/Lead_Management/Loyaltician/elinaire/newassets/elinaire_logo.jpeg" alt="Club Elinaire Premium">
  </span>
...
<p class=MsoNormal><span lang=EN-IN style="font-size:12.0pt;line-height:107%">&nbsp;</span></p>
                          ...
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN><b><u>Membership Details</u></b></span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>&nbsp;</span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>Membership Level - Premium</span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>Your Membership Card number is '.$member_id.'. </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>The membership is valid till '.date('M Y', strtotime($validity)).' </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN> </span></p>
...
$htmtab1='<table border="1" cellpadding="5">
                                            ...
                                            <tr>
                                            <th colspan="6" style="text-align:center;"> Representative for, Club Elinaire by K Raheja Corp Private Limited,  contactus@theresortexperiences.com </th>
                                            </tr>
