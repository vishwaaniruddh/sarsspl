                                    ...
                                    <div class="demo-checkbox">
                                        ...
                                        while ($sql_result = mysqli_fetch_assoc($sql)) { ?>
                                            ...
                                            <input type="checkbox" name="reasons[]"
                                                value="<?php echo $sql_result['closeRenewal_id']; ?>"
                                                id="basic_checkbox_<?php echo $i; ?>" class="filled-in">

                                            <label
                                                for="basic_checkbox_<?php echo $i; ?>"><?php echo $sql_result['CloseRenewalReason']; ?></label>
