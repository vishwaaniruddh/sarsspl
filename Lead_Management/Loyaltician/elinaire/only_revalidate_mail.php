...
require 'phpmail/src/Exception.php';
      ...
      $pagesource = "only_revalidate_mail";
$memid = $id;
$msg = "";
...
try{
    ...
    $rev_mail2->Host = 'mail.theresortexperiences.com';  // Specify main and backup SMTP servers
    $rev_mail2->SMTPAuth = true;                               // Enable SMTP authentication
    $rev_mail2->Username = 'contactus@theresortexperiences.com';                 // SMTP username
    $rev_mail2->Password = '94Z6g.;d1CSq';                           // SMTP password
