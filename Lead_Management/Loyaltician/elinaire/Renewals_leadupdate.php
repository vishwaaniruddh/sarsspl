                        ...
                        <div class="card m-b-30">
                            ...
                            <div class="card-body ">
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="leadid" value="<?php echo $leadid; ?>"
                                        name="leadid" placeholder="Lead Id *" required="true" readonly>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="LastName" name="LastName"
                                            placeholder="Last Name " value="<?php echo $row['LastName']; ?>" readonly
                                            required>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="Comments" name="Comments" class="form-control" rows="4" cols="50"
                                        required> </textarea>
                                </div>
                                ...
                                <div class="form-group" id="UpTime" style="display:none">
                                    ...
                                    <input type="text" name="dt1" id="dt1" class="form-control"
                                ...
                                <div class="form-group" style="display:none" id="showonclose">
                                    ...
                                    <select class="form-control" name="ClosedReason" id="ClosedReason">
                                        ...
                                        while ($qfetch = mysqli_fetch_array($qrycolse)) {
                                            ?>
                                            <option value="<?php echo $qfetch['CloseLeadReason']; ?>"
                                                id="<?php echo $qfetch['CloseLeadReason']; ?>">
                                                <?php echo $qfetch['CloseLeadReason']; ?></option>
                                        <?php } ?>
                                    </select>
