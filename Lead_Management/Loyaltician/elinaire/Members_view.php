...
<body class="sidebar-pinned" id="rightclick">
    ...
    <main class="admin-main">
        ...
        <section class="admin-content">
            ...
            //     } else if($contact1){
            //         $View = "select * from Members  where Static_LeadID IN (SELECT Lead_id FROM `Leads_table` where Status='5' and MobileNumber = '".$contact1."')  ";
            //     } else {
            ...
            // $usrid = $_SESSION['id'];
            $uid = 34;
            // $usrsql = mysqli_query($conn,"select * from Users where UserId = '".$uid."' ");
            // $usrsql_res = mysql_fetch_assoc($usrsql);
            // echo mysqli_num_rows($usrsql);
            // echo $rollid = $usrsql_res['roll_id'];
            ...
            <div class="container  pull-up">
                ...
                <!--    <input type="text" name="fname" class="form-control" value="<?php echo $_POST['fname']; ?>" id="fname">-->
                <!--    <br>-->
                <!--    <input type="submit" class="btn btn-primary" name="submit" value="Search">-->
                <!--</div>-->
                <!--                        <div class="form-group col-md-3">-->
                <!--                            <label for="contact">Contact 1</label>-->
                <!--                            <input type="text" name="contact1" class="form-control" value="<?php echo $_POST['contact1']; ?>" id="contact1">-->
                <!--                        </div>-->

                <!--                        <div class="form-group col-md-3">-->
                <!--                            <label for="fname">Contact 2</label>-->
                <!--                            <input type="text" name="contact" class="form-control" value="<?php echo $_POST['contact']; ?>" id="contact">-->
