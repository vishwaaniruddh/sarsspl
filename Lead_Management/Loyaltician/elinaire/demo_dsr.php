...
<?php include("config.php");
  //  $View="select * from Leads_table where leadEntryef='".$_SESSION['id']."'";
 	  $View="SELECT * FROM `Members` where Static_LeadID IN (SELECT Lead_id FROM `Leads_table` where Status='5') and DATE(entryDate)='".date("Y-m-d")."' or date(CancelationDate)='".date("Y-m-d")."'  ";
