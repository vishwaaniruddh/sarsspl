                            ...
                            <div class="media">
                                ...
                                <div class="media-body">
                                    <a class="btn btn-primary"
                                        href="Leadpdf/receipt.php?id=<?php echo $Static_LeadID; ?>">PDF</a>
                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <table border=1 class="table  m-t-20">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <?php echo $sql_result['MembershipDetails_Fee'] ?></td>
                                                    <td class="text-right">
                                                        <?php echo $sql_result['MembershipDts_NetPayment'] ?></td>
                                                ...
                                                <tr>
                                                    <td class="" colspan="1"
                                                        ...
                                                        <?php echo $sql_result['MembershipDts_PaymentMode']; ?></td>

                                                    <?php if ($State == "MAHARASHTRA") { ?>

                                                        <td class="text-center" colspan="2"
                                                            style="background-color:#FFFACD ; color: black; "><b>CGST @ 9%
                                                            </b></td>
                                                        <td class="text-right" colspan="1"
                                                            style="background-color:#FFFACD ; color: black; "><?= $CGST ?>
                                                        </td>

                                                    <?php } else { ?>
                                                        <td class="text-center" colspan="2" rowspan="2"
                                                            style="background-color:#FFFACD ; color: black; "><b>IGST @ 18%
                                                            </b></td>
                                                        <td class="text-right" colspan="1" rowspan="1"
                                                            style="background-color:#FFFACD; color: black; ">
                                                            <?php echo $CGST * 2; ?> </td>
                                                    <?php }
                                                    ?>
                                                ...
                                                <tr>
                                                    <td class="" colspan="1"
                                                        ...
                                                        Approval Code:
                                                        <?php echo $sql_result['MembershipDts_InstrumentNumber']; ?></td>

                                                    <?php if ($State == "MAHARASHTRA") { ?>
                                                        <td class="text-center" colspan="2"
                                                            style="background-color: #FFFACD; color: black; "><b>SGST @ 9%
                                                            </b></td>
                                                    ...
                                                    <?php } else { ?>
                                                        ...
                                                        <td class="text-right" colspan="1"
                                                            style="background-color: #FFFACD; color: black; "></td>
                                                    <?php } ?>
                                                ...
                                                <tr>
                                                    <td class="" colspan="1"
                                                        ...
                                                        LCRM - CY Marriott Vadodara- ClubElinaire Membership:</td>
                                                    <td class="text-center" colspan="2"
                                                        style="background-color:#ef9a9a;color:black">Total including
                                                        Taxes </td>
                                                    <td class="text-right" colspan="1"
                                                        style="background-color:#ef9a9a;color:black">
                                                        <?php echo $sql_result['MembershipDts_GrossTotal']; ?></td>
                                    ...
                                    <div class="p-t-10 p-b-20">
                                        <p class="text-muted ">
                                            Signed</br></br>
                                            For LCRM - CY Marriott Vadodara
                                        </p>
                                        <hr>
                                        <div class="text-center opacity-75">
                                            &copy; Loyaltician 2023
                                        </div>
                                    </div>
                                </div>
                            </div>
