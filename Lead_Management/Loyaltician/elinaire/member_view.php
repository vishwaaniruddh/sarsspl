                            ...
                            <div class="card-body">
                                    ...
                                    <select class="form-control" name="Primary_Title" id="Primary_Title" required>
                                        <?php if ($Mainid != "") { ?>
                                            <option value="<?php echo $fetchLead['Title']; ?>">
                                                <?php echo $fetchLead['Title']; ?></option><?php } ?>
                                        ...
                                        while ($fetchTitle = mysqli_fetch_array($runTitle)) { ?>
                                            <option value="<?php echo $fetchTitle['titleName']; ?>">
                                                <?php echo $fetchTitle['titleName']; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="Primary_Pincode"
                                            name="Primary_Pincode" onblur="getStateCity();"
                                            value="<?php if ($Mainid != "") {
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8 col-sm-8">
                                        ...
                                        <input type="text" class="form-control" id="Primary_Contact2"
                                            name="Primary_Contact2" maxlength="10"
                                            value="<?php if ($Mainid != "") {
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="email" class="form-control" id="Primary_Email_ID2"
                                        name="Primary_Email_ID2" placeholder="Email-ID "
                                        value="<?php if ($Mainid != "") {
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-8 col-sm-8">
                                            ...
                                            <input type="text" class="form-control" id="Spouse_mob1MArid1"
                                                name="Spouse_mob1MArid1" maxlength="10"
                                                value="<?php if ($Mainid != "") {
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Spouse_mcode1Married2"
                                                id="Spouse_mcode1Married2" maxlength="3"
                                                value="+<?php if ($Mainid != "") {
                                        ...
                                        <div class="form-group col-md-8 col-sm-8">
                                            ...
                                            <input type="text" class="form-control" id="Spouse_mob1MArid2"
                                                name="Spouse_mob1MArid2" maxlength="10"
                                                value="<?php if ($Mainid != "") {
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Spouse_Contact1codeMArid"
                                                id="Spouse_Contact1codeMArid" maxlength="3"
                                                value="<?php if ($Mainid != "") {
                                ...
                                --> <select class="form-control" name="MembershipDts_PaymentMode"
                                        ...
                                        while ($fetchMode = mysqli_fetch_array($runMode)) {
                                            ...
                                            <option value="<?php echo $fetchMode['Payment_mode']; ?>" <?php if ($fetchMode['Payment_mode'] == $fetchMem['MembershipDts_PaymentMode']) { ?>Selected
                                                <?php } ?>><?php echo $fetchMode['Payment_mode']; ?></option>
                                        <?php } ?>
                                    </select>
