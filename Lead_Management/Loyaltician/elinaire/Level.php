                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="card m-b-30">
                            ...
                            <form method="post" action="Level_process.php" enctype="multipart/form-data"
                                            ...
                                            <td>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-5">
                                                        <input type="text" class="code form-control" id="levelName"
                                                            name="levelName[]"
                                                            value="<?php echo $fetchlevel['level_name'] ?>"
