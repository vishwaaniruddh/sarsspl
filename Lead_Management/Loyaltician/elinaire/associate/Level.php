                            ...
                            <div class="form-group">
                                <label for="inputAddress">Hotel Name</label>&nbsp;
                                        ...
                                        <option value="">Select Hotel *</option>
                                         <?php 
                                          $abc="select Hotel_Name,hotel_id from Hotel_Creation ";
                                ...
                                <div class="form-group col-md-5">
                              	<input type="text" class="code form-control" id="levelName" name="levelName[]" value="" placeholder="Level Name" required/> &nbsp;
                                    		  </div>
                                <div class="form-group col-md-5">
                                   
                               		<input type="text" class="code form-control" id="price" name="price[]" value="" placeholder="Price" required/> &nbsp;
                                    
                                    	 </div>
                                    	  <div class="form-group col-md-2">	 <a href="javascript:void(0);" class="addCF">Add</a></div>
                            </div>
...
<script>
	...
	$(".addCF").click(function(){
		$("#customFields").append('<tr valign="top"><td><input type="text" class="code" id="levelName" name="levelName[]" value="" placeholder="Level Name" /> &nbsp; <input type="text" class="code" id="price" name="price[]" value="" placeholder="Price" /> &nbsp; <a href="javascript:void(0);" class="remCF">Remove</a></td></tr>');
	});
