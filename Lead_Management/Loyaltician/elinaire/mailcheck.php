...
$nodes = 'sendmailapi.sarmicrosystems.in/testelinairemailapi.php';
// $nodes = 'sendmailapi.sarmicrosystems.in/blank.php';
$EmailSubject2="Testing Welcome to Club Elinaire!";
$subject = $EmailSubject2 ; 

$Primary_name = "Dr. Chhavi Gautam";

$attachment = "https://loyaltician.in/elinaire/Leadpdf/memberpdf/$Primary_name.pdf";


$Static_LeadID = 9820;
      
        $message2 ='<table width="50%" align="center"><td><img style="width:60%;padding-left:20%" id="Picture 4" src="http://loyaltician.in/elinaire/newassets/elinaire_mail_head.jpeg"></td></table>
                  ...
                  <tr>
                    ...
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                        <p align="right" style="text-align:center">
                          <span style="text-decoration:none"><img border="0" width="130" style="width:3.3541in" src="http://loyaltician.in/elinaire/newassets/elinaire_logo.jpeg" alt="The Resort Mumbai Classic">
                          </span>
                       <u></u><u></u></p>
                    </td>
                  </tr>
...
enhanced benefits, unparalleled experiences and a great time for you with us this upcoming year!</span></p>
                          ...
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>Your Membership Card number is 1233456'.'. </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>The membership is valid till . </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN> </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in">
                          <span lang=EN-IN>The annual membership charge of Rs.  + 18% Goods &amp; Services Tax amounting to Rs.  .  /- ( )
has been received by '.'.  A receipt is enclosed in
...
$htmtab1='<table border="1" cellpadding="5">
                                        ...
                                        <tr>
                                            <td colspan="4"><b>Name :</b> '.$Primary_name.' </td>
                                            <td colspan="1"><b>Invoice / Receipt: </b></td>
                                            <td colspan="1">'.$receipt_no.'</td>
                                        </tr>
                                        <tr>

                                            <td colspan="4"><b>Phone: </b>'.'1234567890'.'</td>
                                            <td colspan="2"><b>Membership Details</b></td>
                                        </tr>


                                        <tr>
                                            <td class="" colspan="4"><b>Email :</b> tes@gmail.com </td>
...
$bccc = array(
    '0'=>'rajeshrungta719@gmail.com',
    '1'=>'hellbinderkumar@gmail.com',
    );
$cc = [];
$bcc  = ["rajeshrungta719@gmail.com","hellbinderkumar@gmail.com"];
$to = 'hellbinderkumar@gmail.com';
// $to = 'rajeshbiswas@sarmicrosystems.in';
// $to = 'durgesh@prolyftdigital.com';

$attach = "$Primary_name.pdf";
$filepath = "https://loyaltician.in/resortmumbai/Leadpdf/memberpdf";
