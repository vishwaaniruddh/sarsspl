...
class MYPDF extends TCPDF {
    ...
    $To=$_POST['To1'];
       ...
       $image_file ='LoyalticianLogo.jpg';
        $this->Image($image_file, 130, 4, 35, '', 'jpg', '', 'T', false, 300, '', false, false, 0, false, false, false);

       $image_file ='../newassets/elinaire_logo.jpeg';
        $this->Image($image_file, 10, 4, 35, '', 'jpg', '', 'T', false, 300, '', false, false, 0, false, false, false);

        $this->Ln(22);
        // Set font
        $this->SetFont('helvetica', 'B', 15);
          $this->Cell(0, 10,'Club Elinaire', 0, false, 'L', 0, '', 0, false, 'M', 'M');
          $this->Ln();
...
<tr>
<th>Select</th><td>'.$QfetchGold['0'].'</td>
</tr>
<tr>
<th>Plus</th><td>'.$QfetchPlatinum['0'].'</td>
</tr>
<tr>
<th>Premium</th><td>'.$QfetchIvory['0'].'</td>
</tr>
<tr style="background-color:gray">
