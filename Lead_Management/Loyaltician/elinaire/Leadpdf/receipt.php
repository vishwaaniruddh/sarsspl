...
$Address = $sql_result['Primary_BuldNo_addrss'].' '.$sql_result['Primary_Area_addrss'].' '.$sql_result['Primary_Landmark_addrss'];
$membershipId = $sql_result['GenerateMember_Id'];
if($memGST){
...
$Pincode = $leads_sql_result['PinCode'];
...
$htmtab1='<table border="1" cellpadding="5">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <img src="../newassets/elinaire_logo.jpeg" style="margin-left:250px;height:60px;">
                                            </th>
                                            </tr>

                                            <tr>
                                            <th colspan="6" style="font-size:20px;font-weight:700;text-align:center;"> LCRM - CY MARRIOTT VADODARA	</th>
                                            </tr>
                                            
                                            <tr>
                                            <th colspan="6" style="font-size:20px;font-weight:700;text-align:center;"> Loyaltician CRM India Private Limited	</th>
                                            </tr>
                                            ...
                                            E Mail:contactus@clubelinaire.com Website : www.clubelinaire.com 
</th>
                                            </tr>
                                        ...
                                        <tr>
                                            <td colspan="4"><b>Attention Name :</b> '.$Primary_nameOnTheCard.' </td>
                                            <td colspan="1"><b>Invoice / Receipt: </b></td>
                                            <td colspan="1">'.$receipt_no.'</td>
                                        </tr>
                                        <tr>

                                            <td colspan="4"><b>Address: </b>'.$Address.' '.$City.', '.$state.' '.$Pincode.'</td>
                                            <td colspan="2" style="background-color: #b48a1c; color: black; "><b>Membership Details</b></td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="1"><b>Membership :</b></td>
                                            <td colspan="1">'.$membershipId.'</td>
                                        </tr>
                                    ...
                                    <tr>
                                            <td class="" colspan="3" style="padding-top: 10px; padding-bottom: 60px; ">'.$level.' Annual Membership: </td>
                                           <td colspan="1">1</td>
                                        ...
                                        <tr>
                                            <td class="" colspan="3" style="background-color: #b48a1c; color: black; ">Received by : '.$MembershipDts_PaymentMode.'</td>';
                                             ...
                                             if($State=="MAHARASHTRA"){
                                                    ...
                                                    $htmtab1 .='<td colspan="2" style="background-color: ; color: black; "><b>CGST @ 9% </b></td>
                                       ...
                                       <tr>
                                        <td class="" colspan="3" style="padding-top: 10px; padding-bottom: 40px; ">Terms and Conditions<br>
