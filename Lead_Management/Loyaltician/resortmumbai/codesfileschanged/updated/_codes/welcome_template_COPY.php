...
function classic($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf){
     global $conn;
...
enhanced benefits, unparalleled experiences and a great time for you with us this upcoming year!</span></p>
                          ...
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN> </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in">
                          <span lang=EN-IN>The annual membership charge of Rs. 7500 + 18% Goods &amp; Services Tax amounting to Rs. 8850 /- (Rupees Eight Thousand Eight Hundred and Fifty only)
...
function signature($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf)
{
     global $conn;
    $EmailSubject2="Welcome to The Resort Mumbai !";
...
//==============mail end===
 ...
 function ivory($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf)
 {
     global $conn;
