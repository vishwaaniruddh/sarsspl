                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> View Additional Issued Voucher Details
                        </h4>
                    </div>
                </div>
            </div>
...
<?php include("config.php");
  //  $View="select * from Leads_table where leadEntryef='".$_SESSION['id']."'";
 	  $View="select * from voucher_issued_additional ";
...
?>
	...
	$sql3="select voucher_name from issue_voucher_code where v_id='".$_row['v_id']."'";
  ...
  ?>
	...
	<td><?php echo $_row['voucher_name']; ?></td>
...
<td><input type="button" onclick="window.open('voucher_issued_additional.php?id=<?php echo $_row['v_id'];?>','_self');" value="Edit Voucher">  </td>
