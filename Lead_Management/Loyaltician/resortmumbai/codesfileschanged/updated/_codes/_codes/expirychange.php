                            ...
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="button" class="btn btn-primary" name="submit" onclick="searchfiltter()" value="Search">
                                </div>
                                            ...
                                            <tbody id="setTable">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php if ($_SESSION['usertype'] == 'Admin' || $_SESSION['usertype'] == 'HOTEL MANGER') { ?><td>
                                                        <?php
                                                        ...
                                                        ?></td><?php } ?>
                                                        <?php if ($_SESSION['usertype'] == 'Admin') { ?> <td>
                                                        <?php
                                                        ...
                                                        ?>
                                                            ...
                                                            <td><?php echo date('d-m-Y',strtotime($mem_detail_res['ExpiryDate'])) ;?></td>
                                                        
                                                        <td><?php if ($_SESSION['usertype'] == 'Admin') { ?><input type="button" class="btn btn-primary" onclick="window.open('update_expirydate.php?id=<?php echo $_row['Lead_id']; ?>&excelid=0','_self');" value="Edit"><?php } ?> </td>
