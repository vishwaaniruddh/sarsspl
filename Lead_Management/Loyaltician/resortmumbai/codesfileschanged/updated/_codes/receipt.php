 ...
 <div class="table-responsive ">
                                    ...
                                    <tr >
                                           ...
                                           <td class="text-center" >1</td>
                                            ...
                                            <td class="text-right"><?php echo $sql_result['MembershipDts_NetPayment']?></td>
                                        ...
                                        <tr>
                                            <td class="" colspan="1" style="background-color:#ef9a9a;color:black">Cheque Favouring - Loyaltician CRM India Private Limited- theresortmumbai Membership:</td>
