...
function addTime($time, $days, $months, $years)
{
    ...
    return $date_time->format('Y-m-d');
                        ...
                        if($sql4fetch['Leval_id']=='1'){
                             classic($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,1,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf);

                        }
    else if($sql4fetch['Leval_id']=='2'){
                             signature($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,2,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf);

    }


     else if($sql4fetch['Leval_id']=='3'){
                             ivory($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,3,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf);
