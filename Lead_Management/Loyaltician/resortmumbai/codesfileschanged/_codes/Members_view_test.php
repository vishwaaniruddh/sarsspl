                                ...
                                <div class="card-body">
                                       <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" id="contact_form">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="contact2" class="form-control" value="<?php echo $_POST['contact2']; ?>" id="contact2">
                                        </div>
                                        
                                        <div class="form-group col-md-3">
                                            <label for="memid">Membership Number</label>
                                            <input type="text" name="memid" class="form-control" value="<?php echo $_POST['memid']; ?>" id="memid">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" class="btn btn-danger" onclick="promotional_voucher(<?php echo $_row['Static_LeadID']; ?>)">Assign Voucher</a>
                                                        <?php } else { 
