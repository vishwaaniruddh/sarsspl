                                ...
                                <div class="card-body">
                                       <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST" id="contact_form">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <input type="text" name="contact" maxlength="10" class="form-control" value="<?php echo $_POST['contact']; ?>" id="contact">
                                            <br>
                                            ...
                                            <tbody id="setTable">
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <?php if ($_SESSION['usertype'] == 'Admin') {
                                                            if ($_row['Status'] == '0') { ?> <td><input type="checkbox" name="check[]" value="<?php echo $_row['Lead_id']; ?>"></td>
                                                            <?php } else { ?><td> </td> <?php }
                                                                                } ?>
