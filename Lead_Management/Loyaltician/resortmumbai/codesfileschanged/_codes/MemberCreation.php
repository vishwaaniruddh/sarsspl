                             ...
                             <div class="custom-control custom-checkbox">
                              ...
                              <div class="custom-control custom-checkbox">
                               ...
                               <div class="custom-control custom-checkbox">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="RenewalCheck1" name="RenewalCheck1">
                                    <label class="custom-control-label" for="RenewalCheck1">Issue Renewal Certificate</label>
                                </div>

                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="ExpiryCheck_0" name="ExpiryCheck1" onclick="expirycheck('0')">
                                ...
                                <div class="form-row" style="display:none" id="new">
                                    <div class="form-group col-md-6" id="actual">
                                        ...
                                        <input type="text" class="form-control" id="ActualExpiry"  name="ActualExpiry" value="<?php echo $expirydate;?>" placeholder="Actual Expiry" readonly >
                                    </div>

                                    <div class="form-group col-md-6"  id="changed">
                                        <label for="ActualExpiry">Changed Expiry</label>
                                        <input type="date" class="form-control" id="ChangedExpiry"  name="ChangedExpiry" placeholder="New Expiry">
                                    </div>
                                </div>
