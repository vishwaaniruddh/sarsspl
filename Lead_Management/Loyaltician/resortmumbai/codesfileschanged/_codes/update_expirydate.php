            ...
            <div class="row">
              ...
              <option value="India" <?php if($Main_id!=""){?>selected<?php }else{?>selected <?} ?>>India</option>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="Gmail" name="Gmail" value="<?php if($Main_id!=""){echo $qeryfetch['EmailId'];?>  <?php }?>" placeholder="Email"  <?php if($Main_id!=""){?>     <?php }else{ ?>  <?php } ?> readonly>
                            </div>

                            
                             <div class="form-group">
                                <label for="inputAddress2">Pincode</label>
                                <input type="text" class="form-control" onblur="getStateCity();"  id="Pincode" name="Pincode" value="<?php if($Main_id!=""){echo $qeryfetch['PinCode'];}?>" Placeholder="Pincode"  onkeypress="return isNumber(event)"  maxlength="6" required readonly>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="ExpiryDate" name="ExpiryDate" value="<?php if($Main_id!=""){echo $mem_detail_res['ExpiryDate'];}?>" placeholder="Expiry Date *" required="true">
                                </div>
