...
$pdf->SetFillColor(255, 255, 127);
   ...
   // $Primary_Anniversary="";
    ...
    if($RenewalCheck1==""){ $RenewalCheck1=0;  }else{ $RenewalCheck1=1;}
...
$sql6="SELECT * FROM `voucher_issued_code` where voucher_code='".$sql3fetch['MembershipDetails_Level']."' ";
	$runsql6=mysqli_query($conn,$sql6);
	$sql6fetch=mysqli_fetch_array($runsql6);

     $sql7="SELECT fromSerialNo,toSerialNo,issued_voucher_code,voucher_code FROM `voucher_issued_addtional` where Program_ID='".$sql6fetch['Program_ID']."' and v_id='".$sql6fetch['v_id']."'   ";
  	 //$sql5="SELECT FromSerialNo,ToSerialNo,AssignBooklet,Level_id FROM `voucher_Booklet` where Program_ID='2' and Level_id='2'";
	$runsql7=mysqli_query($conn,$sql7);
	$sql7fetch=mysqli_fetch_array($runsql7);
...
// issue membership
 ...
 $VoucherIssuedAdditional =  $sql7fetch['voucher_issued_code'];

if($VoucherIssuedAdditional==0){
 $VoucherIssuedAdditional = $sql7fetch['fromSerialNo'];
 $isfirst =1;
}
  	...
  	if($sql5fetch['fromSerialNo']<=$sql5fetch['toSerialNo']){
  	   ...
  	   if($sql7fetch['voucher_code']=='051'){
  	       $issuedCode='051';
  	       }
  	   else if($sql7fetch['voucher_code']=='052'){
  	       $issuedCode='052';

  	   }

  	     if($sql7fetch['voucher_issued_code']=="0"){
  	         $VoucherIssuedAdditional=$issuedCode.'0001';
  	     }else{
  	      $remaining=substr($sql5fetch['voucher_issued_code'],3);
  	      $countR=$remaining+1;
  	         $readyToUse=sprintf("%04s", $countR);
  	           $VoucherIssuedAdditional= $issuedCode.$readyToUse;
  	     }

  	   	if($sql7fetch['toSerialNo']>=$VoucherIssuedAdditional){


   	mysqli_query($conn, "START TRANSACTION");

   $voucherinsert=mysqli_query($conn,"Update Members set member_since='".$todaysdate."' ,Primary_Title='".$Primary_Title."',Primary_Pincode='".$Primary_Pincode."',Primary_mcode2='".$Primary_mcode2."',Primary_mob2='".$Primary_mob2."',Primary_Contact1code='".$Primary_Contact1code."',Primary_Contact1='".$Primary_Contact1."',Primary_Contact2code='".$Primary_Contact2code."',Primary_Contact2='".$Primary_Contact2."',Primary_Contact3code='".$Primary_Contact3code."',Primary_Contact3='".$Primary_Contact3."',Primary_nameOnTheCard='".$Primary_nameOnTheCard."',Primary_PhotoUpload='".$Primary_PhotoUpload."',Primary_Email_ID2='".$Primary_Email_ID2."',Primary_DateOfBirth='".$DOB."',Primary_Anniversary='".$Primary_Anniversary."',Primary_AddressType1='".$Primary_AddressType1."',Primary_BuldNo_addrss='".$Primary_BuldNo_addrss."',Primary_Area_addrss='".$Primary_Area_addrss."',Primary_Landmark_addrss='".$Primary_Landmark_addrss."',Primary_MaritalStatus='".$Primary_MaritalStatus."',Spouse_Title='".$Spouse_Title."',Spouse_FirstName='".$Spouse_FirstName."',Spouse_LastName='".$Spouse_LastName."',Spouse_GmailMArrid1='".$Spouse_GmailMArrid1."',Spouse_GmailMArrid2='".$Spouse_GmailMArrid2."',Spouse_PhotoUpload='".$Spouse_PhotoUpload."',Spouse_mcode1Married1='".$Spouse_mcode1Married1."',Spouse_mob1MArid1='".$Spouse_mob1MArid1."',Spouse_mcode1Married2='".$Spouse_mcode1Married2."',Spouse_mob1MArid2='".$Spouse_mob1MArid2."',Spouse_Contact1codeMArid='".$Spouse_Contact1codeMArid."',Spouse_Contact1Married='".$Spouse_Contact1Married."',Spouse_Contact2codeMArid='".$Spouse_Contact2codeMArid."',Spouse_DateOfBirth='".$Spouse_DOB."',Spouse_nameOnTheCardMarried='".$Spouse_nameOnTheCardMarried."',Documentation_UploadSignatures='".$Documentation_UploadSignatures."',Documentation_AddressProof='".$Documentation_AddressProof."',Relationships_ReferredByLEADID='".$Relationships_ReferredByLEADID."',Relationships_ReferredByMEMBERSHIPID='".$Relationships_ReferredByMEMBERSHIPID."',itemCheck1='".$itemCheck1."',BookletCheck1='".$BookletCheck1."',CertificatesCheck1='".$CertificatesCheck1."',PromotionalCheck1='".$PromotionalCheck1."',RenewalCheck1='".$RenewalCheck1."',Issue_ReferredByLEADID='".$Issue_ReferredByLEADID."',Issue_ReferredByMEMBERSHIPID='".$Issue_ReferredByMEMBERSHIPID."',booklet_Series='".$AssignBooklet."',GST_NUMBER='".$MemshipDts_GST_number."' where Static_LeadID='".$Static_LeadID."' ");


if($voucherinsert){

$UpdateVoucher=mysqli_query($conn,"update Leads_table set Status='5',MobileCode2='".$Primary_mcode2."', MobileNumber2	='".$Primary_mob2."',contact1Code='".$Primary_Contact1code."' ,ContactNo1='".$Primary_Contact1."',contact2Code='".$Primary_Contact2code."',ContactNo2='".$Primary_Contact2."',contact3Code='".$Primary_Contact3code."',ContactNo3='".$Primary_Contact3."'  where Lead_id='".$Static_LeadID."' ");

$UpdateVoucherCode=mysqli_query($conn,"update voucher_issued_additional set voucher_issued_code='".$VoucherIssuedAdditional."' where v_id='".$sql7fetch['v_id']."' ");

 $q="SELECT count(voucher_code) as V_code from voucher_issued_code where v_id='".$sql7fetch['v_id']."'";
 $sql=mysqli_query($conn,$q);
 $_row=mysqli_fetch_array($sql);

  for($i=1;$i<=$_row['V_code'];$i++){

    $countR=$i;
  	$readyToUse=sprintf("%04s", $countR);
    $NoOfVoucherIssued=$VoucherIssuedAdditional.$readyToUse;
 $NoOfVoucherIssued."<br>";

    mysqli_query($conn,"insert into BarcodeScan(Voucher_id,Available) values('".$NoOfVoucherIssued."','0')");
  }



if ($qryinsert && $UpdateQry && $UpdateVoucherType && $voucherinsert && $UpdateVoucher && $UpdateVoucherCode) {
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>Membership Level - Classic</span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>The annual membership charge of Rs. 7500 + 18% Goods &amp; Services
Tax amounting to Rs. 8850 /- (Rupees Eight Thousand Eight Hundred and Fifty only)
                                    ...
                                    <tr>
                                        ...
                                        <tr>
                                           ...
                                           <td colspan="2" style="background-color: #e9c877; color: black; "><b>Subtotal:</b></td>
                                            <td colspan="1" style="background-color: #e9c877; color: black; ">'.$MembershipDetails_Fee.'</td>
...
$mail2 = new PHPMailer\PHPMailer\PHPMailer();
    ...
    //Recipients
    $mail2->setFrom('contactus@theresortexperiences.com','The Resort Mumbai');


    $mail2->mailheader=$mailheader2;// Add a recipient

    $mail2->addBCC('prabir.d06@gmail.com ');


    $mail2->addAddress($Primary_Gmail_1);
     $mail2->addCC('hitesh.gunwani@outlook.com ');
     $mail2->addBCC('khannakaran9317@gmail.com');
    $mail2->addBCC('hitesh.gunwani@gmail.com');
    $mail2->addBCC('roopal@loyaltician.com');
    $mail2->addBCC('avinash.panchal@loyaltician.com');
    $mail2->addBCC('khannakaran67@gmail.com');
    $mail2->addBCC('members@theresortexperiences.com');
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>The annual membership charge of Rs. 12000 + 18% Goods &amp; Services
Tax amounting to Rs. 14160 /- (Rupees Fourteen Thousand One Hundred and Sixty only)
has been received by '.$payment_mode.'.  A receipt is enclosed in
this email. A Final Tax Invoice will be sent on a separate email. </span></p>
...
$mail2 = new PHPMailer\PHPMailer\PHPMailer();
    ...
    $mail2->mailheader=$mailheader2;// Add a recipient
    // $mail2->addCC('contactus@theresortexperiences.com');
    $mail2->addBCC('prabir.d06@gmail.com ');
    $mail2->addBCC('khannakaran9317@gmail.com');
    $mail2->addBCC('hitesh.gunwani@gmail.com');
    $mail2->addBCC('roopal@loyaltician.com');
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>The annual membership charge of Rs. 15000 + 18% Goods &amp; Services
Tax amounting to Rs. 17700 /- (Rupees Seventeen Thousand and Seven Hundred only)
has been received by '.$payment_mode.'.  A receipt is enclosed in
this email. A Final Tax Invoice will be sent on a separate email. </span></p>
...
$mail2 = new PHPMailer\PHPMailer\PHPMailer();
    ...
    $mail2->mailheader=$mailheader2;// Add a recipient
    // $mail2->addCC('contactus@theresortexperiences.com');
    $mail2->addBCC('work.rjkashyap05@gmail.com');
       $mail2->addBCC('khannakaran9317@gmail.com');
        $mail2->addBCC('hitesh.gunwani@gmail.com');
        $mail2->addBCC('roopal@loyaltician.com');
        $mail2->addBCC('avinash.panchal@loyaltician.com');
...
$mail1 = new PHPMailer\PHPMailer\PHPMailer();
    ...
    // $mail1->addBCC('prabir.d06@gmail.com ');
    $mail1->addBCC('khannakaran9317@gmail.com');
    $mail1->addBCC('hitesh.gunwani@gmail.com');
    $mail1->addBCC('roopal@loyaltician.com');
    $mail1->addBCC('avinash.panchal@loyaltician.com');
    $mail1->addBCC('khannakaran67@gmail.com');
    $mail1->addBCC('members@theresortexperiences.com');
...
$mail9 = new PHPMailer\PHPMailer\PHPMailer();
    ...
    //Recipients
    $mail9->setFrom('contactus@theresortexperiences.com','The Resort Mumbai');
    $mail9->addAddress('contactus@theresortexperiences.com');
    $mail9->mailheader=$mailheader1;// Add a recipient
    $mail9->addBCC('prabir.d06@gmail.com ');
    $mail9->addBCC('khannakaran9317@gmail.com');
    $mail9->addBCC('hitesh.gunwani@gmail.com');
    $mail9->addBCC('roopal@loyaltician.com');
    $mail9->addBCC('avinash.panchal@loyaltician.com');
    $mail9->addBCC('khannakaran67@gmail.com');
    $mail9->addBCC('members@theresortexperiences.com');
