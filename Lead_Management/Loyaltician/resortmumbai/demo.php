...
$Primary_nameOnTheCard = 'Aniruddh';
...
function signature($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,
$AdditionalPromotionalAssignBooklet,$pdf,$MembershipDts_NetPayment,$MembershipDts_GrossTotal,$AssignBooklet)
{
     global $conn,$bcc;
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>Membership Booklet Number is '.$member_id.'. </span></p>
...
$leadsmail = $leadsmail2;
 ...
 // 'attachment' => "https://loyaltician.in/resortmumbai/Leadpdf/memberpdf/$Primary_nameOnTheCard.pdf",    
    ...
    $Primary_Gmail_1 = 'vishwaaniruddh@gmail.com';
...
signature('vishwaaniruddh@gmail.com','Aniruddh',12445771,'2023-1-2','Online',2,24,NULL,NULL,$pdf,7500,8850,12000001) ; 
