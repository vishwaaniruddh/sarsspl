...
<!--site header ends -->    <section class="admin-content ">
                              ...
                              <!--  <button class="btn btn-white-translucent" id="printDiv" > <i class="mdi
                                mdi-printer"></i>
                                    Print</button>-->
                                      ...
                                      <form method="POST" action="Member_Payment_Process1.php" onsubmit="return validation()"  enctype="multipart/form-data" >
                           ...
                           <div class="custom-control custom-checkbox">&nbsp;&nbsp;&nbsp;
                               ...
                               <div class="custom-control custom-checkbox" id="sample" >
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="textarea" class="form-control" id="MembershipDts_Discount_Remark" name="MembershipDts_Discount_Remark" value="<?php if( $_POST['MembershipDts_Discount_Remark']==""){ echo '0';}else{echo $_POST['MembershipDts_Discount_Remark'];} ?>" readonly >
                                 </div>
 ...
 <div class="table-responsive ">
                                    ...
                                    <tr >
                                        ...
                                        <tr>
                                            <td class="" colspan="1" style="background-color:#ef9a9a;color:black">Cheque Favouring - K. Raheja Corp Pvt. Ltd.</td>
