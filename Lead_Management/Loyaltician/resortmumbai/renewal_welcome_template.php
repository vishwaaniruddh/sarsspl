...
$bcc = ['hitesh.gunwani@gmail.com', 'roopal@loyaltician.com', 'digambar@loyaltician.com', 'Bharati@theresortexperiences.com' ,'Experiences@theresortmumbai.com'];

function classic($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$MembershipDts_NetPayment,$MembershipDts_GrossTotal,$AssignBooklet){
     global $conn,$bcc;
    ...
    // $nodes = 'sendmailapi.sarsspl.com/resortapitest.php';
    $nodes = 'https://sarsspl.com/sendmailapi/renewal_mail_test.php';
     
    $attachment = "https://sarsspl.com/Lead_Management/Loyaltician/resortmumbai/Leadpdf/memberpdf/$Primary_nameOnTheCard.pdf";

    $EmailSubject2="Welcome to The Resort Mumbai !";
    $message2 ='<table width="50%" align="center"><td><img style="width:100%;" id="Picture 4" src="https://sarsspl.com/Lead_Management/Loyaltician/resortmumbai/newassets/image001.jpg"></td></table>
                    ...
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                      <p>
                        <span style="text-decoration:none">
                          <img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/resortmumbai/newassets/image002.png" alt="The Resort Mumbai Classic"></span>
                        <u></u><u></u></p>
                    </td>
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                        <p align="right" style="text-align:right">
                          <span style="text-decoration:none"><img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/resortmumbai/newassets/image003.png" alt="The Resort Mumbai Classic">
                          </span>
                       <u></u><u></u></p>
                    </td>
                  </tr>
...
lang=EN-IN><a href="https://www.theresortexperiences.com">www.theresortexperiences.com</a></span><span
lang=EN-IN> </span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN><a href="https://www.theresortexperiences.com"><span style="font-size:12.0pt;
...
$htmtab1='<table border="1" cellpadding="5">
                                        <tbody>
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <img src="https://sarsspl.com/Lead_Management/Loyaltician/resortmumbai/Leadpdf/logoai.jpg" style="margin-left:200px;height:60px;">
                                            </th>
                                            </tr>
...
function signature($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$MembershipDts_NetPayment,$MembershipDts_GrossTotal,$AssignBooklet)
{
     global $conn,$bcc;
...
<td>
<img style="width:100%;" id="Picture 4" src="https://sarsspl.com/Lead_Management/Loyaltician/resortmumbai/newassets/image001.jpg">
...
<td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
<p>
      <img border="0" width="130" style="width:5.5541in" src="https://sarsspl.com/Lead_Management/Loyaltician/resortmumbai/newassets/Picture3.jpg" alt="The Resort Mumbai Signature">
</p>
</td>
</tr>
</tbody>
...
<p align="right" style="text-align:left">
  <span style="text-decoration:none">
    <img border="0" width="130" style="width:0.9541in" src="https://sarsspl.com/Lead_Management/Loyaltician/resortmumbai/newassets/image003.png" alt="The Resort Mumbai Signature">
  </span>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN><b>A Warm Welcome to The Resort Experiences!</b></span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>Membership Booklet Number is '.$AssignBooklet.'. </span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>
The annual membership charge of Rs. '.$MembershipDts_NetPayment.'. + 18% Goods &amp; Services
Tax amounting to Rs. '.$MembershipDts_GrossTotal.'. /- ( '.getIndianCurrency($MembershipDts_GrossTotal).')
has been received by '.$payment_mode.'. A receipt for the payment is enclosed in this email. A Final Tax Invoice will be sent on a separate email. </span></p>

<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>&nbsp;</span></p>

<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>You can present your membership number and a copy of this email to start using your membership card benefits.</span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>
The complete welcome package will reach you within 10 working days of this e-mail. Your membership certificates
included in the membership package are given at the bottom of this email.
</span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>
We will look forward to your visits!
</span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>
<a href="https://www.theresortexperiences.com"><span style="font-size:12.0pt;
line-height:107%">www.theresortexperiences.com</span></a>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>
<a href="mailto:experiences@theresortmumbai.com"><span style="font-size:12.0pt;
line-height:107%">experiences@theresortmumbai.com</span></a>
</span><span lang=EN-IN
style="font-size:12.0pt;line-height:107%"> </span></p>
...
$message2 .= '<tr style="height:14.5pt">
  ...
  <td width=329 valign=top style="width:247.0pt;border:solid windowtext 1.0pt;
  padding:0in 5.4pt 0in 5.4pt;height:14.5pt">
  <p class=MsoNormal style="margin-bottom:0in;line-height:normal"><span
  lang=EN-IN style="font-size:10.5pt;
  border:none windowtext 1.0pt;padding:0in;background:white">'. $sql2fetch['serviceName'].'</span></p>
...
var_dump($response);
 ...
 function ivory($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$MembershipDts_NetPayment,$MembershipDts_GrossTotal,$AssignBooklet)
 {
     global $conn,$bcc;
...
<p>
      ...
      <span style="text-decoration:none">
      <img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/resortmumbai/newassets/image002.png" alt="The Resort Mumbai Ivory"></span>
    <u></u><u></u></p>
</td>
<td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
<p align="right" style="text-align:right">

  <span style="text-decoration:none"><img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/resortmumbai/newassets/image003.png" alt="The Resort Mumbai Ivory">
  </span>
