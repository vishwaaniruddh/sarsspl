                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            function checkmember($id)
                            {
                                ...
                                $sql = mysqli_query($conn, "select Static_LeadID from Members where Static_LeadID='" . $id . "'");
                            ...
                            $View = "select * from Leads_table where leadEntryef='" . $_SESSION['id'] . "' or created_by ='" . $_SESSION['id'] . "'";
                                        ...
                                        <tbody>
                                            ...
                                            while ($_row = mysqli_fetch_array($qrys)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $_row['Designation']; ?>
                                                    </td>
                                                    <td>
                                                        <?php echo checkmember($id); ?>
                                                    </td>
