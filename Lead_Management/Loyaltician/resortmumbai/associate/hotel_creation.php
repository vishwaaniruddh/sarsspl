                    ...
                    <div class="card m-b-30">
                        ...
                        <div class="card-body ">
                            <div class="form-group">
                                <label for="inputAddress">Program</label>&nbsp;
                                        <select class="form-control"  name="Program" id="Program"  required>
                                        <option value="">Select Program *</option>
                                         <?php 
                                          $abc="select * from Program ";
                                          $runabc=mysqli_query($conn,$abc);
                                          while($fetch=mysqli_fetch_array($runabc)){?>
                                          <option value="<?php echo $fetch['Program_ID'];?>" id="<?php echo $fetch['Progam_name']?>"><?php echo $fetch['Progam_name'];?></option>
                                         <?php } ?>
                                         </select> 
