            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        ...
                        <form action="lead_entry1_process.php" method="POST">
                        ...
                        <div class="card-body ">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="Gmail" name="Gmail" placeholder="Email *" onblur="chkmailexs();" >
                            </div>
                            
                            
                            <div class="form-group" style="display:none">
                                <label for="inputAddress2">State</label>
                                <select class="form-control"  name="state" id="state" onchange="modelnos()" >
                                        <option value=" ">Select State</option>
                                          ...
                                          while ($fetch = mysqli_fetch_array($runabc)) { ?>
                                              <option value="<?php echo $fetch['state_id']; ?>" <?php if ($fetch['state_id'] == "1") { ?> selected="selected"<?php } ?>><?php echo $fetch['state'] ?></option>
                                         <?php } ?>
                                          </select>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-8 col-sm-8">
                                    ...
                                    <input type="text" class="form-control" id="mob1" name="mob1" maxlength="10" onkeypress="return isNumber(event)" onchange="chkmobile();" placeholder="Mobile number" Required>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input type="text" class="form-control" name="Contact1code" id="Contact1code" value="022" onkeypress="return isNumber(event)" maxlength="3" placeholder="eg. 022">
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                            ...
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary" id="submitbtn" name="submitbtn" value="Submit" onclick="submitfun()">
                            </div>
                        </div>
