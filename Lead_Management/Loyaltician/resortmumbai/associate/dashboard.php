...
<body class="sidebar-pinned page-home">
    ...
    <main class="admin-main">
        ...
        <section class="admin-content">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <p class="opacity-75 ">
                            ...
                            Thank you for participating in the lead generation exercise for the membership of your
                            hotel.<br /> Start by clicking on new Prospect or track your productivity on the dashboard.
                            Good luck.
                        </p>
            ...
            $sql = "select count(Lead_id) from Leads_table where (leadEntryef='" . $_SESSION['id'] . "' or created_by='" . $_SESSION['id'] . "') and date(Creation)='" . $dates . "'";
            $runsql = mysqli_query($conn, $sql);
            $fetchrun = mysqli_fetch_array($runsql);

            $sqlLead = "select count(Lead_id) from Leads_table where (leadEntryef='" . $_SESSION['id'] . "' or created_by='" . $_SESSION['id'] . "') and date(Creation) between '" . $FirstDate . "' and '" . $LastDate . "'";
            $runsqlLead = mysqli_query($conn, $sqlLead);
            $fetchMonthLead = mysqli_fetch_array($runsqlLead);


            $yearLead = "select count(Lead_id) from Leads_table where (leadEntryef='" . $_SESSION['id'] . "' or created_by='" . $_SESSION['id'] . "') and date(Creation) between '" . $start_year . "' and '" . $end_year . "'";
            //echo $yearLead;
            ...
            $sql = "select Lead_id from Leads_table where  (leadEntryef='" . $_SESSION['id'] . "' or created_by='" . $_SESSION['id'] . "') and date(Creation)='" . $dates . "'";
            $runsql = mysqli_query($conn, $sql);
                    ...
                    <div class="card-body">
                        ...
                        <div class="m-b-10">
                            <div class="row">
                                <div class="col">
                                    <p class="m-b-5">
                                        <?php echo $fetchrun[0]; ?> <span class="text-muted">Today Leads Added</span>
                                    </p>
                                </div>
                                <?php if ($fetchrun[0] == "0") {
                                    $width = '0%';
                        ...
                        <div class="m-b-10">
                            <div class="row">
                                <div class="col">
                                    <p class="m-b-5">
                                        <?php echo $fetchMonthLead[0]; ?> <span class="text-muted">Monthly Leads
                                            Added</span>
                                    </p>
                                </div>
                        ...
                        <div class="m-b-10">
                            <div class="row">
                                <div class="col">
                                    <p class="m-b-5">
                                        <?php echo $fetchyearLead[0]; ?> <span class="text-muted">Yearly Leads
                                            Added</span>
                                    </p>
                                </div>
                                <div class="col-auto text-right">
                                    <div class="text-muted">
                                        <?php echo $widthYear ?>% Complete
                                    </div>
                                </div>
                            </div>
                            <div class="">
