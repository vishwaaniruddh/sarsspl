...
$nodes = 'sendmailapi.sarmicrosystems.in/resortmailapitest.php';
// $nodes = 'sendmailapi.sarmicrosystems.in/blank.php';
$EmailSubject2="Testing Welcome to Resort Mumbai!";
$subject = $EmailSubject2 ; 

$Primary_name = "Ms Carmelita Fernandes";

$attachment = "https://loyaltician.in/resortmumbai/Leadpdf/memberpdf/$Primary_name.pdf";
