            ...
            <div class="container  m-b-30">
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class="">Additional Voucher Creation
                        </h4>
                       <!-- <p class="opacity-75 ">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="m-b-0">
                                Additional Voucher Entry
                            </h5>
                            <!--<p class="m-b-0 text-muted">
                                Standard form controls
                            </p>-->
                        </div>
                        <form method="post" action="voucher_issued_code_Process.php" enctype="multipart/form-data" onsubmit="return validation()" >
                        <div class="card-body ">
                      <div class="form-group">
                                <label for="inputAddress">Program Name</label>&nbsp;
                                        <select class="form-control"  name="Program" id="Program" onfocus="setProgram();" onchange="AdditionalIssuedVoucherSet()" required>
                                ...
                                <!-- <div class="form-group">
                                <label for="inputAddress">Program Voucher</label>&nbsp;
                                        <select class="form-control"  name="VoucherCode" id="VoucherCode"  required>
                               ...
                               <div class="form-row">
                                <div class="form-group col-md-5">
                              	<input type="text" class="code form-control" id="voucherCode" name="voucherCode[]" value="" placeholder="Voucher Code *" required/> &nbsp;
                                    		  </div>
                                <div class="form-group col-md-5">

                               		<input type="text" class="code form-control" id="voucherName" name="voucherName[]" value="" placeholder="Voucher Name *" required/> &nbsp;
...
<script>
	...
	$(".addCF").click(function(){
		$("#customFields").append('<tr valign="top"><td><input type="text" class="code" id="voucherCode" name="voucherCode[]" value="" placeholder="Voucher Code *" required/> &nbsp; <input type="text" class="code" id="voucherName" name="voucherName[]" value="" placeholder="Voucher Name*" required/> &nbsp; <button type="button" class="btn m-b-15 ml-2 mr-2  btn-rounded-circle btn-info remCF"><i class="mdi mdi-minus"></i></button></td></tr>');
	});
