            ...
            if ($qryinsert) {
                ...
                if ($qryinsert && $UpdateQry && $UpdateVoucherType) {
                    ...
                    if ($sql4fetch['Leval_id'] == '1') {
                        gold($Primary_Gmail_1, $Primary_nameOnTheCard, $member_id, $validity, $payment_mode, 1, $Static_LeadID, $AdditionalRenewalAssignBooklet, $AdditionalPromotionalAssignBooklet, $pdf, $MembershipDts_NetPayment, $MembershipDts_GrossTotal, $AssignBooklet);

                    } else if ($sql4fetch['Leval_id'] == '2') {
                        platinum($Primary_Gmail_1, $Primary_nameOnTheCard, $member_id, $validity, $payment_mode, 2, $Static_LeadID, $AdditionalRenewalAssignBooklet, $AdditionalPromotionalAssignBooklet, $pdf, $MembershipDts_NetPayment, $MembershipDts_GrossTotal, $AssignBooklet);
