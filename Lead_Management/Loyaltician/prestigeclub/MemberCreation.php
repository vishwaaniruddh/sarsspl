...
<head>
    ...
    if ($Mainid != "") {
        ...
        $rungen = mysqli_query($conn, "SELECT GenerateMember_Id,MembershipDts_PaymentMode,entryDate,MembershipDts_NetPayment,MembershipDts_GrossTotal,receipt_no,booklet_series,MembershipDetails_Level FROM `Members` where Static_LeadID='" . $Mainid . "'");
        $fetchgen = mysqli_fetch_array($rungen);
        $sqlexpiry = "SELECT Expiry_month FROM `validity` where Leval_id='" . $fetchgen['MembershipDetails_Level'] . "' ";
        //echo $sqlexpiry;
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            if (value == 'Married') {
                ...
                $("#Spouse_Fee").attr("required", true);
                $("#Spouse_VAT").attr("required", true);
            }
        });
        ...
        function setSpouseMember() {
            ...
            if (value == 'Married') {
                ...
                $("#Spouse_Fee").attr("required", false);
                $("#Spouse_VAT").attr("required", false);
                ...
                document.getElementById('Spouse_Fee').value = "";
                document.getElementById('Spouse_VAT').value = "";
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card m-b-30">
                            ...
                            <form method="POST" action="MemberCreation_Review.php" enctype="multipart/form-data"
                                ...
                                <!-- <form method="POST" action="MemberCreation_ReviewCopy.php"  enctype="multipart/form-data" onsubmit="return val()" > -->
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="Primary_Country" id="Primary_Country"
                                                ...
                                                <?php
                                                $country_sql = mysqli_query($conn, "select Country from Country order by id");
                                                while ($country_res = mysqli_fetch_assoc($country_sql)) {
                                                    $name = $country_res['Country'];
                                                    ?>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_mcode1"
                                                id="Primary_mcode1" maxlength="3" onkeypress="return isNumberKey(event)"
                                                value="+<?php if ($Mainid != "") {
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_mcode2"
                                                id="Primary_mcode2" maxlength="3" onkeypress="return isNumberKey(event)"
                                                value="+254" placeholder="eg. 254">
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            <label for="inputPassword4">Mobile number *</label>&nbsp;<label
                                                id="label5"></label>
                                            <input type="text" class="form-control" id="Primary_mob2"
                                                ...
                                                onkeypress="return isNumberKey(event)" placeholder="Mobile number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-8 col-sm-8">
                                            ...
                                            <input type="text" class="form-control" id="Primary_Contact1"
                                                ...
                                                onkeypress="return isNumberKey(event)" placeholder="Contact Number 1">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_Contact2code"
                                                id="Primary_Contact2code" value="+254"
                                                onkeypress="return isNumberKey(event)" maxlength="3"
                                                placeholder="eg. +254">
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            ...
                                            <input type="text" class="form-control" id="Primary_Contact2"
                                                ...
                                                onkeypress="return isNumberKey(event)" placeholder="Contact Number 2">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_Contact3code"
                                                id="Primary_Contact3code" value="+254"
                                                onkeypress="return isNumberKey(event)" maxlength="3"
                                                placeholder="eg. +254">
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            ...
                                            <input type="text" class="form-control" id="Primary_Contact3"
                                                name="Primary_Contact3" onkeypress="return isNumberKey(event)"
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="Primary_DateOfBirth"
                                            name="Primary_DateOfBirth" placeholder="dd-mm-yyyy" required>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="Primary_Anniversary"
                                            name="Primary_Anniversary" placeholder="dd-mm-yyyy">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Primary_BuldNo_addrss"
                                            name="Primary_BuldNo_addrss" placeholder="Buld No./Room NO.">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Primary_Area_addrss"
                                            name="Primary_Area_addrss" placeholder="Area/Location">

                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword4">Address</label>
                                        <input type="text" class="form-control" id="Primary_Landmark_addrss"
                                            name="Primary_Landmark_addrss" placeholder="Landmark">
                                    ...
                                    <div id="Spouse" style="display:none">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4 col-sm-4">
                                                ...
                                                <input type="text" class="form-control" name="Spouse_mcode1Married1"
                                                    id="Spouse_mcode1Married1" maxlength="3"
                                                    onkeypress="return isNumberKey(event)" value="+254"
                                                    placeholder="eg. 254">
                                            </div>
                                            <div class="form-group col-md-8 col-sm-8">
                                                <label for="inputPassword4">Mobile number *</label>&nbsp;<label
                                                ...
                                                <input type="text" class="form-control" id="Spouse_mob1MArid1"
                                                    name="Spouse_mob1MArid1" maxlength="09"
                                                    onkeypress="return isNumberKey(event)" placeholder="Mobile number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="form-group col-md-8 col-sm-8">
                                                ...
                                                <input type="text" class="form-control" id="Spouse_mob1MArid2"
                                                    name="Spouse_mob1MArid2" maxlength="09"
                                                    onkeypress="return isNumberKey(event)" placeholder="Mobile number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4 col-sm-4">
                                                ...
                                                <input type="text" class="form-control" name="Spouse_Contact2codeMArid"
                                                    id="Spouse_Contact2codeMArid" value="+254" maxlength="3"
                                                    onkeypress="return isNumberKey(event)" placeholder="eg. +254">
                                            </div>
                                            <div class="form-group col-md-8 col-sm-8">
                                                <label for="inputPassword4">Contact2 Number</label>
                                                <input type="text" class="form-control" id="Spouse_Contact2Married"
                                                    name="Spouse_Contact2Married" maxlength="09"
                                                    onkeypress="return isNumberKey(event)" placeholder="Contact Number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" id="Spouse_DateOfBirth"
                                                name="Spouse_DateOfBirth" placeholder="dd-mm-yyyy" required>
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" id="Spouse_Fee" name="Spouse_Fee"
                                                placeholder="Spouse Fee"
                                                value="<?php echo $fetchStatic_LeadID['Spouse_Fee']; ?>" readonly>
                                        </div>

                                        <div class="form-group ">
                                            <label for="inputPassword4">Name on the Card</label>
                                            <input type="text" class="form-control" id="Spouse_VAT" name="Spouse_VAT"
                                                placeholder="Spouse VAT"
                                                value="<?php echo $fetchStatic_LeadID['Spouse_VAT']; ?>" readonly>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDetails_Level"
                                            ...
                                            value="<?php echo $fetchStatic_LeadID1['level_name']; ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDts_GST"
                                            ...
                                            value="<?php echo $fetchStatic_LeadID['MembershipDts_GST']; ?>">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDts_PaymentDate"
                                            ...
                                            value="<?php echo $fetchStatic_LeadID['MembershipDts_PaymentDate']; ?>">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDts_PaymentMode"
                                            ...
                                            value="<?php echo $fetchStatic_LeadID['MembershipDts_PaymentMode']; ?>">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MemshipDts_GST_number"
                                            ...
                                            value="<?php echo $fetchStatic_LeadID['GST_Number']; ?>" maxlength="15">
                                    </div>
                               ...
                               -->
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                id="Relationships_ReferredByLEADID" placeholder="Referred by LEAD ID">
                                        </div>
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                ...
                                                placeholder="Referred by MEMBERSHIP ID">
                                        </div>
                                    </div>
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="PromotionalCheck1"
                                            name="PromotionalCheck1">
                                        <label class="custom-control-label" for="PromotionalCheck1">Issue Promotional
                                            Certificate</label>
                                    </div>

                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="RenewalCheck1"
                                            name="RenewalCheck1">
                                        <label class="custom-control-label" for="RenewalCheck1">Issue Renewal
                                            Certificate</label>
                                    </div>

                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="ExpiryCheck_0"
                                            name="ExpiryCheck1" onclick="expirycheck('0')">
                                        <label class="custom-control-label" for="ExpiryCheck_0">Issue Expiry
                                            Change</label>
                                    </div>

                                    <div class="form-row" style="display:none" id="new">
                                        <div class="form-group col-md-6" id="actual">
                                            <label for="ActualExpiry">Actual Expiry</label>
                                            <input type="text" class="form-control" id="ActualExpiry"
                                                name="ActualExpiry" value="<?php echo $expirydate; ?>"
                                                placeholder="Actual Expiry" readonly>
                                        </div>

                                        <div class="form-group col-md-6" id="changed">
                                            <label for="ActualExpiry">Changed Expiry</label>
                                            <input type="date" class="form-control" id="ChangedExpiry"
                                                name="ChangedExpiry" placeholder="New Expiry">
                                        </div>
                                    </div>
