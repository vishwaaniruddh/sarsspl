                                        ...
                                        <div style="display:none">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<?php echo $_POST['Mainid']; ?>" id="Mainid"
                                                    name="Mainid">
                                                <input type="hidden"
                                                    value="<?php echo $_POST['MemshipDts_Receiptno']; ?>"
                                                    name="MemshipDts_Receiptno" id="MemshipDts_Receiptno">

                                                <input type="hidden" name="Spouse_Fee" id="Spouse_Fee"
                                                    value="<?php echo $_POST['Spouse_Fee']; ?>">
                                                <input type="hidden" name="Spouse_VAT" id="Spouse_VAT"
                                                    value="<?php echo $_POST['Spouse_VAT']; ?>">
                                            </div>
