...
$bcc = ['hitesh.gunwani@gmail.com', 'roopal@loyaltician.com', 'digambar@loyaltician.com', 'Bharati@theresortexperiences.com' ,'Experiences@theresortmumbai.com','accounts@loyaltician.com'];

function gold($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf,$MembershipDts_NetPayment,$MembershipDts_GrossTotal,$AssignBooklet){
     global $conn,$bcc;
    ...
    // $nodes = 'https://arpeeindustries.in/mail.php';
     $nodes = 'https://sarsspl.com/sendmail/prestigeclubapitest.php';
    // $nodes = 'sendmailapi.sarmicrosystems.in/prestigeclubapitest.php';
    
    
    $attachment = "https://sarsspl.com/Lead_Management/Loyaltician/prestigeclub/Leadpdf/memberpdf/$Primary_nameOnTheCard.pdf";

    $EmailSubject2="Welcome to The Boma Hotels !";
    $message2 ='
                    ...
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                      <p>
                        <span style="text-decoration:none">
                          <img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/prestigeclub/newassets/Prestige-Club.jpg" alt="The Boma Hotels Gold"></span>
                        <u></u><u></u></p>
                    </td>
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                        <p align="right" style="text-align:right">
                          <span style="text-decoration:none"><img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/prestigeclub/newassets/BOMA-LOGO.jpg" alt="The Boma Hotels Gold">
                          </span>
                       <u></u><u></u></p>
                    </td>
                  </tr>
                ...
                <table width="50%" align="center">
                    <tbody>
                       <td>
                          ...
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>A Warm Welcome to Prestige Club of The Boma Hotels !</span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>&nbsp;</span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in">
                          <span lang=EN-IN style="color:black">We thank you for your decision to become a member at The Boma Hotels. Your membership has been issued and details are as follows:</span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>&nbsp;</span></p>
                          ...
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>&nbsp;</span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>Membership Level - Gold</span></p>
                          ...
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN> </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in">
                          <span lang=EN-IN>The annual membership charge of KSHS '.$MembershipDts_NetPayment.'.  + 16% VAT amounting to net KSHS '.$MembershipDts_GrossTotal.'.  /- ( '.getKenyanCurrency($MembershipDts_GrossTotal).')
has been received by '.$payment_mode.'.  We have issued a receipt for the same. The Receipt Number is '.$receiptNO.' </span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN>You can present your membership number and a copy of this email to start using your membership card benefits. To know more about these benefits please visit </span><span
lang=EN-IN><a href="https://www.prestigeclub.co.ke ">www.prestigeclub.co.ke</a></span><span
lang=EN-IN> </span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>&nbsp;</span></p>
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>Your personalized welcome package will reach you within 10 working days of this e-mail. Do note that the membership gift voucher can be used only upon receipt of the membership package and have to be presented in original. The certificates issued along with the membership are given at the bottom of this email. Should there be a need to use any of these certificates urgently before they arrive, do reach out to our Member Help Desk for help.</span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>&nbsp;</span></p>
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in">
<span lang=EN-IN>Payment of the membership fee confirms that you have read and understood the membership terms and conditions and then made the payment to enrol. Do take a moment to view all benefits and terms at <a href="https://www.prestigeclub.cop.ke"> www.prestigeclub.co.ke </a> or reach out to our Member Help Desk from Monday to Saturday, 9.30 AM to 6.30 PM for any clarifications.</span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN style="font-size:12.0pt;line-height:107%">Team Prestige Club</span></p>

<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN style="font-size:12.0pt;line-height:107%">+254 114500206</span></p>

<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN><a href="https://www.prestigeclub.co.ke.com"><span style="font-size:12.0pt;
line-height:107%">www.prestigeclub.co.ke.com</span></a></span><span lang=EN-IN
style="font-size:12.0pt;line-height:107%"> </span></p>

<p class=MsoNormal><span lang=EN-IN style="font-size:12.0pt;line-height:107%">&nbsp;</span></p>

<p class=MsoNormal align=center style="text-align:center"><span lang=EN-IN
style="font-size:12.0pt;line-height:107%">Gift Vouchers issued</span></p>
...
<p class=MsoNormal><em><span lang=EN-IN style="font-size:10.5pt;line-height:
107%;border:none windowtext 1.0pt;
padding:0in;background:white">The membership program is exclusively operated by Prolyft Digital Africa Limited for The Boma Hotels. </span></em></p>

<p class=MsoNormal><em><span lang=EN-IN style="font-size:10.5pt;line-height:
107%;border:none windowtext 1.0pt;
padding:0in;background:white">This message is sent to you because your email address is on our subscribers list as a Member with an express consent to communicate with you. We will ensure only high quality / relevant information is sent to you to manage your membership. If you wish to change any communication preferences, please write to us at </span></em><span lang=EN-IN><a
href="mailto:www.prestigeclub.co.ke"><span style="font-size:10.5pt;
line-height:107%;border:none windowtext 1.0pt;
padding:0in;background:white">www.prestigeclub.co.ke</span></a></span><em><span
...
color:#444444;border:none windowtext 1.0pt;padding:0in">Disclaimer: This message has been sent as a part of discussion between ‘Prestige Club’ and the addressee whose name is specified above. Should you receive this message by mistake, we would be most grateful if you informed us that the message has been sent to you. In this case, we also ask that you delete this message from your mailbox, and do not forward it or any part of it to anyone else. Thank you for your cooperation and understanding.</span></i></p>
...
$htmtab1='<table border="1" cellpadding="5">
                                        <tbody>
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <img src="https://sarsspl.com/Lead_Management/Loyaltician/prestigeclub/Leadpdf/logoai.jpg" style="margin-left:200px;height:60px;">
                                            </th>
                                            </tr>
...
$leadsmail2= " www.prestigeclub.co.ke";
...
$leadsmail = $leadsmail2;
 ...
 $from = ' www.prestigeclub.co.ke';
    $fromname = 'The Boma Hotels' ; 
...
function platinum($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf,$MembershipDts_NetPayment,$MembershipDts_GrossTotal,$AssignBooklet){
     global $conn,$bcc;
                ...
                <tbody>
                  <tr>
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                      <p>
                        <span style="text-decoration:none">
                          <img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/prestigeclub/newassets/Prestige-Club.jpg" alt="The Boma Hotels Platinum"></span>
                        <u></u><u></u></p>
                    </td>
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                        <p align="right" style="text-align:right">
                          <span style="text-decoration:none"><img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/prestigeclub/newassets/BOMA-LOGO.jpg" alt="The Boma Hotels Platinum">
                          </span>
                       <u></u><u></u></p>
                    </td>
                  </tr>
                ...
                <table width="50%" align="center">
                    <tbody>
                       <td>
                          ...
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN><b><u>Membership Details</u></b></span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>&nbsp;</span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>Membership Level - Platinum</span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>Your Membership Card number is '.$member_id.'. </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>The membership is valid till '.date('M Y', strtotime($validity)).' </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN> </span></p>
                          <p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>&nbsp;</span></p>
...
function getKenyanCurrency(float $number) {
    ...
    return ('Kenyan Shillings' . $Rupees ? $Rupees  : '') . $paise. ' only';
}
