...
$sqlr=mysqli_query($conn,"INSERT INTO `HotelUsers`( `hotelname`,Brand,`empname`, `empno`,`emailid`, `mobile`, `password`,Department) VALUES ('".$name."','".$Brand."','".$Lname."','".$enumber."','".$email."','".$mob."','".$password."','".$Department."')");
