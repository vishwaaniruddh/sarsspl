                                ...
                                <div class="card-body ">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="program" id="program" <?php if ($id != "") { ?>disabled<?php } ?> required>
                                            ...
                                            <?php if ($id != "") { ?>
                                                <option value="<?php echo $fetchname['Program_ID']; ?>">
                                                    <?php echo $fetchname['Progam_name'] ?> </option>
                                            <?php } else { ?>
                                                <option value="">Select Program *</option>
                                            <?php } ?>
                                            <?php
                                            ...
                                            while ($fetch = mysqli_fetch_array($runabc)) { ?>
                                                <option value="<?php echo $fetch['Program_ID']; ?>"
                                                    id="<?php echo $fetch['Program_ID'] ?>">
                                                    <?php echo $fetch['Progam_name']; ?></option>
                                            <?php } ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        <label for="inputAddress">Participating Hotels Name</label>&nbsp;<label
                                            id="label3"></label>
                                        <input type="text" class="form-control" id="ParticipatingHotelsName"
                                            name="ParticipatingHotelsName" placeholder="Participating Hotels Name *"
                                            value="<?php echo $fetch1['Progam_name'] ?>" required>
                                    </div>
