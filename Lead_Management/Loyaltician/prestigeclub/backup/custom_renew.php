                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                ...
                                <a class="btn btn-danger" href="member_view.php?id=<? echo $id; ?>">View Member Info</a>
                           ...
                           <div id="vouchers">
                               ...
                               <br>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="from_date" id="datepicker2" class="form-control" value="<? echo date("Y/m/d")?>">
                                </div>
        ...
        <select class="form-control" name="extension">
                    ...
                    <?       
                        ...
                        while($sql_result = mysqli_fetch_assoc($sql)){ ?>
                            <option value="<? echo $sql_result['id'];?>">
                                <? echo $sql_result['extension'].' Months';?>
                            </option>
                            <? $i++; } ?>
                        </select>
</div>            
...
while($voucher_sql_result = mysqli_fetch_assoc($voucher_sql)){
    ...
    // echo '</del>';        
          ...
          <input class="mem_vouchers" type="checkbox" name="vouchers[]" value="<? echo $voucher;?>"
          >
<?        echo $voucher .' - '.get_voucher_name($level_id,$voucher_name_id);
    echo '<br>';
    }
