                                ...
                                <div class="card-body ">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="Hotel" id="Hotel" <?php if ($id != "") { ?>readonly<?php } ?> required>
                                            <?php if ($id != "") { ?>
                                                <option value="<?php echo $fetchname['hotel_id']; ?>">
                                                    <?php echo $fetchname['Hotel_Name'] ?> </option>
                                            <?php } else { ?>
                                            ...
                                            while ($fetch = mysqli_fetch_array($runabc)) { ?>
                                                <option value="<?php echo $fetch['hotel_id']; ?>"
                                                    id="<?php echo $fetch['hotel_id']; ?>"><?php echo $fetch['Hotel_Name'] ?>
                                                </option>
                                            <?php } ?>
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Program" name="Program"
                                            placeholder="Program *" value="<?php echo $fetch1['Progam_name'] ?>"
                                            required>
                                    </div>
