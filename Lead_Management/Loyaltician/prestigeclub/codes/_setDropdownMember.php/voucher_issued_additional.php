                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="card m-b-30">
                            ...
                            <form method="post" action="voucher_issued_additional_Process.php"
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="Program" id="Program" onfocus="setProgram();"
                                            onchange="AdditionalIssuedVoucherSet()" <?php if ($id != "") { ?>disabled<?php } ?> required>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-3">
                                                        <select class="form-control" style="padding-left: 0px;"
                                                            name="voucher[]" id="voucher" <?php if ($id != "") { ?>disabled<?php } ?> required>
                                                            <?php if ($id != "") { ?>
                                                                <option value="<?php echo $vouchername['v_id']; ?>">
                                                                    <?php echo $vouchername['voucher_name'] ?> </option>
                                                            <?php } else { ?>
