                                ...
                                <div class="card-body ">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="Program" id="Program" onfocus="setProgram();"
                                            onchange="levelSet()" <?php if ($_GET['id'] != "") { ?>disabled <?php } ?>
                                            required>

                                            <?php if ($_GET['id'] != "") { ?>
                                                <option value="<?php echo $fetch_prog['Program_ID']; ?>"
                                                    id="<?php echo $fetch_prog['Program_ID'] ?>">
                                                    <?php echo $fetch_prog['Progam_name']; ?></option>
                                            <?php } else { ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="Level" id="Level" onfocus="levelSet();" <?php if ($_GET['id'] != "") { ?>disabled <?php } ?> required>
                                            ...
                                            <?php if ($_GET['id'] != "") { ?>
                                                <option value="<?php echo $fetchLeval['Leval_id']; ?>"
                                                    id="<?php echo $fetchLeval['Leval_id'] ?>">
                                                    <?php echo $fetchLeval['level_name']; ?></option>
                                            <?php } else { ?>
                                            ...
                                            if ($_GET['id'] != "") {
                                                ...
                                                <tr valign="top">
                                                    <td style="display:flex;">
                                                        ...
                                                        <input type="text" class="code form-control" id="CardBenefit"
                                                            name="CardBenefit[]"
                                                            value="<?php echo $fetchBenefit['CardBenefit']; ?>"
                                                            placeholder="Card Benefit *" required /> &nbsp;
                                                ...
                                                <tr valign="top">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-10">
                                                            <input type="text" class="code form-control" id="CardBenefit"
                                                                name="CardBenefit[]" value="" placeholder="Card Benefit *"
                                                                required /> &nbsp;
                                                        </div>

                                                        <div class="form-group col-md-2">
                                                            <button type="button"
                                                                class="btn m-b-15 ml-2 mr-2  btn-rounded-circle btn-info addCF"><i
