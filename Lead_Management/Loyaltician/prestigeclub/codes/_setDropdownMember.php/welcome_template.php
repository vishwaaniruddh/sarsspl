...
function gold($Primary_Gmail_1,$Primary_nameOnTheCard,$member_id,$validity,$payment_mode,$level_id,$Static_LeadID,$AdditionalRenewalAssignBooklet,$AdditionalPromotionalAssignBooklet,$pdf,$MembershipDts_NetPayment,$MembershipDts_GrossTotal,$AssignBooklet){
    ...
    $attachment = "https://loyaltician.in/prestigeclub/Leadpdf/memberpdf/$Primary_nameOnTheCard.pdf";
                    ...
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                      <p>
                        <span style="text-decoration:none">
                          <img border="0" width="130" style="width:1.3541in" src="http://loyaltician.in/prestigeclub/newassets/Prestige-Club.jpg" alt="The Boma Hotels Gold"></span>
                        <u></u><u></u></p>
                    </td>
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                        <p align="right" style="text-align:right">
                          <span style="text-decoration:none"><img border="0" width="130" style="width:1.3541in" src="http://loyaltician.in/prestigeclub/newassets/BOMA-LOGO.jpg" alt="The Boma Hotels Gold">
                          </span>
                       <u></u><u></u></p>
                    </td>
                  </tr>
...
lang=EN-IN><a href="http://www.prestigeclub.co.ke ">www.prestigeclub.co.ke</a></span><span
lang=EN-IN> </span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span lang=EN-IN>&nbsp;</span></p>
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in">
<span lang=EN-IN>Payment of the membership fee confirms that you have read and understood the membership terms and conditions and then made the payment to enrol. Do take a moment to view all benefits and terms at <a href="http://www.prestigeclub.cop.ke"> www.prestigeclub.co.ke </a> or reach out to our Member Help Desk from Monday to Saturday, 9.30 AM to 6.30 PM for any clarifications.</span></p>
...
<p class=MsoNormal style="margin-bottom:0in;margin-bottom:0in;margin-top:0in"><span
lang=EN-IN><a href="http://www.prestigeclub.co.ke.com"><span style="font-size:12.0pt;
...
$htmtab1='<table border="1" cellpadding="5">
                                        <tbody>
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <img src="http://sarmicrosystems.in/Lead_Management/Loyaltician/prestigeclub/Leadpdf/logoai.jpg" style="margin-left:200px;height:60px;">
                                            </th>
                                            </tr>
                ...
                <tbody>
                  <tr>
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                      <p>
                        <span style="text-decoration:none">
                          <img border="0" width="130" style="width:1.3541in" src="http://loyaltician.in/prestigeclub/newassets/Prestige-Club.jpg" alt="The Boma Hotels Platinum"></span>
                        <u></u><u></u></p>
                    </td>
                    <td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
                        <p align="right" style="text-align:right">
                          <span style="text-decoration:none"><img border="0" width="130" style="width:1.3541in" src="http://loyaltician.in/prestigeclub/newassets/BOMA-LOGO.jpg" alt="The Boma Hotels Platinum">
                          </span>
                       <u></u><u></u></p>
                    </td>
                  </tr>
