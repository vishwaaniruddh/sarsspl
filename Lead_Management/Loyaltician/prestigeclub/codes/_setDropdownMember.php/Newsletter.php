                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="card m-b-30">
                            ...
                            <form id="myForm" method="POST" action="newsletter_review.php" target="_blank"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control" name="Membership_Level" id="Membership_Level"
                                            onchange="chkIndividual()" required>
                                    ...
                                    <div class="form-group " id="hd_geo" style="display:none">
                                        <input type="text" name="GeoPincode" id="GeoPincode" class="form-control "
                                    ...
                                    <div class="form-group " id="hd_mul" style="display:none">
                                        ...
                                        <select name="lstStates" multiple="multiple" id="lstStates" class="form-control"
                                            onchange="per()">
                                            ...
                                            <optgroup label=" ">
                                                ...
                                                while ($fetch = mysqli_fetch_array($runabc)) {
                                                    ...
                                                    ?>
                                                    <option value="<?php echo $fetch['MembershipNumber']; ?>">
                                                        <?php echo $fetch['MembershipNumber'] . "          " . $fetchMem['Primary_nameOnTheCard']; ?>
                                                    </option>
                                                    < <?php } ?>
                                            </optgroup>
                                            </optgroup>
