...
<body class="sidebar-pinned page-home">
    ...
    <main class="admin-main">
        ...
        <section class="admin-content">
                ...
                <div class="row">
                    ...
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <p class="opacity-75 ">
                            ...
                            Thank you for participating in the sales generation exercise for the membership of your
                            hotel.<br /> Track your productivity on the dashboard. Good luck.
                        </p>
            ...
            $yearLead = "select count(Lead_id) from Leads_table where date(Creation) between '" . $start_year . "' and '" . $end_year . "'";
            //echo $yearLead;
                    ...
                    <div class="col d-lg-block d-none m-b-30">
                        <div class="card ">
                            <div class="   text-center card-body">
                                ...
                                <div class=" text-center">
                                    <h3><?php echo $fetchyearLead[0] ?></h3>
                                    </h3>
                                </div>
                                <div class="text-overline ">
                                    YEARLY SALES
                ...
                <div class="card m-b-30">
                    <div class="card-body">
                        ...
                        <div class="m-b-10">
                            <div class="row">
                                <div class="col">
                                    <p class="m-b-5"><?php echo $fetchrun[0]; ?> <span class="text-muted">Today Sales
                                            Added</span>
                                    </p>
                                </div>
                                <?php if ($fetchrun[0] == "0") {
