...
<head>
    ...
    <script>
        ...
        function spouseShowHide() {
            if ($('#MembershipDetails_SpouseCheck1').is(":checked")) {

                $("#Hide_Spouse_UplodeAuthorisation").show();

            }
            else {
                $("#Hide_Spouse_UplodeAuthorisation").hide();
        ...
        function cal_SpousePayment() {

            var Sfee = document.getElementById('Spouse_Fee').value;
            //  var discnt=document.getElementById('').value;

            var SAmt = (Sfee * 16) / 100;




            if (Sfee != "") {
                document.getElementById('Spouse_VAT').value = SAmt;
            } else {
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="card m-b-30">
                            ...
                            <form method="POST" action="invoice_copy.php" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="hidden" id="Hidden_MembershipDetails_id"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="cols-md-4">
                                            <div class="custom-control custom-checkbox">&nbsp;&nbsp;&nbsp;
                                                <input type="checkbox" class="custom-control-input"
                                                    id="MembershipDetails_SpouseCheck1"
                                                    name="MembershipDetails_SpouseCheck1" onchange="spouseShowHide()">
                                                <label class="custom-control-label"
                                                    for="MembershipDetails_SpouseCheck1">Spouse</label>&nbsp;&nbsp;&nbsp;
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div id="Hide_Discount_UplodeAuthorisation" style="display:none">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="MembershipDts_Discount"
                                                name="MembershipDts_Discount" onkeyup="cal_NetPayment()" value="0">
                                        </div>

                                        <div class="form-group">
                                            <label for="inputEmail4">% Discount Remark</label>
                                            <input type="textarea" class="form-control"
                                                id="MembershipDts_Discount_Remark" name="MembershipDts_Discount_Remark"
                                                value="">
                                        </div>
                                    ...
                                    <div id="Hide_Spouse_UplodeAuthorisation" style="display:none">
                                        <div class="form-group">
                                            <label for="inputEmail4">Spouse Fee</label>
                                            <input type="text" class="form-control" id="Spouse_Fee" name="Spouse_Fee"
                                                onkeyup="cal_SpousePayment()" value="0">
                                        </div>

                                        <div class="form-group">
                                            <label for="inputEmail4">Spouse VAT</label>
                                            <input type="textarea" class="form-control" id="Spouse_VAT"
                                                name="Spouse_VAT" value="">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDts_PaymentDate"
                                            name="MembershipDts_PaymentDate" autocomplete="off" Placeholder="dd-mm-yyyy"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="MembershipDts_PaymentMode"
                                            ...
                                            while ($fetchMode = mysqli_fetch_array($runMode)) {
                                                ...
                                                <option value="<?php echo $fetchMode['Payment_mode']; ?>">
                                                    <?php echo $fetchMode['Payment_mode']; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MemshipDts_Receiptno"
                                            name="MemshipDts_Receiptno" placeholder='Receipt No.'>
                                    </div>
