                            ...
                            <div class="form-row">
                             ...
                             <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Pincode" name="Pincode" placeholder="Pincode *" onkeypress="return isNumber(event)" maxlength="7" >
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Contact No</label>
                                    <input type="text" class="form-control" id="ContactNo" name="ContactNo" placeholder="Contact No *" onkeypress="return isNumber(event)" maxlength="9" required>
                                </div>
                            </div>
