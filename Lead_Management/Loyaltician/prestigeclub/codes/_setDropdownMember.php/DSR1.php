...
// function getPromotional_voucher($member_id)
// {
//     global $conn;
        ...
        function searchfiltter() {
            ...
            if (Ab_Filtter == "") {
                ...
                $.ajax({
                    ...
                    type: 'POST',
                    url: 'DSRsearch_Filtter_COPY.php',
...
<body class="sidebar-pinned" id="rightclick">
                                        ...
                                        <tbody id="setTable">
                                            ...
                                            while ($_row = mysqli_fetch_array($qrys)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php echo $_row['promotional_voucher_code']; ?>
                                                    </td>

                                                    <td>
                                                        <?php echo $_row['renewal_voucher_code']; ?>
                                                    </td>
   ...
   <td></td>	-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="cols-md-4">
                                        <form name="frm" method="post" action="Leadpdf/DSRreportPDF_1.php"
                                            target="_new">
