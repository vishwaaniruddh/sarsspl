                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        ...
                        for (var i = 0; i < json.length; ++i) {
                            ...
                            $('#setTable').append('<tr role="row" class="odd" ><td class="sorting_1">' + srno + '</td><td>' + json[i].entryDate + '</td><td>' + json[i].MembershipDetails_Level + '</td><td>' + json[i].booklet_Series + '</td><td>' + json[i].GenerateMember_Id + '</td><td>' + json[i].Primary_nameOnTheCard + '</td><td>' + statusSample + '</td> </tr>');
                        }
...
<body class="sidebar-pinned" id="rightclick">
                                        ...
                                        <select class="form-control" name="Level_Filtter" id="Level_Filtter">
                                            ...
                                            while ($fetchLevel = mysqli_fetch_array($runlevel)) { ?>
                                                <option value="<?php echo $fetchLevel['Leval_id']; ?>">
                                                    <?php echo $fetchLevel['level_name']; ?></option>
                                            <?php } ?>
                                        </select>
    ...
    -->
                                ...
                                <div class="row">
                                    <div class="cols-md-8">
                                        <form name="frm" method="post" action="export_BookletsAssignmentReport.php"
                                            target="_new">
                                    ...
                                    <div class="cols-md-4">
                                        <form name="frm" method="post" action="Leadpdf/BookletsAssignmentReport_PDF.php"
                                            target="_new">
