...
<html> 
  <head>
        ...
        <title>Leads dalegate update</title>
...
Page=strPage;
	 ...
	 $.ajax({
             type: "POST",
             url: "delegatelead_process.php",
			 
             data: 'Page='+Page+'&perpg='+perp+'&strdt='+dt1+'&endt='+dt2+'&fname='+fname+'&lname='+lname+'&Mobile='+Mobile+'&Email='+Email+'&Pincode='+Pincode,
...
<!--<div>
      ...
      <form  method="post" id="formf" action="delegation.php">
        ...
        <h2 align="center">Update Leads</h2>
