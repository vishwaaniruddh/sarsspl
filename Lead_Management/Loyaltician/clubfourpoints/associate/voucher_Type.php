...
<script>
	...
	$(".addCF").click(function(){
		$("#customFields").append('<tr valign="top"><td><input type="text" class="code" id="serialNo" name="serialNo[]" value="" placeholder="serial No. *" required/> &nbsp; <input type="text" class="code" id="ServiceName" name="ServiceName[]" value="" placeholder="ServiceName" required/> &nbsp; <a href="javascript:void(0);" class="remCF">Remove</a></td></tr>');
	});
