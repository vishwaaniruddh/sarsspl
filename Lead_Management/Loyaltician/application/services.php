                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="card m-b-30">
                            ...
                            <form method="post" action="services_process.php" enctype="multipart/form-data"
                                onsubmit="return validation()">
                                <input type="hidden" name="mainid" id="mainid" value="<?php echo $id ?>" />
                                <div class="card-body ">
                                    <div class="form-group">
                                        <label for="inputAddress">Participating Hotels</label>&nbsp;
                                        <select class="form-control" name="ParticipatingHotels" id="ParticipatingHotels"
                                            required>
                                            ...
                                            while ($fetch = mysqli_fetch_array($runabc)) { ?>
                                                <option value="<?php echo $fetch['particip_id']; ?>"
                                                    id="<?php echo $fetch['particip_id'] ?>">
                                                    <?php echo $fetch['ParticipatingHotelsName']; ?></option>
                                            <?php } ?>
                                        </select>
                                            ...
                                            <td>
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-5">
                                                        <input type="text" class="code form-control" id="serviceName"
                                                            name="serviceName[]" value="<?php echo $fetch1['name'] ?>"
                                                            placeholder="Service Name" required /> &nbsp;
                                                    </div>
                                                    <div class="form-group col-md-5">

                                                        <input type="text" class="code form-control" id="POScode"
                                                            name="POScode[]" value="<?php echo $fetch1['POScode'] ?>"
