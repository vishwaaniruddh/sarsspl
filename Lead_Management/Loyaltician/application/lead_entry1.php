...
<head>
    ...
    <script>
        ...
        */
        ...
        function submitfun(action) {//alert(chkmailexs())
            //alert(chkmobile())
            //alert(validation())
                            ...
                            <div class="card-body ">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="FirstName" name="FirstName" value="<?php if ($Main_id != "") {
                                            echo $qeryfetch['FirstName'];
                                        } ?>" placeholder="First Name *" required="true">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="inputPassword4">Last Name</label>
                                        <input type="text" class="form-control" id="LastName" name="LastName" value="<?php if ($Main_id != "") {
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="Company" name="Company" value="<?php if ($Main_id != "") {
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="Gmail" name="Gmail" value="<?php if ($Main_id != "") {
                                        echo $qeryfetch['EmailId']; ?>  <?php } ?>" placeholder="Email" <?php if ($Main_id != "") { ?> <?php } else { ?> <?php } ?>>
                                </div>

                                <div class="form-group">
                                    <label for="PincodeOfArea">Pincode Of Area</label>
                                    <input type="text" class="form-control" id="PincodeOfArea" name="PincodeOfArea"
                                        value="<?php if ($Main_id != "") {
                                            echo $qeryfetch['pincodeOfArea']; ?>  <?php } ?>"
                                        placeholder="Area of Pincode" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" onblur="getStateCity();" id="Pincode"
                                        ...
                                        } ?>" Placeholder="Pincode" onkeypress="return isNumber(event)" maxlength="6"
                                        required>
                                </div>

                                <div class="form-group">
                                    <label for="inputAddress2">State</label>
                                    <input type="text" class="form-control" id="state" name="state" value="<?php if ($Main_id != "") {
...
-->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="City" name="City" value="<?php if ($Main_id != "") {
                                        echo $qeryfetch['City'];
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8 col-sm-8">
                                        ...
                                        <input type="text" class="form-control" id="mob1" name="mob1" maxlength="10"
                                            <?php if ($Main_id != "") { ?> readonly <?php } else { ?>
                                                onblur="chkmobile();" <?php } ?> onkeypress="return isNumber(event)" value="<?php if ($Main_id != "") {
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input type="text" class="form-control"  name="mcode2" id="mcode2" maxlength="3"  <?php if ($Main_id != "") {
                                    } else { ?> onblur="chkmobile1();" <?php } ?>     value="<?php if ($Main_id != "") {
                                                  echo '+' . $qeryfetch['MobileCode2'];
                                              } else {
                                                  echo '+91';
                                              } ?>" onkeypress="return isNumber(event)" placeholder="eg. 91">
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    ...
                                    <input type="text" class="form-control" id="mob2" name="mob2" maxlength="10" <?php if ($Main_id != "") { ?> readonly <?php } else { ?> onblur="chkmobile1();" <?php } ?>      onkeypress="return isNumber(event)" value="<?php if ($Main_id != "") {
                                                          echo $qeryfetch['MobileNumber2'];
                                                      } ?>"   placeholder="Mobile number" >
                                </div>
                            </div>-->
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8 col-sm-8">
                                        ...
                                        <input type="text" class="form-control" id="offNum" name="offNum" maxlength="10"
                                            onkeypress="return isNumber(event)" value="<?php if ($Main_id != "") {
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8 col-sm-8">
                                        ...
                                        <input type="text" class="form-control" id="Contact2" name="Contact2"
                                            maxlength="10" value="<?php if ($Main_id != "") {
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="Facebook" name="Facebook" value="<?php if ($Main_id != "") {
                                ...
                                <div class="form-group" id="LeadByL" style="display:none">
                                    ...
                                    <input type="text" class="form-control" id="LeadByLead" name="LeadByLead" value="<?php if ($Main_id != "") {
                                ...
                                <div class="form-group" id="LeadByM" style="display:none">
                                    ...
                                    <input type="text" class="form-control" id="LeadByMember" name="LeadByMember" value="<?php if ($Main_id != "") {
