...
$qgen1= mysqli_query($conn,"select * from Extension_history where member_id='".$id."' and extention_type='EX'");
...
$ext1=date('M Y', $date);
 ...
 $EmailSubject2="Membership Extension";
        ...
        $message2.='<th  style="text-align: left;"><br><b>Dear '. $name.' , </b><br></th></tr><tr><td>&nbsp;</td></tr><tr>';
         ...
         We thank you for being with us and as a small gesture from our side, we are extending your Gold membership by an <b>additional validity.  Your new membership validity will be December 31, 2021.</b>
