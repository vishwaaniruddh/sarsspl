        ...
        <tbody id="setTable">
            ...
            for ($i = $From_Month; $i <= $From_To; $i++) {
                ...
                <tr>
                    ...
                    <td><?php if ($f1['No_of_Pax'] != "") {
                        echo $f1['No_of_Pax'];
                    } else {
                        echo "0";
                    } ?></td>
                    <td><?php if ($f1['No_of_paxClose'] != "") {
                        echo $f1['No_of_paxClose'];
                    } else {
                        echo "0";
                    } ?></td>
                    <td><?php if ($f1['FoodAmt'] != "") {
                        echo $f1['FoodAmt'];
                    } else {
                        echo "0";
                    } ?></td>
                    <td><?php if ($f1['SoftBevAmt'] != "") {
                        echo $f1['SoftBevAmt'];
                    } else {
                        echo "0";
                    } ?></td>
                    <td><?php if ($f1['IndianLiqAmt'] != "") {
                        echo $f1['IndianLiqAmt'] + $f1['ImpLiqAmt'];
                    } else {
                        echo "0";
                    } ?></td>
                    <td><?php if ($f1['No_of_MiscAmt'] != "") {
                        echo $f1['No_of_MiscAmt'];
                    } else {
                        echo "0";
                    } ?></td>
                    <td><?php if ($revenu1 != "") {
