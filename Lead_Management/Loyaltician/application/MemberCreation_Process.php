...
<body>
    ...
    function get_email($id)
    {
        ...
        $sql = mysqli_query($conn, "select * from Leads_table where Lead_id = '" . $id . "'");
        $sql_result = mysqli_fetch_assoc($sql);
        return $sql_result['EmailId'];
    }
...
cooperation and understanding.</td></tr>';
                        ...
                        $member_email = get_email($Static_LeadID);
                        $to = [$member_email];
                        $cc = ['orchidgoldpune@orchidhotel.com', 'hitesh@loyaltician.com'];
                        $bcc = ['vishwaaniruddh@gmail.com', 'khannakaran67@gmail.com'];
                        ...
                        // var_dump(sendexternalmail($subject,$message,$leadsmail,$host,$hostusername,$hostpassword,$port,$from,$fromname,$to,$cc,$bcc));
                        ...
                        // //Recipients
                        // $mail->setFrom('orchidgoldpune@orchidhotel.com','The Orchid Hotel Pune');
                        // $mail->addAddress('orchidgoldpune@orchidhotel.com'); 
                        // $mail->addCC('vishwaaniruddh@gmail.com');
                        // $mail->addBCC('khannakaran67@gmail.com');
    

                        // $mail->isHTML(true);                                  // Set email format to HTML
                        // $mail->Subject = $EmailSubject2."\r\n";
                        // $mail->Body    = $message2;
                        // $mail->send();
...
Disclaimer: This message has been sent as a part of discussion between (orchidgoldpune@orchidhotel.com) and the addressee whose name is specified above. Should you receive this message by mistake, we would be most grateful if you informed us that the message has been sent to you. In this case, we also ask that you delete this message from your mailbox, and do not forward it or any part of it to anyone else. Thank you for your cooperation and understanding.</td></tr>';
                    ...
                    $cc = ['vishwaaniruddh@gmail.com', 'hitesh@loyaltician.com'];
