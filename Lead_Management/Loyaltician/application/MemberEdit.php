                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="card m-b-30">
                            ...
                            <form method="POST" action="MemberEdit_Process1.php" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="bg-dark" style="color:white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Static
                                        Info</div>
                                    <input type="hidden" value="<?php echo $HOtelNameChk; ?>" id="hotlName"
                                        name="hotlName" required>


                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputEmail4">Lead ID</label>
                                            <input type="text" class="form-control" id="Static_LeadID"
                                                name="Static_LeadID" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['Lead_id'];
                                                } ?>" readonly required>
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <!--   <input type="text" class="form-control" id="Static_LeadSource" name="Static_LeadSource" value="<?php if ($Mainid != "") {
                                                echo $fetchLead_Sources['Name'];
                                            } ?>"  required >
                                -->
                                            <select class="form-control" name="Static_LeadSource"
                                                id="Static_LeadSource">
                                                ...
                                                <?php if ($Mainid != "") {
                                                    ...
                                                    while ($Sourcesfetch = mysqli_fetch_array($qerySources)) {
                                                        ...
                                                        <option value="<?php echo $Sourcesfetch['SourceId']; ?>"
                                                            id="<?php echo $Sourcesfetch['SourceId']; ?>" <?php if ($Mainid != "") {
                                                                   if ($Sourcesfetch['Name'] == $fetchLead_Sources['Name']) { ?>selected <?php }
                                                               } ?>><?php echo $Sourcesfetch['Name']; ?>
                                                        </option>
                                                    <?php }
                                                } ?>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Static_FirstName"
                                                name="Static_FirstName" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['FirstName'];
                                                } ?>" placeholder="First Name *" readonly required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Last Name</label>
                                            <input type="text" class="form-control" id="Static_LastName"
                                                name="Static_LastName" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['LastName'];
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Static_AssignedTo"
                                                name="Static_AssignedTo" value="<?php if ($Mainid != "") {
                                                    echo $fetchSalesmanId['FirstName'] . " " . $fetchSalesmanId['LastName'];
                                                } ?>" readonly required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Date of Assignment</label>
                                            <input type="text" class="form-control" id="Static_DateOfAssignment"
                                                name="Static_DateOfAssignment" value="<?php if ($Mainid != "") {
                                                    echo $fetchDelegate['DelegatedTIme'];
                                                } ?>" readonly required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Static_DateOfEntry"
                                                name="Static_DateOfEntry" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['Creation'];
                                                } ?>" readonly required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Status</label>
                                            <input type="text" class="form-control" id="Static_Status"
                                                name="Static_Status" value="<?php if ($Mainid != "") {
                                                    if ($fetchLead['Status'] == '4' || $fetchLead['Status'] == '5') {
                                    ...
                                    <input type="text" class="form-control" id="LastName" name="LastName" value="<?php if ($Mainid != "") {
                                        echo $fetchLead['LastName'];
                                    } ?>"   >
                                </div>-->
                                    ...
                                    <br /><br />
                                    <div class="bg-dark" style="color:white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Part
                                        1. Primary Member Entry</div>

                                    <div class="form-group">
                                        <label for="inputAddress2">Title</label>
                                        <select class="form-control" name="Primary_Title" id="Primary_Title" required>
                                            <?php if ($Mainid != "") { ?>
                                                <option value="<?php echo $fetchLead['Title']; ?>">
                                                    <?php echo $fetchLead['Title']; ?>
                                                </option><?php } ?>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputEmail4">First Name</label>
                                            <input type="text" class="form-control" id="Primary_FirstName"
                                                name="Primary_FirstName" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['FirstName'];
                                                } ?>" placeholder="First Name *" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Last Name</label>
                                            <input type="text" class="form-control" id="Primary_LastName"
                                                name="Primary_LastName" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['LastName'];
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Primary_Company"
                                                name="Primary_Company" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['Company'];
                                                } ?>" placeholder="Company Name " required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Designation</label>
                                            <input type="text" class="form-control" id="Primary_Designation"
                                                name="Primary_Designation" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['Designation'];
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="Primary_Area" name="Primary_Area"
                                            value="<?php if ($Mainid != "") {
                                                echo $fetchLead['pincodeOfArea'];
                                            } ?>" placeholder="Area">
                                    </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Primary_Pincode"
                                                name="Primary_Pincode" onblur="getStateCity();" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['PinCode'];
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Primary_State"
                                                name="Primary_State" placeholder="State *" readonly value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['State'];
                                                } ?>" required>
                                      ...
                                      <option value="<?php echo $Statefetch['state_id']; ?>" id="<?php echo $Statefetch['state_id']; ?>" <?php if ($Mainid != "") {
                                                if ($Statefetch['state'] == $fetchState['state']) { ?>selected <?php }
                                            } ?>><?php echo $Statefetch['state']; ?></option><?php } ?>
                                           <?php } ?>
                                          </select>-->
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Primary_City"
                                                name="Primary_City" placeholder="city *" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['City'];
                                                } ?>" readonly required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="email" class="form-control" id="Primary_Gmail_1"
                                            name="Primary_Gmail_1" placeholder="Email *" value="<?php if ($Mainid != "") {
                                                echo $fetchLead['EmailId'];
                                            } ?>" required>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_mcode1"
                                                id="Primary_mcode1" maxlength="3" value="+<?php if ($Mainid != "") {
                                                    echo $fetchLead['MobileCode'];
                                                } ?>" placeholder="eg. 91" required>
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            <label for="inputPassword4">Mobile number *</label>&nbsp;<label
                                                id="label5"></label>
                                            <input type="text" class="form-control" id="Primary_mob1"
                                                name="Primary_mob1" maxlength="10" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['MobileNumber'];
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            <label for="inputEmail4">Mobile Code *</label>
                                            <input type="text" class="form-control" name="Primary_mcode2"
                                                id="Primary_mcode2" maxlength="3" value="+<?php if ($Mainid != "") {
                                                    echo $fetchLead['MobileCode2'];
                                                } ?>" placeholder="eg. 91">
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            <label for="inputPassword4">Mobile number *</label>&nbsp;<label
                                                id="label5"></label>
                                            <input type="text" class="form-control" id="Primary_mob2"
                                                name="Primary_mob2" maxlength="10" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['MobileNumber2'];
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_Contact1code"
                                                id="Primary_Contact1code" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['contact1Code'];
                                                } else {
                                                    echo "022";
                                                } ?>" maxlength="3" placeholder="eg. 022">
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            <label for="inputPassword4">Contact Number1</label>
                                            <input type="text" class="form-control" id="Primary_Contact1"
                                                name="Primary_Contact1" maxlength="10" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['ContactNo1'];
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            <label for="inputEmail4">Code</label>
                                            <input type="text" class="form-control" name="Primary_Contact2code"
                                                id="Primary_Contact2code" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['contact2Code'];
                                                } else {
                                                    echo "022";
                                                } ?>" maxlength="3" placeholder="eg. 022">
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            ...
                                            <input type="text" class="form-control" id="Primary_Contact2"
                                                name="Primary_Contact2" maxlength="10" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['ContactNo2'];
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            <label for="inputEmail4">Code</label>
                                            <input type="text" class="form-control" name="Primary_Contact3code"
                                                id="Primary_Contact3code" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['contact3Code'];
                                                } else {
                                                    echo "022";
                                                } ?>" maxlength="3" placeholder="eg. 022">
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            ...
                                            <input type="text" class="form-control" id="Primary_Contact3"
                                                name="Primary_Contact3" value="<?php if ($Mainid != "") {
                                                    echo $fetchLead['ContactNo3'];
                                                } ?>" maxlength="10" placeholder="Contact Number3">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="Primary_nameOnTheCard"
                                            name="Primary_nameOnTheCard" value="<?php if ($Mainid != "") {
                                                echo $fetchMem['Primary_nameOnTheCard'];
                                            } ?>" maxlength="22" placeholder="22 Characters including spaces" required>
                                    </div>

                                    <div class="form-group " style="display:none">
                                        <label for="inputPassword4">Photo Upload</label>
                                        <input type="file" class="form-control" id="Primary_PhotoUpload"
                                            name="Primary_PhotoUpload">
                                    </div>
                                    <div class="form-group ">
                                        <label for="inputPassword4">Email-ID 2(Gmail)</label>
                                        <input type="email" class="form-control" id="Primary_Email_ID2"
                                            name="Primary_Email_ID2" placeholder="Email-ID " value="<?php if ($Mainid != "") {
                                                echo $fetchMem['Primary_Email_ID2'];
                                            } ?>">
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="Primary_DateOfBirth"
                                            name="Primary_DateOfBirth" value="<?php if ($Mainid != "") {
                                                $c = $fetchMem['Primary_DateOfBirth'];
                                                if ($c == "0000-00-00") {
                                                    echo "0000-00-00";
                                                } else {
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="Primary_Anniversary"
                                            name="Primary_Anniversary" value="<?php if ($Mainid != "") {
                                                $cc = $fetchMem['Primary_Anniversary'];
                                                if ($cc == "0000-00-00") {
                                                    echo "0000-00-00";
                                                } else {
                                                    echo date("d-m-Y", strtotime($cc));
                                                }
                                            } ?>" placeholder="dd-mm-yyyy" required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="Primary_AddressType1"
                                            id="Primary_AddressType1" required>
                                            <option value="">Select Type *</option>
                                            <option value="Business" <?php if ($fetchMem['Primary_AddressType1'] == "Business") { ?>Selected <?php } ?>>
                                                Business</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Primary_BuldNo_addrss"
                                            name="Primary_BuldNo_addrss" value="<?php if ($Mainid != "") {
                                                echo $fetchMem['Primary_BuldNo_addrss'];
                                            } ?>" placeholder="Buld No./Room NO.">

                                    </div>

                                    <div class="form-group">
                                        <label for="inputPassword4">Address</label>
                                        <input type="text" class="form-control" id="Primary_Area_addrss"
                                            name="Primary_Area_addrss" value="<?php if ($Mainid != "") {
                                                echo $fetchMem['Primary_Area_addrss'];
                                            } ?>" placeholder="Area/Location">

                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword4">Address</label>
                                        <input type="text" class="form-control" id="Primary_Landmark_addrss"
                                            name="Primary_Landmark_addrss" value="<?php if ($Mainid != "") {
                                                echo $fetchMem['Primary_Landmark_addrss'];
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control" name="Primary_MaritalStatus"
                                            id="Primary_MaritalStatus" onchange="setSpouseMember()" required>
                                            <option value="">Select Type *</option>
                                            <option id="Single" value="Single" <?php if ($fetchMem['Primary_MaritalStatus'] == "Single") { ?>Selected <?php } ?>>
                                                Single</option>
                                            <option id="Married" value="Married" <?php if ($fetchMem['Primary_MaritalStatus'] == "Married") { ?>Selected <?php } ?>>
                                                Married</option>
                                        </select>
                                    </div>
                                    ...
                                    <div id="Spouse" style="display:none">
                                        <div class="bg-dark" style="color:white;">
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Part 2. Spouse Member Entry</div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="Spouse_Title" id="Spouse_Title">
                                                ...
                                                $runTitle = mysqli_query($conn, $titleQry);
                                                while ($fetchTitle = mysqli_fetch_array($runTitle)) { ?>
                                                    <option value="<?php echo $fetchTitle['titleName']; ?>" <?php if ($fetchTitle['titleName'] == $fetchMem['Spouse_Title']) { ?>Selected
                                                        <?php } ?>><?php echo $fetchTitle['titleName']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="Spouse_FirstName"
                                                    name="Spouse_FirstName" value="<?php if ($Mainid != "") {
                                                        echo $fetchMem['Spouse_FirstName'];
                                                    } ?>" placeholder="First Name *">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">Last Name</label>
                                                <input type="text" class="form-control" id="Spouse_LastName"
                                                    name="Spouse_LastName" value="<?php if ($Mainid != "") {
                                                        echo $fetchMem['Spouse_LastName'];
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="Spouse_GmailMArrid1"
                                                name="Spouse_GmailMArrid1" value="<?php if ($Mainid != "") {
                                                    echo $fetchMem['Spouse_GmailMArrid1'];
                                                } ?>" placeholder="Email *">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="Spouse_GmailMArrid2"
                                                name="Spouse_GmailMArrid2" value="<?php if ($Mainid != "") {
                                                    echo $fetchMem['Spouse_GmailMArrid2'];
                                                } ?>" placeholder="Email-id (Gmail) *">
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4 col-sm-4">
                                                ...
                                                <input type="text" class="form-control" name="Spouse_mcode1Married1"
                                                    id="Spouse_mcode1Married1" value="+<?php if ($Mainid != "") {
                                                        echo $fetchMem['Spouse_mcode1Married1'];
                                                    } else {
                                                        echo "91";
                                                    } ?>" maxlength="3" value="+91" placeholder="eg. 91">
                                            </div>
                                            <div class="form-group col-md-8 col-sm-8">
                                                <label for="inputPassword4">Mobile number *</label>&nbsp;<label
                                                    id="label5"></label>
                                                <input type="text" class="form-control" id="Spouse_mob1MArid1"
                                                    name="Spouse_mob1MArid1" maxlength="10" value="<?php if ($Mainid != "") {
                                                        echo $fetchMem['Spouse_mob1MArid1'];
                                                    } ?>" placeholder="Mobile number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4 col-sm-4">
                                                ...
                                                <input type="text" class="form-control" name="Spouse_mcode1Married2"
                                                    id="Spouse_mcode1Married2" maxlength="3" value="+<?php if ($Mainid != "") {
                                                        echo $fetchMem['Spouse_mcode1Married2'];
                                                    } else {
                                                        echo "91";
                                                    } ?>" placeholder="eg. 91">
                                            </div>
                                            <div class="form-group col-md-8 col-sm-8">
                                                ...
                                                <input type="text" class="form-control" id="Spouse_mob1MArid2"
                                                    name="Spouse_mob1MArid2" maxlength="10" value="<?php if ($Mainid != "") {
                                                        echo $fetchMem['Spouse_mob1MArid2'];
                                                    } ?>" placeholder="Mobile number">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4 col-sm-4">
                                                ...
                                                <input type="text" class="form-control" name="Spouse_Contact1codeMArid"
                                                    id="Spouse_Contact1codeMArid" maxlength="3" value="<?php if ($Mainid != "") {
                                                        echo $fetchMem['Spouse_Contact1codeMArid'];
                                                    } else {
                                                        echo "022";
                                                    } ?>" placeholder="eg. 022">
                                            </div>
                                            <div class="form-group col-md-8 col-sm-8">
                                                ...
                                                <input type="text" class="form-control" id="Spouse_Contact1Married"
                                                    name="Spouse_Contact1Married" maxlength="10" value="<?php if ($Mainid != "") {
                                                        echo $fetchMem['Spouse_Contact1Married'];
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-4 col-sm-4">
                                                ...
                                                <input type="text" class="form-control" name="Spouse_Contact2codeMArid"
                                                    id="Spouse_Contact2codeMArid" value="<?php if ($Mainid != "") {
                                                        echo $fetchMem['Spouse_Contact2codeMArid'];
                                                    } else {
                                                        echo "022";
                                                    } ?>" maxlength="3" placeholder="eg. 022">
                                            </div>
                                            <div class="form-group col-md-8 col-sm-8">
                                                ...
                                                <input type="text" class="form-control" id="Spouse_Contact2Married"
                                                    name="Spouse_Contact2Married" maxlength="10" value="<?php if ($Mainid != "") {
                                                        echo $fetchMem['Spouse_Contact2Married'];
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" id="Spouse_DateOfBirth"
                                                name="Spouse_DateOfBirth" value="<?php if ($Mainid != "") {
                                                    $e = $fetchMem['Spouse_DateOfBirth'];
                                                    if ($e == "0000-00-00") {
                                                        echo "0000-00-00";
                                                    } else {
                                                        echo date("d-m-Y", strtotime($e));
                                                    }
                                                } ?>" placeholder="dd-mm-yyyy" required />
                                        </div>
                                        ...
                                        <div class="form-group ">
                                            ...
                                            <input type="text" class="form-control" id="Spouse_nameOnTheCardMarried"
                                                name="Spouse_nameOnTheCardMarried" value="<?php if ($Mainid != "") {
                                                    echo $fetchMem['Spouse_nameOnTheCardMarried'];
                                                } ?>" maxlength="22" placeholder="22 Characters including spaces">
                                        </div>
                                        <br /><br />
                                    ...
                                    <div class="bg-dark" style="color:white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Part 3
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDetails_Level"
                                            ...
                                            value="<?php echo $fetchStatic_LeadID1['level_name']; ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDetails_Fee"
                                            ...
                                            value="<?php echo $fetchStatic_LeadID['MembershipDetails_Fee']; ?>"
                                            readonly>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDts_PaymentDate"
                                            name="MembershipDts_PaymentDate" value="<?php if ($Mainid != "") {
                                                $ccc = $fetchStatic_LeadID['MembershipDts_PaymentDate'];
                                                if ($ccc == "0000-00-00") {
                                                    echo "0000-00-00";
                                                } else {
                                                    echo date("d-m-Y", strtotime($ccc));
                                                }
                                            } ?>">
                                    </div>
                                    <div class="form-group">
                                ...
                                --> <select class="form-control" name="MembershipDts_PaymentMode"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MemshipDts_GST_number"
                                            name="MemshipDts_GST_number" value="<?php if ($fetchStatic_LeadID['GST_Number'] != "") {
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control"  name="MembershipDetails_Level" id="MembershipDetails_Level" onblur="cal_NetPayment()"   onchange="setDropDown('MembershipDetails_Level','PrimaryMembershipFee','P_Level_id','MembershipFee_id','NewMembership','MembershipDetails_Fee')" required>
                                        ...
                                        if ($Mainid != "") {
                                            $levelQry .= " and Program_ID=(SELECT Program_ID FROM `Program` where Hotel_id='" . $HOtelNameChk . "')";
                                        }
                        ...
                        <div id="Hide_Discount_UplodeAuthorisation" style="display:none">        
                               ...
                               -->
                                    ...
                                    <div class="bg-dark" style="color:white;display:none">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Part 4. Documentation</div>

                                    <div class="form-group" style="display:none">
                                        <label for="inputEmail4">Upload Signatures</label>
                                        <input type="file" class="form-control" id="Documentation_UploadSignatures"
                                            name="Documentation_UploadSignatures">
                                    </div>


                                    <div class="form-group" style="display:none">
                                        <label for="inputEmail4">Address Proof</label>
                                        <input type="file" class="form-control" id="Documentation_AddressProof"
                                            name="Documentation_AddressProof">
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                name="Relationships_ReferredByLEADID"
                                                id="Relationships_ReferredByLEADID"
                                                value="<?php echo $fetchMem['Relationships_ReferredByLEADID']; ?>"
                                                placeholder="Referred by LEAD ID" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Referred by MEMBERSHIP ID</label>
                                            <input type="text" class="form-control"
                                                id="Relationships_ReferredByMEMBERSHIPID"
                                                name="Relationships_ReferredByMEMBERSHIPID"
                                                value="<?php echo $fetchMem['Relationships_ReferredByMEMBERSHIPID']; ?>"
                                                placeholder="Referred by MEMBERSHIP ID" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="bg-dark" style="color:white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Part
                                        6. Issue Membership</div>



                                    <div class="custom-control custom-checkbox" style="display:none">
                                        <input type="checkbox" class="custom-control-input" id="itemCheck1"
                                            name="itemCheck1" <?php if ($fetchMem['itemCheck1'] != "") { ?>checked
                                        <?php } ?>>
                                        <label class="custom-control-label" for="itemCheck1">Check this item</label>
                                    </div>

                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="BookletCheck1"
                                            name="BookletCheck1" <?php if ($fetchMem['BookletCheck1'] != "") { ?>checked
                                        <?php } ?> >
                                        <label class="custom-control-label" for="BookletCheck1">Issue Booklet</label>
                                    </div>

                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input" id="CertificatesCheck1"
                                            name="CertificatesCheck1" <?php if ($fetchMem['CertificatesCheck1'] != "") { ?>checked
                                        <?php } ?>>
                                        <label class="custom-control-label" for="CertificatesCheck1">Issue
                                            Certificates</label>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            <label for="inputEmail4">Referred by LEAD ID</label>
                                            <input type="text" class="form-control" name="Issue_ReferredByLEADID"
                                                id="Issue_ReferredByLEADID" placeholder="Referred by LEAD ID"
                                                value="<?php echo $fetchMem['Issue_ReferredByLEADID']; ?>" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Referred by MEMBERSHIP ID</label>
                                            <input type="text" class="form-control" id="Issue_ReferredByMEMBERSHIPID"
                                                name="Issue_ReferredByMEMBERSHIPID"
                                                value="<?php echo $fetchMem['Issue_ReferredByMEMBERSHIPID']; ?>"
                                                placeholder="Referred by MEMBERSHIP ID" required>
                                        </div>
                                    </div>

                                    <br>
                                    <!--======================== Part 6 Promotional Vouchers (start)================================--->
                                    <div class="bg-dark" style="color:white;">
                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Promotional Vouchers</div>
                                    ...
                                    $provoucher = mysqli_query($conn, "select * from voucher_issued_code where program_id = '" . $fetchStatic_LeadID['MembershipDetails_Level'] . "' and  status=1 ");
                                    while ($voucher_sql_result = mysqli_fetch_assoc($provoucher)) {

                                        $voucherid = $voucher_sql_result['v_id'];
                                        $voucher = $voucher_sql_result['voucher_code'];
                                        $voucher_name = $voucher_sql_result['voucher_name'];

                                        ?>

                                        <input class="mem_vouchers" type="checkbox" name="vouchers[] "
