                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="card m-b-30">
                            ...
                            <form method="post" action="voucher_Type_Process.php" enctype="multipart/form-data"
                                            ...
                                            <td>
                                                <div class="form-row">
                                                    <div class="form-group col-md-5">
                                                        <input type="text" class="code form-control" id="serialNo"
                                                            name="serialNo[]" value="" placeholder="serial No. *"
                                                            required /> &nbsp;
                                                    </div>
                                                    <div class="form-group col-md-5">

                                                        <input type="text" class="code form-control" id="ServiceName"
                                                            name="ServiceName[]" value="" placeholder="Service Name *"
                                                            required /> &nbsp;
