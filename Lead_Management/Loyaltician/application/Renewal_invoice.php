                        ...
                        <div class="col-md-6 text-white p-b-30">
                            <div class="media">
                                ...
                                mdi-printer"></i>
                                    ...
                                    <form method="POST" action="RenewalMember_Payment_Process.php"
                                        ...
                                        <div style="display:none">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="MembershipDts_Discount"
                                                    name="MembershipDts_Discount" value="<?php if ($_POST['MembershipDts_Discount'] == "") {
                                                        echo '0';
                                                    } else {
                                    ...
                                    <div class="table-responsive ">
                                        <table border=1 class="table  m-t-20">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="" colspan="2">Email :
                                                        <?php echo $fetchLead['EmailId']; ?>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="" colspan="1"
                                                        ...
                                                        <?php echo $FL['level_name'] . " Membership:"; ?>
                                                    </td>
                                                    <td class="text-center">1</td>
                                                    <td class="text-right"><?php echo $_POST['MembershipDetails_Fee'] ?>
                                                    </td>
                                                    <td class="text-right">
                                                        <?php echo $_POST['MembershipDts_NetPayment'] ?>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="" colspan="1"
                                                        ...
                                                        <?php echo $_POST['MembershipDts_PaymentMode']; ?>
                                                    </td>
                                                    <td class="text-center" colspan="2"
                                                ...
                                                <tr>
                                                    <td class="" colspan="1"
                                                        ...
                                                        Approval Code:
                                                        <?php echo $_POST['MembershipDts_InstrumentNumber']; ?>
                                                    </td>
                                                    <td class="text-center" colspan="2"
