                            ...
                            <form method="POST" action="MemberCreation_Review.php" enctype="multipart/form-data">
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Primary_Pincode"
                                                name="Primary_Pincode" value="<?php if ($Mainid != "") {
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_mcode1"
                                                ...
                                                } ?>" placeholder="eg. 91" required readonly>
                                        </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_mcode2"
                                                id="Primary_mcode2" maxlength="3" value="+91" placeholder="eg. 91">
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            <label for="inputPassword4">Mobile number *</label>&nbsp;<label
                                                id="label5"></label>
                                            <input type="text" class="form-control" id="Primary_mob2"
                                                name="Primary_mob2" maxlength="10" placeholder="Mobile number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_Contact2code"
                                                id="Primary_Contact2code" value="022" maxlength="3"
                                                placeholder="eg. 022">
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_Contact3code"
                                                id="Primary_Contact3code" value="022" maxlength="3"
                                                placeholder="eg. 022">
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            <label for="inputPassword4">Contact Number3</label>
                                            <input type="text" class="form-control" id="Primary_Contact3"
                                                name="Primary_Contact3" maxlength="10" placeholder="Contact Number3">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="MembershipDetails_Level"
                                            id="MembershipDetails_Level" onblur="cal_NetPayment()"
                                            onchange="setDropDown('MembershipDetails_Level','PrimaryMembershipFee','P_Level_id','MembershipFee_id','NewMembership','MembershipDetails_Fee')"
                                            required>
                                            ...
                                            <option value="<?php echo $fetchLevel['Leval_id']; ?>">
                                                <?php echo $fetchLevel['level_name']; ?>
                                            </option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipDetails_Fee"
                                            name="MembershipDetails_Fee" onblur="cal_NetPayment()" readonly required>
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                            id="MembershipDetails_offerCheck1" name="MembershipDetails_offerCheck1"
                                            onchange="valueChangedHideShow()">
                                    ...
                                    <div id="Hide_Discount_UplodeAuthorisation" style="display:none">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="MembershipDts_Discount"
                                                name="MembershipDts_Discount" onblur="cal_NetPayment()" value="0">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" id="MembershipDts_Author"
                                                name="MembershipDts_Author">
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="file" class="form-control" id="MemshipDts_UploadCopyOfTheInstmnt"
                                            name="MemshipDts_UploadCopyOfTheInstmnt">
                                    </div>
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" name="Issue_ReferredByLEADID"
                                                id="Issue_ReferredByLEADID" placeholder="Referred by LEAD ID" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Referred by MEMBERSHIP ID</label>
