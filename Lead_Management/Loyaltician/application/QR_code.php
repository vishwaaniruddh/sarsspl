                            ...
                            <form id="myForm" method="post" action="Leadpdf/VoucherQRcode.php">
                                <div class="card-body">
                                  ...
                                  <option value="Birthday">Birthday</option>
                                        ...
                                        <div class="form-group col-md-4"> <input type="hidden" name="drop" id="drop" />
                                            <select name="lstStates" multiple="multiple" id="lstStates"
                                                class="form-control" onchange="per()" required>
                                                ...
                                                <optgroup label=" ">
                                                    ...
                                                    while ($fetch = mysqli_fetch_array($runabc)) {
                                                        ...
                                                        ?>
                                                        <option value="<?php echo $fetch['VoucherBookletNumber']; ?>">
                                                            <?php echo $fetch['VoucherBookletNumber'] . "          " . $fetchMem['Primary_nameOnTheCard']; ?>
                                                        </option>
                                                        < <?php } ?>
                                                </optgroup>
                                                </optgroup>
