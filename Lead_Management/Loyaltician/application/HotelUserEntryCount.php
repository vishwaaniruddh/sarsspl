                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <select class="form-control" name="Ab_Filtter" id="Ab_Filtter">
                                            ...
                                            while ($fecthuser = mysqli_fetch_array($userQuery1)) { ?>
                                                <option value="<?php echo $fecthuser['id']; ?>">
                                                    <?php echo $fecthuser['empname']; ?></option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div align="center"> Total :-<input type="text" id="total" style="border:none" readonly>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="cols-md-8">
                                        <form name="frm" method="post" action="exporHoteluserEntry.php" target="_new">
                                            ...
                                            <input type="hidden" name="Ab_Filtterid" id="Ab_Filtterid" value=""
                                                readonly>
