                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form onSubmit="if(!confirm('Is the form filled out correctly?')){return false;}"
                                    action="<?php echo $_SERVER['PHP_SELF']; ?>?id=<?php echo $id; ?>" method="post">
                                    ...
                                    <h4>Membership Extension for - <u> <span style="color:red;">
                                                <?php echo $booklet_series; ?></span></u></h4>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" data-date-format='yyyy-mm-dd' name="payment_date"
                                            id="datepicker" value="<?php echo $expiry; ?>" class="form-control"
                                    ...
                                    <br>
                                    <input type="submit" name="submit" value="Extend Membership" class="btn btn-danger"
                                        style="margin-left: 2%;">
