...
$getLevel= substr($Voucher, 1, 1);
 ...
 if($_rowMemb['MembershipNumber']!=""){
    ...
    //  $promovoucher = explode(',',$promotional_voucher_code);
 ...
 $L=4;
  ...
  $htmtab1_body.='<td ><p style="line-height:100%;font-size:8px;">  
  <img src="'.$ccc.'" alt="Smiley face" width="52" height="52" style="float:left;" >
  <div style="line-height:-280%;text-align:right">'.$detailsMemb['Primary_nameOnTheCard'].'</div><br/>
  <div style="line-height:-90%;text-align:right">MemberId :'.$detailsMemb['GenerateMember_Id'].'</div>
  <br/>
  <div style="line-height:-25%;text-align:right">Voucher :'.$codeContents.'</div><br/>
  <div style="line-height:-15%;text-align:right"> Expiry '.$R.'</div>
  </p>
  </td> ';
