                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="card m-b-30">
                            ...
                            <form method="post" action="PrimaryMembershipFee_process.php"
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="NewMembership"
                                                name="NewMembership" value="0" placeholder="New Membership Fee*"
                                                required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">Renewal Membership Fee</label>
                                            <input type="text" class="form-control" id="RenewalMembership"
                                                name="RenewalMembership" value="0" placeholder="Renewal Membership Fee*"
                                                required>
                                        </div>
                                    </div>
