                    ...
                    <div class="row">
                        <div class="col-12 text-white p-t-40 p-b-90">
                            ...
                            <h4 class=""> <span class="btn btn-white-translucent">
                                ...
                                <a class="btn btn-danger" href="MemberEdit.php?id=<?php echo $id; ?>">View Member
                                    Info</a>
                                ...
                                <form action="renewal_extension_process.php?id=<?php echo $id; ?>" method="post">
                                    ...
                                    <div class="cust_content">
                                        ...
                                        <div class="date_select">
                                            ...
                                            <input type="text" data-date-format='yyyy-mm-dd' name="payment_date"
                                                id="datepicker" class="form-control" placeholder="Select Date">
                                        </div>
                                    ...
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                            id="renewalPromotionalCheck1" name="renewalPromotionalCheck1">
                                        <label class="custom-control-label" for="renewalPromotionalCheck1">Issue Renewal
                                            Promotional Certificate</label>
                                    </div>
                                    <br>
                                    <br><br>
