                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                <div class="bg-dark" style="color:white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Static
                                    Info</div>
                                <input type="hidden" value="<?php echo $HOtelNameChk; ?>" id="hotlName" name="hotlName"
                                    required>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control"
                                            value="<?php echo $fetchMem['GenerateMember_Id']; ?>" readonly required>
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="inputEmail4">Booklet Series</label>
                                        <input type="text" class="form-control"
                                            value="<?php echo $fetchMem['booklet_Series']; ?>" readonly required>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="Static_LeadID" name="Static_LeadID"
                                            value="<?php if ($Mainid != "") {
                                                ...
                                                while ($Sourcesfetch = mysqli_fetch_array($qerySources)) {
                                                    ...
                                                    <option value="<?php echo $Sourcesfetch['SourceId']; ?>"
                                                        id="<?php echo $Sourcesfetch['SourceId']; ?>" <?php if ($Mainid != "") {
                                                               if ($Sourcesfetch['Name'] == $fetchLead_Sources['Name']) { ?>selected
                                                            <?php }
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="Static_Status" name="Static_Status"
                                            value="<?php if ($Mainid != "") {
                                ...
                                <br /><br />
                                <div class="bg-dark" style="color:white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Part 1.
                                    Primary Member Entry</div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="Primary_Area" name="Primary_Area" value="<?php if ($Mainid != "") {
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="Primary_State" name="Primary_State"
                                            placeholder="State *" readonly value="<?php if ($Mainid != "") {
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="Primary_City" name="Primary_City"
                                            placeholder="city *" value="<?php if ($Mainid != "") {
                                                echo $fetchLead['City'];
                                            } ?>" readonly required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" class="form-control" id="Primary_Gmail_1" name="Primary_Gmail_1"
                                        placeholder="Email *" value="<?php if ($Mainid != "") {
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8 col-sm-8">
                                        <label for="inputPassword4">Mobile number *</label>&nbsp;<label
                                            id="label5"></label>
                                        <input type="text" class="form-control" id="Primary_mob1" name="Primary_mob1"
                                            maxlength="10" value="<?php if ($Mainid != "") {
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-8 col-sm-8">
                                        <label for="inputPassword4">Mobile number *</label>&nbsp;<label
                                            id="label5"></label>
                                        <input type="text" class="form-control" id="Primary_mob2" name="Primary_mob2"
                                            maxlength="10" value="<?php if ($Mainid != "") {
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="Primary_AddressType1" id="Primary_AddressType1"
                                        required>
                                        <option value="">Select Type *</option>
                                        <option value="Business" <?php if ($fetchMem['Primary_AddressType1'] == "Business") { ?>Selected <?php } ?>>
                                            Business</option>
                                        <option value="Residence" <?php if ($fetchMem['Primary_AddressType1'] == "Residence") { ?>Selected <?php } ?>>
                                            Residence</option>
                                    </select>
                                ...
                                <div class="form-group ">
                                    ...
                                    <select class="form-control" name="Primary_MaritalStatus" id="Primary_MaritalStatus"
                                        onchange="setSpouseMember()" required>
                                        <option value="">Select Type *</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="MembershipDetails_Fee"
                                        ...
                                        value="<?php echo $fetchStatic_LeadID['MembershipDetails_Fee']; ?>" readonly>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="MembershipDts_Discount"
                                        ...
                                        value="<?php echo $fetchStatic_LeadID['MembershipDts_Discount']; ?>" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="MembershipDts_NetPayment"
                                        ...
                                        value="<?php echo $fetchStatic_LeadID['MembershipDts_NetPayment']; ?>" readonly>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="MembershipDts_GrossTotal"
                                        ...
                                        value="<?php echo $fetchStatic_LeadID['MembershipDts_GrossTotal']; ?>" readonly>
                                </div>
                                <div class="form-group">
                        ...
                        <div id="Hide_Discount_UplodeAuthorisation" style="display:none">        
                               ...
                               -->
                                ...
                                <div class="bg-dark" style="color:white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Part 5.
                                    Relationships</div>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="Relationships_ReferredByLEADID"
                                ...
                                <div class="bg-dark" style="color:white;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Part 6.
                                    Issue Membership</div>
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="PromotionalCheck1"
                                        name="PromotionalCheck1" <?php if ($fetchMem['PromotionalCheck1'] != "") { ?>checked
                                    <?php } ?>>
                                    <label class="custom-control-label" for="PromotionalCheck1">Issue Promotional
                                        Certificate</label>
                                </div>
