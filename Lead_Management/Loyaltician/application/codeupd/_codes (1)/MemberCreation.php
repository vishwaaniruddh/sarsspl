                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Static_LeadSource"
                                                name="Static_LeadSource" value="<?php if ($Mainid != "") {
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Primary_Area" name="Primary_Area"
                                            placeholder="Area of pincode *" value="<?php if ($Mainid != "") {
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Primary_State"
                                                name="Primary_State" placeholder="State *" value="<?php if ($Mainid != "") {
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-4 col-sm-4">
                                            ...
                                            <input type="text" class="form-control" name="Primary_mcode1"
                                                ...
                                                } else { ?>91<?php } ?>" placeholder="eg. 91" required>
                                        </div>
                                        <div class="form-group col-md-8 col-sm-8">
                                            ...
                                            <input type="text" class="form-control" id="Primary_mob1"
                                                ...
                                                onkeypress="return isNumberKey(event)" value="<?php if ($Mainid != "") {
