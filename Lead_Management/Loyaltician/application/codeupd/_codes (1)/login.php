                    ...
                    <div class="row align-items-center m-h-100">
                        <div class="mx-auto col-md-8">
                            ...
                            <div class="p-b-20 text-center">
                                <p> <img src="assets/img/Loyaltician Logo.jpg" width="120px" alt="User" />
                            ...
                            <form class="needs-validation" action="process_login.php" method="post">
                                <div class="form-row">
                                    ...
                                    <div class="form-group floating-label col-md-12">
                                        ...
                                        <input type="text" required class="form-control" id="uname" name="uname"
                                            style="text-align: center" placeholder="Email/Mobile">
                                    </div>
                                    <center>
                            ...
                            <br />
                            <p style="display: inline;"><a href="signup.php" style="padding-top: 10px;"
                                    class="text-underline ">Sign up</a></p>
                            <p style="display: inline;"><a href="forgot.php" style="float: right;"
                                    class="text-underline ">Forgot Password?</a></p>
