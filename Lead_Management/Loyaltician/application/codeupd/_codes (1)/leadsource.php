                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Name" name="Name"
                                            placeholder="Name *" value="<?php echo $fetch1['Name'] ?>" required>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputAddress">Description</label>&nbsp;<label id="label3"></label>
                                        <input type="text" class="form-control" id="Description" name="Description"
                                            placeholder="Description *" value="<?php echo $fetch1['Description'] ?>"
                                            required>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="Active" id="Active" required>
                                            ...
                                            <?php if ($id != "") { ?>
                                                <option value="<?php echo $fetch1['Active']; ?>">
                                                    <?php echo $fetch1['Active'] ?> </option>
                                            <?php } else { ?>
                                                <option value="">select </option>
                                            <?php } ?>
