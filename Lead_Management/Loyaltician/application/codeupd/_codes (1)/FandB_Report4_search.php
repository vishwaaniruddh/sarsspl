    ...
    <table id="example" class="table" style="width:100%">
        ...
        <tbody id="setTable">
            ...
            while ($f1 = mysqli_fetch_array($q1)) {
                ...
                if ($f1['Time'] >= "07:00:00" && $f1['Time'] <= "10:59:59") {
                    $periods = "Breakfast";
                } else if ($f1['Time'] >= "11:00:00" && $f1['Time'] <= "16:59:59") {
                    $periods = "Lunch";
                } else if ($f1['Time'] >= "17:00:00" && $f1['Time'] <= "23:59:59") {
                    $periods = "Dinner";
                } else if ($f1['Time'] >= "00:00:00" && $f1['Time'] <= "06:59:59") {
                    $periods = "Misc";
                }
