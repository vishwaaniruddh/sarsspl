                    ...
                    <tbody id="setTable">
                      ...
                      while ($_row = mysqli_fetch_array($qrys)) {
                        ...
                        <tr>
                          ...
                          <!-- <td><?php while ($sql2fetch = mysqli_fetch_array($runsql2)) {
                            echo $sql2fetch['name'];
                          } ?></td>-->
                          <td><input type="button" value="view permission" id="myBtn"
                              onclick="getPermission(<?php echo $_row['roll_id'] ?>)"></td>
                          <td><?php if ($_row['Active'] == 1) {
                            echo "Active";
                          } else {
                            echo "Inactive";
                          } ?></td>
