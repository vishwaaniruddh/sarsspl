                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="Primary_Pincode"
                                                onblur="getStateCity();" name="Primary_Pincode" value="<?php if ($Mainid != "") {
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <select class="form-control" name="Static_AssignedTo"
                                                id="Static_AssignedTo">
                                                ...
                                                while ($fetch = mysqli_fetch_array($runabc)) { ?>
                                                    <option value="<?php echo $fetch['SalesmanId']; ?>">
                                    ...
                                    while ($Sourcesfetch = mysqli_fetch_array($qerySources)) {
                                        ?>
                                            <option value=" <?php echo $Sourcesfetch['SourceId']; ?>"
                                                    id="<?php echo $Sourcesfetch['SourceId']; ?>"><?php echo $Sourcesfetch['Name']; ?>
                                                    </option>
                                                <?php } ?>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" id="Primary_Anniversary"
                                            name="Primary_Anniversary" placeholder="dd-mm-yyyy" required>
                                    </div>
                                        ...
                                        <div class="cols-md-6">
                                            <div class="custom-control custom-checkbox">&nbsp;&nbsp;&nbsp;
                                                <input type="checkbox" class="custom-control-input"
                                                    ...
                                                    name="MembershipDetails_offerCheck1"
                                        ...
                                        <div class="cols-md-6">
                                            <div class="custom-control custom-checkbox" id="sample"
                                                ...
                                                <input type="checkbox" class="custom-control-input"
                                                    ...
                                                    name="MembershipSampal_offerCheck1">
                                                <label class="custom-control-label"
