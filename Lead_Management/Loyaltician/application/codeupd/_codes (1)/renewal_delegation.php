                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="process_renewal_delegation.php" method="post">
                                    ...
                                    <?php $sql = mysqli_query($conn, "select * from Users where roll_id='15'");

                                    while ($sql_result = mysqli_fetch_assoc($sql)) { ?>

                                        <div style="padding: 1%;font-size: 18px; margin: auto 1%;">
                                            <input type="hidden" name="member_id" value="<?php echo $_GET['id']; ?>">
                                            <input type="radio" name="renewal_del"
                                                value="<?php echo $sql_result['UserId']; ?>"
                                                style="height: 20px; width: 20px;margin: auto 1%;">
