                                    ...
                                    <table id="example" class="table" style="width:100%">
                                        ...
                                        <tbody id="setTable">
                                            ...
                                            while ($_row = mysqli_fetch_array($qrys)) {
                                                ...
                                                $promotionalvoucher = $_row['promotional_voucher_code'];


                                                $voucherp = str_replace(array('[', ']'), '', $promotionalvoucher);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if ($_row['promotional_voucher_code']) {
                                                            echo $voucherp = str_replace(array('[', ']'), '', $_row['promotional_voucher_code']);
                                                        }
