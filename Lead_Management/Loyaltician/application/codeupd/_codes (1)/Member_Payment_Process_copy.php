...
<body>
  ...
  if ($qryinsert) {//echo "<br>success";
    ...
    if ($MembershipDts_PaymentMode == "Online") {
      ...
      $pagesource = "Orchid_Member_Payment_Process_Copy";
      $memid = $Static_LeadID;
      $msg = "";
