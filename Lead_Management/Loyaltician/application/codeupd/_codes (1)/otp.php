                        ...
                        <div class="mx-auto col-md-8">
                            ...
                            <form class="needs-validation" action="process_login.php" method="post">
                                <div class="form-row">
                                    <div class="form-group floating-label col-md-12">
                                        ...
                                        <input type="text" required class="form-control" id="otp" name="otp"
                                            style="text-align: center" placeholder="OTP">
                                        <input type="hidden" name="mob" id="mob"
                                            value="<?php echo $_SESSION['$mob']; ?>">
                                ...
                                <button type="button" class="btn btn-primary btn-block btn-lg"
                                    onClick="javascript:verify();">VERIFY</button><br />
                                <p style="display: inline;"><a onClick="ReGenerateOTP();" style="float: right;"
                                        class="text-underline ">Generate OTP</a></p>
