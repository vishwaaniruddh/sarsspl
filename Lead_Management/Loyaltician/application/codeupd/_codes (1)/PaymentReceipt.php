                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="fromSeries" name="fromSeries"
                                                placeholder="From Series *" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="inputPassword4">To Series</label>
                                            <input type="text" class="form-control" id="ToSeries" name="ToSeries"
                                                placeholder="To Series *" required>
                                        </div>
                                    </div>

                                    <div class="form-group">
                                        <label for="inputPassword4">Receipt Format</label>
                                        <input type="text" class="form-control" id="ReceiptFormat" name="ReceiptFormat"
                                            placeholder="Receipt Format *" required>
                                    </div>
