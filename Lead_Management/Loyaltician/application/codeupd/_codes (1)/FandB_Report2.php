                                ...
                                <div class="card-body">
                                                ...
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="text-center p-t-30 p-b-20">
                                                            ...
                                                            <h1 class="text-success" id="BoxCOVERS">
                                                                <?php echo $f1['No_of_paxClose']; ?></h1>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="text-center p-t-30 p-b-20">
                                                            ...
                                                            <h1 class="text-danger" id="BoxRevenue">
                                                                <?php echo $netRevenue2; ?></h1>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="card ">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="text-center p-t-30 p-b-20">
                                                            ...
                                                            <h1 class="text-success" id="BoxDiscount">
                                                                <?php echo $disPer2; ?> </h1>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-2">
                                            <label for="inputAddress2">From Date</lable>
                                                <input class="form-control js-datepicker" id="fromDt" autocomplete="off"
                                                    name="fromDt" data-large-mode="true" type="text">
                                        </div>

                                        <div class="form-group col-md-2">
                                            <label for="inputAddress2">To Date</lable>
                                                <input class="form-control js-datepicker" id="ToDt" autocomplete="off"
                                                    name="ToDt" data-large-mode="true" type="text">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6"
                                            ...
                                            <h3 align="center" id="hd_text1" style="display:none">Covers by Meal Period
                                            </h3>
                                            <div id="chart"></div>
                                        </div>
                                        <div class="col-md-6">
                                            <h3 align="center" id="hd_text2" style="display:none">Covers by Day of the
                                                week</h3>
                                            <div id="chart02"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6"
                                            style="position: relative;padding-left: 15px;border-right-width: 73px;padding-right: 58px;">
                                            <h3 align="center" id="hd_text3" style="display:none">Visits by Meal Period
                                            </h3>
                                            <div id="chart03"></div>
                                        </div>
                                        <div class="col-md-6">
                                            <h3 align="center" id="hd_text4" style="display:none">Visits by Day of the
                                                week</h3>
                                            <div id="chart04"></div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6"
                                            style="position: relative;padding-left: 15px;border-right-width: 73px;padding-right: 58px;">
                                            <h3 align="center" id="hd_text5" style="display:none">Net Revenue by Meal
                                                Period</h3>
                                            <div id="chart05"></div>
                                        </div>
                                        <div class="col-md-6">
                                            <h3 align="center" id="hd_text6" style="display:none">Net Revenue by Day of
                                                the week</h3>
                                            <div id="chart06"></div>
                                        </div>
                                    </div>
