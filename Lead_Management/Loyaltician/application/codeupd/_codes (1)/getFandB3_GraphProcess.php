...
if ($graph == 'graph1') {
  ...
  for ($i = $From_Month; $i <= $From_To; $i++) {
    ...
    if ($f1['No_of_paxClose'] != "") {
      $Breakfast = $f1['No_of_paxClose'];
    } else {
      $Breakfast = "0";
    }
    if ($f2['No_of_paxClose'] != "") {
      $Lunch = $f2['No_of_paxClose'];
    } else {
      $Lunch = "0";
    }
    if ($f3['No_of_paxClose'] != "") {
      $Dinner = $f3['No_of_paxClose'];
    } else {
      $Dinner = "0";
    }
  ...
  if ($monarray1 != "") {
    ...
    if ($Monf1['No_of_paxClose'] != "") {
      $MonBreakfast = $Monf1['No_of_paxClose'];
    } else {
      $MonBreakfast = "0";
    }
    ;
    if ($Monf2['No_of_paxClose'] != "") {
      $MonLunch = $Monf2['No_of_paxClose'];
    } else {
      $MonLunch = "0";
    }
    ;
    if ($Monf3['No_of_paxClose'] != "") {
      $MonDinner = $Monf3['No_of_paxClose'];
    } else {
      $MonDinner = "0";
    }
    ;
  ...
  if ($Tuearray1 != "") {
    ...
    if ($Tuef1['No_of_paxClose'] != "") {
      $TueBreakfast = $Tuef1['No_of_paxClose'];
    } else {
      $TueBreakfast = "0";
    }
    ;
    if ($Tuef2['No_of_paxClose'] != "") {
      $TueLunch = $Tuef2['No_of_paxClose'];
    } else {
      $TueLunch = "0";
    }
    ;
    if ($Tuef3['No_of_paxClose'] != "") {
      $TueDinner = $Tuef3['No_of_paxClose'];
    } else {
      $TueDinner = "0";
    }
    ;
  ...
  if ($Wedarray1 != "") {
    ...
    if ($Wedf1['No_of_paxClose'] != "") {
      $WedBreakfast = $Wedf1['No_of_paxClose'];
    } else {
      $WedBreakfast = "0";
    }
    ;
    if ($Wedf2['No_of_paxClose'] != "") {
      $WedLunch = $Wedf2['No_of_paxClose'];
    } else {
      $WedLunch = "0";
    }
    ;
    if ($Wedf3['No_of_paxClose'] != "") {
      $WedDinner = $Wedf3['No_of_paxClose'];
    } else {
      $WedDinner = "0";
    }
    ;
  ...
  if ($Thurarray1 != "") {
    ...
    if ($Thurf1['No_of_paxClose'] != "") {
      $ThurBreakfast = $Thurf1['No_of_paxClose'];
    } else {
      $ThurBreakfast = "0";
    }
    ;
    if ($Thurf2['No_of_paxClose'] != "") {
      $ThurLunch = $Thurf2['No_of_paxClose'];
    } else {
      $ThurLunch = "0";
    }
    ;
    if ($Thurf3['No_of_paxClose'] != "") {
      $ThurDinner = $Thurf3['No_of_paxClose'];
    } else {
      $ThurDinner = "0";
    }
    ;
  ...
  if ($Friarray1 != "") {
    ...
    if ($Frirf1['No_of_paxClose'] != "") {
      $FriBreakfast = $Frirf1['No_of_paxClose'];
    } else {
      $FriBreakfast = "0";
    }
    ;
    if ($Frirf2['No_of_paxClose'] != "") {
      $FriLunch = $Frirf2['No_of_paxClose'];
    } else {
      $FriLunch = "0";
    }
    ;
    if ($Frirf3['No_of_paxClose'] != "") {
      $FriDinner = $Frirf3['No_of_paxClose'];
    } else {
      $FriDinner = "0";
    }
    ;
  ...
  if ($satarray1 != "") {
    ...
    if ($satf1['No_of_paxClose'] != "") {
      $satBreakfast = $satf1['No_of_paxClose'];
    } else {
      $satBreakfast = "0";
    }
    ;
    if ($satf2['No_of_paxClose'] != "") {
      $satLunch = $satf2['No_of_paxClose'];
    } else {
      $satLunch = "0";
    }
    ;
    if ($satf3['No_of_paxClose'] != "") {
      $satDinner = $satf3['No_of_paxClose'];
    } else {
      $satDinner = "0";
    }
    ;
  ...
  if ($sunarray1 != "") {
    ...
    if ($sunf1['No_of_paxClose'] != "") {
      $sunBreakfast = $sunf1['No_of_paxClose'];
    } else {
      $sunBreakfast = "0";
    }
    ;
    if ($sunf2['No_of_paxClose'] != "") {
      $sunLunch = $sunf2['No_of_paxClose'];
    } else {
      $sunLunch = "0";
    }
    ;
    if ($sunf3['No_of_paxClose'] != "") {
      $sunDinner = $sunf3['No_of_paxClose'];
    } else {
      $sunDinner = "0";
    }
    ;
  ...
  $data[] = [
    ...
    'WedDinner' => $WedDinner,
    'Thursday' => 'Thur',
    'ThurBreakfast' => $ThurBreakfast,
    'ThurLunch' => $ThurLunch,
    'ThurDinner' => $ThurDinner,
    'Friday' => 'Fri',
