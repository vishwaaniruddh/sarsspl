                                        ...
                                        <tbody>
                                            ...
                                            while ($_row = mysqli_fetch_array($qrys)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><img src="<?php echo 'http://sarmicrosystems.in/Lead_Management/Loyaltician/' . $_row['logo']; ?>"
                                                    ...
                                                    <td><input type="button"
                                                            onclick="window.open('Card_Benefits.php?id=<?php echo $_row['Brand_id']; ?>','_self');"
                                                            value="Edit Lead"> </td>
