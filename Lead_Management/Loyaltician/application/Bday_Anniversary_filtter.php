...
while ($_row = mysqli_fetch_array($QuryGetLead)) {
  ...
  if ($_row['Primary_DateOfBirth'] == "0000-00-00") {
    $Primary_DateOfBirth = "00-00-0000";
  } else {
    $Primary_DateOfBirth = date('d-m', strtotime($_row['Primary_DateOfBirth']));
  }
  if ($_row['Primary_Anniversary'] == "0000-00-00") {
    $Primary_Anniversary = "00-00-0000";
  } else {
    $Primary_Anniversary = date('d-m', strtotime($_row['Primary_Anniversary']));
  }
...
if ($Ab_Filtter != "Anniversary") {
  ...
  while ($_row2 = mysqli_fetch_array($QuryGetLead2)) {
    ...
    if ($_row2['Primary_DateOfBirth'] == "0000-00-00") {
      $Primary_DateOfBirth = "00-00-0000";
    } else {
      $Primary_DateOfBirth = date('d-m-Y', strtotime($_row2['Primary_DateOfBirth']));
    }
    if ($_row2['Primary_Anniversary'] == "0000-00-00") {
      $Primary_Anniversary = "00-00-0000";
    } else {
      $Primary_Anniversary = date('d-m-Y', strtotime($_row2['Primary_Anniversary']));
    }

    if ($_row2['Spouse_DateOfBirth'] == "0000-00-00") {
      $spouse_DateOfBirth = "00-00-0000";
    } else {
      $spouse_DateOfBirth = date('d-m', strtotime($_row2['Spouse_DateOfBirth']));
    }
...
<div class="table-responsive p-t-10">
                             ...
                             for ($i = 0; $i < count($array1); $i++) {
                               $srno = $i + 1;
                               $Birth_Anni = "";
                               if ($Ab_Filtter == "Birthday") {
                                 if ($array1[$i]['Primary_DateOfBirth'] == '01-01-1970') {
                                   $Birth_Anni = "00-00-0000";
                                 } else {
                                   $Birth_Anni = $array1[$i]['Primary_DateOfBirth'];
                                 }
                               } else if ($Ab_Filtter == "Anniversary") {
                                 if ($array1[$i]['Primary_Anniversary'] == '01-01-1970') {
                                   $Birth_Anni = "00-00-0000";
                                 } else {
                                   $Birth_Anni = $array1[$i]['Primary_Anniversary'];
                                 }
                               }
