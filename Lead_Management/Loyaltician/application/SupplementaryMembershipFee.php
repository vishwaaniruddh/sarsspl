                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="MembershipFee" id="MembershipFee" required>
                                            ...
                                            <option value="SupplementaryMembershipFee">Supplementary Membership Fee
                                            </option>
                                            <option value="ComplimentaryMembershipFee">Complimentary Membership Fee
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="Fee" name="Fee" value="0"
                                            placeholder="Membership Fee*" required>
                                    </div>
