...
$fname=$_POST['fname'];
    ...
    $View="select * from Lead_Sources where 1=1";
 //echo $View;
...
<!--<td><input type="button" onclick="window.open('edituser.php?id=<?php echo $_row['UserId'];?>','_self');" value="Edit Lead">  </td>
