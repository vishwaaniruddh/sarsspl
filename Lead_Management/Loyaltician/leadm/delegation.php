...
">
            ...
            <div class="row" style="margin-top:2%;">
                <div class="col-md-6 col-md-offset-3" style="border: 1px solid #bfbfbf;">
                    <form id="myForm" class="login" action="delegate_process.php" method="post" style="
    margin-bottom: 0px;
    margin-top: 0px;
    padding-bottom: 0px;
">
                        ...
                        <h1>Select Sales associate </h1>

                        <fieldset>

                            <select class="rounded" name="Sales" id="Sales">
                                ...
                                while ($fetch = mysqli_fetch_array($runabc)) { ?>
                                    <option value="<?php echo $fetch['SalesmanId']; ?>"><?php echo $fetch['FirstName'] ?>
                                    </option>
                                <?php } ?>
                            </select>
