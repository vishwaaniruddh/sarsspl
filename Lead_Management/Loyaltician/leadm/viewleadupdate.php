...
Page=strPage;
	 ...
	 $.ajax({
             type: "POST",
             url: "viewleadupdate_process.php",
			 
             data: 'Page='+Page+'&perpg='+perp+'&fname='+fname+'&lname='+lname+'&Mobile='+Mobile+'&status='+status,
...
<!--<div>
      ...
      <form  method="post" id="formf" action="delegation.php">
        ...
        <h2 align="center">View Lead Updates</h2>

        
       	<table width="70%"  align="center">
		<tr>
		    <td><label><b>Status:</b></label>
          <select class="rounded" name="status" id="status" style="width: 100px;height: 25px;">
