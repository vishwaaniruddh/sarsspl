...
Page=strPage;
	 ...
	 $.ajax({
             type: "POST",
             url: "viewleadsource_process.php",
			 
             data: 'Page='+Page+'&perpg='+perp+'&Active='+Active+'&fname='+fname,
...
<!--<div>
      ...
      <form  method="post">
        ...
        <h2 align="center">View Lead Source</h2>

        
       	<table width="50%"  align="center">
		<tr>
		<td><input type="text" name="fname" id="fname" placeholder=" User Name"></td>
		<td><label for="board"><b>Active:</b></label><label id="label6"></label>
