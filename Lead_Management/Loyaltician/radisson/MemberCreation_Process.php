...
// $nodes = 'https://arpeeindustries.in/mail.php';
    ...
    $attachment = "https://sarsspl.com/Lead_Management/Loyaltician/radisson/Leadpdf/memberpdf/$Primary_nameOnTheCard.pdf";
...
<p>
  ...
  <img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/radisson/newassets/wlogo.png" alt="Elite Plus">
    <u></u><u></u></p>
</td>
<td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
<p align="right" style="text-align:right">
  ...
  <span style="text-decoration:none">
    <img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/radisson/assets/Image2.png" alt="Elite Plus">
  </span>
...
<p class=MsoNormal><span lang=EN-IN style="font-size:12.0pt;line-height:107%">&nbsp;</span></p>
                        ...
                        $htmtab1 = '<table border="1" cellpadding="5">
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                            <img src="https://sarsspl.com/Lead_Management/Loyaltician/radisson/assets/Image1.png" style="margin-left:200px;height:60px;">
                                            </th>
                                            </tr>
...
3. No refunds are entertained beyond 15 days of purchase<br>
                        ...
                        try{
                            ...
                            //Recipients
                            $mail->setFrom('contactus@clubeliteplus.com','Club Elite Plus');
...
// //exit;
        ...
        <td>' . $yearscount . '</td>
                    ...
                    $cc = ['contactus@clubeliteplus.com', 'nikhil@loyaltician.com', 'farheen@loyaltician.com'];
                    $bcc = [];
                    ...
                    $message = $message1;
                    $to = ['contactus@clubeliteplus.com'];
                    $cc = ['contactus@clubeliteplus.com', 'nikhil@loyaltician.com', 'farheen@loyaltician.com', 'hitesh@loyaltician.com'];
                    $bcc = [];
