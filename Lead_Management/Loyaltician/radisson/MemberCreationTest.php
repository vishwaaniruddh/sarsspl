            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                      ...
                      <form method="POST" action="MemberCreation_ReviewTest.php"  enctype="multipart/form-data" onsubmit="return val()" >
                        <div class="card-body">
                             ...
                             <div class="custom-control custom-checkbox">
                              ...
                              <div class="custom-control custom-checkbox">
                               ...
                               <div class="custom-control custom-checkbox">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="MealCheck2" name="MealCheck2">
                                    <label class="custom-control-label" for="MealCheck2">Set Meal for Group Dining</label> 
                                </div>
