            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        ...
                        <form method="POST" action="MemberCreation_ProcessTest.php" onSubmit="return validation()" enctype="multipart/form-data" >
                        <div class="card-body ">
                             ...
                             <div class="custom-control custom-checkbox">
                              ...
                              <div class="custom-control custom-checkbox">
                               ...
                               <div class="custom-control custom-checkbox">
                                ...
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="MealCheck1" name="MealCheck1" <?php if($_POST['MealCheck1']!=""){?>checked <?php }?>>
                                    <label class="custom-control-label" for="MealCheck1">Issue Promotional Certificate</label> 
                                </div>
                                
                                <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="MealCheck2" name="MealCheck2" <?php if($_POST['MealCheck2']!=""){?>checked <?php }?>>
                                    <label class="custom-control-label" for="MealCheck2">Issue Promotional Certificate</label> 
                                </div>
