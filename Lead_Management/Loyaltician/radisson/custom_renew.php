...
function getrenewfee($level){
    global $conn;
    $sql = mysqli_query($conn,"select * from PrimaryMembershipFee where P_Level_id='".$level."'");
...
$PaymentReceiptQuery = mysqli_query($conn,"select * from PaymentReceipt where Program_ID = '2' ");
$PaymentReceipt_result = mysqli_fetch_assoc($PaymentReceiptQuery);
$countReceipt = $PaymentReceipt_result['CountRecipt'];
    ...
    <section class="admin-content">
        ...
        <div class="container  pull-up">
            ...
            <form onSubmit="if(!confirm('Is the form filled out correctly?')){return false;}" id="renew_form" action="custom_renewal_process.php" method="post">
                ...
                <input type="hidden" name="countReceipt" value="<?=$countReceipt?>">
               ...
               <h2>Renewal Details </h2>   
                        ...
                        ?>
                                ...
                                <div class="form-group">
                                    ...
                                    value="<?php echo getrenewfee(get_members_data($_GET['id'],'MembershipDetails_Level')); ?>"
                                    readonly>
                            ...
                            <div class="form-group">
                                ...
                                <hr>
                                 ...
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="MealCheck1" name="MealCheck1">
                                    <label class="custom-control-label" for="MealCheck1">Set Meal for Two</label> 
                                </div>
                                ...
                                <hr>
                                 ...
                                 <div class="custom-control custom-checkbox">
                                    ...
                                    <label class="custom-control-label" for="renewalPromotionalCheck1">Issue Revalidation Certificate</label> 
                                </div>
