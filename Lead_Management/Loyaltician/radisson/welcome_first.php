...
$EmailSubject2="Renewal Welcome Email - Orchid First";
        ...
        $message2.='<tr>';
        $message2.='<th><img src="https://sarsspl.com/Lead_Management/Loyaltician/application/img/orchid-first.png" alt="gold_logo.png" width="700"/>  </th></tr><tr>';
           
        $message2.='<th><img src="https://sarsspl.com/Lead_Management/Loyaltician/application/img/first.png" alt="first.png" width="200"/>    </th>';
        $message2.='</tr><tr>';
...
$message2.='<table width="50%" align="center">
                <tr><td><img align="center" alt="" src="https://sarsspl.com/Lead_Management/Loyaltician/application/img/renewal_footer.jpg" width="600" style="max-width:877px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" >
                </td>';
