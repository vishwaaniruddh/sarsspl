...
$EmailSubject="Thank you, lead submitted successfully!";
    ...
    $message="Dear ".$fullname."\r\n"."Thank you for your interest in our membership program at radisson. We are scheduled to launch the membership in the first week of April. One of our associates will call you to discuss the member benefits and enroll you as a patron member with us."."\r\n";
            
    $leadsmail=" contactus@clubeliteplus.com";
...
$mail = new PHPMailer\PHPMailer\PHPMailer();
    ...
    $mail->Host = 'mail.radisson.com';  // Specify main and backup SMTP servers
    ...
    $mail->addAddress('contactus@clubeliteplus.com');
