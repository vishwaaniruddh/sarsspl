...
class MYPDF extends TCPDF {
    ...
    $To=$_POST['To1'];
       ...
       $image_file ='wlogo.jpg';
        $this->Image($image_file, 10, 4, 25, '', 'jpg', '', 'T', false, 300, '', false, false, 0, false, false, false);
       
        $this->Ln(22);
        // Set font
        $this->SetFont('helvetica', 'B', 15);
          $this->Cell(0, 10,'Radisson', 0, false, 'L', 0, '', 0, false, 'M', 'M');
          $this->Ln();
...
<td>'. $_row['promotional_voucher_code'].'</td>
...
$totallevel = $QfetchGold['0']+$QfetchPlatinum['0'];
