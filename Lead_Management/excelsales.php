...
">
        ...
        <fieldset>
          ...
          <form action="excelsales_process.php" method="post" enctype="multipart/form-data" onSubmit="return validate(this)" name="form">

<table>
<tr>
    <td width="432" height="35"><b>Upload Excel:  <a href="Excel/addsales.xls" download>Download format </a></b></td>  
</tr>
<tr>
<label><td width="432" height="35"><b>Select *.xls File to Import :</b>
<input type="file" name="userfile" value="" id="userfile" /></td></label>
</tr>
...
<center>
<tr>
<td height="35" colspan="2"><input type="submit" value="submit" style="border-radius: 50px;width: 206px;height: 37px;background-color: #fbba00;"/></td>
</tr>
</center></br>
</table>
