...
">
   ...
   <input type="text" name="leadid" id="leadid" value="<?php echo $leadid;?>"/>  
        ...
        <fieldset>
          ...
          <input type="text" id="LastName" name="LastName" placeholder="Last Name" value="<?php echo $row['LastName'];?>">
          
          <label for="mobile"><b>Mobile code  &nbsp;&nbsp;&nbsp;&nbsp; </b><b>Mobile number:</b>
         <div class="row">
             <div class="col-md-4">
         <input type="text" class="rounded" name="mcode1" id="mcode1" maxlength="3" onkeypress="return isNumber(event)" value="<?php echo $number0[0];?>">
             </div>
             <div class="col-md-8">
                 <input type="text" id="mob1" name="mob1" maxlength="10" onkeypress="return isNumber(event)" placeholder="Mobile number" value="<?php echo $number0[1];?>">
             </div>
         </div>
          </label>
         ...
         <div class="row">
             <div class="col-md-4">
         <input type="text" class="rounded" name="Contact1code" id="Contact1code" onkeypress="return isNumber(event)" maxlength="3" value="<?php echo $number1[0];?>">
             </div>
             <div class="col-md-8">
                 <input type="text" id="Contact1" name="Contact1" maxlength="10" onkeypress="return isNumber(event)" placeholder="Contact 1" value="<?php echo $number1[1];?>">
             </div>
         </div>
          </label>
         ...
         <div class="row">
             <div class="col-md-4">
         <input type="text" class="rounded" name="Contact2code" id="Contact2code" onkeypress="return isNumber(event)" maxlength="3" value="<?php echo $number2[0];?>">
             </div>
             <div class="col-md-8">
                 <input type="text" id="Contact2" name="Contact2" maxlength="10" onkeypress="return isNumber(event)" placeholder="Contact 2" value="<?php echo $number2[1];?>">
             </div>
         </div>
          </label>
         ...
         <div class="row">
             <div class="col-md-4">
         <input type="text" class="rounded" name="Contact3code" id="Contact3code" onkeypress="return isNumber(event)" maxlength="3" value="<?php echo $number3[0];?>">
             </div>
             <div class="col-md-8">
                 <input type="text" id="Contact3" name="Contact3" maxlength="10" onkeypress="return isNumber(event)" placeholder="Contact 3" value="<?php echo $number3[1];?>">
             </div>
         </div>
          </label>
...
<option value='Christian'>Christian</option>
     ...
     <input type="text" id="Company" name="Company" placeholder="Company Name" value="<?php echo $row['Company'];?>"> 
     
     <label for="mail"><b>Designation:</b></label>
     <input type="text" id="Designation" name="Designation" placeholder="Designation" value="<?php echo $row['Designation'];?>">
     
     <label for="mail"><b>Gmail</b></label>
     <input type="text" id="Gmail" name="Gmail" placeholder="Email ID" value="<?php echo $row['EmailId'];?>">
     
     <label for="mail"><b>Facebook ID</b></label>
     <input type="text" id="Facebook" name="Facebook" placeholder="Facebook ID" value="<?php echo $row['FacebookId'];?>">
     
     <label for="mail"><b>Relationship Status :</b></label>
     <input type="text" id="Relationship" name="Relationship" placeholder="Relationship Status" value="<?php echo $row['DelegationStatus'];?>">
<center>
