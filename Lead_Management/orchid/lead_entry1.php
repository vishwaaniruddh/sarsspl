...
<script>
   ...
   url:'lead_entry1_process.php',
    ...
    data:'FirstName='+FirstName+'&LastName='+LastName+'&Contact1code='+Contact1code+'&offNum='+offNum+'&mcode1='+mcode1+'&mob1='+mob1+'&state='+state+'&City='+City+'&Company='+Company+'&Designation='+Designation+'&Gmail='+Gmail,
  ...
  //  });
    window.open("lead_entry1.php","_self");
     ...
     /*swal("successfully Added");
      ...
      window.open("lead_entry1.php","_blank");
     */
 }else{
     swal("error");
 }
                        ...
                        <div class="card-body ">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input type="text" class="form-control"  name="mcode1" id="mcode1" maxlength="3" onblur="chkmobile();" value="+91" onkeypress="return isNumber(event)" placeholder="eg. 91">
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    <label for="inputPassword4">Mobile number *</label>&nbsp;<label id="label5"></label>
                                    <input type="text" class="form-control" id="mob1" name="mob1" maxlength="10" onkeypress="return isNumber(event)" onblur="chkmobile();" placeholder="Mobile number" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <button type="button" class="btn btn-primary" onclick="submitfun()">Submit</button>
                            </div>
                        </div>
                    </div>
                    <!--widget card ends-->
