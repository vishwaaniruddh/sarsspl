...
">
     ...
     <input type="text" id="Contact1" name="Contact1" placeholder="Contact1"maxlength="10" onkeypress="return isNumber(event)" > 
     
     <label for="mail"><b>Contact2:</b></label>
     <input type="text" id="Contact2" name="Contact2" placeholder="Contact2"maxlength="10" onkeypress="return isNumber(event)" > 
