...
">
      <form  method="post">
        ...
        <fieldset>
         ...
         <div class="row">
             <div class="col-md-4">
         <input type="text" class="rounded" name="mcode1"  id="mcode1" maxlength="3" onkeypress="return isNumber(event)">
             </div>
             <div class="col-md-8">
                 <input type="text" id="mob1" name="mob1" maxlength="10" onkeypress="return isNumber(event)" placeholder="Mobile number">
             </div>
         </div>
          </label>
         ...
         <div class="row">
             <div class="col-md-4">
         <input type="text" class="rounded" name="Contact1code" id="Contact1code" onkeypress="return isNumber(event)" maxlength="3">
             </div>
             <div class="col-md-8">
                 <input type="text" id="Contact1" name="Contact1" maxlength="10" onkeypress="return isNumber(event)" placeholder="Contact 1">
             </div>
         </div>
          </label>
         ...
         <div class="row">
             <div class="col-md-4">
         <input type="text" class="rounded" name="Contact2code" id="Contact2code" onkeypress="return isNumber(event)" maxlength="3">
             </div>
             <div class="col-md-8">
                 <input type="text" id="Contact2" name="Contact2" maxlength="10" onkeypress="return isNumber(event)" placeholder="Contact 2">
             </div>
         </div>
          </label>
         ...
         <div class="row">
             <div class="col-md-4">
         <input type="text" class="rounded" name="Contact3code" id="Contact3code" onkeypress="return isNumber(event)" maxlength="3">
             </div>
             <div class="col-md-8">
                 <input type="text" id="Contact3" name="Contact3" maxlength="10" onkeypress="return isNumber(event)" placeholder="Contact 3">
             </div>
         </div>
          </label>
...
<option value='Christian'>Christian</option>
     ...
     <input type="text" id="Relationship" name="Relationship" placeholder="Relationship Status">
     ...
     <label for="state"><b>Lead Source:</b></label>
          ...
          <option value="<?php echo $fetch3['SourceId'];?>"><?php echo $fetch3['Name']?></option>
         <?php } ?>
          </select>
<center>
