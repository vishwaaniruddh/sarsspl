...
$Mobile=$_POST['Mobile'];
    ...
    $View="select * from Location where 1=1";
 //echo $View;
...
if($email!=""){
  $View.=" and Email='".$email."'";  
}
if($Mobile!=""){
  $View.=" and Contact LIKE '%".$Mobile."%' or Contact2 like '%".$Mobile."%'";  
}
...
//echo $View;
  ...
  ?>
	...
	<td><?php echo $_row['Contact']; ?></td>
	<td><?php echo $_row['Contact2']; ?></td>
	<td><?php echo $_row['ContactPerson']; ?></td>
