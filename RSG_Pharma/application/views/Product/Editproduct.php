 <!-- Start Content-->
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <form action="<?=base_url('Product/ProductEdit')?>/<?=$product->item_id?>" method="post">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            <label for="rack" class="col-form-label">Medicine Shelf No </label>
                                                           <input type="text" name="rack" value="<?=$product->rack?>" id="rack" class="form-control" placeholder="Medicine Shelf No">
                                                        </div>
         ...
         -->
                                                    ...
                                                    <a href="<?=base_url('Product/Stock')?>" class="btn btn-danger ">Back</a>
                                                     ...
                                                     <input type="submit" name="Editproduct" class="btn btn-success float-right" value="Add Product">
