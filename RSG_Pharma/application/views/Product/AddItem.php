                                                ...
                                                <form action="<?=base_url('Product/Add')?>" method="post">
                                                    <div class="form-row">
                                                        ...
                                                        <div class="form-group col-md-4">
                                                           ...
                                                           <input type="text" name="unit" id="unit" class="form-control" placeholder="unit Like ml,gm,teb" required>
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                            <label for="rack" class="col-form-label">Medicine Shelf No </label>
                                                           <input type="text" name="rack" id="rack" class="form-control" placeholder="Medicine Shelf No">
                                                        </div>
