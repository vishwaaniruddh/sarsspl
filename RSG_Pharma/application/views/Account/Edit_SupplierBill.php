<!-- Start Content-->
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                              <form action="<?=base_url('Supplier/Bill_Edit/'.$bills_data->pur_id)?>" method="post">
                                <div class="card">
                                    <div class="card-body">
                                        <!-- <h4 class="header-title">Input Types</h4> -->
                                            <div class="tab-pane show active" id="input-types-preview">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="form-group mb-3">
                                                                <label for="simpleinput">   Supllier Name:</label>
                                                                <select name="supp_id" id="supplier" class="form-control" required>
                                                                  <option value="">Select Supplier</option>
                                                                  <?php
                                                                  foreach ($supplier as $key => $value) {
                                                                  ?>
                                                                  <option value="<?=$value->person_id?>" <?php if($value->person_id==$bills_data->supp_id){ echo "selected";} ?>><?=$value->company_name?></option>
                                                                  <?php
                                                                }
                                                                  ?>
                                                                </select>
                                                  ...
                                                  <div class="row">
                                                      ...
                                                      <input type="hidden" name="rowcount" id="rowcount" value="1">
                                                        <table class="table">
                                                           ...
                                                           <tr id="rowid_<?=$key+1?>">
															    ...
															    <td>
															        <input class="form-control cprice" id="cprice<?=$key+1?>" name="cprice[]" type="text" value="<?=$product->cost_price?>"/>
															    </td>
															    <td>
															        <input class="form-control qty" id="qty<?=$key+1?>" name="qty[]" onchange="subtotal()" value="<?=$product->qty?>" type="text"/>
															    </td>
															    <td>
															        <input class="form-control subtotal" id="subtotal<?=$key+1?>" name="totalamt" onchange="subtotal()" value="<?=$product->qty*$product->cost_price?>" type="text"/>
															    </td>
															    <!-- <td>
                                                    ...
                                                    <br/>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mb-3">
                                                                ...
                                                                <input type="text" id="totalamt" name="totalamt" value="<?=$bills_data->totalamt?>" class="form-control">
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="col-md-1">
                                                        ...
                                                        <div class="form-group mb-3 offset-md-4">
                                                                ...
                                                                <input type="text" name="payamt" id="payamt" value="<?=$bills_data->payamt?>" class="form-control">
                                                            </div>
                                                    </div>
                                                </div>
