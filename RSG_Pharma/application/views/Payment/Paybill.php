                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <form action="<?=base_url('Bill/Create')?>" method="post">
                                                    <div class="form-row">
                                                        <div class="form-group col-md-4">
                                                            <label for="suppliername" class="col-form-label">Supplier Name <span class="text-danger"  title="Required">*</span></label>
                                                            <input type="text" class="form-control" name="suppliername" id="suppliername" placeholder="Supplier-Name" value="<?=$supplier->company_name?>" readonly>
                                                            <input type="hidden" name="pur_id" value="<?=$Bill_Details->pur_id?>">
                                                        </div>
                                                        <div class="form-group col-md-4">
                                                    ...
                                                    <div class="form-row">           
                                                        ...
                                                        <div class="form-group col-md-4">
                                                            ...
                                                            <input type="number" class="form-control" name="payamount" id="payamount" value="<?=$Bill_Details->outstanding?>" placeholder="Payment Amount" required>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <?php if($Bill_Details->outstanding>0){ ?>
