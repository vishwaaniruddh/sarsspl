                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-4">
                            <div class="text-lg-right">
                                <a class="btn btn-danger mb-2 mr-2" href="<?=base_url('Sale/Bill_entry')?>" >
                        ...
                        <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-body font-weight-bold">
                                            <?php if(isset($bill->customer_name)){ echo $bill->customer_name; }?>
                                        </a>
                                    </td>
                                    <td>
                                    ...
                                    <td>                                        
                                        <a class="action-icon" href="<?=base_url('Sale/Bill_details')?>/<?=$bill->pur_id?>">
                                            <i class="mdi mdi-eye">
                                            </i>
                                        </a>
