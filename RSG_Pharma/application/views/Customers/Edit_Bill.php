                                                      ...
                                                      <input type="hidden" name="rowcount" id="rowcount" value="1">
                                                        <table class="table">
                                                           ...
                                                           <tr id="rowid_<?=$key+1?>">
															    ...
															    <td>
															        <input class="form-control cprice" id="cprice<?=$key+1?>" name="cprice[]" onkeyup="subtotal()" type="text" value="<?=$product->cost_price?>"/>
															    </td>
															    <td>
															        <input class="form-control qty" id="qty<?=$key+1?>" name="qty[]" onkeyup="subtotal()" value="<?=$product->qty?>" type="text"/>
															    </td>
															    <td>
															        <input readonly class="form-control subtotal" id="subtotal<?=$key+1?>" name="totalamt" onkeyup="subtotal()" value="<?=$product->qty*$product->cost_price?>" type="text"/>
															    </td>
															    <!-- <td>
