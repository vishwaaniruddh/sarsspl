...
<body onLoad>
	<div id="view_ad" class="login-popup">
		...
		<p style="color:#ac0404; font-weight:bold; font-size:16px;" align="center"> <a href="home.php" class="close">Go
				Back</a><br>View Admission</p><br />
		...
		<table border="1" style="border:2px #ac0404 solid; text-align:left;">
			...
			?>
				...
				<tr>
					<td width='110'> <?php if (isset($row1[1])) {
											if ($row1[1] == "") {
												echo  $row[6];
											} else {
												echo $row1[1];
					...
					<!--  <td width="110"> <?php //echo $row1[6]; 
											?></td>		  -->

					<td width='110'> <?php if (isset($row2[1])) {
											if ($row2[1] == "") {
												echo  $row[1];
											} else {
												echo $row2[1];
					...
					<!--	<td width="110"> <?php //echo $row2[1]; 
												?></td>		-->
					<td width="105">
						<?php if (isset($row[3]) and $row[3] != '0000-00-00') echo date('d/m/Y', strtotime($row[3])); ?></td>
					<td width="105">
						<?php if (isset($row[4]) and $row[4] != '0000-00-00') echo date('d/m/Y', strtotime($row[5])); ?></td>
					<td width="105"> <?php echo $row[7]; ?></td>
					<td width='105'> <?php if (isset($row3[1])) {
											if ($row3[1] == "") {
												echo  $row[1];
											} else {
												echo $row3[1];
					...
					<!--   <td width="105"> <?php //echo $row3[1]; 
											?></td>  	 -->
					<td width="65" align="center"><input name="code5[]" id="code5[]" type="checkbox" value="<?php echo $row[1]; ?>" onclick="window.location.href='visit_doc.php?id=<?php echo $row[1]; ?>&ad=<?php echo $row[0]; ?>'" />
					</td>
