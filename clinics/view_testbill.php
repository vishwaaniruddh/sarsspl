...
// 		document.location="delete_service.php?id="+id;
// 	}
// }
...
?>
          ...
          <p style="color:#ac0404; font-weight:bold; font-size:16px;" align="center">Test Bill Records</p>
          <table>
          <tr>
    <td><input type="text" style="width:80px;" name="idd" id="idd" value=""  placeholder="search id "  onkeyup="searchById('Listing','1');" /></td>
    <td><input type="text" style="width:130px;" name="fname22" id="fname22"  placeholder="search Service name" onkeyup="searchById('Listing','1');"/></td>
