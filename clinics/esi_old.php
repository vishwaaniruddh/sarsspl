...
function pres() {
    ...
    /*popcontact('esi_print.php?id=<?php //echo $id;      ?>& cond='+cond+' & impalnt='+implant+' & amtc='+amtc+' & amtad='+amtad+' & rem='+rem+' & proc1='+proc1+' & other1='+other1+' & code1='+code1+' & rate1='+rate1+' & amt1='+amt1);
        ...
        popcontact('esi_print.php?id=<?php echo $id; ?>&cond=' + cond + '&amtc=' + amtc + '&amtad=' + amtad + '&rem=' +
            rem + '&code1=' + code1 + '&proc1=' + proc1 + '&other1=' + other1 + '&rate1=' + rate1 + '&amt1=' + amt1 +
            '&implan=' + implan + '&other_proc1=' + other_proc1 + '&other_rate1=' + other_rate1);
    }
    ...
    <form method="post" class="signin" action="process_esi.php">
        ...
        <table id="ds">
            ...
            <tr>
                ...
                <td><input id="bill" name="bill" type="text" value="<?php if (isset($id)) {
                        echo $id;
                    } else {
                        echo "";
            ...
            <tr>
                ...
                <td width="168"><input id="name" name="name" type="text" value="<?php if (isset($row1[6])) {
                        echo $row1[6];
                    } ?>" style="background-color:#DCDCDC;"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input id="fd" name="fd" type="text" value="<?php if (isset($row1[26], $row1[27])) {
            ...
            <tr>
                ...
                <td> <input id="datead" name="datead" type="text" style="background-color:#DCDCDC;" value="<?php if (isset($row1[23])) {
                        echo $row1[23];
                    } ?>"=""></td>
            </tr>
            ...
            <tr>
                ...
                <td><input id="fd" name="fd" type="text" value="<?php if (isset($row1[39])) {
                        echo $row1[39];
                    } ?>" style="background-color:#DCDCDC;"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input id="fd" name="fd" type="text" value="<?php if (isset($row1[40])) {
                        echo $row1[40];
                    } ?>" style="background-color:#DCDCDC;"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input id="refno" name="refno" type="text" value="<?php if (isset($row1[34])) {
                        echo $row[34];
                    } ?>" style="background-color:#DCDCDC;"></td>
            </tr>
            ...
            <tr>
                ...
                <td><input id="dateref" name="dateref" type="text" value="<?php if (isset($row[35]) and $row[35] != '0000-00-00')
                        echo date('d/m/Y', strtotime($row[35])); ?>" style="background-color:#DCDCDC;"></td>
            </tr>

            <tr>
                <td><label class="datead">Date of Admission :</label></td>
                <td><input id="datedoa" name="datedoa" type="text" value="<?php if (isset($row[3]) and $row[3] != '0000-00-00')
            ...
            <tr>
                ...
                <td><input id="datedis" name="datedis" type="text" value="<?php if (isset($row[5]) and $row[5] != '0000-00-00')
                        echo date('d/m/Y', strtotime($row[5])); ?>" style="background-color:#DCDCDC;"></td>
            </tr>

            <tr>
                <td><label class="datead">Time of Discharge :</label></td>
                <td><input id="timedis" name="timedis" type="text" value="<?php if (isset($row1[6])) {
                        echo $row[6];
                    } ?>" style="background-color:#DCDCDC;"></td>
            </tr>
            ...
            <tr>
                <td colspan="4"> CGHS/other Code no/nos for chargable procedures :
                    ...
                    <table width="882" border="1" id="detail">
                        ...
                        <?php
                            ...
                            for ($j = 0; $j <= 4; $j++) {
                                ...
                                ?>
                        <tr>
                            <td><input type="hidden" value="<?php echo $cnt; ?>" name="sr[]" id="sr" class="sr" />
                                <?php echo $cnt; ?>
                            </td>
                            <td>

                                <select style="width:140px;" name="proc[]" id="proc<?php echo $j; ?>" class="proc"
                                    onchange="proce(<?php echo $j; ?>);">
                            ...
                            <td><input type="text" name="rate[]" id="rate<?php echo $j; ?>" class="rate"
                                    style="width:140px;" /></td>
                            <td><input type="text" name="qty[]" id="qty<?php echo $j; ?>" value="1" class="rate"
                                    style="width:40px;" onchange="netamt1(<?php echo $j; ?>);" /></td>
                            <td><input type="text" name="amt[]" id="amt<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                            <td><input type="text" name="amtdt[]" id="amtdt<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                            <td><input type="text" name="amtad[]" id="amtad<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                            <td><input type="text" name="rem[]" id="rem<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                        </tr>
                    ...
                    <a href="#" id="add" style="color:#ac0404; font-weight:bold; font-size:16px;"
                        onClick="MakeRequest();">Add More </a>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="4">
                    ...
                    <table border="1" id="detail1">
                        ...
                        <tr>
                            ...
                            <td width="151">
                                <select style="width:140px;" name="other_proc[]" id="other_proc<?php echo $a; ?>"
                                    class="other_proc" onchange="otherproc(<?php echo $a; ?>);">
                                    <option value="0">Select</option>
                            ...
                            <td width="148"><input type="text" name="other_rate[]" id="other_rate<?php echo $a; ?>"
                                    class="other_rate"></td>
                            <td width="40"><input type="text" name="other_qty[]" id="other_qty<?php echo $a; ?>"
                                    value="1" class="other_rate" onchange="netamt2(<?php echo $a; ?>);"></td>
                            <td width="148"><input type="text" name="other_crate[]" id="other_crate<?php echo $a; ?>"
                                    class="other_rate"></td>
                            <td width="148"><input type="text" name="other_cdate[]" id="other_cdate<?php echo $a; ?>"
                                    class="other_rate"></td>
                            <td width="148"><input type="text" name="other_adrate[]" id="other_adrate<?php echo $a; ?>"
                                    class="other_rate"></td>
                            <td width="148"><input type="text" name="other_rem[]" id="other_rem<?php echo $a; ?>"
                                    class="other_rate"></td>
                        </tr>
                        <?php } ?><input type="hidden" name="cnt1" id="cnt1" value="<?php echo $cnt1; ?>" />
                    </table>
                    <a href="#" id="add" style="color:#ac0404; font-weight:bold; font-size:16px;"
                        onClick="MakeRequest1();">Add More </a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="4">
                    <table width="882" border="1" id="detail2">
                        ...
                        <?php
                            ...
                            for ($j = 0; $j <= 4; $j++) {
                                ...
                                ?>
                        <tr>
                            <td><input type="hidden" value="<?php echo $cnt; ?>" name="sr1[]" id="sr1" class="sr" />
                                <?php echo $cnt; ?>
                            </td>
                            <td>
                            ...
                            <td><input type="text" name="rates[]" id="rates<?php echo $j; ?>" class="rate"
                                    style="width:140px;" /></td>
                            <td width="40"><input type="text" name="qtys[]" id="qtys<?php echo $j; ?>" value="1"
                                    class="rate" style="width:40px;" onchange="netamt3(<?php echo $j; ?>);" /></td>
                            <td><input type="text" name="amts[]" id="amts<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                            <td><input type="text" name="amtsdt[]" id="amtsdt<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                            <td><input type="text" name="amtads[]" id="amtads<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                            <td><input type="text" name="rems[]" id="rems<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                        </tr>
                    ...
                    <a href="#" id="add" style="color:#ac0404; font-weight:bold; font-size:16px;"
                        onClick="MakeRequest2();">Add More </a>
                </td>
            </tr>
            <tr>
                ...
                <td colspan="4">
                    <table width="882" border="1" id="detail3">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="amtst[]" id="amtst<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                            <td><input type="text" name="amtstdt[]" id="amtstdt<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                            <td><input type="text" name="amtadst[]" id="amtadst<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                            <td><input type="text" name="remst[]" id="remst<?php echo $j; ?>" class="amt"
                                    style="width:140px;" /></td>
                        </tr>
                    ...
                    <a href="#" id="add" style="color:#ac0404; font-weight:bold; font-size:16px;"
                        onClick="MakeRequest3();">Add More </a>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" align="center"><button class="submit formbutton"
