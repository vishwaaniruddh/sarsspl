...
values('$fname',STR_TO_DATE('".$dob."','%d/%m/%Y'),'$age','$gender','$contact','$city','$address','$ref','$d','$height','$bloodgroup','$ms','$email','$hos','$esino','$esiname','$rel','$date','NA','NA','$aadhar')";
...
$sql2="insert into appoint(no,ref,reason,doctor,date,app_date,time,type,charges,waiting_list,status) values('$id','$ref','','$ref','".date("Y-m-d H:i:s")."','".$date."','".$time."','','$charges',0,'')";
