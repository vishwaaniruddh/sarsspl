...
if ($addsql) {
    $dischargesql = mysqli_query($con, "INSERT INTO discharge(ad_id, diagnosis, condi, implant, amt1, amt2, amt3, remarks, department, consultant, amt4, patient_name, ref_no, insurance_no, pensioner_name, amtad1, amtad2, amtad3, amtad4, totalamt, totalamtad, indoor_reg_no, bill_no) VALUES('$id', '$diag', '$cond', '$implan', '$amtc', '$amtcII', '$amtcIII', '$rem', '$dept', '$consult', '$amtcIV', '$name', '$refno', '$insurance_no', '$pensioner_name', '$amtad1', '$amtad2', '$amtad3', '$amtad4', '$totalamt', '$totalamtad', '$indoor_reg_no', '$bill_no')");
    if ($dischargesql) {
        ...
        header("Location: printesibill.php?id=$id");
