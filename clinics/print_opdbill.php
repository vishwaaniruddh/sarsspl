...
<div  class="login-popup" id="printme" >                      
		         ...
		         <DIV><TABLE><TR><TD><IMG src="images\gdh.jpg" height="100" width="250" /></TD><TD align="center"><div align="center"> <b> SAI NAMAN HOSPITAL
 </b> </div>
<p align="center"> Run By : Swargiya Gindodi Devi Charitable Trust <BR>G.E. ROAD, KHURSIPAR - 490 021 (C.G.)<BR>PHONE: 0788- 4051001 </p>
</TD></TR></TABLE></DIV>
                ...
                <td><label><?php if(isset($rowd[10])){ if($rowd[10]==""){ echo  $rowd[10]; }else { echo $rowd[10]; }}?></label></td>
                </tr>
           ...
           <!--     				
			...
			-->	
                ...
                <td><label><?php if(isset($rowd[7])){ if($rowd[7]==""){ echo  $rowd[7]; }else { echo $rowd[7]; }}?></label></td>
                </tr>
				
				<tr>
                <td><label class="inv">Consultant:</label></td>
                <td><label><?php if(isset($rowd[8])){ if($rowd[8]==""){ echo  $rowd[8]; }else { echo $rowd[8]; }}?></label></td>
                </tr>
		...
		$sq=mysqli_query($con,"select * from procedures where id='$ron[1]'");
			...
			echo $ro[1]; ?>                                
               ...
               <tr>
                ...
                <td><<?php if(isset($rowd[2])){ if($rowd[2]==""){ echo  $rowd[2]; }else { echo $rowd[2]; }}?></td>
                <td width="153">Amount Claimed (I): </td>
                <td width="224"><?php if(isset($rowd[3])){ if($rowd[3]==""){ echo  $rowd[3]; }else { echo $rowd[3]; }}?></td>
                </tr>
	 ...
	 $sq2=mysqli_query($con,"select * from opdbill_details where ad_id='$id' and type=2");
		...
		<tr>
                ...
                <td><?php if(isset($rowd[4])){ if($rowd[4]==""){ echo  $rowd[4]; }else { echo $rowd[4]; }}?></td>
		...
		<tr>
                ...
                <td><?php if(isset($rowd[5])){ if($rowd[5]==""){ echo  $rowd[5]; }else { echo $rowd[5]; }}?></td>
		...
		<tr>
                ...
                <td><?php if(isset($rowd[9])){ if($rowd[9]==""){ echo  $rowd[9]; }else { echo $rowd[9]; }}?></td>
