...
if (isset($_SESSION['SESS_USER_NAME'])) {
    ...
    $sql = "SELECT * FROM ipdbill WHERE id='" . $id . "'";
    ...
    $admissionDate = $row['addmission_date'];
    ...
    $sql1 = "SELECT * FROM  ipdbill_details WHERE bill_id='" . $bill_id . "'";
...
<div id="maindiv">
    ...
    <table border="1" width="100%">
        <?php if($observation=="yes") { ?>
        <p align="center"><b>IPD BILL NO.
                <?php echo $id." "."(Observation)" ; ?>
            </b>
        </p>
        <?php } else { ?>
        <p align="center"><b>IPD BILL NO.
    ...
    <table border="1" width="100%">
        ...
        <tr>
            ...
            <td align="center"><b>
                    <?php $discountamt = $row['discount']; if(isset($discountamt)){ echo $discountamt.'.00';}else{ echo "0.00";}; ?>
                </b></td>
        </tr>
