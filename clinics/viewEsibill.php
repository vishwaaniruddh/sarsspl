        ...
        $('#myTable').DataTable({
            ...
            "ajax": {
                ...
                "dataSrc": function (json) {
                    ...
                    // Optionally display the query on the page
                    document.getElementById('debug-query').innerText = json.query;
                    return json.data;
                }
            },
            "columns": [
...
<body>
    ...
    <div id="view_discharge">
        ...
        <div id="debug-query" style="margin-top:20px; color: red;"></div> <!-- Query will be displayed here -->
    </div>
</body>
