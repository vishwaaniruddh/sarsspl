...
*/
$sql_report = mysqli_query($con, "select * from report order by id desc limit 1 ");
...
<div id="maindiv">
    ...
    <table border="0" width="100%" class="name_row">
        <tr>
            ...
            <td><b><?= ucwords($form_21_sql['certifying_person_name']) ?></b></td>
        </tr>
    </table>
    <table border="0" width="100%" class="basic_details">
        ...
        <tr>
            ...
            <td><b>EMP ID.:</b></td>
            <td><b><?= $sql_report_result['emp_id']; ?></b></td>
            <td><b>AGE:</b></td>
        ...
        <tr>
            ...
            <td><b><?= $sql_report_result['exam_date'] ?></b></td>
            <td><b>DESIG:</b></td>
            <td><b><?= ucwords($sql_report_result['designation']); ?></b></td>
            <td><b>AADHAR:</b></td>
            <td><b><?= $sql_report_result['aadhar_no']; ?></b></td>
            <td><b>ESIC:</b></td>
            <td><b><?= $sql_report_result['esic']; ?></b></td>

        </tr>
        <tr>
            <td><b>TYPE OF EXAMINATION:</b></td>
            <td><b><?= $sql_report_result['exam_type']; ?></b></td>
            <td><b>LAST PME/PEME DT:</b></td>
            <td><b><?= $sql_report_result['last_pme_peme_date'] ?></b></td>
            <td><b>DATE OF JOINING:</b></td>
            <td><b><?= $sql_report_result['join_date'] ?></b></td>
            <td></td>
            <td></td>
        ...
        <tr>
            ...
            <td><b><?= ucwords($row['discharge_type']); ?></b></td>
        </tr>
    ...
    <div style="width:100%;display:flex;justify-content:space-around;">
        ...
        <div style="margin:15px ;width:50%;">
            ...
            <table>
                ...
                <tr>
                    <td>RIGHT:</td>
                    <td><b><?= $sql_eyes_result['distant_vision_without_right'] ?></b></td>
                    <td>LEFT:</td>
                    <td><b><?= $sql_eyes_result['distant_vision_without_left'] ?></b></td>
                </tr>
                ...
                <tr>
                    <td>RIGHT:</td>
                    <td><b><?= $sql_eyes_result['distant_vision_with_right'] ?></b></td>
                    <td>LEFT:</td>
                    <td><b><?= $sql_eyes_result['distant_vision_with_left'] ?></b></td>
                </tr>
        ...
        <div style="margin:15px;width:50%;">
            ...
            <table>
                <div class="col-6" style="margin:5px;width:50%;">
                    ...
                    <tr>
                        ...
                        <td><b><?= $sql_report_result['menstrual_history'] ?></b></td>
                        <td>OBSTETRIC HISTORY:</td>
                        <td><b><?= $sql_report_result['obstetric_history'] ?></b></td>
                    </tr>
                    <tr>
                        <td>MENARCH AT:</td>
                        <td><b><?= $sql_report_result['menarche'] ?> YRS</b></td>
                        <td>GRAVIDA:</td>
                        <td><b><?= $sql_report_result['gravida'] ?></b></td>
                    </tr>
                    <tr>
                        <td>PARA:</td>
                        <td><b><?= $sql_report_result['para'] ?></b></td>
                        <td>LMP:</td>
                        <td><b><?= $sql_report_result['lmp'] ?></b></td>
                    </tr>
                    <tr>
                        <td>MENSTRUAL IRREGULARITY,IF ANY:</td>
                        <td><b><?= $sql_report_result['menstrual_irregularity'] ?></b></td>
                    </tr>
            </table>
            <table style=" margin:5px;">
                ...
                <tr>
                    <td>WIDAL:</td>
                    <td><b><?= $sql_report_result['widal'] ?></b></td>
                    <td>HEP B:</td>
                    <td><b><?= $sql_report_result['hep_b'] ?></b></td>
                </tr>
                <tr>
                    <td>SPUTUM FOR AFB:</td>
                    <td><b><?= $sql_report_result['sputum_for_afb'] ?></b></td>
                    <td>SKIN DISEASES:</td>
                    <td><b><?= $sql_report_result['skin_diseases'] ?></b></td>
                </tr>
                <tr>
                    <td>HIV:</td>
                    <td><b><?= $sql_report_result['htv'] ?></b></td>
                    <td>WORM INFECTION:</td>
                    <td><b><?= $sql_report_result['worm_infection'] ?></b></td>
                </tr>
            ...
            <table>
                ...
                <tr>
                    <td>USG WHOLE ABDOMEN: _______________________</td>
                    <!--<td><?= $sql_report_result['usg_whole_abdomen'] ?></td>-->
