...
<div class="login-popup">
    ...
    <form method="post" id="invoiceForm" action="ipdbill_process.php">

        <!-- <input type="hidden" name="myvar" value="0" id="theValue" /> -->
        <p style="color:#ac0404; font-weight:bold; font-size:20px;" align="center">Discharge Summary</p>
        ...
        <table id="ds">
            ...
            <tr>
                ...
                <td>
                    <input id="bill" name="bill" type="text" class="form-control" value="<?= $idd; ?>" readonly>
                </td>
            </tr>

            <tr>
                <td><label for="indoor_reg_no">Indoor Reg. No. </label></td>
                <td><input type="text" id="indoor_reg_no" name="indoor_reg_no"></td>
            </tr>
