...
// $sql = "SELECT * FROM admission WHERE new_esi_id='$id'";
// $add_result = mysqli_query($con, $sql);
// $add_row = mysqli_fetch_assoc($add_result);
// $new_esi_id = $add_row['new_esi_id'];
...
$disc_sql = mysqli_query($con, "select * from newdischarge_summary where id = '$new_esi_id' ");
$disc_sql_result = mysqli_fetch_assoc($disc_sql);

$discharge_date = $disc_sql_result['datedis'];
$discharge_date = date('d-m-Y', strtotime($discharge_date));

$discharge_time = $disc_sql_result['timedis'];
$discharge_time = date('H:i:s a', strtotime($discharge_time));

$admit_date = $disc_sql_result['add_date'];
$admit_date = date('d-m-Y', strtotime($admit_date));

$admit_time = $disc_sql_result['add_time'];
$admit_time = date('H:i:s a', strtotime($admit_time));

$newesi_sql = mysqli_query($con,"select * from esibill where new_esi_id = '$new_esi_id' ");
$newesi_result = mysqli_fetch_assoc($newesi_sql);



// discharge details table
// $esibill_details =  "select * from esibill_details where new_esi_id = '$new_esi_id' ";
...
<body>
    <div class="container" id="maindiv">
            ...
            <table border="1" style="width:100%;">
                <tr>
                    <td style="vertical-align:top; width:50%;">
                        <p><strong>Bill no. :</strong> <?php echo $newesi_result['bill_no']; ?></p>
                        <p><strong>Registration No. :</strong> <?php echo $newesi_result['indoor_reg_no']; ?></p>
                        <p><strong>Name :</strong> <?php echo $disc_sql_result['name']; ?></p>
                        <p><strong>Age/Sex :</strong> <?= $disc_sql_result['age']; ?>/<?= $disc_sql_result['gender']; ?></p>
                        <p><strong>Address :</strong> <?php echo $disc_sql_result['address']; ?></p>
                        <p><strong>Date of Referral :</strong> <?php echo $disc_sql_result['date_of_referral']; ?></p>
                        <p><strong>Diagnosis :</strong> <?php echo $newesi_result['diagnosis']; ?></p>
                        <p><strong>Date/Time of Admission :</strong> <?php echo $admit_date; ?> <?= $admit_time; ?></p>

                    </td>
                    <td style="vertical-align:top; width:50%;">
                        <p><strong>Contact No:</strong> <?php echo $disc_sql_result['contact_no']; ?></p>
                        <p><strong>Insurance Number/Staff Card No/Pensioner Card No. :</strong>
                            <?php echo $newesi_result['insurance_no']; ?></p>
                        <p><strong>Insurance Pensioner Name :</strong>
                            <?php echo $newesi_result['pensioner_name']; ?>
                        </p>
                        <p><strong>Referral SL.No. (Routine)/Emergency/Referred through SSMC/SSMC :</strong>
                            <?php echo $newesi_result['ref_no']; ?>
                        </p>
                        <p><strong>Consultant :</strong> <?php echo $newesi_result['consultant']; ?></p>
                        <p><strong>Department :</strong> <?php echo $newesi_result['department']; ?></p>
                ...
                <tr>
                    <td colspan="2">
                        <p><strong>Condition of the patient at discharge : </strong>
                            <?php echo $newesi_result['condi']; ?></p>
        ...
        <div class="section">
            ...
            <table border="1" width="100%">
                ...
                $i = 1;
                $esibill_details = " select * from esibill_details where new_esi_id = '$new_esi_id' and type = '1' order by type asc";
                $esibill_details_result = mysqli_query($con, $esibill_details);
                $num_rows = mysqli_num_rows($esibill_details_result);
                while ($details1 = mysqli_fetch_assoc($esibill_details_result)) {
                    $code = $details1['code'];
            ...
            <table border="1" width="100%">
                <tr>
                    ...
                    <td><?= $newesi_result['implant']; ?></td>
                    <td><b>Amount Claimed(I):</b></td>
                    <td><?= $newesi_result['amt1']; ?></td>
                </tr>
                <tr>
                    <td><b>Amount Admitted (I): </b></td>
                    <td><?= $newesi_result['amtad1']; ?></td>
                    <td><b>Remarks:</b></td>
                    <td></td>
                </tr>
            </table>
        ...
        <div class="section">
            ...
            <table border="1" width="100%">
                ...
                $i = 1;
                $esibill_details = "select * from esibill_details where new_esi_id = '$new_esi_id' and type = '2' order by type asc";
                $esibill_details_res = mysqli_query($con, $esibill_details);
                $num_rows = mysqli_num_rows($esibill_details_res);
                while ($details2 = mysqli_fetch_assoc($esibill_details_res)) {
                    $code = $details2['code'];
            ...
            <table border="1" width="100%">
                <tr>
                    ...
                    <td><?= $newesi_result['amt2']; ?></td>
                    <td><b>Amount Admitted (II): </b></td>
                    <td><?= $newesi_result['amtad2']; ?></td>
                </tr>
            </table>
        </div>
        <div class="section">
            ...
            <table border="1" width="100%">
                ...
                $i = 1;
                $esibill_details = "select * from esibill_details where new_esi_id = '$new_esi_id'  and type = '3' order by type asc";
                $esibill_details_result = mysqli_query($con, $esibill_details);
                $num_rows = mysqli_num_rows($esibill_details_result);
                while ($details3 = mysqli_fetch_assoc($esibill_details_result)) {
                    $code = $details3['code'];
                    $getprocedurename = get_procedure($code);
            ...
            <table border="1" width="100%">
                <tr>
                    ...
                    <td><?= $newesi_result['amt3']; ?></td>
                    <td><b>Amount Admitted (III): </b></td>
                    <td><?= $newesi_result['amtad3']; ?></td>
                </tr>
            </table>
        </div>
        <div class="section">
            ...
            <table border="1" width="100%">
                ...
                $i = 1;
                $esibill_details = "select * from esibill_details where new_esi_id = '$new_esi_id' and type = '4' order by type asc";
                $esibill_details_result = mysqli_query($con, $esibill_details);
                $num_rows = mysqli_num_rows($esibill_details_result);
                while ($details4 = mysqli_fetch_assoc($esibill_details_result)) {
                    $code = $details4['code'];
            ...
            <table border="1" width="100%">
                <tr>
                    ...
                    <td><?= $newesi_result['amt4']; ?></td>
                    <td><b>Amount Admitted (IV): </b></td>
                    <td><?= $newesi_result['amtad4']; ?></td>
                </tr>
            </table>
            <br>
            <table border="1" width="100%">
                <tr>
                    <table border="1" width="100%">
                        <tr>
                            ...
                            <td><?= $newesi_result['totalamt']; ?></td>

                        </tr>
                        <tr>
                            <td width="27%"><b>Total Amount Admitted (X)(I+II+III+IV) ₹: </b></td>
                            <td><?= $newesi_result['totalamtad']; ?></td>
                            <td width="20%"><b>Remarks: </b></td>
                            <td width="35%"><?= $newesi_result['remarks']; ?></td>
                        </tr>
                    </table>
                </tr>
            </table>
    ...
    <script>
        function divprint() {
            ...
            mywindow.document.write('<html><head><title>ESI BILL_<?=$disc_sql_result['name']?></title>');
