...
?> <table width="1190" border="1" id="results" cellpadding="4" cellspacing="0">
    ...
    <tr>
        <td width="74" style="color:#ac0404; font-size:14px; font-weight:bold;">ID</td>
        ...
        <td width="92" style="color:#ac0404; font-size:14px; font-weight:bold;">View Full Details</td>
    </tr>
