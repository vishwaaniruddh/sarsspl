    ...
    <div class="login-popup" id="printme">
      ...
      ?>
        <DIV>
            <TABLE align="center">
                <TR>
                    <TD><IMG src="images\logo.jpg" height="100" width="250" /></TD>
                    <TD align="center">
                        <div align="center"><b>SAI NAMAN HOSPITAL
                            </b> </div>
                        <p align="center"> Run By : Sai Naman Hospital <BR>G.E. ROAD, SIRSA GATE, BHILAI - 490 012
                            (C.G.)<BR>PHONE: 0788- 4051001 , 4051002 </p>
                    </TD>
                </TR>
            </TABLE>
        </DIV>
        ...
        <strong>GDH/ESIC/IPD/2014/01/<?php echo $cc; ?> </strong>
        <p align="right"><strong>Dated: <?php echo date('d/m/Y'); ?></strong></p>
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tr>
                <td colspan="6" valign="top">
                    <p><strong>Please find enclosed herewith Bills for reimbursement as per details given below
                            :</strong></p>
                </td>
            </tr>
        </table>
        ...
        <table id="ds" border="1">
          ...
          ?>
            <tr>
                ...
                <td style="height:60px"><label><?php if (isset($row[1])) {
                                                echo $row[1];
                                              } ?></label></td>
                <td style="height:60px"><label><?php if (isset($row1[39])) {
                                                echo $row1[39];
                                              } ?></label></td>
                <td style="height:60px"><?php if (isset($row1[40])) {
                                        echo $row1[40];
                                      } ?></td>
                <td style="height:60px"><?php if (isset($row1[6])) {
                                        echo $row1[6];
                                      } ?></td>
        ...
        <div><br>
            <table border="0" cellspacing="0" cellpadding="0">
                <tr>
                    <td valign="top">
                        <p align="center"><strong>(RS. <?php echo int_to_words($sum); ?> ONLY)</strong></p>
                    </td>
                </tr>
            </table> <br><br>
            <table border="0" cellspacing="0" cellpadding="0">
