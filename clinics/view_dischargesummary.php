...
<body>
    ...
    $sqlQuery = mysqli_query($con, "select * from newdischarge_summary ");
            ...
            <tbody>
                ...
                while ($sqlQuery_result = mysqli_fetch_assoc($sqlQuery)) {
                    ...
                    <tr>
                        ...
                        <td><?= $sqlQuery_result['age'] ?>/<?= $sqlQuery_result['gender'] ?></td>
                        <td><?= $sqlQuery_result['contact_no'] ?></td>
                        <td><?= $sqlQuery_result['city'] ?></td>
                        <td><?= $sqlQuery_result['address'] ?></td>
                        <td><?= $sqlQuery_result['bed_no'] ?></td>
                        <td><?= $sqlQuery_result['consult_doc'] ?></td>
                        ...
                        <td>
                            ...
                            <a href="newesi.php?id=<?php echo $sqlQuery_result['id']; ?>" target="_new"><input
                                    type="submit" class="form-control formbutton_new btn btn-warning" value="ESI Bill"></a>
                            <a href="esibillPrint.php?id=<?php echo $sqlQuery_result['id']; ?>" target="_new"><input
                                    type="submit" class="form-control formbutton " value="Print ESI BILL"></a>
                        </td>
                    </tr>
                    <?php $i++;
                } ?>
