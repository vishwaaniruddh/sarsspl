...
function pres() {
    ...
    popcontact('discharge_print.php?id=<?php echo $id; ?>&pd=' + pd + '&fd=' + fd + '&inv=' + inv + '&jj=' + jj +
        '&jjdate=' + jjdate + '&uc=' + uc + '&ucdate=' + ucdate + '&op=' + op + '&po=' + po + '&proc=' + proc +
        '&add_proc=' + add_proc + '&treat=' + treat + '&adv=' + adv + '&visit=' + visit);

    popcontact('discharge_print.php?id=<?php echo $id; 
    ?> 
    & pd = '+pd+' & fd = '+fd+' & inv = '+inv+' & jj = '+jj+' & jjdate = '+jjdate+' & uc = '+uc+' & ucdate =
        '+ucdate);
        ...
        <fieldset class="textbox">
            ...
            <table id="ds">
                ...
                <tr>
                    ...
                    <td><input id="pid" name="pid" type="text" value="<?php echo $row[1]; ?>" readonly
                            style="background-color:#DCDCDC;"></td>
                    <td><input id="name" name="name" type="text" value="<?php echo $row1[1]; ?>" readonly
                            style="background-color:#DCDCDC;"></td>
                ...
                <tr>
                    ...
                    <td> <input id="datead" name="datead" type="text" style="background-color:#DCDCDC;"
                            value="<?php if (isset($row[3]) and $row[3] != '0000-00-00') echo date('d/m/Y', strtotime($row[3])); ?>"
                            readonly="readonly"></td>

                    <td><label class="datead">Date of Discharge:</label></td>
                    <td> <input id="datedis" name="datedis" type="text" onClick="displayDatePicker('datedis');"
                            value="<?php if (isset($row[4]) and $row[4] != '0000-00-00') echo date('d/m/Y', strtotime($row[4])); ?>">
                    </td>
                </tr>
                ...
                <tr>
                    <td>JJ stent: </td>
                    <td><input id="jj" name="jj" type="text"></td>
                    <td>Removal Date:</td>
                    <td><input id="jjdate" name="jjdate" type="text" onClick="displayDatePicker('jjdate');"></td>
                </tr>

                <tr>
                    <td>Uretric Cath: </td>
                    <td><input id="uc" name="uc" type="text"></label></td>
                    <td>Removal Date:</td>
                    <td><input id="ucdate" name="ucdate" type="text" onClick="displayDatePicker('ucdate');"></td>
