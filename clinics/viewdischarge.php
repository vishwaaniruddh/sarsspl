    ...
    <div id="view_discharge" class="login-popup">
        ...
        <table border="1" style="border:2px #ac0404 solid; text-align:left;">
            ...
            <?php while ($row = mysqli_fetch_row($result)) {
                $did = $row[0];
                // echo $did;
                $result2 = mysqli_query($con, "select * from admission where ad_id='" . $did . "'");
                $row2 = mysqli_fetch_row($result2);
                if (isset($result2)) {
                    $pid = $row2[1];
                    echo $pid;
                    $result1 = mysqli_query($con, "select * from patient where no='" . $pid . "'");
            ...
            ?>
                ...
                <tr>
                    ...
                    <td width="110"> <?php if (isset($row1[6])) {
                                            echo $row1[6];
                                        } ?></td>
                    <td width="110">
                        <?php if (isset($row2[5]) and $row2[5] != '0000-00-00') echo date('d/m/Y', strtotime($row2[5])); ?></td>
                    ...
                    <td> <a href="printesibill.php?id=<?php echo $row[0]; ?>"> Print </a></td>
