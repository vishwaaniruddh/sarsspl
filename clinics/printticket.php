...
?>
    <div id="maindiv">
            ...
            <TABLE>
                <TR>
                    ...
                    <TD align="center">
                        ...
                        <p align="center"> Owned By :Swargiya Gindodi Devi Charitable Trust <BR>G.E. ROAD, KHURSIPAR - 490 012 (C.G.)<BR>PHONE: 0788- 3594666 </p>
                    </TD>
                </TR>
            </TABLE>
        </DIV>
        ...
        <p align="left">Patient ID :<?php echo $id; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <!--Type:<?php echo $row[16]; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
            Doctor : <?php echo $row1[1]; ?>
        </p>
        <p align="left">Patient Name :<?php if (isset($row[6])) {
                                            echo $row[6];
                                        } ?> &nbsp;&nbsp;&nbsp; Sex :<?php echo $row[27]; ?> &nbsp;&nbsp;&nbsp; Age :<?php echo $row[26]; ?> </p>
