...
<body onLoad="searchById('Listing','1')">
    <div id="view_patient" class="login-popup">
        <div id="view_patient1">
            ...
            <table>
                <tr>
                    <td>From date<input id="frdt" name="frdt" type="text" value="<?php echo date('d/m/Y');?>"
                            onClick="displayDatePicker('frdt');" /></td>
                    <td>To date<input id="todt" name="todt" type="text" value="<?php echo date('d/m/Y');?>"
                            onClick="displayDatePicker('todt');" /></td>
                    <td>Select Doctor
                        <?php 
	 ...
	 ?>
                        <select id="doc" name="doc"
                            style="background:#fff;border-bottom:1px solid #ac0404;border-left:1px solid #ac0404;border-right:1px solid #ac0404;border-top:1px solid #ac0404;width:300px;"
                            onchange="searchById('Listing','1');">
