    ...
    <div class="login-popup" id="printme">
        ...
        <table id="ds">
            ...
            <tr>
                ...
                <td><label><?php if(isset($row[35]) and $row[35]!='0000-00-00') echo date('d/m/Y',strtotime($row[35])); ?></label>
                </td>
            </tr>

            <tr>
                <td><label class="datead">Date of Admission :</label></td>
                <td><label><?php if(isset($row[3]) and $row[3]!='0000-00-00') echo date('d/m/Y',strtotime($row[3]))." ".$row[4]; ?></label>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><label><?php if(isset($row[5]) and $row[5]!='0000-00-00') echo date('d/m/Y',strtotime($row[5]))." ".$row[6]; ?></label>
                </td>
            </tr>
		...
		$sq=mysqli_query($con,"select * from procedures where id='$ron[1]'");
			...
			echo $ro[1]; ?>
                            ...
                            <td><?php echo $ron[5]; ?></td>
                            <td><?php echo $ron[7]; ?></td>
                            <td></td>
                            <td></td>
                        </tr>
	 ...
	 $sq2=mysqli_query($con,"select * from discharge_details where ad_id='$id' and type=2");
			   ...
			   $cnt1=$cnt1+1; ?>
				...
				$ro1=mysqli_fetch_row($sq1);				
                 echo $ro1[1]; ?>
                            ...
                            <td width="148"><?php echo $ro2[5]; ?></td>
                            <td><?php echo $ro2[7]; ?></td>
                            <td width="148"></td>
                            <td width="148"></td>
                        </tr><?php } ?>
                    </table>
            ...
            <tr>
				...
				echo $ro[1]; ?>
                            ...
                            <td><?php echo $ro3[5]; ?></td>
                            <td><?php echo $ro3[7]; ?></td>
                            <td></td>
                            <td></td>
                        </tr>
        ...
        <div><br><br><br>
            ...
            the bill has/ have been claimed as per the <br>terms & conditions laid down in the agreement signed with
            ESIC.
            <br>
