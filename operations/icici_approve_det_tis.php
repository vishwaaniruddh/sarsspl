...
fd.append('svn',svn);
  ...
  $.ajax({
            url: "process_icici_approval_tis.php",
            type: "POST",
            data: fd ,
            contentType: false,
            cache: false,
...
window.open('icici_quot_view_tis.php?qoid=<?php echo $qoid;?>'+'&strdt=<?php echo $sts;?>'+'&endt=<?php echo $ends;?>'+'&oatm=<?php echo $atms;?>','_self');
...
$.ajax({
            url:"process_icici_final_approval_tis.php",
            type: "POST",
