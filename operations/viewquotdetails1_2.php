...
<body>
    ...
    <table  border="1" cellpadding="2" cellspacing="0" id="custtable">
        <tr>
            ...
            <td colspan="8" align="center" style="background:#9cc2e5"><b>Quatation :</b> <?= $qrrow[1] ; ?></td>
        </tr>
        <tr style="background:#ffff00;">
            <td colspan="8" align="center"><?php echo '<b>Place Of Work : </b>' . $qrrow[6]; ?></td>
        </tr>
        <tr style="background:#ffff00;">
            <td colspan="8" align="center"><?php echo '<b>ATMID / Branch Code : </b>' . $qrrow['atm']; ?></td>
        </tr>
        <tr style="background:#a6a6a6; color:white">
            <th width="10" style="font-weight:normal">S.No.</th>
            <th width="200" style="font-weight:normal">Item Code/RC</th>
            <th width="200" style="font-weight:normal">Description of Goods</th>
            <th width="200" style="font-weight:normal">Unit</th>
            <th width="450" style="font-weight:normal">Qty</th>
            <th width="200" style="font-weight:normal">Rate</th>
            <th width="200" style="font-weight:normal">Amount</th>
            <th width="550" style="font-weight:normal">Remarks</th>
        </tr>
        <tr>
                <?php
                $qdetc = mysqli_query($con,"select distinct(particular) from quotation_details where qid='" . $qid . "'");
...
<tr>
    <td></td>
    <td style="background:#ffff00;"></td>
    <td style="background:#ffff00;white-space: nowrap;">GST Extra as per applicable</td>
    <td style="background:#ffff00;" colspan="2"><center>Total Amount</center></td>
    <td style="background:#ffff00;"></td>
    <td style="background:#ffff00;"><center><?= number_format((float)$grandTotal, 2, '.', '') ; ?></center></td>
    <td></td>
