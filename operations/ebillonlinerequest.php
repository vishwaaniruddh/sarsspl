...
//document.getElementById("cmdsub").readOnly = true;
return true;
}
}
function updateData()
...
//xmlhttp.send();
	...
	var m_add=escape(document.getElementById('address').value);
	//alert(cust);
	/*alert(m_atm);
	alert(m_dist);
	alert(m_due);
	...
	//alert(m_dat);
	if(m_atm!='' && m_cust!=''){
var dat="cust="+m_cust+"&consumer="+m_consumr+"&trckid="+m_trackerid+"&distri="+m_dist+"&duedt="+m_due+"&land="+m_land+"&billunit="+m_billunit+"&mtr="+m_meter+"&atm="+m_atm+"&add="+m_add;
//alert(dat);
...
document.getElementById('weblink').value=s2[16];
document.getElementById('username').value=s2[17];
document.getElementById('password').value=s2[18];
...
<?php
	...
	if($_SESSION['designation']=='8' && $_SESSION['serviceauth']=='2' && $_SESSION['dept']=='4'){
?>
if(Number(s2[14])>0)
{
	//document.getElementById('cmdsub').disabled=true;
	document.getElementById('todisabled').value='true';
	alert(s2[15]);
}
else
	document.getElementById('todisabled').value='false';
<?php
	}
?>
   ...
   // alert(xmlhttp.responseText);
	...
	else
	{
		<?php
			if($_SESSION['designation']=='8' && $_SESSION['serviceauth']=='2' && $_SESSION['dept']=='4'){
		?>
		if(document.getElementById('todisabled').value=="true")
			document.getElementById('cmdsub').disabled=true;
		else
			document.getElementById('cmdsub').disabled=false;
		<?php
...
{
//document.getElementById('testing_here').innerHTML=xmlhttp.responseText;
document.getElementById('cmdsub').disabled=false;
}
...
<form id="form1" name="form1" method="post" action="processonlinerequest.php" onsubmit="return validate(this)" autocomplete="OFF" enctype="multipart/form-data">
 ...
 <td><div align="center">
  <p>
    <select name="cust" id="cust"> <option value="">Select Client</option>
     <?php
	 include("config.php");
	 $str="Select short_name,contact_first from contacts where type='c'";
...
if($val !== FALSE)
{
   ...
   ?>
    ...
    <td width="29"></td>
     ...
     <td><div align="center">
       <textarea name="address" id="address" value="" rows="5" cols="50"/></textarea>
     </div></td>
  </tr>      
 <tr>
 <td width="146" height="52"><div align="center">ATM ID</div></td>
 <td><div align="center">
   <p>
     <input type="text" name="atmid" id="atmid" value="<?php echo $row[3]; ?>" onblur="getdetails(this.value,'atm_id1');" />
   </p>
 </div></td>
    <td width="29"></td>
     <td><div align="center">Distributor</div></td>
     <td><div align="center" id="dist">
       <!--<input type="text" name="distributor" id="distributor" <?php if($_SESSION['designation']=='11'){ ?> readonly="readonly" <?php } ?>/>-->
       <select name="distributor" id="distributor" style="width:150px"><option value="">select Provider</option>
<?php
...
{
?>
<option value="<?php echo $spro[0]; ?>"><?php echo $spro[1]; ?>
<?php
}
?>
</select>
  ...
  <tr>
    ...
    <td width="211"><div align="center">
      <p>
        <input type="text" name="trackid" id="trackid" value="" <?php if($_SESSION['designation']=='11'){ ?> readonly="readonly" <?php } ?> />
        </p>
      </div></td>
  <td width="29"></td>
    ...
    <td width="248"><div align="center">
      ...
      <input type="text" name="con_no" id="con_no" readOnly="readOnly" />
       <!-- <input type="text" name="con_no" id="con_no" <?php if($_SESSION['designation']=='11'){ ?> readonly="readonly" <?php } ?> />--></div><br />
       <!-- <input type="checkbox" name="cons" id="cons" onclick="show(this.id)" />&nbsp;&nbsp;-->
		<!--<div id="oldcons">New Consumer Number</div><br />-->
     ...
     <tr>
 <td width="146" height="52"><div align="center">Upload Scanned Bill</div></td>
   <td><div align="center">
   <input type="file" name="scancpy" id="scancpy">
     <input type="hidden" name="duedate" id="duedate" <?php if($_SESSION['designation']=='11'){ ?> readonly="readonly" <?php } ?>/>
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><div align="center">Landlord</div></td>
     <td><div align="center">
       <p>
         <input type="text" name="landlord" id="landlord" <?php if($_SESSION['designation']=='11'){ ?> readonly="readonly" <?php } ?>/>
       </p>
     </div></td>
    </tr>    
...
<tr>
    ...
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td width="146" height="52"><div align="center">Website Link</div></td>
    <td><div align="center"><input type="text" name="weblink" id="weblink"></div></td>
</tr>   

<tr>
    <td width="146" height="52"><div align="center">Username</div></td>
    <td><div align="center"><input type="text" name="username" id="username"></div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td width="146" height="52"><div align="center">Password</div></td>
    <td><div align="center"><input type="text" name="password" id="password"></div></td>
</tr>   
<tr>
 <td width="146" height="52"><div align="center">Billing Unit</div></td>
   <td><div align="center">
     <input type="text" name="billunit" <?php if($_SESSION['designation']=='11'){ ?> readonly="readonly" <?php } ?> id="billunit"/>
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><div align="center">Meter Number</div></td>
     <td><div align="center"><!--  onblur="getdetails(this.value,'meter_no');"-->
       <p>
...
<tr>
 <td width="146" height="52"><div align="center">Averarge Bill</div></td>
   <td><div align="center">
     <input type="text" name="avgbill" <?php if($_SESSION['designation']=='11'){ ?> readonly="readonly" <?php } ?> id="avgbill"/>
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td align="center">Bill Date</td>
     <td align="center"><input type="text" name="bill_date" id="bill_date" onclick="displayDatePicker('bill_date');" onblur="checkdt(this.value,'bill_date');" readonly /></td>
</tr>
<tr>
 <td width="146" height="52"><div align="center">Start Date</div></td>
   <td><div align="center">
     <input type="text" name="fromdt" id="fromdt" onclick="displayDatePicker('fromdt');" onblur="checkdt(this.value,'start_date');" readonly />
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td align="center">End Date</td>
     <td align="center"><input type="text" name="todt" id="todt" onclick="displayDatePicker('todt');" onblur="checkdt(this.value,'end_date');" readonly /></td>
</tr>
<tr>
 <td width="146" height="52"><div align="center">Due Date</div></td>
   <td><div align="center">
     <input type="text" name="duedt" id="duedt" onclick="displayDatePicker('duedt');" onblur="checkdt(this.value,'due_date');" readonly/>
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td align="center">Opening Reading</td>
     <td align="center"><input type="text" name="openr" id="openr" onkeyup="calc('openr','closer');" value="0"  /></td>
</tr>
<tr>
 <td align="center">Close Reading</td>
     <td align="center"><input type="text" name="closer" id="closer" onkeyup="calc('openr','closer');" value="0"  /></td> 
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td width="146" height="52"><div align="center">Unit</div></td>
   <td><div align="center">
     <input type="text" name="unit" id="unit" tabindex="" />
   </div></td>
...
<tr>
 <td width="146" height="52"><div align="center">Supervisor</div></td>
   <td><div align="center">
    ONLINE
   <input type="hidden" name="sv" id="sv" value="ONLINE" />
 ...
 $sup=mysqli_query($con,"select distinct(hname) from fundaccounts where status=0 order by hname ASC");
   ...
   <?php } ?>  
    ...
    <?php
		...
		//echo "select hname from fundaccounts where srno='".$srno[0]."'";
    		$sup=mysqli_query($con,"select hname from fundaccounts where srno='".$srno[0]."'");
    		$supro=mysqli_fetch_array($sup);
    		if(mysqli_num_rows($sup)>0)
    		{
    		echo $supro[0]; 
    	?>
 <!--   <input type="hidden" name="sv" id="sv" value="<?php echo $supro[0]; ?>" /> -->
    <?php
    		}
    		else
    		{
    			$disabled_submit=1;
    			echo "You dont have rights to raise request";
    		}
    	}*/
    ?>
    <!-- <select name="sv" id="sv" ><option value="-1" >Select</option><option value="Mumbai" >Mumbai</option><option value="Ashish Usrehte" >Ashish Usrehte</option>
     <option value="Omveer Singh" >Omveer Singh</option><option value="Paresh Gotrija" >Paresh Gotrija</option><option value="Tanvir Ahemad" >Tanvir Ahemad</option><option value="Anil Kumar" >Anil Kumar</option><option value="Ajay Tiwari" >Ajay Tiwari</option><option value="Raghvendra Billava" >Raghvendra Billava</option><option value="Jasvant Singh" >Jasvant Singh</option><option value="Sanjay Mishra" >Sanjay Mishra</option><option value="Ram Mehra" >Ram Mehra</option><option value="Bishnu Mishra" >Bishnu Mishra</option><option value="Durgesh Vasani" >Durgesh Vasani</option><option value="Amod Gupta" >Amod Gupta</option><option value="RajKumar Sharma/Daljeet Singh" >RajKumar Sharma/Daljeet Singh</option><option value="Ram Prakash" >Ram Prakash</option><option value="Mahavir Singh" >Mahavir Singh</option><option value="Sapna Sharma" >Sapna Sharma</option><option value="Manoj Singh" >Manoj Singh</option><option value="Bidhee Gupta" >Bidhee Gupta</option><option value="Anil Yadav" >Anil Yadav</option><option value="T.S.Reddy" >T.S.Reddy</option><option value="Yogesh Lodhi" >Yogesh Lodhi</option><option value="Roop Singh" >Roop Singh</option><option value="Jitendra Choudhari" >Jitendra Choudhari</option><option value="Chandan Singh" >Chandan Singh</option><option value="Aslam Khan" >Aslam Khan</option><option value="Balachandran Pillai" >Balachandran Pillai</option><option value="Shankar Gadkar" >Shankar Gadkar</option><option value="Bimal Pandey" >Bimal Pandey</option><option value="Virendra Singh" >Virendra Singh</option><option value="Indrajeet Yadav" >Indrajeet Yadav</option><option value="Sadhana(Sapna Yadav)" >Sadhana(Sapna Yadav)</option><option value="Prajul Paunikar" >Prajul Paunikar</option><option value="Deepak Kamble" >Deepak Kamble</option><option value="Jitendra Koli" >Jitendra Koli</option><option value="Vikrant Dhawale" >Vikrant Dhawale</option><option value="Santosh Sen" >Santosh Sen</option><option value="Prakash Dubey" >Prakash Dubey</option><option value="Navnath Suryavanshi" >Navnath Suryavanshi</option><option value="Deepak Mane" >Deepak Mane</option><option value="Prakash Dubey(Bhupendra)" >Prakash Dubey(Bhupendra)</option><option value="Roop Singh" >Roop Singh</option><option value="Harish Chand Dubey" >Harish Chand Dubey</option><option value="Anil Shinde" >Anil Shinde</option><option value="rauf Maniyar" >rauf Maniyar</option>
     <option value="Bhavin Vaghela">Bhavin Vaghela</option>
     </select>-->
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<tr>
  <td align="center">memo</td>
     <td align="center" colspan="3"><textarea name="memo" id="memo"></textarea></td>
   
    <td align="center">Priority<select name="cases" id="cases" ><option value="Normal" >Normal</option>
  ...
  <tr>
    <td colspan="11" align="center"><input type="hidden" name="stat" id="stat" value="unpaid"/><input type="text" name="err" id="err" readonly="readonly" />
    <?php if(!$disabled_submit){ ?>
    <input type="submit" value="submit"  id="cmdsub" name="cmdsub" />
    	<?php
		if($_SESSION['designation']=='8' && $_SESSION['serviceauth']=='2' && $_SESSION['dept']=='4'){
	?>
    	<input type="hidden" id="todisabled" value="false"/>
    	<?php
		}
	?>
    <?php } ?>
    <!--<input type="submit" name="cmdapp" id="cmdapp" value="Send for Approval" /> -->
   <?php if($_SESSION['designation']!='11'){ ?> <input type="button" name="update" id="update" value="Update"  onclick="updateData();" /><?php  }  ?>
      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <!--<select name="cases" id="cases" ><option value="Normal" >Normal</option>
     <option value="Very Urgent" >Very Urgent</option>
     <option value="Disconnection" >Disconnection</option>
     </select>-->
