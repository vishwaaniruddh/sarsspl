...
<h2>Handover Site</h2>
<?php
//echo "select * from ".$cid."_sites where trackerid='".$trackid."'";
$sql="select * from ".$cid."_sites where trackerid='".$trackid."'";
...
<form action="processhandover.php" method="post" name="form" enctype="multipart/form-data">
<input type="hidden" name="track" id="track" value="<?php echo $trackid; ?>">
<table>
<tr>
<td>Takeover Date:</td><td><input type="hidden" name="toverfrm" id="toverfrm" value="" /><input type="text" name="toverdt" id="toverdt" value="<?php 
echo date('d/m/Y',strtotime($qryrow[28])); ?>" readonly="readonly" /></td>
</tr>
<tr>
...
<input type="hidden" name="atmid" value="<?php echo $atmid; ?>" /><input type="text" name="cid" value="<?php echo $cid; ?>" readonly />
