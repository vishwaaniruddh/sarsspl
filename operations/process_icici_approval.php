...
$qryins=mysqli_query($con,"INSERT INTO `quotation_approve_details`(`qid`, `pocap`, `po`, `pr`, `sr`, `remark`, `app_by`, `filename`, `app_amt`, `reqby`, `entrydate`,`approved_date`,req_amt) values('".$qid."','".$pocap."','".$po."','".$pr."','".$sr."','".$rem."','".$appby."','".$image_name."','".$appamt."','".$srno[0]."','".$dt."','".$appdate."','".$reqamt."')");
