...
<form id="form1" name="form1" method="post" action="processnewsiteup.php" onsubmit="return validate1(this)" enctype="multipart/form-data" >
 <table width="200" border="1" align="center" cellpadding="4" cellspacing="0">
 
  <?php

	
		$sql = "SELECT distinct cust_id, cust_name FROM sites";
		$result = mysqli_query($con,$sql);
		?>
        <tr><td>Select Customer</td><td align="left">
...
<tr>
    ...
    <td ><div align="left">
    <input type="checkbox" name="caretake" id="caretake" value="caretaker" /> Caretaker<br />
    <input type="checkbox" name="housekeep" id="housekeep" value="housekeeping" /> HouseKeeping<br />
     <input type="checkbox" name="maintain" id="maintain" value="maintenance" /> Maintenance<br />
     <input type="checkbox" name="ebill" id="ebill" value="ebill" /> Ebill<br />
    </div></td>
  </tr>
  <tr>
  ...
  <tr><td colspan="2"><b>Format:</b>AC Manager,	AC Manager Number,	Caretaker,	Housekeeping,	Maintainence,	Ebill,	Bank,	ATM_Id 1,	ATM_Id 2,	ATM_Id 3,	Site_Id,	Site type,	Site Address,	State,	City,	Zone,	CSS Local BranchManager Name,	CSS Local Branch Manager Number,CSS Local Supervisor Name,	CSS Local Supervisor Number,	Takeover_date,	Remarks
