...
<div id="header">
<form action="process_delegation.php" method="post" name="form" >
<table>
<?php
...
//echo $sql;
//$engg=mysqli_query($con,$sql);
$engg=mysqli_query($con,"select username,srno from login where designation='11' and status=1");
if(!$engg)
...
$q=mysqli_query($con,"select location from cssbranch where id='".$row[2]."'");
$r=mysqli_fetch_row($q);
$q2=mysqli_query($con,"select city from cities where city_id='".$row[3]."'");
