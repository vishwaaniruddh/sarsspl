...
//echo "select bill_date from ebillfundrequests where reqstatus<>'0' and cust_id='".$cid."' and (atmid='".$atmid."' OR trackerid='".$trackid."') and ".$tbl." like '".$dt2."%'";
$qry=mysqli_query($con,"select bill_date from ebillfundrequests where reqstatus<>'0' and cust_id='".$cid."' and (atmid='".$atmid."' OR trackerid='".$trackid."') and ".$tbl." like '".$dt2."%'");
