...
$.ajax({
           ...
           contentType: false,
            ...
            success: function(msg){
                ...
                alert(msg);
<?php if($_GET['supvl']!="") {?>
window.open('sup_view_quot_tis.php?qoid=<?php echo $qoid;?>'+'&strdt=<?php echo $sts;?>'+'&endt=<?php echo $ends;?>'+'&atms=<?php echo $atms;?>','_self');
<?php
}
elseif($_GET['ic']!="")
{
?>
window.open('icici_quot_view_tis.php?qoid=<?php echo $qoid;?>'+'&strdt=<?php echo $sts;?>'+'&endt=<?php echo $ends;?>'+'&atms=<?php echo $atms;?>','_self');
<?php
}
else
{
?>
window.open('quotation_approve_tis.php?qoid=<?php echo $qoid;?>'+'&strdt=<?php echo $sts;?>'+'&endt=<?php echo $ends;?>'+'&atms=<?php echo $atms;?>','_self');
<?php }?>  
            }
        });
...
<input type="button" value="Submit"  onclick="cancqfunc();" >
...
{
?>
onclick="window.open('icici_quot_view_tis.php?qoid=<?php echo $qoid;?>'+'&strdt=<?php echo $sts;?>'+'&endt=<?php echo $ends;?>'+'&oatm=<?php echo $atms;?>','_self');"/>
<?php
}
else 
{
