...
var unitarr=[];
		var fields7 = document.getElementsByName("unit[]");
		for(var i = 0; i < fields7.length; i++){
			unitarr.push(fields7[i].value);
		}
...
if(validate()){
    ...
    $.ajax({
        ...
        data: {partic:partic,partyp:partyp,partqty:partqty,partrate:partrate,partamt:partamt,cust:cust,bank:bank,address:address,city:city,state:state,atm:atm,proj:proj,typ:typ,sv:sv,tcode:tcodearr,uom:uom,svtxarr:svtxarr,unit:unitarr,categoryName:categoryName,ticketNo:ticketNo,quotationDate:quotationDate},
        beforeSend: function(){
        ...
        success: function(msg){
            //alert(msg);
            console.log(msg);
            window.open('quotation1.php','_self');
        }
    });
}
...
<th>Service tax</th>
<th>Amount</th>
<th>Code(For Kotak)</th>
<th >Remark (For Kotak)</th>
...
<tr>
  ...
  <td align="center">
       ...
       <td align="center">
           <input style="width:150px" type="text" name="unit[]" id="unit1" />
     </td>
...
<tr>
   ...
   <td align="center">
      ...
      <td align="center">
           <input style="width:150px" type="text" name="unit[]" id="unit2" />
     </td>
...
<tr>
    <td align="center" width="400">
     ...
     <td align="center">
         ...
         <td align="center">
           <input style="width:150px" type="text" name="unit[]" id="unit3" />
     </td>
...
<tr>
   ...
   <td align="center">
          <input style="width:150px" type="text" name="unit[]" id="unit4" />
      </td>
...
<tr>
     ...
     <td align="center">
        <input style="width:150px" type="text" name="unit[]" id="unit5" />
    </td>
...
<tr>
     ...
     <td align="center">
          ...
          <td align="center">
        <input style="width:150px" type="text" name="unit[]" id="unit6" />
    </td>
...
<tr>
     ...
     <td align="center">
        ...
        <td align="center">
        <input style="width:150px" type="text" name="unit[]" id="unit7" />
    </td>
...
<tr>
    ...
    <td align="center">
        <input style="width:150px" type="text" name="unit[]" id="unit8" />
    </td>
...
<tr>
  ...
  <td align="center">
        <input style="width:150px" type="text" name="unit[]" id="unit9" />
    </td>
...
<tr>
     ...
     <td align="center">
       ...
       <td align="center">
        <input style="width:150px" type="text" name="unit[]" id="unit10" />
    </td>
...
<script>
   ...
   var idname= ["pr","prc","unit","rate","stx","amt","tcode","descdet",];
