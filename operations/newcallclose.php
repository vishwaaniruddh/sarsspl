...
$sq=mysqli_query($con,"select cust_id from alert where alert_id='$id'");
$ro=mysqli_fetch_row($sq);

$sq1=mysqli_query($con,"select * from cust where id='$ro[0]'");
...
include_once('class_files/filter.php');
	...
	$tab1=mysqli_query($con,"select * from customer where cust_id='".$ro[0]."'");
