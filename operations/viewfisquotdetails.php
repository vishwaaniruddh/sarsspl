...
$gdeta=mysqli_fetch_array($qdet);
 ...
 $gpartnew=mysqli_query($con,"select * from quotation_details where particular='".$gdeta[0]."' and qid='".$qid."'");
...
$fisnewq=mysqli_query($con,"select * from quotation_details where particular='".$gdetca[0]."' and qid='".$qid."'");
