...
//alert(xmlhttp.responseText);
   ...
   // alert("Fund Approved");
	...
	var amt=document.getElementById("amt"+cnt).value;
...
function addamt(amt1,amt2,id)
  {
 // alert(amt+" "+id);
  if(document.getElementById(id).checked==true)
  {
	  var newval1=Number(document.getElementById('seltot1').value)+Number(amt2);
	  var newval2=Number(document.getElementById('seltot2').value)+Number(amt1);
	  if(newval2<1)
	  	document.getElementById("dispatch_btn").disabled = true;
	  else
	  	document.getElementById("dispatch_btn").disabled = false;
	document.getElementById('seltot1').value=newval1;
	document.getElementById('seltot2').value=newval2;
	document.getElementById('diff').value=(newval2-newval1);
  }
  else
  {
...
?>
    ...
    <td>
    	<input type="hidden" name="sdate" id="sdate" onclick="displayDatePicker('sdate');" readonly="readonly" placeholder="From Date"/>
	<input type="hidden" name="edate" id="edate"  onclick="displayDatePicker('edate');" readonly="readonly" placeholder="To Date"/>
    </td>
