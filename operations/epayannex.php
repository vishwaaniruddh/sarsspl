...
<th width="75">Project ID</th>
<th width="75">Atm Id1</th>
<th width="75">Atm Id2</th>
<th width="75">Atm Id3</th>
...
<th width="75">Consumer_No</th><th width="75">Distributor</th><th width="75">landlord</th><th width="75">billing_unit</th><th width="75">meter_no</th>
<th width="75">CSS LOCAL BRANCH</th>
<th width="75">Supervisor NAME</th>
<th width="75">Contact Number</th>
<?php	
...
$sql.=" and cust_id in ($cl1)";	
        $table=mysqli_query($con,$sql); 
        if(mysqli_num_rows($table)>0){   
        $row=mysqli_fetch_row($table);
$qry1=mysqli_query($con,"select bank,atmsite_address,location,atm_id2,atm_id3,projectid,csslocalbranch,hsupervisor_name,super_contact from ".$row[12]."_sites where trackerid='".$row[14]."'");
$qrrow=mysqli_fetch_array($qry1);
$qry2=mysqli_query($con,"select `Consumer_No`, `Distributor`, `landlord`, `billing_unit`, `meter_no` from ".$row[12]."_ebill where atmtrackid='".$row[14]."'");
...
<td width="75"><?php echo $qrrow[5]; ?></td>
<td width="75"><?php echo $row[1]; ?></td>
<td width="75"><?php echo $qrrow[3]; ?></td>
<td width="75"><?php echo $qrrow[4]; ?></td>
...
<td width="75"><?php echo $qrrow2[0]; ?></td>
<td width="75"><?php echo $qrrow2[1]; ?></td>
<td width="75"><?php echo $qrrow2[2]; ?></td>
<td width="75"><?php echo $qrrow2[3]; ?></td>
<td width="75"><?php echo $qrrow2[4]; ?></td>
