...
// var accname = document.getElementById('accname').options[document.getElementById('accname').selectedIndex].value;
<?php } ?>
...
<!--<body onload="getaccm();">-->
<body onload="">
<form method="post" action="quotransfer_export_test.php" target='_blank'>
<center>
...
<th>
    <select id="accname" name="accname" style="width:100px" onchange="func();">
