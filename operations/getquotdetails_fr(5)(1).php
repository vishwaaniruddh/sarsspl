...
<?php }?>
	...
	<?php
	if($_SESSION['designation']=="20" && $_SESSION['serviceauth']=='2' && $_SESSION['dept']=='6' && $_POST['stat']=="0"  )
...
if($_SESSION['designation']=="20" && $_SESSION['serviceauth']=='2' && $_SESSION['dept']=='6')
...
if($row[2]!='ICICI' && $row[2]!='ICICI_Direct' && $row[2]!='Knight_Frank' && $row[2]!='RATNAKAR')
{
	if($_SESSION['designation']=="20" && $_SESSION['serviceauth']=='2' && $_SESSION['dept']=='6'  && ($_POST['stat']=="0" || $_POST['stat']=="1" ))
