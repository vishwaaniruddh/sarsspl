...
$upqry=mysqli_query ("Update icici_quot_details_tis SET `qid`='".$qid."',`material_group`='".$matg."',`service_no`='".$servno."',`material_text`='".$matext."',`gprice`='".$gprice."',`qnty`='".$qnty."',`unit`='".$unit."',`amt`='".$amt."',`remark`='".$rem."' where id='".$detailid."' and qid='".$qid."' ");
if(!$upqry)
{
