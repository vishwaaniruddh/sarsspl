...
$sql="select short_name,contact_first from contacts where type='c' and short_name in(select distinct(cust_id) from mastersites)";
...
echo "00/00/0000";
 ...
 <!------>
 <!---Show date --->
<td><?php echo date('d/m/y',strtotime($duedtro[8])); ?></td><!---6--->
<td><?php echo date('d/m/y',strtotime($duedtro[9])); ?></td><!---7--->
