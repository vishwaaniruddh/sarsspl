...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
 	...
 	//alert(br);
			...
			if(a!="Loading"){ 
			 pmeters = 'cid='+cid+'&bank='+bank+'&Page='+b+'&perpg='+ppg+"&dt="+dt+"&dt2="+dt2+"&atm="+atm+"&yr="+yr+"&mon="+mon+"&range="+ran;
			// alert(pmeters);
			}
			else
			{
...
//echo $sql;
          ...
          <select name="bank" id="bank" onchange="searchById('Listing','1','');" ><option value="">select Bank</option>
           ...
           <option value="<?php echo "0 and ".date('t') ?>">All</option>
           <option value="<?php echo date('d')." and ".date('d',strtotime('+1 week')); ?>">Next 7 Days</option>
           <option value="<?php echo "0 and ".date('d',strtotime('-1 days')); ?>">Over Dues</option>
           </select>
