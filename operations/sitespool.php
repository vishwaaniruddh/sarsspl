...
<div align="center">
  ...
  <h2 class="style1">SITE Spool</h2>

</div><br /><br />

<form id="form1" name="form1" method="post" action="procsitespool.php" onsubmit="validate1(this)" >
 ...
 <table width="375" border="1" align="center" cellpadding="4" cellspacing="0">
  ...
  <?php
		...
		$sql = "SELECT contact_first,short_name FROM contacts where type='c'";
...
<option value="">Select Zone</option>
  ...
  <tr>
    ...
    <td><div align="left">
      ...
      <select name="state[]" multiple><option value="-1">All</option>

    <?php 

           $sql2 = "SELECT distinct state FROM state";
