...
document.getElementById('history').innerHTML=xmlhttp.responseText;
//alert('<?php echo $_SESSION['custid']; ?>'+" "+cid);
...
<form id="form1" name="form1" method="post" action="processbillent2.php" onsubmit="return validate(this)" autocomplete="OFF">
<input type="hidden" name="bank" id="bank" />
<table><tr><td valign="top"><h2>History</h2><div id="history"></div></td><td>
...
if($val !== FALSE)
{
   ...
   ?>
    ...
    <td width="29"></td>
     ...
     <td><div align="center">
       <input type="text" name="address" id="address" onblur="getdetails(this.value,'address');" value=""/>
     </div></td>
  </tr>      
 <tr>
 ...
 <td><div align="center">
   <p>
    ...
    <td width="29"></td>
     ...
     <td><div align="center">
       <input type="text" name="distributor" id="distributor" readonly="readonly"/>
     </div></td>
  </tr>      
  <tr>
  ...
  <td width="29"></td>
    ...
    <td width="248"><div align="center">
      ...
      <div id='divcon_no' style="display:block">
        <input type="text" name="con_no" id="con_no" onblur="getdetails(this.value,'Consumer_No');" /></div><br />
 ...
 <td width="146" height="52"><div align="center"></div></td>
   <td><div align="center">
     <input type="hidden" name="duedate" id="duedate" readonly="readonly"/>
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td><div align="center">Landlord</div></td>
     <td><div align="center">
       <p>
         <input type="text" name="landlord" id="landlord" readonly="readonly"/>
       </p>
     </div></td>
    </tr>    
<tr>
 <td width="146" height="52"><div align="center">Billing Unit</div></td>
   <td><div align="center">
     <input type="text" name="billunit" readonly="readonly" id="billunit"/>
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
 ...
 <td width="146" height="52"><div align="center">Averarge Bill</div></td>
   <td><div align="center">
    ...
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     ...
     <td align="center"><input type="text" name="bill_date" id="bill_date" onclick="displayDatePicker('bill_date');" onblur="checkdt(this.value,'bill_date');" /></td>
</tr>
<tr>
 <td width="146" height="52"><div align="center">Start Date</div></td>
   <td><div align="center">
     <input type="text" name="fromdt" id="fromdt" onclick="displayDatePicker('fromdt');" onblur="checkdt(this.value,'start_date');" />
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
     <td align="center">End Date</td>
     <td align="center"><input type="text" name="todt" id="todt" onclick="displayDatePicker('todt');" onblur="checkdt(this.value,'end_date');" /></td>
</tr>
<tr>
 <td width="146" height="52"><div align="center">Due Date</div></td>
   <td><div align="center">
     <input type="text" name="duedt" id="duedt" onclick="displayDatePicker('duedt');" onblur="checkdt(this.value,'due_date');"/>
   </div></td>
    <td width="29">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
