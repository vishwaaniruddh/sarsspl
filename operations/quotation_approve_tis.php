...
//alert(qid);
 ...
 window.open('savequotpdf_tis.php?qid='+qid,'_blank');
...
//alert(qid);
 ...
 window.open('editquotation_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm,'_self');
...
//alert(qid);
 ...
 window.open('appedit_quot_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm,'_self');
...
$.ajax({
            url: "process_quotfinal_close_tis.php",
            type: "POST",
            data:fd,    
            contentType: false,
            cache: false,
...
window.open('canc_quotation_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm,'_self');
...
$.ajax({
   type: 'POST',    
url:'getquotdetails1_tis.php',
 beforeSend: function()
                   {
        
                  document.getElementById("show").innerHTML ="<center><img src=loader.gif></center>";
                  },
data:'qid='+qid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm+'&accname='+accname+'&type='+type+'&fundtyp='+fundtyp+'&perpg='+perp+'&Page='+Page+'&calltyp='+calltyp+'&qtst='+qtst+'&cust1='+cust,
...
<body onload="func('','');" >
<form id="frmup" name="frmup"  method="post" action="expquot_tis.php" target="_blank">
<center>
...
$nwr=mysqli_query($con,"select distinct(reqby) from quotation1_tis where cust in($csds)");
