...
while($rw=mysqli_fetch_array($qrys))
{
    ...
    if($rw["REQID"]!="")
    {
    $sr2=mysqli_query($con,"select *  from ebillfundrequests where req_no='".$rw["REQID"]."'");
			$fr2=mysqli_fetch_row($sr2);

    ?>
    <td><?php  echo date('d-m-Y', strtotime($fr2[9]));?></td>
    <td><?php echo date('d-m-Y', strtotime($fr2[6]));?></td>
    <td><?php echo date('d-m-Y', strtotime($fr2[7]));?></td>
    <td><?php echo "";?></td>
    <td><?php echo $fr2[3];?></td>
...
?>
<a href="<?php echo "../ebill/".$billcopylnk;?>" download="<?php echo $billcopynm;?>">Download</a>
<?php
...
?>
<a href="<?php echo "../ebill/".$recopylnk;?>" download="<?php echo $recopynm;?>">Download</a>
<?php
