...
$sqlmysqli_query($con,("select * from alert where status<>'Done'");
...
$sq=mysqli_query($con,"select up from alert_updates where alert_id='$row[0]' order by id desc limit 1");
...
//$sql=mysqli_query($con,"select * from alert where alert_id='$row[0]' and ");
