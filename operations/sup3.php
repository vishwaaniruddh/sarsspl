...
if($sup_status)
{
	$sup_str.="and srno in (select srno from login where username='".$_SESSION['user']."')";
}
...
echo "select * from ebpayment where  Bill_No in(select r.req_no from ebillfundrequests r,fundaccounts a where r.supervisor=a.hname and a.aid='".$_POST['sup']."') and upby!='' and entrydt>='".date('Y-m-d',strtotime(str_replace("/","-",$_POST['frmdt'])))." 00:00:00' AND  entrydt<='".date('Y-m-d',strtotime(str_replace("/","-",$_POST['todt'])))." 23:59:59'"."<br>";
