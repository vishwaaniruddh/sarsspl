...
$.ajax({
            ...
            success: function(msg){
                ...
                alert(msg);
                window.open('editquotation.php?qid='+quotid,'_self');
...
window.open('editquotation.php?qid='+qid,'_self');
            }           
       });
...
$.ajax({
            type: "POST",
            url: "process_quotation_cancel.php",
...
<?php
$edqry2=mysqli_query($con,"Select distinct(particular) from quotation_details where qid='".$qid."' ");

$gtot2=mysqli_query($con,"Select sum(Total) from quotation_details where qid='".$qid."'");
...
<?php
  ...
  $subqry2=mysqli_query($con,"select * from quotation_details where particular='".$rowqry2[0]."' and qid='".$qid."'");
...
<input type="button" name="bck" id="bck" value="Back" <?php if($_GET['supvl']=="") { ?> onclick="window.open('quotation_approve.php?qoid=<?php echo $qoid;?>'+'&strdt=<?php echo $sts;?>'+'&endt=<?php echo $ends;?>'+'&oatm=<?php echo $atms;?>','_self');"  <?php } else {?>
onclick="window.open('sup_view_quot.php?qoid=<?php echo $qoid;?>'+'&strdt=<?php echo $sts;?>'+'&endt=<?php echo $ends;?>'+'&oatm=<?php echo $atms;?>','_self');"  <?php }?>
/>
</center>
