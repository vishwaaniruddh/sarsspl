...
$qry=mysqli_query($con,"SELECT `cid`,`bankname`,`state`,`city`,`address`,`pincode`,`area`,`servicetype` FROM `Amc` WHERE `amcid`='$atm'");
...
$qry=mysqli_query($con,"SELECT `cust_id`,`bank_name`,`state`,`city`,`address`,`pincode`,`area`,`servicetype` FROM `atm` WHERE `track_id`='$atm'");
