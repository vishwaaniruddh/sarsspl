...
$objSheet->setCellValue('R1', 'Po Number');
$objSheet->setCellValue('S1', 'Status');
$objSheet->setCellValue('T1', 'Call Status');
$objSheet->setCellValue('U1', 'Call Status History');
$objSheet->setCellValue('V1', 'Transferred Amount');
$objSheet->setCellValue('W1', 'Transferred Date');
$objSheet->setCellValue('X1', 'Cheque No');
$objSheet->setCellValue('Y1', 'Beneficiary Name');
...
$rowamt="";
	      ...
	      {
	      $amtqry=mysqli_query($con,"select app_amt,filename,app_by,approved_date,remark,req_amt from quotation_approve_details where qid='".$rowarr[0]."'");
...
$trastamt=$trastamt+$trdrow[0];
  ...
  $transfdt=date('d-m-Y',strtotime($trdrow[1]));
   ...
   $podet=mysqli_query($con,"select po from quotation_approve_details where qid='".$rowarr[0]."'");
...
$objSheet->setCellValueByColumnAndRow(17, $row, $porow[0]);
$objSheet->setCellValueByColumnAndRow(18, $row, $stat);
$objSheet->setCellValueByColumnAndRow(19, $row, $cstat);
$objSheet->setCellValueByColumnAndRow(20, $row, $qchis);

$objSheet->setCellValueByColumnAndRow(21, $row, round($trdrow[0]));
$objSheet->setCellValueByColumnAndRow(22, $row, $transfdt);
$objSheet->setCellValueByColumnAndRow(23, $row, $trdrow[2]);
$objSheet->setCellValueByColumnAndRow(24, $row, $supvn);
...
$objSheet->setCellValueByColumnAndRow(21,$lastrow, round($trastamt));
