...
//xmlhttp.send();
	...
	var m_add=document.getElementById('address').value;
	//alert(cust);
	/*alert(m_atm);
	alert(m_dist);
	alert(m_due);
...
<table><tr><td valign="top"><h2>History</h2><div id="history" style="height:500px; overflow:auto"></div></td><td valign="top">
    ...
    <td width="248"><div align="center">
      ...
      <input type="text" name="con_no" id="con_no" />
       <!-- <input type="text" name="con_no" id="con_no" <?php if($_SESSION['designation']=='11'){ ?> readonly="readonly" <?php } ?> />--></div><br />
        <input type="checkbox" name="cons" id="cons" onclick="show(this.id)" />&nbsp;&nbsp;<div id="oldcons">New Consumer Number</div><br />
...
<tr>
  ...
  <tr>
    <td colspan="11" align="center"><input type="hidden" name="stat" id="stat" value="unpaid"/><input type="text" name="err" id="err" readonly="readonly" /><input type="submit" value="submit" id="cmdsub" name="cmdsub" />
