...
//alert(qid);
 ...
 window.open('editquotation_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm+'&supvl='+supvl,'_self');
...
//alert(qid);
 ...
 window.open('appedit_quot_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm+'&supvl='+supvl,'_self');
...
//alert(qid);
 ...
 window.open('close_quotation_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm+='+atm+'&supvl='+supvl,'_self');
...
window.open('canc_quotation_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm+'&supvl='+supvl,'_self');
...
data:'qid='+qid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm+'&accname='+accname+'&type='+type+'&cust1='+cust1+'&supvl='+supvl+'&fundtyp='+fundtyp+'&perpg='+perp+'&Page='+Page,
