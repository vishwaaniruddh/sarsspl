...
xmlhttp.open("GET","getcitycat.php?cid="+val,true);
xmlhttp.send();
}
...
<tr><td>Old Rate Change Till Date(for multiple rates in a month)</td><td><input type="text" name="rtdt" id="rtdt" value="00/00/0000"></td></tr>
<tr><td>Old Rate(for multiple rates in a month)</td><td><input type="text" name="chngrate" id="chngrate" value=""></td></tr>
