				...
				<div class="page-wrapper">
					<div class="page-body">
						<div class="card" id="filter">
                            ...
                            $sqlapp = "select * from mis_newvisit_app_test  where activity_type in('RMS','Cloud') ";
                            $sqlappCount = "select count(1) as total from mis_newvisit_app_test  where activity_type in('RMS','Cloud')";
											...
											<tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td>
                                                    ...
                                                    <td><?=$validity; ?><br/><a href="#" class="btn btn-danger" onclick="updateStatus(<? echo $id; ?>,<? echo $new_status; ?>)">Make Valid/Invalid</a></td>
