                            ...
                            <div class="page-body">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        $schedule_eng_sql = mysqli_query($con, "select engineer_user_id as eng_id from mis_newsite where atmid = '".$atmid."' ");
                                        $schedule_eng_sql_result = mysqli_fetch_assoc($schedule_eng_sql);
                                        $_engid = $schedule_eng_sql_result['eng_id'];
