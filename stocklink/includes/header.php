    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        ...
        <ul class="nav navbar-nav navbar-right">
          ...
          <li id="navBOQ"><a href="boq.php"><i class="glyphicon glyphicon-th-list"></i> BOQ </a></li>
          ...
          <li class="dropdown" id="navOrder">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> <i class="glyphicon glyphicon-shopping-cart"></i> Masters <span class="caret"></span></a>
            <ul class="dropdown-menu">
              <li id="courier"><a href="courier.php"> <i class="glyphicon glyphicon-check"></i> Courier </a></li>
              <li id="importbrand"><a href="importbrand.php"> <i class="glyphicon glyphicon-check"></i> Import Brand </a></li>
              <li id="topNavAddOrder"><a href="importcategory.php"> <i class="glyphicon glyphicon-check"></i> Import Category</a></li>
              <li id="topNavManageOrder"><a href="importproduct.php"> <i class="glyphicon glyphicon-check"></i> Import Product</a></li>
            </ul>
          </li>
