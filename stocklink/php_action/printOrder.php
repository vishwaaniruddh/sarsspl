...
$sql = "SELECT order_date, client_name, client_contact, sub_total, vat, total_amount, discount, grand_total, paid, due, payment_place,gstn FROM stocklink_orders WHERE order_id = $orderId";
...
product.product_name FROM stocklink_order_item order_item
   INNER JOIN stocklink_product product ON order_item.product_id = product.product_id 
