...
$sql = "SELECT order_id, order_date, client_name, client_contact, payment_status FROM stocklink_orders WHERE order_status = 1";
...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	$countOrderItemSql = "SELECT count(*) FROM stocklink_order_item WHERE order_id = $orderId";
