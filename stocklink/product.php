		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<a class="btn btn-default button1" href="./productEntries.php"> <i class="glyphicon glyphicon-plus-sign"></i> Entries </a>
		...
		<div class="modal-content">
			...
			<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select name="productName" id="productName" class="form-control">
								...
								<?php
								$sql = mysqli_query($connect, "select * from stocklink_boq where status='Active'");
								while ($sql_result = mysqli_fetch_assoc($sql)) {
									$productName = $sql_result['productName'];
								?>
					...
					<div class="form-group">
						<label for="rate" class="col-sm-3 control-label">Single Product Price </label>
						<label class="col-sm-1 control-label">: </label>
						<div class="col-sm-8">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<select class="form-control" id="brandName" name="brandName">
								<option value="">SELECT</option>
								<?php
								$sql = "SELECT brand_id, brand_name, brand_active, brand_status FROM stocklink_brands 
					...
					<div class="form-group">
						<label for="editProductStatus" class="col-sm-3 control-label">Serial Number : </label>
						<label class="col-sm-1 control-label">: </label>
						<div class="col-sm-8 addserialNumbers">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select class="form-control" id="editBrandName" name="editBrandName">
											<option value="">SELECT</option>
											<?php
											$sql = "SELECT brand_id, brand_name, brand_active, brand_status FROM stocklink_brands WHERE brand_status = 1 AND brand_active = 1";
											$result = $connect->query($sql);
...
<script>
	$(document).on('keyup', '#quantity', function() {
		...
		var serialContainer = $('.addserialNumbers');
		serialContainer.empty(); // Clear previous serial numbers

		// Generate serial number inputs
		for (var i = 1; i <= quantity; i++) {
			serialContainer.append('<input type="text" name="serialNumber[]" class="form-control serial-input" placeholder="Add serial number" />');
		}
	});
</script>

<script src="custom/js/allproduct.js"></script>
