	...
	<div class="col-md-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<form class="form-horizontal" id="submitImportForm" action="php_action/createProductImport.php" method="POST" enctype="multipart/form-data">
	        	...
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
						...
						<a href="assests/import/product.xlsx" download>Sample file</a>
