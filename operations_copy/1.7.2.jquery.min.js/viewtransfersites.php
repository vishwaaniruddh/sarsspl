...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
		 ...
		 /* if(document.getElementById('idd').value=="" && document.getElementById('fname22').value=="")
		  {
			...
			var auth=document.getElementById('serviceauth').value;
		...
		var pmeters="";
			...
			if(a!="Loading"){ 
			 pmeters = 'id='+id+'&cid='+cid+'&city='+city+'&state='+state+'&area='+area+'&bank='+bank+'&Page='+b+'&perpg='+ppg+'&sdate='+sdate+'&edate='+edate+'&desig='+desig+"&auth="+auth+"&dept="+dept;
			}//alert("gg");
			else
			{
			pmeters = 'Page='+b+'&perpg='+ppg+'&desig='+desig+"&auth="+auth+"&dept="+dept;	
			}
			//alert(pmeters);
...
<h2 class="h2color">View Transfer Sites</h2>
...
<input type="hidden" name="serviceauth" id="serviceauth" value="<?php echo $_SESSION['serviceauth']; ?>"/>
...
$sql2="select distinct fromcid from transfer_req where 1";
if($_SESSION['custid']!='all')
$sql2.=" and fromcid in (".$cl.")";
