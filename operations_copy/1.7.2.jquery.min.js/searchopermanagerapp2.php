...
<table width="800" border="1" id="custtable">
  <tr>
   ...
   <th scope="col"><div align="center">Housekeeping Takeoverdate</div></th>
    <th scope="col"><div align="center">Caretaker </div></th>
	
<th scope="col"><div align="center">Caretaker Takeoverdate </div></th>
    <th scope="col"><div align="center">Maintenance </div></th>
	
   <th scope="col"><div align="center">Maintenance Takeoverdate</div></th>
    <th scope="col"><div align="center">Ebill </div></th>
	 <th scope="col"><div align="center">Ebill Takeoverdate </div></th>
		...
		?>
		 <tr <?php if($row[55]==''){ ?> style="background:#FF7519" <?php } ?>>
		   ...
		   <td><?php echo $row[5]; ?></td>
            <td><?php if(isset($row[61]) and $row[61]!='0000-00-00'){  echo date('d/m/Y',strtotime($row[61])); }//housekeeping
             ?></td>
		 ...
		 <td><?php if(isset($row[29]) and $row[29]!='0000-00-00'){  echo date('d/m/Y',strtotime($row[29])); }//caretaker
		  ?></td>
			  
			 <td><?php echo $row[9]; ?></td>
			<td><?php if(isset($row[62]) and $row[62]!='0000-00-00'){  echo date('d/m/Y',strtotime($row[62])); }//maintenance
			 ?></td>
           
             
			 <td><?php echo $row[53]; ?></td>
             <td><?php if(isset($row[63]) and $row[63]!='0000-00-00'){  echo date('d/m/Y',strtotime($row[63])); }//Ebill
              ?></td>
