...
$upqry=mysqli_query ("Update quotation_details SET `description`='".$pr."',`quantity`='".$prc."',`rate`='".$rate."',`total`='".$amt."',tcode='".$tcode."',uom='".$descdet."',ServiceTax='".$stx1."' where id='".$detailid."' and qid='".$qid."'");
if(!$upqry)
{
