...
if($resume=='')
{
$qry=mysqli_query($con,"Update area_engg set city='".$city."', engg_name='".$name."', area='".$area."',email_id='".$email."',phone_no1='".$cont."' where engg_id='".$id."' ");
if($qry)
header("location:view_areaeng.php");
else
...
$qry=mysqli_query($con,"Update area_engg set city='".$city."', engg_name='".$name."', area='".$area."',email_id='".$email."',phone_no1='".$cont."',resume='".$newname."' where engg_id='".$id."' ");
if($qry)
{
	header('Location:view_areaeng.php');
}
