...
<td><?php echo ($total+$total2+$total3+$total4+$total5+$total6)-($paidamt+$paidamt2+$paidamt3+$paidamt4+$paidamt5+$paidamt6+$opening_fund['eb_received_bfsft']+$update_receipt_amt); ?></td>
</tr>
<?php
	$i++;
	}
