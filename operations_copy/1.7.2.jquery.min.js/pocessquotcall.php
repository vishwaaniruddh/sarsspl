...
NULL, 
'".$logro[0]."',
 '".$_POST['bank']."', '".$_POST['trackid']."', '".$rem."','".$_POST['department']."','".$_POST['stype']."','".$curdt."','".$sup."','".$_POST['csslocalbr']."','".$_POST['ccmail']."','".$_POST['atmid']."','".$_POST['cssarea1']."')";
//echo $str;
...
$qry=mysqli_query($con,"INSERT INTO `quot_details` (`quotdetid`, `quotid`, `material`,`component`,`now`,`cldocno`,`memo`,`qty`,`remark`) VALUES (NULL, '".$quotid."', '".$mat[$i]."','".$asst[$i]."','".$now[$i]."','".$docno[$i]."','".$remrk[$i]."','1','".$remrk[$i]."')");
...
$trst=1;
 ...
 $aaa="INSERT INTO `alert` (`alert_id`, `cust_id`, `atm_id`, `bank_name`,`area`, `address`, `city`, `state`, `pincode`, `problem`, `entry_date`, `alert_date`, `caller_name`, `caller_phone`, `caller_email`, `status`, `call_status`, `alert_type`, `close_date`, `createdby`, `state1`,quotdetid,cldocno,mattype,callpriority,eta,delegate,transfer_to_status) VALUES 
(NULL, '".$_POST['bank']."','".$_POST['atmid']."', '".$_POST['bk']."','".$_POST['csslocalbr']."', '".$_POST['address']."', '".$_POST['city']."', '".$_POST['csslocalbr']."', NULL, '".$prblm."', '".$curdt."', '".$alertdt."','".$_POST['authn']."', '".$_POST['connum']."', '".$_POST['email']."', '1', '1', '".$_POST['stype']."', '0000-00-00 00:00:00','".$docketno."','".$_POST['state']."','".$quotid."','".$cldoc."','".$qdtr[1]."_".$qdtr[0]."','".$_POST['prio']."','".$etdt."','".$_POST['del']."','".$trst."')";
...
$ins=mysqli_query($con,"Update quotation set subject='".$sub."',type='".$_POST['type']."',status='1',totalcost='0',materialcnt='".$stat."',mailperson='".$_POST['authn']."',`reqamt`='0',`taskrecfrm`='".$_POST['authn']."' where quotid='".$quotid."'");
if($ins)
...
echo "<script type='text/javascript'>alert('Call logged Successfully');window.location='servicecall.php'</script>";
