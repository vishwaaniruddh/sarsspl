...
if(isset($_GET['page']) && $_GET['page']!=''){
	...
	$sql="Select s.atm_id1,s.atmsite_address,s.bank,s.location,s.city,s.state,s.takeover_date,t.fromcid,t.to,t.handoverdt,t.takeoverdt,t.handoverform,t.takeoverform,t.remarks,t.transferid,t.status from ".$_POST['cid']."_sites s,transfer_req t where t.status='2' and t.to='".$_POST['cid']."' and s.active=0 and t.atmid=s.atm_id1";
...
if($_POST['desig']=='3' && $row[15]!='2'){ ?><td width="75" id="app<?php echo $count; ?>"><input type="button" onClick="approvetransfer('<?php echo $count; ?>','<?php echo $row[14]; ?>','1')" value="Approve"></td>  <?php } ?>
