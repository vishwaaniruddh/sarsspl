...
<th width="200" style="font-weight:normal">Customer</th>	
<th width="180" style="font-weight:normal" >Bank</th>	
<th width="85" style="font-weight:normal">Site ID</th>
<th width="200" style="font-weight:normal">Code</th>
<th width="200" style="font-weight:normal">ATM</th>
<th width="200" style="font-weight:normal">Project ID</th>
<th width="450" style="font-weight:normal">Location</th>
<th width="200" style="font-weight:normal">City</th>
<th width="200" style="font-weight:normal">State</th>
<th width="550" style="font-weight:normal">Particulars</th>
<th width="200" style="font-weight:normal">Rate</th>
<th width="60" style="font-weight:normal">Qnt / Sqt</th>
...
<td align="center"><?php echo $qrrow[2];?></td>
<td align="center"><?php echo $qrrow[4];?></td>
<td align="center"><?php echo $qname[1];?></td>
<td align="center"><?php echo "";?></td>
<td align="center"><?php echo $qrrow[3];?></td>
<td align="center"><?php echo $qrrow[5];?></td>
<td align="center"><?php echo $qrrow[6];?></td>
<td align="center"><?php echo $qrrow[7];?></td>
<td align="center"><?php echo $qrrow[8];?></td>
<td align="center"><b><u><?php echo $gdeta[0];?></u></b></td>
<td align="center"></td>
<td align="center"></td>
<td align="center"></td>
</tr>
...
$str= 'a';
 ...
 <tr>
 <td colspan="11"></td>
 <td align="center"><b><u><?php echo $gdetca[0];?></u></b></td>
 <td>
...
?>
<tr>
<td colspan="14" align="left"><?php echo no_to_words(round($gdeta[1]));   ?></td>
