...
/*if(chk.value==0)
{
	alert("Please selet service type Authority for this Cordinator");
...
<table>
<tr>
<td width="174" height="35">State : </td>
<td width="293" colspan=2>
<?php
$st=mysqli_query($con,"select state from state order by state ASC");
?>
...
<tr>
<td width="174" height="35"> Location (This branch will be rectified by this location) : </td>
<td width="293" colspan=2>
...
<tr>
<td width="174" height="35">Branch Address : </td>
<td width="293" colspan=2>
<textarea name="bradd"></textarea>
</td>
</tr>
<tr>
<td width="174" height="35">City : </td>
<td width="293" colspan=2>
<input type="text" name="brcity">
</td>
</tr>
<tr>
<td width="174" height="35">Pincode : </td>
<td width="293" colspan=2>
...
<!--<tr>
<td width="174" height="35" valign="top">Service Authority : </td>
<td width="293" colspan=2>
<table width="104%">
...
$cnt=0;
include("config.php");
$qryser=mysqli_query($con,"Select * from servicetype");
while($qryserro=mysqli_fetch_array($qryser))
{
$cnt=$cnt+1;
?>
<tr><td width="100%"><input type="checkbox" name="service[]" id="service<?php echo $cnt; ?>" value="<?php echo $qryserro[0]; ?>" onclick="incre(this.id);" /> <?php echo $qryserro[1]; ?></td></tr>
<?php
}
?>
</table>
