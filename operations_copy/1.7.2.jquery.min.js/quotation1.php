...
if(validate()){
    ...
    $.ajax({
        ...
        data: {partic:partic,partyp:partyp,partqty:partqty,partrate:partrate,partamt:partamt,cust:cust,bank:bank,address:address,city:city,state:state,atm:atm,proj:proj,typ:typ,sv:sv,tcode:tcodearr,uom:uom,svtxarr:svtxarr,unit:unitarr},
        beforeSend: function(){
