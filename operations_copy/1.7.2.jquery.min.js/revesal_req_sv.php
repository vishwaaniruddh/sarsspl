...
<form method="post" action="process_revesal_req_sv.php"> 
	<table>
    	<?php
			$qry1=mysqli_query($con,"select dbtaccno from ebfundtransfers where reqid='".$_REQUEST['reqid']."'");
        ...
        <tr>
        	<td>Transfer From</td>
            <th><?php echo $supro[1]."/ ".$supro[4]."/ ".$supro[2]; ?></td>
    	</tr> 
		<?php
			}
		?>
