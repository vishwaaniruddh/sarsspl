...
$sql.="select s.cust_id,s.atm_id1,s.atm_id2,s.atm_id3,s.bank,s.projectid,s.atmsite_address,s.city,s.state,e.Distributor,e.Consumer_No,e.billing_unit,e.landlord,s.csslocalbranch,s.hsupervisor_name,s.trackerid from ".$cid."_ebill e,".$cid."_sites s where e.atmtrackid=s.trackerid and s.ebill='Y'";
...
<table width="800" border="1" align="center" cellpadding="4" cellspacing="0">
  ...
  <!--<th scope="col"><div align="center">Trackerid</div></th>-->
