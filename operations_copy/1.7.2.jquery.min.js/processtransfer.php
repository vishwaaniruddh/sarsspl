...
$stat='1';
$qry=mysqli_query($con,"INSERT INTO `transfer_req` (`transferid`, `fromcid`, `to`, `atmid`, `handoverdt`, `takeoverdt`, `handoverform`, `takeoverform`, `remarks`, `status`,`trackerid`) VALUES (NULL, '".$fcid."', '".$tcid."', '".$atmid."',STR_TO_DATE('".$hoverdt."','%d/%m/%Y'), STR_TO_DATE('".$toverdt."','%d/%m/%Y'), '".$handover."', '".$takeover."', '".$rem."', '".$stat."','".$_POST['trackerid']."')");
if($qry)
header('location:view_site.php?success=Transfer Request Sent Successfully.');
else
