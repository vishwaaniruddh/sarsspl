...
//alert(qid);
 ...
 window.open('icici_edit_history_tis.php?qid='+qid,'_blank');
...
//alert(qid);
 ...
 window.open('iciciquotedit_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm,'_self');
...
//alert(qid);
 ...
 window.open('icici_approve_det_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm,'_self');
...
//alert(qid);
 ...
 window.open('close_quotation_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm+'&ic=ic','_self');
...
window.open('canc_quotation_tis.php?qid='+qid+'&qoid='+qoid+'&strdt='+strdt+'&endt='+endt+'&atm='+atm+'&ic=ic','_self');
...
$.ajax({
   type: 'POST',    
url:'get_icici_quotdetails_tis.php',
 beforeSend: function()
                   {
