...
xmlhttp.send();
	...
	<center>ATM ID: <input type="text" maxlength="50" size="30" name="atmid" id="atmid" onblur="gethistory('atm_id1',this.value);">&nbsp;&nbsp;&nbsp;    ATM ID2: <input type="text" maxlength="50" size="30" name="atmid2">&nbsp;</center></tr><tr><td width="180">
			 Client :<?php //echo $_SESSION['custid']; ?>
			  <select name="cid" id="cid" onchange="searchById('Listing','1','');getproj(this.value);" ><option value="">select Client</option>
			   ...
			   <?php } ?>   </select></td><td width="255" align="center"> Bank :
			   <?php
			   $bank=array();
			   $zone=array();
...
<?php
 ...
 ?>
</select></td><td width="452">
				&nbsp;Site ID: 
				<input type="text" name="siteid"></td><td width="318"> Site Type: 
			   ...
			   <tr><td valign="middle" align="right" colspan="1">
				 ...
				 <tr><td align="center"> State: <select name="state" id="state" onchange="getcity(this.id);"><option value="">select State</option>
