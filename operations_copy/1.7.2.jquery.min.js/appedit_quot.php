...
if(wbs!="" && appamts=="0"){ alert("please Enter approval Amount");}
else if(vpr!="" && appamts=="0"){ alert("please Enter approval Amount");}
else if(jid!="" && appamts=="0"){ alert("please Enter approval Amount");}
else if(pcode!="" && appamts=="0"){ alert("please Enter approval Amount");}
else if(tno!="" && appamts=="0"){ alert("please Enter approval Amount");}
else if(refno!="" && appamts=="0"){ alert("please Enter approval Amount");}
...
fd.append('svn',svn);
 ...
 <?php if($_GET['supvl']=="") {?>
window.open('quotation_approve.php?qoid=<?php echo $qoid;?>'+'&strdt=<?php echo $sts;?>'+'&endt=<?php echo $ends;?>'+'&oatm=<?php echo $atms;?>','_self');
<?php } else {?>
window.open('sup_view_quot.php?qoid=<?php echo $qoid;?>'+'&strdt=<?php echo $sts;?>'+'&endt=<?php echo $ends;?>'+'&oatm=<?php echo $atms;?>','_self');
<?php }?>
            }           
       });
...
$.ajax({
            url: "process_quotfinal_approval.php",
            type: "POST",
...
<td align="center"><input type="text" name="reqamt" id="reqamt"  value="<?php echo $detrow[13]; ?>" onblur="chckapp();"  <?php if($row[18]=="2" || $row[18]=="1"){ ?> readonly="readonly"  <?php }?> ></td>
</tr>
...
<td align="center"><input type="text" name="wbs" id="wbs"  value="<?php echo $detrow[2]; ?>" <?php if($row[18]=="2" || $row[18]=="1"){ ?> readonly="readonly"  <?php }?> ></td>
</tr>

<tr>
<td width="150">VPR No</td>
<td align="center"><input type="text" name="vpr" id="vpr" value="<?php echo $detrow[3]; ?>"  <?php if($row[18]=="2" || $row[18]=="1"){ ?> readonly="readonly"  <?php }?> ></td>
</tr>

<tr>
<td width="150">JOB ID</td>
<td align="center"><input type="text" name="jid" id="jid" value="<?php echo $detrow[4]; ?>"  <?php if($row[18]=="2" || $row[18]=="1"){ ?> readonly="readonly"  <?php }?> ></td>
</tr>
...
<td align="center"><input type="text" name="pcode" id="pcode" value="<?php echo $detrow[5]; ?>" <?php if($row[18]=="2" || $row[18]=="1"){ ?> readonly="readonly"  <?php }?> ></td>
</tr>

<tr>
<td width="150">Ticket Number</td>
<td align="center"><input type="text" name="tno" id="tno"  value="<?php echo $detrow[14]; ?>" <?php if($row[18]=="2" || $row[18]=="1"){ ?> readonly="readonly"  <?php }?> ></td>
</tr>

<tr>
<td width="150">Reference Number </td>
<td align="center"><input type="text" name="refno" id="refno" value="<?php echo $detrow[15]; ?>" <?php if($row[18]=="2" || $row[18]=="1"){ ?> readonly="readonly"  <?php }?> ></td>
</tr>
