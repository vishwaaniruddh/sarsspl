...
<?php
	...
	$qry.="and id in(select qid from quotation_approve_details_tis where po='".$_POST['pono']."' ) ";
	  }  
...
//echo $qry;
	...
	while($row=mysqli_fetch_array($qrys))
	{
	   ...
	   $getamt=mysqli_query($con,"select sum(amt) from icici_quot_details_tis where qid='".$row[0]."'");
	  ...
	  $mdrow=mysqli_fetch_array($mdby);
         ...
         $podet=mysqli_query($con,"select po from quotation_approve_details_tis where qid='".$row[0]."'");
...
$qdetc=mysqli_query($con,"select * from icici_quot_details_tis where qid='".$row[0]."'");
...
<td  align="center" width="150">
 <?php echo $porow[0];?>
	 ...
	 <td  align="center" width="150">
	    ...
	    <td  align="center" width="150">
	    <?php 
                $chnewq=mysqli_query($con,"select req_amt from quotation_approve_details_tis where qid='".$row[0]."'");
