...
<?php 
   // if($location = "/blog_detail8.php"){ ?>
        <!--<meta property="og:image" content="https://sarsspl.com/assets/images/blogs/8.png">-->
   <? //}else { ?>
        <!--<meta property="og:image" content="https://sarsspl.com/assets/images/logo/headlogo.png">-->
    <? //}
?>
<!--<meta property="og:image" content="https://sarsspl.com/assets/images/logo/headlogo.png">-->
<meta property="og:image" content="https://sarsspl.com/assets/images/blogs/8.png">
