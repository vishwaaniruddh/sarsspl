...
if(WindowObjectReference == null || WindowObjectReference.closed)
{
 ...
 WindowObjectReference=window.open('viewinvoicehistory.php?send_id='+num,'MyWindow','scrollbars,width=500,height=250,left='+left+',top='+top);
}
else
{
	WindowObjectReference=window.open('viewinvoicehistory.php?send_id='+num,'MyWindow','width=500,height=250,left='+left+',top='+top);
...
ppg=document.getElementById().value;
