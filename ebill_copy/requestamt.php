			...
			<table>
				...
				<tr>
					...
					<td>
						...
						$tp = mysqli_query($con, "select `deptid`, `desc` from department where deptid<>'1' AND deptid<>'4'");
				...
				<tr>
					...
					<td colspan="2" align="center">
						...
						<input type="submit" name="submit"
							id="submit"><!--<a href="javascript:if(confirm('Close window?'))window.close()">cancel</a>-->
