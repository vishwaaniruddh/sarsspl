        ...
        function PrintDiv1() {    
           ...
           popupWin.document.write('<html><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
            popupWin.document.close();
				 ...
				 function PrintDiv2() {    
           var divToPrint = document.getElementById('page4');
           var popupWin = window.open('', '_blank', 'width=800,height=500');
           popupWin.document.open();
           popupWin.document.write('<html><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
            popupWin.document.close();
           ...
           popupWin.document.write('<html><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
            popupWin.document.close();
                  ...
                  function PrintDiv4() {    
           var divToPrint = document.getElementById('page5');
           var popupWin = window.open('', '_blank', 'width=800,height=500');
           popupWin.document.open();
           popupWin.document.write('<html><body onload="window.print()">' + divToPrint.innerHTML + '</html>');
            popupWin.document.close();
...
$currentdate=date('Y-m-d');
    ...
    $getgstnumos=mysqli_query($con,"select * from gst_no_os where state ='Maharashtra'");
        ...
        if($getgstnumosf[2]=="" or $sttcodef[2]=="na"){
    
    $sttcodemhgst=mysqli_query($con,"select * from gst_no_os where State like '%Maharashtra%'");
$sttcodemhgstf=mysqli_fetch_array($sttcodemhgst);
$statenamegst=$sttcodemhgstf[1];
$gstcodegst=$sttcodemhgstf[2];
$statenamesttcode=$sttcodemhgstf[9];   
}else{
  $statenamegst=$getgstnumosf[1];
$gstcodegst=$getgstnumosf[2];  
 $statenamesttcode=$getgstnumosf[9];   
}
...
<table width="850" cellpadding="0" cellspacing="0">
  ...
  <tr height="17">
   ...
   echo  $invro[5]; ?>
    ...
    <div align="right">Date :- <?php echo date("d-F-Y",strtotime($invro[3])); ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
    </br>
    </br></br></br>
    GSTIN Number : <?php echo $getgstnumosf[2];?>
...
<table cellspacing="0" cellpadding="0" border='1'>
    <?php
//echo "select * from fis_gst where State like '%".$addrow1[8]."%'";
  $sndbillqry=mysqli_query($con,"select * from send_bill where send_id='".$_GET['invid']."' ");
   
     $sndbillqryf=mysqli_fetch_array($sndbillqry);
$sttcode=mysqli_query($con,"select * from fss_gst where State like'%".$sndbillqryf['state']."%'");

//echo "select * from fss_gst where State like'%".$sndbillqryf['state']."%'";
$sttcodef=mysqli_fetch_array($sttcode);
$statename="";
$gstcode="";

if($sttcodef[3]=="" or $sttcodef[3]=="na"){
    
    $sttcodemh=mysqli_query($con,"select * from fss_gst where State like '%Maharashtra%'");
$sttcodefmh=mysqli_fetch_array($sttcodemh);
$statename=$sttcodefmh[1];
$gstcode=$sttcodefmh[3];
}else{
  $statename=$sttcodef[1];
$gstcode=$sttcodef[3];  
...
?>
    ...
    <tr>
        <td colspan=2 rowspan=5 align="center"><img src="images/or_logo.jpg"></td>
        <td colspan=14 align="center"><b>Invoice</b></td>
      
    </tr>
     <tr>
        <td colspan=14 rowspan="" align="center">
            <b>CLEAR SECURED SERVICES PRIVATE LIMITED</b>
       </td>
       </tr>
     <tr>
       <td colspan=14 align="center">
      <b>D-201, RUNWAL & OMKAR ESQUARE,NEAR SION FORT SION (EAST), MUMBAI-400022</b>
      </td>
      </tr>
     <tr>
       <td colspan=14 align="center">
      Mail Id:- ssharma@cssindia.in,  Contact No:+91-22-24022435
      </td>
      </tr>
     <tr>
       <td colspan=14 align="center">
     Mail id:- dattatrayp@cssindia.in  Contact no:- 7718899311
    ...
    <tr>
        ...
        <td colspan=8 align="center"><b>Details Of Consignee</b><br/>
        </td>
    </tr>  
    <tr>
        <td colspan=8  align="" rowspan= >
            GSTIN Number : <?php echo $sttcodef[3]; ?><br/>
            Tax is Payable On Reverse charges : (Y / N) : N<br/>
           <!-- Invoice Serial Number : <?php echo $sndbillqryf['invoice_no']; ?><br/>-->
           Invoice Serial Number : <?php echo $sndbillqryf['invoice2']; ?><br/>
            Invoice Date : <?php echo date("d-F-Y",strtotime($invro[3])); ?><br/>
        </td>
       
        <td colspan=8 rowspan= align="center">
            Transportation Mode : (Apply for Supply of Goods Only)<br/>
            Veh No :<br/>
            Date & Time of Supply : <br/>
            Place Of Supply : Thane, Maharastra <br/>
    ...
    <tr>
        ...
        <td colspan=8  align="" > 
            Name : M/s Financial Software and Systems Private Limited<br/>
            Address :<?php echo $sttcodef[6]; ?><br/>
           State : <?php echo $sttcodef[1]; ?><br/>
           
            State Code :  <?php echo $sttcodef[2]; ?><br/>
            GSTIN  NO:  <?php echo $sttcodef[3]; ?><br/>
        </td>
       <?php 
        
        ?>
        <td colspan=8  align="" > 
            Name : CLEAR SECURED SERVICES PRIVATE LIMITED<br/>
            Address : <?php echo  $getgstnumosf['address']; ?><br/>
           State : <?php echo  $statenamegst; ?> <br/>
           
            State Code :<?php echo $statenamesttcode; ?><br/>
            GSTIN  NO: <?php echo  $gstcodegst; ?><br/>
        </td>
    </tr>
    <tr>
     ...
     <tr>
        <td colspan=0 align="center" >S.No.</td>
        <td colspan=2 align="center">Description of Services
</td>
        <td colspan=0 align="center">SAC Code (GST)</td>
        <td colspan=0 align="center">Qty.</td>
        <td colspan=0 align="center">UOM</td>
        <td colspan=0 align="center">Rate</td>
        <td colspan=0 align="center">Total</td>
        <td colspan=0 align="center">Discount</td>
        <td colspan=0 align="center">Taxable Amount</td>
        <td colspan=0 align="center">Rate</td>
        <td colspan=0 align="center">Amt.</td>
        <td colspan=0 align="center">Rate</td>
        <td colspan=0 align="center">Amt.</td>
        <td colspan=0 align="center">Rate</td>
        <td colspan=0 align="center">Amt.</td>
      ...
      <?php 
          ...
          $i=1;
          $sndbillqrydtls=mysqli_query($con,"select sum(srvchrg),sum(discon_chrg),count(send_id) from send_bill_detail where send_id='".$_GET['invid']."' and status=0 ");
    ...
    ?>
     <tr>
        ...
        <td colspan=2 align="" width="200px">Service charged towords electricity bill paid for <?php echo $projid;?> SITE ATM</td>
        <td colspan=0 align="center">998599</td>
        ...
        <td colspan=0 align="right"><?php echo $sndbillqrydtlsf[0]; ?></td>
          <td colspan=0 align="right"><?php echo $sndbillqrydtlsf[1]; ?></td>
         
        <td colspan=0 align="right"><?php $ttltax=$sndbillqrydtlsf[0]-$sndbillqrydtlsf[1]; echo $ttltax; ?>
     ...
     <tr>
        ...
        <td colspan=0 align="center"></td>
        <td colspan=0 align="center"></td>
         <td colspan=0 align="right">Rs.<?php echo $ttltax; ?></td>
        <td colspan=0 align="center"></td>
        <td colspan=0 align="right">Rs.<?php echo $cgstamt; ?></td>
        <td colspan=0 align="center"></td>
         <td colspan=0 align="right">Rs.<?php echo $sgstamt; ?></td>
        <td colspan=0 align="center"></td>
         <td colspan=0 align="right">Rs.<?php echo $igstamt; ?></td>
        
        
    </tr>
      <tr>
      
        <td colspan="11"  align="center" > Invoice Value (In Words )</td>
       
        <td colspan="4"  align="center">Total </td>
         <td colspan=0 align="right"><?php echo $sndbillqryf['servchrg']; ?></td>
    </tr>
    <tr>
        <td colspan=11 rowspan=5 align="center" > <?php $st=int_to_words(round( $sndbillqryf['servchrg'])); echo $st." Only /-";

 ?></td>
        <td colspan=4 align="center">Freight Charges</td>
        <td colspan=0 align="center">0</td>
       
        
    </tr>
    <tr>
        <td colspan=4 align="center">Loading & Packing Charges</td>
        <td colspan=0 align="center">0</td>
        
        
    </tr>
     <tr>
      <td colspan=4 align="center">Insurance cahrges</td>
        <td colspan=0 align="center">0</td>
        
    </tr>
    <tr>
       <td colspan=4 align="center">Others charges</td>
        <td colspan=0 align="center">0</td>
        
        
    </tr>
    <tr>
       <td colspan=4 align="center">Invoice Total</td>
        <td colspan=0 align="right"><?php echo $sndbillqryf['servchrg']; ?></td>
    ...
    <tr>
        ...
        <td colspan="11"  align="center" >Amount of Tax Subject to Reverse charges </td>
       
        <td colspan="" rowspan="" align="center">NA </td>
     ...
     <tr>
       <td colspan=8 align="center">Certified that the particulars given above are ture & Correct</td>
        <td colspan=8 align="center">Electronic  Reference  charges</td>
    ...
    <tr>
       <td colspan=8 align="center">YOUR TERM & CONDITION OF SALE</td>
        <td colspan=8 align="center">vendor name</td>
        
        
    </tr>
    <tr>
       <td colspan=8 align="center">1: All payment should be made by Demand Draft/Pay Order/Crossed Chque drawn in favour of <br/>
         Vendor Name. The company will not be responsible/<br/>
           liable for any payment made to any other payee at paid except through specified instrument <br/>
           2: Payment should be released within 15 days of receipt of this bill or else, interest @ 24% P.A<br/>
           Would be levied. The interest once leived will not be waived under any circumstances.<br/>
           </td>
        <td colspan=8 align="">
        <table border="0" width="100%">
            ...
            <tr>
                ...
                <td align="">Dattatray Phatak <br/>
                </td>
            
            </tr>
            <tr>
                <td align="">Designation :<br/>
                </td>
                
                <td align="">E-Bill Executive<br/>
                </td>
...
?>
    ...
    <tr>
        <td colspan=2 rowspan=5 align="center"><img src="images/or_logo.jpg"></td>
        <td colspan=14 align="center"><b>DEBIT NOTE</b></td>
    ...
    ?>
     <tr>
        <td colspan=0 align="center" ><?php echo $i; ?></td>
        <td colspan=2 align="" width="200px">Service charged towords electricity bill paid for <?php echo $projid;?> SITE ATM</td>
        <td colspan=0 align="center">N/A</td>
        <td colspan=0 align="right"><?php echo $cb; ?></td>
        <td colspan=0 align="right"><?php echo "SITES"; ?></td>
        <td colspan=0 align="right"><?php echo ""; ?></td>
        <td colspan=0 align="right"><?php echo $annextotmt; ?></td>
          <td colspan=0 align="right"><?php echo ""; ?></td>
         
        <td colspan=0 align="right"><?php echo $annextotmt; ?>
    ...
    <tr>
        <td colspan=11 rowspan=5 align="center" > <?php
       
        
        $st=int_to_words(round($annextotmt)); echo $st." Only /-";
			...
			function formatTwoDecimals($value, $trim)
{
  ...
  <tr height="20">
    <td width="208" height="20" colspan="2" align="left" >&nbsp;&nbsp;&nbsp;&nbsp;Bill Date :- <?php echo date("d-F-Y",strtotime($invro[3])); ?>
    
      <br/>
    <br/><br/>
    <div align="right"> <?php echo "GSTIN/Unique ID:".$getgstnumosf['gst'];?> 
    </div>
...
<tr><td style="align:left;">GSTIN/Unique ID :- </td>
<td>27AAACF2351C1Z7</td>
</tr>
</table>
...
<tr>
    ...
    <td colspan="4" align="right">CGST </td>
...
<tr>
    ...
    <td colspan="4" align="right">SGST</td>
...
<tr>
  ...
  <td colspan="4" align="right"><b>Grand Total </b></td>
    ...
    echo number_format(round($nwtt),2); ?></td>
