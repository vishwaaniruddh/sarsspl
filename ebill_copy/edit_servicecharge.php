...
xmlhttp.onreadystatechange=function()
  ...
  if (xmlhttp.readyState==4 && xmlhttp.status==200)
    ...
    document.getElementById("charges").value=xmlhttp.responseText;
    document.getElementById("id").value=val;
    document.getElementById("old_amt").value=xmlhttp.responseText;
    
    }
  }
 // alert("process_servicecharge.php?val="+val);
xmlhttp.open("GET","process_servicecharge.php?val="+val,true);
xmlhttp.send();
...
<div align="center">
  ...
  <h2 class="style1">Edit service Chage</h2>

</div><br /><br />

<form id="form1" name="form1" method="post" action="proceess_edit_chage.php" onsubmit="validate1(this)" >
 <table width="375" border="1" align="center" cellpadding="4" cellspacing="0">

  <?php
		$sql = "SELECT * FROM `ebillcharges` where 1" ;
  ...
  <tr>
    ...
    <td>
    <div align="left">
    	<select name="cid" id="cid" onchange="getdata(this.value);" >
    		<option value="-1">-- select --</option>
    	<?php 
           while($row = mysqli_fetch_row($result)){
                     $cust = $row[0] ;?>
              <option value="<?php echo $row[8] ; ?>" ><?php echo $row[0]." (".$row[6].")"." (".$row[7].")" ; ?></option>
    ...
    <td><div align="center">Charges</div></td>
...
<tr>
    ...
    <input type="hidden" name="old_amt" id="old_amt" value="" >
