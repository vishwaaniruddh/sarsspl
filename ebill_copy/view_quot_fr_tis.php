...
<option value="4" <?php if($typr=='4'){ echo "selected"; } ?>>Rnm Delhi approval pending</option>
<option value="2" <?php if($typr=='2'){ echo "selected"; } ?>>Closed</option>
<option value="10" <?php if($typr=='10'){ echo "selected"; } ?>>Rejected</option>

<option value="100" <?php if($typr=='100'){ echo "selected"; } ?>>Archieved Old</option>
<option value="101" <?php if($typr=='101'){ echo "selected"; } ?>>Archieved</option>
...
<option value="628" >rnmdelhi</option>
