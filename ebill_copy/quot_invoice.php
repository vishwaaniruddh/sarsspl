...
$.ajax({
   type: 'POST',    
url:'search_invoiceannex.php',
 beforeSend: function()
                   {
        
                  document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
                  },
data:'cid='+cid+'&sdate='+sdate+'&edate='+edate+"&atmid="+atmid+"&qid="+qid+'&perpg='+perp+'&Page='+Page+'&bank='+bank+'&accname='+accname+'&project='+proj+'&state='+state,
success: function(msg){
...
function getproject(cst)
{
   ...
   xmlhttp.open("GET","../operations/getprojquot.php?val="+cst,true);
   xmlhttp.send();
...
<tr>
<th width="75">
<select name="cid" id="cid" onchange="getaccm(this.value);getbank(this.value);">
