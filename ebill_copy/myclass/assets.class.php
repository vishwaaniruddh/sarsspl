...
$sql = mysqli_query($con,"INSERT INTO `satyavan_accounts`.`assets_specification` (`assets_id`, `name`,`company_name`) VALUES ('".$this->assets."',  '".$this->spec."', '".$this->cmp."')");
