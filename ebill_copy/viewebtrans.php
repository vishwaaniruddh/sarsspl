...
//echo "select * from ebfundtransfers where chqno='".$tid."' and status=0";
       $tra=mysqli_query($con,"select * from ebfundtransfers where chqno='".$tid."' and status=0");
...
<tr><td width="600" >TO	</td><td>			<B>DATE :- <?php echo date('d-m-Y',strtotime($traro[3])); ?></B>	</td></tr>
...
<tr><td width="600" ></td><td>			</td></tr>																				
<tr><td width="600" >Please debit  on my a/c No. <?php echo $traro[7]; ?> & my account recognised as</td><td>			</td></tr>													
...
$qry1=mysqli_query($con,"select distinct(accid) from ebfundtransfers where chqno='$tid' and status=0 and accid<>90");
$ct=1;
...
$qry2=mysqli_query($con,"select sum(approvedamt) from ebillfundrequests where req_no in(select reqid from ebfundtransfers where chqno='$tid' and accid='$qrrow[0]' and status=0)");
...
<?php
 ...
 $qry3=mysqli_query($con,"select accid,reqid,narration from ebfundtransfers where chqno='$tid' and accid=90 and status=0");
//$ct=1;
...
$qry3=mysqli_query($con,"select approvedamt from ebillfundrequests where req_no ='".$qrrow3[1]."'");
