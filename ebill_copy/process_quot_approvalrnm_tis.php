...
$qryins = mysqli_query($con, "update quotation_approve_details_tis set filename='" . $image_name . "',app_amt='" . $appamt . "',req_amt='" . $reqamt . "',approved_date='" . $appdate . "',app_by='" . $appby . "',remark='" . $rem . "',ticket_no='" . $ticket . "' where qid='" . $qid . "'");
