...
//echo $_SESSION['branch'];
 ?></center>
<div align="center">
  <h2 class="style1">Upload data with rates</h2>
</div><br /><br />
<form id="form1" name="form1" method="post" action="processservicerate.php" onsubmit="return validate1(this)" enctype="multipart/form-data" >
 <table width="200" border="1" align="center" cellpadding="4" cellspacing="0">
  ...
  <tr><td colspan="2">Rate are compulsory where services are 'Y'
</td></tr>
