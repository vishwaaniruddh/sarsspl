...
if ($num > 0) {
	...
	$upqry = mysqli_query($con, "Update quotation_details_tis SET `description`='" . $pr . "',`quantity`='" . $prc . "',`rate`='" . $rate . "',`total`='" . $amt . "',tcode='" . $tcode . "',uom='" . $descdet . "' where id='" . $detailid . "' and qid='" . $qid . "'");
