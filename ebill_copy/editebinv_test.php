...
xmlhttp.open("GET","reminvsite_test.php?id="+id+"&tbl=send_bill_detail&stat=1&field=detail_id",true);
xmlhttp.send();
}
  }
...
<tr>
<td colspan="3" align="right">Service Tax@12%<?php
...
<td colspan="3" align="right"> Education Cess @2%</td><td align="right"><?php echo formatTwoDecimals($ec, "."); ?></td></tr>
<td colspan="3" align="right">Secondary &amp; Higher Education Cess    @1%</td><td align="right"><?php echo formatTwoDecimals($shec, "."); ?></td></tr>
<tr>
