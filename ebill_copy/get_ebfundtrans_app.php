...
?>
	<tr>
        ...
        <?php
			...
			{
		?>
        <td><form method="post" name="ebform" action="process_ebfundtrans_app.php"><input type="hidden" name="reqid" value="<?php echo $ebfundreq['req_no']; ?>"/><input type="submit" value="Approve" name="sub"/></form></td>
        <td><form method="post" name="ebform" action="process_ebfundtrans_rej.php"><input type="hidden" name="reqid" value="<?php echo $ebfundreq['req_no']; ?>"/><input type="submit" value="Reject" name="sub"/></form></td>
        <?php
			}
		?>
    </tr>
