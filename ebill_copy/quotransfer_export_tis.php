...
//ini_set('max_execution_time', 123456);
 $tamt="";
if($rowarr[2]=='ICICI' || $rowarr[2]=='RATNAKAR' || $rowarr[2]=='ICICI_Direct' || $rowarr[2]=='Knight_Frank' || $rowarr[2]=='BajajFinance' || $rowarr[2]=='kotak')
{
...
$stat="";
 ...
 $stat="Pending";
  ...
  $gqhis=mysqli_query($con,"select * from quotation_close_detail_tis where qid='".$rowarr[0]."'");
   ...
   $greamt=mysqli_query($con,"select req_amt from quotation1_req_tis where qid='".$rowarr[0]."'");
...
$trandate=mysqli_query($con,"select * from  quotation1ftransfers_tis where qid='".$rowarr[0]."'");
