...
<?php 
 ...
 $qry1=mysqli_query($con,"select cust,quot_id from quotation1 where id='".$qid."'");
...
$str="select * from quotation_edit_history where qid='".$qid."'";
...
<tr>
 ...
 <td align="center"><?php if($hrow[10]==""){ echo "";}else
  {
 ?>
 <a href='../operations/quotuploads/<?php echo $hrow[10]; ?>' download>Download</a>
 <?php
 }
 ?>
 </td>
