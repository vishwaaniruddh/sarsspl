...
//xmlhttp.send();
	...
	//alert(m_dat);
	if(m_atm!='' && m_cust!=''){
var dat="cust="+m_cust+"&consumer="+m_consumr+"&trckid="+m_trackerid+"&distri="+m_dist+"&duedt="+m_due+"&land="+m_land+"&billunit="+m_billunit+"&mtr="+m_meter+"&atm="+m_atm;
//alert(dat);
...
xmlhttp.open("GET","chkbilldt2.php?cid="+cid+'&atmid='+atmid+'&trackid='+trackid+'&billdt='+bill_date+'&frmdt='+frmdt+'&todt='+todt+'&duedt='+duedt,true);
xmlhttp.send();
//alert("chkbilldt2.php?cid="+cid+'&atmid='+atmid+'&trackid='+trackid+'&billdt='+bill_date+'&frmdt='+frmdt+'&todt='+todt+'&duedt='+duedt);
  }
...
if(openre!='' && closr!='')
{
document.getElementById('unit').value=(closr-openre);
}
}
</script>
</head>
...
<center><input type="hidden" name="bank" id="bank" /><input type="text" name="err" id="err" readonly="readonly" /></center>
