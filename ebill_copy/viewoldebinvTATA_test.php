...
$currentdate=date('Y-m-d');
   ...
   $sttcode=mysqli_query($con,"select * from tata_gst where State like'%".$sndbillqryf['state']."%'");
...
if($sttcodef[2]=="" or $sttcodef[2]=="na"){
    ...
    $sttcodemh=mysqli_query($con,"select * from tata_gst where State like '%Maharashtra%'");
...
<tr>
  ...
  <td colspan="4" align="right"><b>Grand Total</b></td>
    ...
    $nwtt=$svgsistotrw[0]+$svgsistotrw[1]+$svgsistotrw[2]+$to;
    ?>
    <td align="right"><?php echo $nwtt; ?></td>
