...
$gpartm=mysqli_query($con,"select * from quotation_details_tis where particular='".$gdeta[0]."' and qid='".$qid."' limit 0,1");
...
$gpartm2=mysqli_query($con,"select * from quotation_details_tis where particular='".$gdetca[0]."' and qid='".$qid."' limit 0,1");
