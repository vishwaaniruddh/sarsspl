    ...
    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post">
        ...
        <table width="291" align="center">
            ...
            <tr>
                ...
                <td width="175"><input name="uname" type="text" value="<?php if (isset($_POST['uname'])) {
                    echo $_POST['uname'];
                } ?>" /></td>
    ...
    <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" name="custform" id="custform">
        ...
        <table>
            ...
            <tr>
                ...
                <td height="35"><input type="button" value="submit" class="readbutton" name="addnewcust"
                        onclick="validate()" /></td>
...
function ServiceForm($ref, $user)
{
    ...
    if ($ref != '' || $ref != NULL) {
        ...
        $re = mysqli_query($con, "select * from Amc where Ref_id='" . $ref . "' limit 1");

        $refid = mysqli_fetch_row($re);

    }

    $qry2 = mysqli_query($con, "select srno from login where username='" . $user . "'");
...
<td valign="top">Reason:<textarea name="how" id="how" /></textarea></td>
                    ...
                    <td>Select PO NO:
                        ...
                        <select name="po" onchange="PO(this.value);" id="po_no">
                            ...
                            <?php if (isset($_POST['po'])) {
                                ...
                                <option value="<?php echo $_POST['po']; ?>">
                                    <?php echo $_POST['po']; ?>
                                </option>
                    ...
                    <td colspan="3" id="reference">
                        ...
                        <select name="ref" id="ref" onchange="">
                            ...
                            <?php if (isset($_POST['ref'])) {
                                ...
                                <option value="<?php echo $_POST['ref']; ?>">
                                    <?php echo $_POST['ref']; ?>
                                </option>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" name="bank" id="bank" value="<?php if (isset($_POST['bank'])) {
                        echo $_POST['bank'];
                    } ?>" readonly /></td>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" name="state" id="state" value="<?php if (isset($_POST['state'])) {
                        echo $_POST['state'];
                    } ?>" readonly /></td>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" name="city" id="city" value="<?php if (isset($_POST['city'])) {
                        echo $_POST['city'];
                    } ?>" readonly /></td>
                ...
                <tr>
                    ...
                    <td colspan="3"><textarea name="add" id="add" readonly rows=5 cols=25 />
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" name="pin" id="pin" value="<?php if (isset($_POST['pin'])) {
                        echo $_POST['pin'];
                    } ?>" readonly /></td>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" name="area" id="area" value="<?php if (isset($_POST['area'])) {
                        echo $_POST['area'];
                    } ?>" readonly /></td>
...
<td><input type="text" name="adate" id="adate" onclick="displayDatePicker('adate');" value="<?php if (isset($_POST['adate'])) {
            echo $_POST['adate'];
        } else {
            echo date('d/m/Y');
        } ?>" /></td>
                ...
                <tr>
                    ...
                    <td colspan="3"><textarea rows="4" cols="28" name="prob" id="prob"> <?php if (isset($_POST['prob'])) {
                        echo $_POST['prob'];
                    } ?></textarea></td>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" name="cname" id="cname" value="<?php if (isset($_POST['cname'])) {
                        echo $_POST['cname'];
                    } ?>" /></td>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" name="cphone" id="cphone" value="<?php if (isset($_POST['cphone'])) {
                        echo $_POST['cphone'];
                    } ?>" /></td>
                ...
                <tr>
                    ...
                    <td colspan="3"><input type="text" name="cemail" id="cemail" value="<?php if (isset($_POST['cemail'])) {
                        echo $_POST['cemail'];
                    } ?>" /></td>
                ...
                <div id="pcbdiv" style="display:none">
                    ...
                    <tr>
                        <td>Approved By:</td>
                        <td colspan="3"><input type="text" name="appby" id="appby" value="<?php if (isset($_POST['appby'])) {
                            echo $_POST['appby'];
                        } ?>" /></td>
                    </tr>
                    <tr>

                        <td valign="top">Refrence:</td>
                        <td colspan="3"><textarea name="how" id="how" />
                            <?php if (isset($_POST['how'])) {
                                echo $_POST['how'];
                            } ?></textarea>

                            <input type="hidden" name="pcbpres" id="pcbpres" value="<?php if (isset($_POST['pcbpres'])) {
                                echo $_POST['pcbpres'];
                            } ?>" />
...
function RefForm()
{
    ...
    Enter Atm ID : <input type="text" name='re' id="re" value="<?php echo $_POST['re']; ?>">&nbsp;&nbsp;<input type="button"
        name="refsub" value="Get Detail" onClick="GetRef('re')">
