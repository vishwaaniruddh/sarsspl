						...
						<table>
							...
							<tr>
								...
								<td width="171"><select id="assets" name="assets">
										...
										<?php $qry = mysqli_query($con, "select * from assets");

										while ($assets = mysqli_fetch_row($qry)) {

											?>

											<option value="<?php echo $assets[0]; ?>">
												<?php echo $assets[1]; ?>
											</option>
							...
							<tr>
								...
								<td><input type="text" name="spec" id="spec" value="<?php if (isset($_POST['spec'])) {
									echo $_POST['spec'];
								} ?>" /></td>
							...
							<tr>
								...
								<td><input type="text" name="cmp" id="cmp" value="<?php if (isset($_POST['cmp'])) {
									echo $_POST['cmp'];
								} ?>" /></td>
						...
						<tr>
							...
							<td>
								...
								<div id="collapse1" style="display:none">
									...
									<p>
									<form action="process_assets.php" method="post">

										Assets Name: <input type="text" id="ass_name" name="ass_name" /> <input
