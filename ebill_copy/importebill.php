...
//echo $_SESSION['branch'];
 ?></center>
  <h2 class="style1">Upload Paid Ebills</h2>
</div><br /><br />
<center>
<form id="form1" name="form1" method="post" action="processimport.php" onsubmit="return validate1(this)" enctype="multipart/form-data" >
 <table border="1">
 
 <tr><td>Select *.xls File to Import :</td><input type="file" name="userfile" id="userfile" /></tr>
 <tr><td>Format:</td><td>Atm id, Consumer Number, From Date, To Date, Billdate, Duedate, Paid Date, Opening Reading, Closing Reading, Units, Paid Amount, Extra Charge, Total Amount,Customer ID</td></tr>
 <tr><td colspan="2"><input type="submit" name="cmdsub" id="cmdsub" /></tr>
 </table>
