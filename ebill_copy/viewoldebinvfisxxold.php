...
<table border='0'>
   <tr>
     <td>Being Electricity Bill Payment  services provided at various ATM sites during the month of  <?php echo date("M-Y",strtotime($invro[3])); ?> as per enclosure. 					
</td>
  
<?php

 $n1sql = "select atm_id from send_bill_detail where send_id='".$_GET['invid']."'";
  //echo $n1sql;
