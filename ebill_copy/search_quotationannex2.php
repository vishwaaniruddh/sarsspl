...
if($_POST['sdate']!='' & $_POST['edate']!='')
 ...
 $qry="Select * from quotation1 where ((status='a' or status='app') and category='a') ";
...
<th width="75">Final Approval Amount</th>
...
}else
{
    ...
    <span id="spn<?php echo $srn;?>"></span>
    <input type="text" id="invno<?php echo $srn;?>"></br>
    <button type="button" id="invbtn<?php echo $srn;?>" onclick='updtinvfunc("<?php echo $row[0];?>",this.id,"invno<?php echo $srn;?>","spn<?php echo $srn;?>")'>Submit</button>
