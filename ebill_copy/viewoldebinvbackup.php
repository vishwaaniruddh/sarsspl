...
$invro=mysqli_fetch_row($inv);
 ?>
<center><?php if( $_SESSION['designation']=='7' && $invro[10]=='0'){ 
...
?>
 <td><a href="#" onclick=canceleinv('<?php echo $invro[0]; ?>','<?php echo $invro[1]; ?>')>Cancel this invoice</a></td>&nbsp;&nbsp;&nbsp;<a href="editebinv.php?invid=<?php echo $_GET['invid']; ?>&yr=<?php echo $_GET['yr']; ?>"> Edit This Invoice</a>&nbsp;&nbsp;&nbsp;
