...
{     
  ...
  $.ajax({
            url: "process_quot_approvalrnm_tis.php",
            type: "POST",
            data: fd ,
            contentType: false,
            cache: false,
...
window.open('appedit_quotrnm_tis.php?qid='+qid,'_self');
...
<td><input type="file" name="email_cpy" id="email_cpy" >  <?php if($detrow[8]!=""){ ?>  <a href='../operations/quotuploads_tis/approve/<?php echo $detrow[8]; ?>' download>Download</a>  <?php }?>
