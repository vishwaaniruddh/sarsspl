...
?>
          ...
          $sql="SELECT contact_first, short_name FROM contacts where type='c' and short_name in (select distinct(cust_id) from ebillfundrequests where print='y')";
