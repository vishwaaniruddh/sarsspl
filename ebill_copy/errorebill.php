...
<body onLoad="searchById('Loading','1','')">
	...
	<div class="fixed">
		...
		<center>
			...
			<button id="myButtonControlID" onClick="tableToExcel('custtable', 'Table Export Example')">Export Table data
				into Excel</button>
			...
			<table border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
					...
					<th width="75">
						...
						$cl = mysqli_query($con, "select short_name,contact_first from contacts where short_name in (select distinct(cid) from uploadedebillerr where status='2') and type='c'");
						...
						<select name="cid" id="cid" onchange="searchById('Listing','1','');">
							...
							while ($client = mysqli_fetch_array($cl)) {
					...
					<th width="75"><input type="text" size="15" name="id" id="id"
							onkeyup="searchById('Listing','1','');" placeholder="consumer no" /></th>
					...
					<th width="75"><input type="text" name="sdate" id="sdate" onclick="displayDatePicker('sdate');"
