...
try {
	...
	//echo $sql;
	if (isset($_POST['services4'])) {
		$res = mysqli_query($con, "select * from " . $cid1 . "_ebill where atmtrackid='" . $_POST['trackid'] . "'");
		...
		mysqli_query($con, "update " . $cid1 . "_sites set ebill='N' where atm_id1='$atmid1'");
	}
