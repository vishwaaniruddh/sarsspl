...
<center><a href="editebinv.php?invid=<?php echo $_GET['invid']; ?>"> Edit This Invoice</a>&nbsp;&nbsp;&nbsp;
...
<form method="post" action="showEbill.php" ><table border="1" width="900px"><thead>
  <tr>
    <th><div align="center" style="width: 28px;">Sr No. </div></th>
      <th><div align="center" style="width: 40px;">Project ID </div></th>
    <th><div align="center" style="width: 40px;"  >BANK</div></th>
    <th><div align="center" style="width: 60px;"  >ATM ID</div></th>
      <th><div align="center" style="width: 60px;"  >SITE ID</div></th>
       <th>
         <div align="center" style="width: 70px;"  >CONSUMER NO.</div>       </th> 
        
    <th align="center"><div align="center" style="width: 270px;"  >LOCATION</div></th>
  
    <th colspan="2"><div align="center" style="width: 110px;"  >BILLING PERIOD </div></th>       
   
    <th><div align="center" style="width: 55px;"  >PAID DATE</div></th>  
     <th><div align="center" style="width: 55px;"  >BILL DATE </div></th>
        <th><div align="center" style="width: 40px;"  >UNITS</div></th> 
        
    <th><div align="center" style="width: 72px;"  > AMOUNT IN INR</div></th>   
		...
		//echo "select location,site_id,bank from ".$cid."_sites where trackerid='$annr[1]'";
		    $res=mysqli_query($con,"select location,site_id,bank,atm_id1,projectid,atmsite_address from ".$cid."_sites where trackerid='$annr[2]'");
			 ...
			 $month=date('F',strtotime($row1[7]));	
				 ...
				 //echo $row3[2];
	?>
		 <tr height="20"><td align="center"><div align="center" style="width: 28px;"><?php echo $ij; ?></div></td>
		 <td align="center"><div align="center" style="width: 40px;"><?php echo $rows[4]; ?></div></td>
         <td align="center"><div align="center" style="width: 40px;"><?php echo $rows[2]; ?></div></td>
		     <td align="center"><div align="center" style="width: 60px;"><?php echo $rows[3]; ?></div></td>
             <td align="center"><div align="center" style="width: 60px;"><?php echo $rows[1]; ?></div></td>
             <td align="center"><div align="center" style="width: 70px;"><?php echo $row[1]; ?></div></td>
             <!--<td align="center" width="28" >&nbsp;<?php echo $row[5]; ?></td>-->
			 <td align="left" style="word-break: keep-all;" ><div align="center" style="width: 270px;"><?php echo  $location; ?></div></td>
			 
			 <td align="center"><div align="center" style="width: 55px;"><?php if(isset($annr[9]) and $annr[9]!='0000-00-00'){ echo date('d/m/Y',strtotime($annr[9])); } else{ echo "NA"; } ?></div></td>			 			              
			  <td align="center"><div align="center" style="width: 55px;"><?php if(isset($annr[10]) and $annr[10]!='0000-00-00'){ echo date('d/m/Y',strtotime($annr[10])); } else{ echo "NA"; } ?></div></td>			 			              
		      <td align="center"><div align="center" style="width: 55px;"><?php  if(isset($annr[13]) and $annr[13]!='0000-00-00'){ echo date('d/m/Y',strtotime($annr[13])); }
		      else{ echo "NA"; }//$bills[$i]; 
		      ?></div></td>
                <td align="center"><div align="center" style="width: 55px;"><?php if(isset($annr[6]) and $annr[6]!='0000-00-00'){ echo date('d/m/Y',strtotime($annr[6])); }
                else{ echo "NA"; } ?></div></td>
                 <td align="center"><div align="center" style="width: 40px;"><?php echo $annr[8]; ?></div></td>
               		 			              
			 <td align="right"><div align="center" style="width: 72px;"><?php echo number_format((float)$annr[12], 2, '.', ''); ?></div></td>			
...
</br><div  align="right"><b>For :<?php echo $rowcomp[1]; ?></b> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div></br>
<br><br>
...
//echo  $to;
 ...
 $gtotal=round($to+$svt+$ec+$shec);
  ...
  ?></td><td align="right"><?php echo number_format($svt,2); ?></td></tr>
