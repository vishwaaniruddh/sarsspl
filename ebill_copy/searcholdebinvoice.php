...
<table border="1" align="center"  id="tblebill">
  <tr>
	...
	<?php	
		...
		{
		$odooInvoice_a = $row['odooInvoice_a'];
		$odooInvoice_b = $row['odooInvoice_b'];
   ...
   <?php if($cust_name_row[0].trim()=="Fidility")
    {
    //echo $cust_name_row[0];
    ?>
    <td><a href="viewoldebinvfis.php?invid=<?php echo $row[0]; ?>&yr=<?php echo $row[14]; ?>" target="_blank">View Bill</a></td>
    <?php
    }
    else if($cust_name_row[0].trim()=="Diebold")
{
?>
<td><a href="viewoldebinvdiebold.php?invid=<?php echo $row[0]; ?>&yr=<?php echo $row[14]; ?>" target="_blank">View Bill</a></td>
...
<?php 
$pgnm="viewoldebinv".$cust_name_row[0].trim()."_test.php";
?>
    ...
    <td>
        ...
        ?>
        <a href="<?php echo $pgnm;?>?invid=<?php echo $row[0]; ?>&yr=<?php echo $row[14]; ?>" target="_blank">View GST Bill</a>
        <?php } ?>
...
<td><?php if($row[16]=='0'){ ?><input type="button" name="clbtn<?php echo $cnt;?>" id="clbtn<?php echo $cnt;?>" value="close invoice" onclick="clsfuncc('<?php echo $row[0]; ?>','<?php echo $row[14]; ?>',this.id);"><?php } 
...
<?php
if($cust_name_row[0].trim()=="Fidility")
    { 
?>
<td><a href="viewsvch.php?invid=<?php echo $row[0]; ?>&yr=<?php echo $row[14]; ?>" target="_blank">View Service Charge</a></td>
...
<td><? 
$finstart = explode('-',$row['fiscalyr'])[0];
if($finstart>=23){ 
    ?>
    <? echo $odooInvoice_a ; ?>
    <a href="processOdooInvoice.php?invid=<?php echo $row[0]; ?>" target="_blank">
        <? if($odooInvoice_a){
            echo ' - Edit' ;
        }else{
            echo 'Enter' ;
