...
$objSheet->setCellValue('V1', 'Transfer Date');
$objSheet->setCellValue('W1', 'Transfer Amount');

$objSheet->setCellValue('X1', 'Approved By');
$objSheet->setCellValue('Y1', 'Mail By');
$objSheet->setCellValue('Z1', 'Call Status');
$objSheet->setCellValue('AA1', 'Prime Code');
...
$objSheet->setCellValueByColumnAndRow(21, $row,$transdetaildate);
$objSheet->setCellValueByColumnAndRow(22, $row,$transdetail[7]);

$objSheet->setCellValueByColumnAndRow(23, $row,$approw[7]);
$objSheet->setCellValueByColumnAndRow(24, $row,$mdrow[0]);
$objSheet->setCellValueByColumnAndRow(25, $row,$st);
$objSheet->setCellValueByColumnAndRow(26, $row,$approw[5]);
