...
$scat=$scat.",".$row[27];
  ...
  <td>&nbsp;<?php echo $row[27]; ?></td>
   <?php
         ...
         <td>&nbsp;<?php if($row[28]>$start_date){ echo date('d/m/Y',strtotime($row[28]));}else{ echo date('d/m/Y',strtotime($start_date));} ?></td>
...
?>
<tr><td colspan="21" align="center"><b>Total Billing Amount</b><?php //echo round($tot,2); ?></td><td align="right"><?php echo number_format(round($tot), 2, '.', ''); ?></td></tr>
