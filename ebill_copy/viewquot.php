...
document.getElementById("search").innerHTML ="<center><img src=loader.gif></center>";
	...
	var pmeters="";
	if(a!="Loading"){ 
			 pmeters = 'cid='+cid+'&Page='+b+'&perpg='+ppg+'&sdate='+sdate+'&edate='+edate+'&desig='+desig+'&service='+serv+'&dept='+dept+'&pstat='+pstat+"&atmid="+atmid+"&app="+app;
			}//alert("gg");
			else
			{
...
<?php
$app=mysqli_query($con,"select description,statuslevel from designation where statuslevel<>0 and statuslevel<>5 order by statuslevel ASC");
