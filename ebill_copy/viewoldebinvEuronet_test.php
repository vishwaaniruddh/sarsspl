...
$currentdate=date('Y-m-d');
   ...
   $sttcode=mysqli_query($con,"select * from euronet_gst where State like'%".$sndbillqryf['state']."%'");
...
if($sttcodef[2]=="" or $sttcodef[2]=="na"){
    ...
    $sttcodemh=mysqli_query($con,"select * from euronet_gst where State like '%Maharashtra%'");
...
<table width="850" cellpadding="0" cellspacing="0">
  ...
  <tr height="17">
    ...
    <td width="300">&nbsp;</td>
     <td width="302" rowspan="8" align="right" valign="top" style="padding-right:8px"><div align="right">Invoice No:-<span id="invoiceNumber_a"><?php 
   echo  $invro[5]; ?></span>
    </div>
...
<?php }
 ...
 $getgstnumos11=mysqli_query($con,"select * from gst_no_os where state like '%".$addrow1[8]."%'");
...
<td><?php echo $getgstnumosf11['gst']; ?></td>
</tr>
			...
			function formatTwoDecimals($value, $trim)
{
  ...
  <col width="151" />
  <tr height="18">
          <td height="18" colspan="2" align="left">Invoice No:- <span id="invoiceNumber_b"> <?php  echo  $invro[9]; ?> </span> </td>
