...
$currentdate=date('Y-m-d');
   ...
   //echo "select * from ags_gst where State like'%".$sndbillqryf['state']."%'";
   $sttcode=mysqli_query($con,"select * from ags_gst where State like'%".$sndbillqryf['state']."%'");
...
if($sttcodef[2]=="" or $sttcodef[2]=="na"){
    ...
    $sttcodemh=mysqli_query($con,"select * from ags_gst where State like '%Maharashtra%'");
...
<table width="850" cellpadding="0" cellspacing="0">
  ...
  <tr height="17">
    ...
    <td width="300">&nbsp;</td>
     <td width="302" rowspan="8" align="left" valign="top" style="padding-right:8px"><div align="left">Invoice No:-<?php 
   echo  $invro[5]; ?>
    </div>
    <div align="left">Date :- <?php echo date("d-F-Y",strtotime($invro[3])); ?></div>
    <br/>
    
    <div align="left"> Clear Secured Services Pvt Ltd. 
    </div>
    <div align="left"> D-201,Runwal & Omkar E-Square, Second Floor, 
    </div>
    <div align="left"> Second Floor, Sion (East), 
    </div>
    <div align="left"> Mumbai - 400 022
    </div>
    <div align="left">Maharastra
    </div>
    ...
    <br/>
    <div align="left"> PAN NO. AADCC5952H
    </div>
    </td>
