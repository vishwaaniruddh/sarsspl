...
for($loop=0;$loop<$desiredLength;$loop++){
    ...
    $sql=mysql_query("select distinct srno,a,b,c,d,final_ans,ideal_time,mcq,topic,sub_topic,imgf from quiztest WHERE topic='".$topic."' and sub_topic='".$main_subtopicArray[$loop]."'  order by rand() ASC LIMIT 1",$con);    
