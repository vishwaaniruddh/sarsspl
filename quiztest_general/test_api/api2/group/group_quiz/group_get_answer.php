...
$sql=mysql_query("SELECT * from group_response where testid='".$testid."' and groupid='".$groupid."'",$con);

// echo "SELECT * from group_response where testid='".$testid."' and groupid='".$groupid."'";
...
$update_sql2="UPDATE quiz_result set p1_responses='".$p1_response."' WHERE id='".$testid."'";
    ...
    // echo $update_sql2;    
           if(mysql_query($update_sql2,$con)){
            echo 1;
        }
        else{
            echo 0;
...
echo "UPDATE quiz_result set p2_responses='".$p2_response."' WHERE id='".$testid."'";
    $update_sql4="UPDATE quiz_result set p2_responses='".$p2_response."' WHERE id='".$testid."'";
        ...
        if(mysql_query($update_sql4,$con)){
            echo 1;
        }
        else{
            echo 0;
