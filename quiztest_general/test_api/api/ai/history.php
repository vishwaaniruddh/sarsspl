...
if($subjectid>0){
    $sql=mysql_query("SELECT * from quiz_result where p1='".$userid."' and p2='AI' and subject='".$subjectid."' ORDER by created_at DESC LIMIT 10",$con);
}
else{
$sql=mysql_query("SELECT * from quiz_result where p1='".$userid."' and p2='AI' ORDER by created_at DESC LIMIT 10",$con);    
}
