...
$sql1=mysql_query("SELECT topic_ids FROM quiz_result WHERE MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) and (p1='".$userid."' OR p2='".$userid."') and topic_ids='".$sql_result['topic_ids']."'",$con);



$array=array();

while($sql_result1=mysql_fetch_assoc($sql1)){
