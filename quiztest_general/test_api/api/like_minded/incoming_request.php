...
$check_sql=mysql_query("SELECT * from like_minded where testid='".$testid."'",$con);
...
if($minutes==30) {
     ...
     $sql1=mysql_query("select * from like_minded where testid='".$testid."' and is_accepted=1",$con);
   ...
   $check_sql=mysql_query("SELECT * from like_minded where testid='".$testid."' and is_accepted=1",$con);
