...
// $time = date('Gi.s', $timestamp);
    ...
    $data[]=['data'=>['p2'=>$p2,'p1_correct_count'=>$p1_correct_count,'topic'=>$topic_name,'subject'=>$subject,'p2_correct_count'=>$p2_correct_count,'player_won'=>$player_won,'date'=>$date,'timestamp'=>$timestamp]];        
    }
