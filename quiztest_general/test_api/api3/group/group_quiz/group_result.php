...
$sql_points=mysql_query("select * from quiz_result where id='".$testid."'",$con);
$sql_points_result=mysql_fetch_assoc($sql_points);
...
$send_sql=mysql_query("select * from quiz_result where id='".$testid."'",$con);
$send_sql_result=mysql_fetch_assoc($send_sql);
