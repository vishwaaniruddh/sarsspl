...
session_start();  
     if($_POST['ptyp']=="1")
            ...
            }else if($_POST['ptyp']=="2")
            {
                $cntd="15";
                
            }else if($_POST['ptyp']=="3" || $_GET['aid']=="4")
            {
                $cntd="10";
...
<head>
 ...
 <script>
  ...
  success: function(data){
   ...
   document.getElementById("mcqshw").innerHTML="test";
   }catch(ex)
   {
...
var myCounter = new Countdown({  
    ...
    onUpdateStatus: function(sec){
           ...
           document.getElementById("timer").innerHTML='<font size="5">Time Left </font>'+sec+ ' seconds';
                ...
                <ul>
                   ...
                   <!-- <li data-transition="fade" data-slotamount="7" data-masterspeed="1500" >
                    ...
                    <li data-transition="zoomout" data-slotamount="7" data-masterspeed="1000" >
                        ...
                        <div id="mcqshw" style="font-size:14px;">
                        ...
                        <div>
<center>
<input type="button" class="btn btn-default btn-lg" onclick="getqfunc(2)" value="Previous">
