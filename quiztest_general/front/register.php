...
<title>Quiz 2 Shine</title>


<meta property="og:title" content="Quiz 2 Shine">
<meta property="og:description" content="Quiz 2 Shine.">
<meta property="og:image" content="http://sarmicrosystems.in/quiztest/img/Quiz2shine.png">
<meta property="og:url" content="https://www.sarmicrosystems.in/quiztest/front/register.php">
...
<? }    ?>
        ...
        <div class="form-group">
        	<input type="text" class="form-control" name="schname" placeholder="school" required="required">
        </div>
...
<option value="10">X</option>
    ...
    if(isset($_GET['rg'])){ ?>
    	...
    	<div class="text-center">Already have an account? <a href="https://www.sarmicrosystems.in/quiztest/front/login.php?rg=<? echo $_GET['rg']; ?>">Sign in</a></div>        
    <? } 
    else{ ?>
       	<div class="text-center">Already have an account? <a href="https://www.sarmicrosystems.in/quiztest/front/login.php">Sign in</a></div> 
    <? } ?>
