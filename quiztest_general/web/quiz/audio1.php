...
<body>
                                 ...
                                 <div class="privew">
                                    <div class="questionsBox">
                                       ...
                                       <div class="row quiz" id="quiz" data-toggle="buttons" style="display: block;">
                                          ...
                                          <p name="q_answer" value="1" id="a" onclick="OptionClicked('a')"
                                             class="element-animation1 btn btn-lg btn-primary btn-block">Loading ..</p>


                                          <p class="element-animation2 btn btn-lg btn-primary btn-block" name="q_answer"
                                             id="b" value="2" onclick="OptionClicked('b')">Loading ..</p>


                                          <p class="element-animation3 btn btn-lg btn-primary btn-block" name="q_answer"
                                             id="c" value="3" onclick="OptionClicked('c')">Loading .. </p>

                                          <p class="element-animation4 btn btn-lg btn-primary btn-block" name="q_answer"
   ...
   <script type="text/javascript">
      ...
      function AIResponce() {
         ...
         if (againstId == '1' && (question.length > (currQNum + 3))) {
            if (ai_type == 'ai1') {
               OppCorrect++;
