...
<div class="banner">
    ...
    <h2 class="heading">Play With Friends</h2>
    </div>
</div>
...
<?}
  ...
  <div class="form-group">
    ...
    <div class="flex">
        <!-- <a href="quiz.php" class="btn btn-primary">Start</a> -->
  ...
  <script>
    ...
    $('#start').click(function() {
       ...
       console.log('subid: ' + subid + ', topicid: ' + topicid + ', AgainstId: ' + "2");
       if(!(+subid>=1)){
       ...
       SendQuizRequestToFriends(0).then(
            data => {
    ...
    function SendQuizRequestToFriends(FriendId) {
        ...
        return new Promise((resolve) => {
            ...
            setTimeout(() => {
                this.PostData(this.CommUrl + "api/player/"+link, myFd).then(
                    data => {
                        console.log("Request sent : ", data);
