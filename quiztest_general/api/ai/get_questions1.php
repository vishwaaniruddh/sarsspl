...
$userid=$_POST['userid'];
  ...
  /*  $select_subtopic_sql=mysqli_query($con,"SELECT distinct(sub_topic) from quiztest where topic='".$topic."'");  // and sub_topic in(220)
    ...
    $sr=array();
    $select_subtopic_sql=mysqli_query($con,"SELECT distinct(sub_topic) from quiztest where topic='".$topic."'");  
