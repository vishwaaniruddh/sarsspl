...
$get_group=mysqli_query($con,"select * from groups where member0='".$userid."' OR member1='".$userid."' OR member2='".$userid."' OR member3='".$userid."' OR created_by='".$userid."'");

while($get_group_result=mysqli_fetch_assoc($get_group)){
...
foreach($groupid as $key => $value){
    ...
    $quiz_sql=mysqli_query($con,"select * from quiz_result where p1='Gr".$value."' and subject='".$subjectid."'");
    
    }
    else{
        
            $quiz_sql=mysqli_query($con,"select * from quiz_result where p1='Gr".$value."'");
    }
    ...
    while($quiz_sql_result=mysqli_fetch_assoc($quiz_sql)){
...
foreach($groupid as $key => $value){
    ...
    if($subjectid>0){
         $quiz_sql=mysqli_query($con,"select * from quiz_result where p2='Gr.".$value."' and subject='".$subjectid."'");
    }
    else{
        $quiz_sql=mysqli_query($con,"select * from quiz_result where p2='Gr.".$value."'");        
    }
