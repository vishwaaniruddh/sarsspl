...
$get_sql=mysqli_query($con,"SELECT * from quiz_result where id='".$testid."'");

$check_sql_result=mysqli_fetch_assoc($get_sql);
...
if($groupid!=$group2){
    ...
    $get_sql=mysqli_query($con,"SELECT * from group_result where testid='".$testid."' and question_id='".$question_id."' and groupid='".$group1."'");
...
if(empty($p1_responses) || $p1_responses=='' || $p1_responses==NULL) {
    ...
    $data[]=['is_submit'=>'1'];
     ...
     $get_sql=mysqli_query($con,"SELECT * from group_result where testid='".$testid."' and question_id='".$question_id."' and groupid='".$group2."'");
...
$sql=mysqli_query($con,"SELECT * from group_response where groupid='".$groupid."' and testid='".$testid."' and question_id='".$question_id."'");
