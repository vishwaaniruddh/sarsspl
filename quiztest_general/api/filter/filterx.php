...
if($time==1  && $subject==0){
      ...
      //    $sql="SELECT sum(points) as points,playerid from leaderboards GROUP BY playerid ORDER BY points DESC LIMIT 10";
    }
...
if($time==1 && $subject>0){
        ...
        $sql2="SELECT sum(points2) as points,p2 from quiz_result where points2>=0 and standard='".$std."' and is_count_points2=1 and subject='".$subject."' and p2!='AI'  and p1 not like '%Gr%' and p2 not like '%Gr%' GROUP BY p2 ORDER BY points DESC LIMIT 10";
}

if($time==1  && $subject==0){
        
        $sql2="SELECT sum(points2) as points,p2 from quiz_result where points2>=0  and p2!='AI' and standard='".$std."' and is_count_points2=1 and  p1 not like '%Gr%' and p2 not like '%Gr%' GROUP BY p2 ORDER BY points DESC LIMIT 10";
    }
...
if($time==2 && $subject>0){
        ...
        $sql2="SELECT sum(points2) as points,p2 from quiz_result where points2>0 and MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) and p2!='AI' and standard='".$std."'  and subject='".$subject."' and is_count_points2=1 and p1 not like '%Gr%' and p2 not like '%Gr%' GROUP BY p2 ORDER BY points DESC LIMIT 10";
...
if($time==2  && $subject==0){
        ...
        $sql2="SELECT sum(points2) as points,p2 from quiz_result where points2>0 and MONTH(created_at) = MONTH(CURRENT_DATE()) AND YEAR(created_at) = YEAR(CURRENT_DATE()) and p2!='AI' and standard='".$std."' and is_count_points2=1 and p1 not like '%Gr%' and p2 not like '%Gr%' GROUP BY p2 ORDER BY points DESC LIMIT 10";
    }
