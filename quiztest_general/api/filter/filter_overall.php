...
$sql=mysqli_query($con,"SELECT sum(points1) as points,p1 from quiz_result where points1>0 GROUP BY p1 ORDER BY points DESC limit 15");
...
$p1=$sql_result['p1'];
 ...
 $points1=$sql_result['points'];
    ...
    $sql2=mysqli_query($con,"SELECT sum(points2) as points,p2 from quiz_result where p2='".$p1."' GROUP BY p2 ORDER BY points limit 15");
