...
<td style="text-align: center;"> 
    <input type="checkbox" name="is_serial_no" id="is_serial_no">
</td>
...
<td>
    <select name="material" id="material" onchange="modelnos()" style="width:200px;"  >
        <option value="">Select</option>
     </select>
</td>
...
<!--<td id="demo"><input type="text" name="qty" id="qty" style="width: 50px;"></td>-->
    <td id="demo">
        <input type="text" name="qty" id="qty" style="width:40px;"> 
    </td>
...
<table id="myTable" style="width:30%" align="center">
  ...
  <tr>
    ...
    <td ><input class="srno" type="text" name="srno[]" id="srno0" style="width: 100%;"></td>
...
$('#is_serial_no').change(function() {
    // this will contain a reference to the checkbox   
    if (this.checked) {
        // alert('check');
        $("#myTable tbody").css('padding','10px');
        $("#myTable tbody").css('box-shadow','0px 0px 10px 2px rgb(0 0 0)');
        $("#myTable tbody").css('margin','20px auto');
        ...
        $("#myTable tbody").css('padding','');
        $("#myTable tbody").css('box-shadow','');
        $("#myTable tbody").css('margin','');
        

        $("#qty").css('box-shadow','0px 0px 10px 2px rgb(0 0 0)');
        $("#qty").css('margin','20px auto');
...
$(document).on('change',"#modelno",function(){
modelno_id  =  $(this).val();


    $.ajax({
        type:'POST',
        url:'get_model_data.php',
        data:'id='+modelno_id,
        datatype:'json',
        success:function(msg){
            var jsr=JSON.parse(msg);
            $("#pono").val(jsr['pono']);
            $("#project").val(jsr['project']);
...
function myCreateFunction() {
    ...
    cnt++;
     ...
     cell1.innerHTML ='<input class="srno" type="text" name="srno[]"  id="srno'+cnt +'" style="width: 100%;">';
     $('#srno'+cnt).focus();
