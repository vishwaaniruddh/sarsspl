...
<table id="myTable" style="width:25%" align="center">
          <tr><td>Model NO:</td></tr>
    <tr><!--<td ><input type="text" name="modelno[]" id="modelno" onFocus="this.value=''" onClick="this.value=''"  style="width: 250px;"></td>-->
    <td ><input type="text" name="modelno[]" id="modelno"  style="width: 250px;"></td>
  </tr>
 </table>
<br>
...
<script>
/*
var input = document.getElementById("modelno");
