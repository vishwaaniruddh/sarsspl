...
$EmailSubject = "Mail test working or not";
$message = "mail test working or not";
...
$to = ["rajeshrungta719@gmail.com"];      //array
$cc = ["hellbinderkumar@gmail.com","work.rajeshb@gmail.com"];      //array
